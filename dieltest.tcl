...
#
#dielectric_cylinder center 3 4 5 axis 3 3 3 radius 4 length 10 res 1 eps 0.2 covers 1
...
constraint pore center 10 10 10 axis 1 0 0 radii 5. 10. length 5  type 0

for { set i 0 } { $i < [ setmd n_part ] } { incr i } {
  set pos [ part $i print pos ]
  puts [ constraint mindist_position [ lindex $pos 0 ] [ lindex $pos 1 ] [ lindex $pos 2 ] ]
}
