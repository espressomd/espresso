...
visualizer = openGLLive(system, background_color=[1,1,1], drag_enabled = True, rasterize_resolution=50.0,rasterize_pointsize = 5 )
...
# SpheroCylinder
#system.constraints.add(shape=SpheroCylinder(center=[25, 25, 25], axis = [1, 0, 0], direction = 1, radius = 10, length = 30), particle_type = 0)

#Maze
#system.constraints.add(shape=Maze(cylrad = 2, dim = 2, nsphere = 5, sphrad = 6), particle_type = 0, penetrable = 1)
...
#Slitpore
#system.constraints.add(shape=Slitpore(channel_width = 30, lower_smoothing_radius = 3, upper_smoothing_radius = 3, pore_length = 40, pore_mouth = 60, pore_width = 10), particle_type = 0, penetrable = 1)
...
#system.thermostat.set_langevin(kT=10.0, gamma=0.01)
#
#for i in range(100):
...
#    cutoff=3.0, shift="auto")
#
#system.non_bonded_inter.set_force_cap(50.0)
