# description: all tcl-Tools to add a cell in IBM simulations
# functions:
...
# Note in order to use these methods you need a mesh file specifying the location of the nodes of all triangles of the cell
# Check samples/immersed_boundary for an example 
# ---------------------------------------------------------------
