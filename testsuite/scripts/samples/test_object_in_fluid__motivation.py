...
os.chdir("/home/thilo/code/espresso2/espresso/testsuite/scripts/samples/local_samples/object_in_fluid")
sample, skipIfMissingFeatures = importlib_wrapper.configure_and_import(
    "/home/thilo/code/espresso2/espresso/testsuite/scripts/samples/local_samples/object_in_fluid/motivation.py", maxCycle=4, cmd_arguments=[0])
