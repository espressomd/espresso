...
electrokinetics boundary charge_density [expr $sigma/$agrid] wall normal 0 0 1 d $padding direction outside
electrokinetics boundary charge_density [expr -$sigma/$agrid] wall normal 0 0 -1 d -[expr $padding+$width] direction outside
