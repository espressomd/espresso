...
puts "----------------------------------------"
puts "- Testcase immersed_boundary.tcl running on [format %02d [setmd n_nodes]] nodes with GPU -"
puts "----------------------------------------"
...
if { [catch {
  ...
  setmd time_step $dt
  setmd skin 0.1
  lbfluid gpu agrid $gridDist dens $rho visc $nu tau $dt ext_force $f 0 0
