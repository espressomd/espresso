...
for {set i 0} {$i <$n} {incr i} {
 part $i pos [expr $l *[t_random]] [expr $l *[t_random]] [expr $l *[t_random]] dip 1 2 3
 set oldPos "$oldPos {[part $i print pos]}"
}
inter magnetic 1 dawaanr
set oldE [analyze energy total]
...
set newE [analyze energy total]
puts "Energy $oldE -> $newE"

if { abs($oldE-$newE)>0.01 } {
   error "Ennergy difference too large."
}
