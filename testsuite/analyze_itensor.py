...
class AnalyzeITensor(ut.TestCase):
    ...
    def setUpClass(self):
        ...
        for i in range(10):
            self.system.part.add(id=i, pos=np.random.random(3) * box_l,type=0)
        for i in range(20,30,1):
            self.system.part.add(id=i, pos=np.random.random(3) * box_l,type=1)
    ...
    def test(self):
        ...
        self.assertTrue(np.allclose(I0, self.system.analysis.momentofinertiamatrix(p_type=0),atol=1E-9))
        # type=1
