...
class CheckpointTest(ut.TestCase):
    ...
    def test_part(self):
        ...
        np.testing.assert_allclose(np.copy(system.part[0].f), np.array([46.78868947, 5.022612, -25.68373659]))
        np.testing.assert_allclose(np.copy(system.part[1].f), np.array([3.90499511e-16, -1.63522209e+00, -1.71556116e+00]))
