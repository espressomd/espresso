...
class Polymer(ut.TestCase):
    ...
    def test(self):
        ...
        # Was the start id considered                       bond=fene,start_id=2)
        for i in 0,1: 
        ...
        # Start position
        np.testing.assert_allclose(np.copy(self.system.part[2].pos),[1.,1.,1.])
        ...
        for i in range(num_poly):
            ...
            for j in range(first_particle+1,first_particle+num_mono):
                ...
                self.assertAlmostEqual(self.system.distance(self.system.part[j],self.system.part[j-1]),0.9,places=5)
        ...
        np.testing.assert_allclose(np.copy(self.system.part[2].pos),[1.,1.,1.])
        np.testing.assert_allclose(np.copy(self.system.part[3].pos),[1.9,1.,1.])
