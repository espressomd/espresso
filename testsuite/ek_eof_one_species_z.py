...
# obtain the desired xi value
        ...
        self.assertLess(total_velocity_difference, 3.5e-07,
                        "Velocity accuracy not achieved")
        self.assertLess(total_pressure_difference_xx, 2.5e-07,
                        "Pressure accuracy xx component not achieved")
        self.assertLess(total_pressure_difference_yy, 2.5e-07,
        ...
        self.assertLess(total_pressure_difference_xy, 1.0e-09,
                        "Pressure accuracy xy component not achieved")
        self.assertLess(total_pressure_difference_yz, 2.0e-06,
                        "Pressure accuracy yz component not achieved")
        self.assertLess(total_pressure_difference_xz, 1.5e-09,
