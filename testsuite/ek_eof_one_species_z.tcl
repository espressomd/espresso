...
if { $total_stress_difference_xx > 5.0e-04 } {
  error_exit "Difference xx component too large"
}
if { $total_stress_difference_yy > 5.0e-04 } {
  error_exit "Difference yy component too large"
}
if { $total_stress_difference_zz > 5.0e-04 } {
...
if { $total_stress_difference_xx_yy > 5.0e-09 } {
  error_exit "Difference xx to yy component too large"
}
if { $total_stress_difference_yy_zz > 5.0e-07 } {
  error_exit "Difference yy to zz component too large"
}
if { $total_stress_difference_yy_zz < 7.5e-08 } {
  error_exit "Difference yy to zz component too small"
}
if { $total_stress_difference_xx_zz > 5.0e-07 } {
  error_exit "Difference xx to zz component too large"
}
if { $total_stress_difference_xx_zz < 7.5e-08 } {
