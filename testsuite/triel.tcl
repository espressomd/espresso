...
puts "---------------------------------------------------------------"
puts "- Testcase triel.tcl running on 1 nodes"
puts "---------------------------------------------------------------"
...
# Verify that the triangle maintains it's shape during $numSteps steps after a single x + 1.0 stretch to a vertex
...
integrate 0
if { ([part 1 print pos] != "2.0 2.0 0.0") || ([part 2 print pos] != "4.0 2.0 0.0")  || ([part 2 print pos] != "2.0 5.0 0.0") } {
...
part 1 pos [expr [lindex $part1pos 0] + 1.0]  [lindex $part1pos 1]  [lindex $part1pos 2]
...
if { [expr abs([lindex $lp0 0] - [lindex $lp0_tmp 0])] > $error_margin ||     
[expr abs([lindex $lp0 1] - [lindex $lp0_tmp 1])] > $error_margin || 
[expr abs([lindex $lp0 2] - [lindex $lp0_tmp 2])] > $error_margin} {

error_exit "Error: Distance between particle 1 and particle 0 incorrect."
}

puts "OK: triangle maintains it's shape during $numSteps steps after a single x + 1.0 stretch to a vertex "
...
puts "OK: Triangle maintains it's shape after $numSteps steps during a constant stretch displacement of x + 0.01 "
