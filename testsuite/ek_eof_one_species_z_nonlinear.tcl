...
puts "###############################################################"
puts "#   Testcase ek_eof_one_species_z_nonlinear.tcl running on    #"
puts "#                           $nn nodes                          #"
puts "###############################################################\n"
...
electrokinetics 1 density $density_counterions D 0.3 valency $valency ext_force 0 0 $force
...
if { $total_pressure_difference_yz > 1.0e-05 } {
  error_exit "Stress accuracy yz component not achieved"
}
if { $total_pressure_difference_xz > 2.5e-10 } {
