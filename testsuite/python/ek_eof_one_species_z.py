...
# obtain the desired xi value
    ...
    self.assertTrue(total_density_difference < 9.0e-06,"Density accuracy not achieved")
    self.assertTrue(total_velocity_difference < 4.0e-06,"Velocity accuracy not achieved")
    self.assertTrue(total_pressure_difference_xx < 1.5e-06,"Pressure accuracy xx component not achieved")
    self.assertTrue(total_pressure_difference_yy < 1.5e-06,"Pressure accuracy yy component not achieved")
    self.assertTrue(total_pressure_difference_zz < 3.0e-05,"Pressure accuracy zz component not achieved")
    self.assertTrue(total_pressure_difference_xy < 4.0e-09,"Pressure accuracy xy component not achieved")
    self.assertTrue(total_pressure_difference_yz < 1.5e-05,"Pressure accuracy yz component not achieved")
    self.assertTrue(total_pressure_difference_xz < 7.0e-09,"Pressure accuracy xz component not achieved")
