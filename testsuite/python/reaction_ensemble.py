...
class ReactionEnsembleTest(ut.TestCase):
    ...
    RE=reaction_ensemble.reaction_ensemble(standard_pressure=standard_pressure_in_simulation_units, temperature=temperature, exclusion_radius=exclusion_radius)
    ...
    def setUpClass(cls):
        ...
        cls.RE.add(equilibrium_constant=cls.K_HA_diss,reactant_types=cls.reactant_types,reactant_coefficients=cls.reactant_coefficients, product_types=cls.product_types, product_coefficients=cls.product_coefficients)
