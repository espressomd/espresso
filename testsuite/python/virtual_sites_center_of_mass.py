...
class VirtualSites(ut.TestCase):
    ...
    def set_molecules_and_vs(self, molecule_ids, n_monomers, monomer_types, vs_type=5):
        """
        ...
        for molecule_id_,n_monomers_,monomer_type_ in zip(molecule_ids, n_monomers, monomer_types):
            ...
            vs = self.system.part.add(pos=[0, 0, 0], virtual=True, type=vs_type)
    ...
    def test_vs_position_mass(self):
        ...
        for mol_id_,vs_id_,monomer_type_ in zip(mid_for_vs.keys(), mid_for_vs.values(), monomer_types):
            ...
            print(f'vs_id = {vs_id_}, vs_mass = {vs_mass}')
            expected_vs_mass = 0
            for part in self.system.part.select(mol_id=mol_id_):
                print(f'part.id = {part.id}, part.mass = {part.mass}')
