...
and ("EXTERNAL_FORCES" in espressomd.features()) and ("BARNES_HUT" in espressomd.features()) :
    class ESMSDriftTest(ut.TestCase):
        ...
        def run_test_case(self):
            ...
            constraint = ShapeBasedConstraint(shape = wall, only_positive = 0, particle_type = 2, penetrable = 0)
            self.es.constraints.add(constraint)
