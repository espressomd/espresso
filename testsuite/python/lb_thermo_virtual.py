...
class LBBoundaryThermoVirtualTest(ut.TestCase):
    ...
    def check_virtual(self, fluid_class):
        ...
        lb_fluid = fluid_class(
            agrid=1.0, dens=1.0, visc=1.0, fric=1.0, tau=1.0, seed=42)
        ...
        s.thermostat.set_lb(kT=0, act_on_virtual=True, seed=123)
        ...
        lb_fluid = fluid_class(
            agrid=1.0, dens=1.0, visc=1.0, fric=1.0, tau=1.0, seed=123)
        s.actors.add(lb_fluid)
