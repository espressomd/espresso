...
class VirtualSites(ut.TestCase):
    ...
    def test_pos_vel_forces(self):
        ...
        s.part.add(rotation=(1,1,1),pos=(0.5,0.5,0.5),id=1,quat=(1,0,0,0),omega_lab=(1,2,3))
        pos2=(0.5,0.4,0.5)
        pos3=(0.3,0.5,0.4)
        pos4=(0.5,0.5,0.5)
        cur_id=2
    ...
    def run_test_lj(self):
        ...
        for i in range(int(n/2)):
          ...
          s.part.add(rotation=(1,1,1),id=3*i, pos=random.random(3)*l,type=1,omega_lab=0.3*random.random(3),v=random.random(3))
          # lj spheres
          s.part.add(rotation=(1,1,1),id=3*i+1,pos=s.part[3*i].pos+s.part[3*i].director/2.,type=0)
          s.part.add(rotation=(1,1,1),id=3*i+2,pos=s.part[3*i].pos-s.part[3*i].director/2.,type=0)
