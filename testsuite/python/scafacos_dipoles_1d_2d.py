...
class Scafacos1d2d(ut.TestCase):
    ...
    def test_scafacos(self):
        ...
        for dim in 2,1:
            ...
            if dim == 2:
                scafacos = magnetostatics.Scafacos(bjerrum_length=1,method_name="p2nfft", method_params={"p2nfft_verbose_tuning":0,"pnfft_N":"64,64,160","pnfft_window_name":"bspline", "pnfft_m":"12","p2nfft_ignore_tolerance":"1","pnfft_diff_ik":"0","p2nfft_r_cut":"6","p2nfft_alpha":"0.8","p2nfft_epsB":"0.05"})
            else:
                if dim == 1:
                    # 1d periodic in x
                    scafacos =magnetostatics.Scafacos(bjerrum_length=1,method_name="p2nfft",method_params={"p2nfft_verbose_tuning":1,"pnfft_N":"32,128,128","pnfft_direct":0,"p2nfft_r_cut":2.855,"p2nfft_alpha":"1.5","p2nfft_intpol_order":"-1","p2nfft_reg_kernel_name":"ewald","p2nfft_p":"16","p2nfft_ignore_tolerance":"1","pnfft_window_name":"bspline","pnfft_m":"8","pnfft_diff_ik":"1","p2nfft_epsB":"0.125"})
