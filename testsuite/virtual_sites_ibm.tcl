...
puts "---------------------------------------------------------------"
puts "- Testcase lbtracers.tcl running on  [format %02d [setmd n_nodes]] nodes: -"
puts "---------------------------------------------------------------"
...
part 1 pos 5 5 6 virtual 1
part 2 pos 5 5 4 virtual 1
...
part 1 pos 9 5 2 virtual 1
part 2 pos 9 2 3 virtual 1

puts [part 1 print pos ]
puts [part 2 print pos ]

# walls located at z=1 and z=boxz-1 in x-y-plane
lbboundary wall dist 9 normal 0. 0. 1. velocity 0 0 0 
lbboundary wall dist -9 normal 0. 0. -1. velocity 0 0 0
...
[expr abs([lindex $part1v 2] - [lindex $part1lbv 2])] > $error_margin} {
 ...
 puts "Particle Vel: $part1v, Fluid Vel: $part1lbv" 
