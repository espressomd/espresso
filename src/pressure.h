...
MDINLINE void add_three_body_bonded_stress(Particle *p1) {
  ...
  while(i < p1->bl.n) {
    ...
    else if(type == BONDED_IA_STRETCHING_FORCE) {		//NEW
      i = i + 2;
    }
    else if(type == BONDED_IA_AREA_FORCE_LOCAL) {		//NEW
      i = i + 3;
    }
    else if(type == BONDED_IA_AREA_FORCE_GLOBAL) {		//NEW
      i = i + 3;
    }
    else if(type == BONDED_IA_BENDING_FORCE) {		//NEW
      i = i + 4;
    }
    else if(type == BONDED_IA_VOLUME_FORCE) {		//NEW
      i = i + 3;
    }
