...
public:
  ...
  Variant call_method(const std::string &name,
    ...
    if (name == "node_get_v")
      return m_lb_walberla->get_node_velocity(
          get_value<Vector3i>(params.at("node")));
    if (name == "set_get_v")
      m_lb_walberla->set_node_velocity(get_value<Vector3i>(params.at("node")),
                                       get_value<Vector3d>(params.at("v")));
    return none;
  };
