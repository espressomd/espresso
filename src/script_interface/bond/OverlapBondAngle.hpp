#ifndef SCRIPT_INTERFACE_BONDS_OVERLAP_BOND_ANGLE_HPP
#define SCRIPT_INTERFACE_BONDS_OVERLAP_BOND_ANGLE_HPP

#include "Bond.hpp"

#include "core/bond/OverlapBondAngle.hpp"
...
namespace Bond {
class OverlapBondAngle : public AutoParameters<Bond> {
  using CoreBond = ::Bond::OverlapBondAngle;
