...
BOOST_AUTO_TEST_CASE(cartesian_to_cylinder_test,
  ...
  auto const transformed_x =
      transform_coordinate_cartesian_to_cylinder(cart_coord, "x");
  auto const transformed_y =
      transform_coordinate_cartesian_to_cylinder(cart_coord, "y");
  auto const transformed_z =
      transform_coordinate_cartesian_to_cylinder(cart_coord, "z");
...
BOOST_AUTO_TEST_CASE(cylinder_to_cartesian_test,
  ...
  auto const transformed_x =
      transform_coordinate_cylinder_to_cartesian(cylinder_coord, "x");
  auto const transformed_y =
      transform_coordinate_cylinder_to_cartesian(cylinder_coord, "y");
  auto const transformed_z =
      transform_coordinate_cylinder_to_cartesian(cylinder_coord, "z");
