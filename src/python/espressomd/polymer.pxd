...
cdef extern from "polymer.hpp":
    vector[vector[Vector3d]] draw_polymer_positions(PartCfg &, int polymers, int monomers, double bond_length, vector[Vector3d] & start_positions, int mode, double shield, int max_try, int use_bond_angle, double angle, double angle2, int constr)
