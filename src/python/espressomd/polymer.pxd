...
cdef extern from "polymer.hpp":
    vector[vector[Vector3d]] draw_polymer_positions(PartCfg &, int N_P, int MPC, double bond_length, vector[Vector3d] & start_positions, int mode, double shield, int max_try, double angle, double angle2, int constr)
