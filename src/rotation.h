...
/** convert torques and angular velocities from the 
...
/** convert torques and angular velocities from the 
    space-fixed frames to body-fixed coordinates */
void convert_torques_space_to_body(Particle *p, double torque[3]);
