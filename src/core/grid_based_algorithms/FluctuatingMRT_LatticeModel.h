...
struct DensityAndMomentumDensity<FluctuatingMRT_LatticeModel>
{
                      ...
                      const FieldPtrOrIterator & it )
   {
        ...
        const double vel2Term = f_12 + f_13 + f_5;
        const double rho = f_0 + f_16 + f_17 + f_2 + f_3 + f_6 + f_9 + vel0Term + vel1Term + vel2Term;
        const double md_0 = -f_13 - f_17 - f_3 - f_7 - f_9 + (0.5)*lm.force_->get(x,y,z,0)/rho + vel0Term;
        const double md_1 = -f_10 - f_12 - f_16 - f_2 + f_8 - f_9 + (0.5)*lm.force_->get(x,y,z,1)/rho + vel1Term;
        const double md_2 = f_11 + f_14 - f_15 - f_16 - f_17 - f_18 - f_6 + (0.5)*lm.force_->get(x,y,z,2)/rho + vel2Term;
