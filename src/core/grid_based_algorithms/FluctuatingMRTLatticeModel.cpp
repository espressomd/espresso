  ...
  for (int ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        ...
        const double xi_249 = _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_256 = _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_259 = _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_265 = _data_force_20_32_10[_stride_force_0 * ctr_0];
        const double xi_266 = _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_269 = _data_force_20_30_10[_stride_force_0 * ctr_0];
        ...
        const double xi_0 = xi_248 + xi_249;
        const double xi_1 = xi_0 + xi_253;
        const double xi_2 = xi_255 + xi_258 + xi_266;
        const double xi_3 = xi_262 + xi_263;
        const double xi_4 = xi_250 + xi_256;
        const double xi_5 = xi_251 + xi_261;
        const double xi_6 = xi_257 + xi_264;
        const double xi_8 = -xi_256;
        ...
        const double xi_21 = xi_10 + xi_20;
        const double xi_22 = -xi_266;
        const double xi_23 = -xi_264;
        const double xi_24 = xi_17 + xi_22 + xi_23 + xi_255;
        const double xi_42 = xi_260 * 0.166666666666667;
        const double xi_50 = xi_269 * 0.166666666666667;
        const double xi_54 = xi_265 * 0.166666666666667;
        const double xi_57 = xi_260 * 0.5;
        const double xi_61 = xi_269 * 0.0833333333333333;
        const double xi_65 = xi_260 * 0.0833333333333333;
        const double xi_75 = xi_265 * 0.0833333333333333;
        const double xi_93 = -xi_252;
        const double xi_94 = xi_263 * 3.0 + xi_264 * 3.0 + xi_93;
        const double xi_95 =
            omega_even * (xi_251 * -3.0 + xi_255 * -3.0 + xi_258 * 3.0 +
                          xi_261 * 3.0 + xi_262 * -3.0 + xi_266 * -3.0 + xi_94);
        const double xi_96 =
            xi_251 * 2.0 + xi_255 * 2.0 + xi_262 * 2.0 + xi_266 * 2.0;
        const double xi_97 = xi_250 * 5.0 + xi_253 * 5.0 + xi_96;
        const double xi_98 =
            omega_even *
            (xi_248 * -5.0 + xi_249 * -5.0 + xi_257 * -5.0 + xi_258 * -2.0 +
             xi_261 * -2.0 + xi_268 * -5.0 + xi_94 + xi_97);
        const double xi_101 = -xi_255;
        const double xi_102 = xi_101 + xi_18;
        const double xi_103 = -xi_267;
        const double xi_106 = -xi_249;
        const double xi_107 = xi_106 + xi_11 + xi_15 + xi_21;
        const double xi_109 = xi_268 * 2.0;
        const double xi_110 = xi_249 * 2.0;
        const double xi_111 = xi_248 * 2.0 + xi_257 * 2.0;
        const double xi_112 =
            omega_even *
            (xi_109 + xi_110 + xi_111 + xi_254 * -7.0 + xi_256 * -7.0 +
             xi_258 * 5.0 + xi_259 * -7.0 + xi_261 * 5.0 + xi_263 * -4.0 +
             xi_264 * -4.0 + xi_267 * -7.0 + xi_93 + xi_97);
        const double xi_113 = xi_101 + xi_262;
        const double xi_114 = xi_113 + xi_14 + xi_22 + xi_251 + xi_258;
        const double xi_116 = xi_114 * xi_115;
        const double xi_118 = xi_103 + xi_259;
        const double xi_122 = Dummy_298 - 0.5;
        const double xi_127 = xi_254 * 2.0;
        const double xi_128 = xi_259 * 2.0;
        const double xi_129 = xi_256 * 2.0 + xi_267 * -2.0;
        const double xi_130 = -xi_127 + xi_128 + xi_129 + xi_14 + xi_19 + xi_2;
        const double xi_132 = xi_130 * xi_131;
        const double xi_133 = Dummy_293 - 0.5;
        const double xi_138 = Dummy_288 - 0.5;
        const double xi_142 = xi_257 + xi_268;
        const double xi_156 = xi_106 + xi_268;
        const double xi_157 = xi_12 + xi_156 + xi_20 + xi_253 + xi_257;
        const double xi_158 = xi_115 * xi_157;
        const double xi_159 = Dummy_296 - 0.5;
        const double xi_161 = xi_1 + xi_127 - xi_128 + xi_129 + xi_13;
        const double xi_162 = xi_131 * xi_161;
        const double xi_163 = Dummy_295 - 0.5;
        const double xi_168 = xi_251 + xi_266;
        ...
        const double xi_238 = xi_157 * xi_213;
        const double xi_239 = xi_161 * xi_211;
        const double vel0Term = xi_1 + xi_259 + xi_267;
        ...
        const double xi_117 = rho * u_1;
        const double xi_119 =
            -vel1Term + xi_117 + xi_118 + xi_256 + xi_262 + xi_5;
        const double xi_121 = xi_119 * xi_120;
        const double xi_187 = xi_119 * xi_186;
        const double xi_197 = xi_196 * (u_0 * xi_117 + xi_118 + xi_254 + xi_8);
        const double xi_198 = -xi_195 - xi_197;
        const double xi_199 = xi_195 + xi_197;
        const double u_2 = xi_7 * (vel2Term + xi_21 + xi_24 + xi_249);
        const double xi_30 = u_2 * xi_265;
        const double xi_31 = xi_30 * 0.333333333333333;
        const double xi_32 = (xi_25 + 2.0) * (xi_27 + xi_29 + xi_31);
        const double xi_35 = xi_30 * 0.666666666666667 + xi_33 + xi_34;
        const double xi_39 = -xi_31;
        ...
        const double xi_71 = -xi_65 + xi_67;
        const double xi_72 = xi_64 + xi_71;
        const double xi_73 = xi_58 * (u_2 * xi_57 + xi_265 * xi_56);
        const double xi_74 = -xi_41 * xi_63;
        const double xi_76 = xi_44 + xi_75;
        const double xi_77 = xi_74 + xi_76;
        const double xi_78 = -xi_73;
        const double xi_79 = xi_58 * (u_0 * xi_265 * 0.5 + u_2 * xi_269 * 0.5);
        const double xi_80 = -xi_79;
        const double xi_81 = -xi_40 * xi_63;
        const double xi_82 = xi_66 + xi_76 + xi_81;
        const double xi_83 = xi_44 - xi_75;
        ...
        const double xi_143 = -xi_100 + xi_263 + xi_264;
        const double xi_144 =
            omega_shear * (xi_0 + xi_105 + xi_142 + xi_143 + xi_16 - xi_258);
        const double xi_145 = xi_144 * 0.125;
        const double xi_147 =
            omega_shear *
            (xi_103 - xi_104 + xi_107 + xi_143 + xi_250 * -2.0 + xi_253 * -2.0 +
             xi_258 + xi_261 + xi_9 + xi_96 + xi_99 * 2.0);
        const double xi_149 =
            xi_147 * -0.0416666666666667 + xi_148 * -0.166666666666667;
        const double xi_150 = xi_149 + xi_89 * -0.1 + xi_95 * -0.05;
        const double xi_151 = xi_141 + xi_145 + xi_146 + xi_150 +
        ...
        const double xi_203 =
            xi_137 + xi_182 + xi_183 + xi_184 + xi_185 + xi_202;
        const double xi_206 = xi_196 * (u_2 * xi_117 + xi_113 + xi_17 + xi_266);
        const double xi_210 =
            xi_149 + xi_204 + xi_205 + xi_206 + xi_207 + xi_208 + xi_209;
        const double xi_219 = xi_171 * xi_186;
        const double xi_221 = xi_219 + xi_220;
        ...
        _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_9 + xi_194 + xi_199 + xi_203 + xi_256;
        _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_10 + xi_198 + xi_201 + xi_203 + xi_259;
        ...
        _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_14 + xi_234 + xi_243 + xi_244 + xi_249;
        _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_15 + xi_227 + xi_229 + xi_246 + xi_266;
