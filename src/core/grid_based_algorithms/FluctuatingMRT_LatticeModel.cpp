   ...
   for (int ctr_2 = 1; ctr_2 < _size_force_2 - 1; ctr_2 += 1)
   {
      ...
      for (int ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1)
      {
         ...
         for (int ctr_0 = 1; ctr_0 < _size_force_0 - 1; ctr_0 += 1)
         {
            ...
            float Dummy_198;
            float Dummy_199;
            philox_float4(time_step, block_offset_0 + ctr_0, block_offset_1 + ctr_1, block_offset_2 + ctr_2, 3, seed, Dummy_196, Dummy_197, Dummy_198, Dummy_199);
            ...
            float Dummy_194;
            float Dummy_195;
            philox_float4(time_step, block_offset_0 + ctr_0, block_offset_1 + ctr_1, block_offset_2 + ctr_2, 2, seed, Dummy_192, Dummy_193, Dummy_194, Dummy_195);
            ...
            float Dummy_190;
            float Dummy_191;
            philox_float4(time_step, block_offset_0 + ctr_0, block_offset_1 + ctr_1, block_offset_2 + ctr_2, 1, seed, Dummy_188, Dummy_189, Dummy_190, Dummy_191);
            ...
            float Dummy_186;
            float Dummy_187;
            philox_float4(time_step, block_offset_0 + ctr_0, block_offset_1 + ctr_1, block_offset_2 + ctr_2, 0, seed, Dummy_184, Dummy_185, Dummy_186, Dummy_187);
            ...
            const double xi_66 = xi_65 + 3.0*_data_pdfs_21_36_10[_stride_pdfs_0*ctr_0] + 3.0*_data_pdfs_2m1_35_10[_stride_pdfs_0*ctr_0];
            const double xi_67 = omega_even*(xi_66 - 3.0*_data_pdfs_21_315_1m1[_stride_pdfs_0*ctr_0] - 3.0*_data_pdfs_21_316_11[_stride_pdfs_0*ctr_0] - 3.0*_data_pdfs_2m1_311_1m1[_stride_pdfs_0*ctr_0] - 3.0*_data_pdfs_2m1_312_11[_stride_pdfs_0*ctr_0] + 3.0*_data_pdfs_20_31_1m1[_stride_pdfs_0*ctr_0] + 3.0*_data_pdfs_20_32_11[_stride_pdfs_0*ctr_0]);
            const double xi_68 = 2.0*_data_pdfs_21_315_1m1[_stride_pdfs_0*ctr_0] + 2.0*_data_pdfs_21_316_11[_stride_pdfs_0*ctr_0] + 2.0*_data_pdfs_2m1_311_1m1[_stride_pdfs_0*ctr_0] + 2.0*_data_pdfs_2m1_312_11[_stride_pdfs_0*ctr_0];
            const double xi_69 = xi_68 + 5.0*_data_pdfs_20_33_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0] + 5.0*_data_pdfs_20_34_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            const double xi_70 = omega_even*(xi_66 + xi_69 - 2.0*_data_pdfs_20_31_1m1[_stride_pdfs_0*ctr_0] - 2.0*_data_pdfs_20_32_11[_stride_pdfs_0*ctr_0] - 5.0*_data_pdfs_21_317_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0] - 5.0*_data_pdfs_21_318_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0] - 5.0*_data_pdfs_2m1_313_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0] - 5.0*_data_pdfs_2m1_314_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0]);
            const double xi_73 = -_data_pdfs_2m1_311_1m1[_stride_pdfs_0*ctr_0];
            const double xi_74 = xi_18 + xi_73;
            const double xi_75 = -_data_pdfs_20_38_1m1[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            const double xi_78 = -_data_pdfs_2m1_314_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            const double xi_79 = xi_11 + xi_15 + xi_21 + xi_78;
            const double xi_81 = 2.0*_data_pdfs_2m1_313_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            const double xi_82 = 2.0*_data_pdfs_2m1_314_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            const double xi_83 = 2.0*_data_pdfs_21_317_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0] + 2.0*_data_pdfs_21_318_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            const double xi_84 = omega_even*(xi_65 + xi_69 + xi_81 + xi_82 + xi_83 - 4.0*_data_pdfs_21_36_10[_stride_pdfs_0*ctr_0] - 4.0*_data_pdfs_2m1_35_10[_stride_pdfs_0*ctr_0] - 7.0*_data_pdfs_20_310_11[_stride_pdfs_0*ctr_0 - _stride_pdfs_0] - 7.0*_data_pdfs_20_37_1m1[_stride_pdfs_0*ctr_0 + _stride_pdfs_0] - 7.0*_data_pdfs_20_38_1m1[_stride_pdfs_0*ctr_0 - _stride_pdfs_0] - 7.0*_data_pdfs_20_39_11[_stride_pdfs_0*ctr_0 + _stride_pdfs_0] + 5.0*_data_pdfs_20_31_1m1[_stride_pdfs_0*ctr_0] + 5.0*_data_pdfs_20_32_11[_stride_pdfs_0*ctr_0]);
            const double xi_85 = xi_73 + _data_pdfs_2m1_312_11[_stride_pdfs_0*ctr_0];
            const double xi_86 = xi_14 + xi_22 + xi_85 + _data_pdfs_20_31_1m1[_stride_pdfs_0*ctr_0] + _data_pdfs_21_316_11[_stride_pdfs_0*ctr_0];
            const double xi_88 = xi_86*xi_87;
            const double xi_90 = xi_75 + _data_pdfs_20_310_11[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            const double xi_94 = Dummy_195 - 0.5;
            const double xi_99 = 2.0*_data_pdfs_20_37_1m1[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            const double xi_100 = 2.0*_data_pdfs_20_310_11[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            const double xi_101 = -2.0*_data_pdfs_20_38_1m1[_stride_pdfs_0*ctr_0 - _stride_pdfs_0] + 2.0*_data_pdfs_20_39_11[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            ...
            const double xi_114 = _data_pdfs_21_317_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0] + _data_pdfs_2m1_313_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            const double xi_128 = xi_78 + _data_pdfs_2m1_313_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            const double xi_129 = xi_12 + xi_128 + xi_20 + _data_pdfs_20_34_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0] + _data_pdfs_21_317_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            ...
            const double xi_140 = _data_pdfs_21_315_1m1[_stride_pdfs_0*ctr_0] + _data_pdfs_21_316_11[_stride_pdfs_0*ctr_0];
            const double xi_141 = xi_140 + xi_23 + xi_74 + _data_pdfs_2m1_35_10[_stride_pdfs_0*ctr_0];
            ...
            const double xi_59 = sqrt(xi_58*(-((-omega_even + 1.0)*(-omega_even + 1.0)) + 1.0));
            const double xi_60 = xi_59*(Dummy_196 - 0.5)*3.7416573867739413;
            const double xi_61 = xi_59*(Dummy_198 - 0.5)*5.4772255750516612;
            const double xi_63 = xi_62*sqrt(xi_58*(-((-omega_bulk + 1.0)*(-omega_bulk + 1.0)) + 1.0))*(Dummy_189 - 0.5);
            const double xi_64 = xi_59*(Dummy_197 - 0.5)*8.3666002653407556;
            const double xi_95 = sqrt(xi_58*(-((-omega_odd + 1.0)*(-omega_odd + 1.0)) + 1.0));
            ...
            const double xi_111 = sqrt(xi_58*(-((-omega_shear + 1.0)*(-omega_shear + 1.0)) + 1.0));
            const double xi_112 = xi_111*0.5;
            const double xi_113 = xi_110*xi_112;
            const double xi_118 = xi_60*-0.119047619047619 + xi_84*-0.0198412698412698;
            ...
            const double xi_192 = xi_60*-0.0238095238095238 + xi_84*-0.00396825396825397;
            ...
            const double xi_126 = -vel0Term + xi_114 + xi_125 + xi_4 + _data_pdfs_20_37_1m1[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            ...
            const double xi_169 = xi_168*(u_0*xi_89 + xi_8 + xi_90 + _data_pdfs_20_37_1m1[_stride_pdfs_0*ctr_0 + _stride_pdfs_0]);
            ...
            const double xi_80 = omega_bulk*(xi_17 + xi_22 + xi_71 + xi_72 + xi_74 + xi_77 + xi_79 + _data_pdfs_20_30_10[_stride_pdfs_0*ctr_0]);
            const double xi_115 = -xi_72 + _data_pdfs_21_36_10[_stride_pdfs_0*ctr_0] + _data_pdfs_2m1_35_10[_stride_pdfs_0*ctr_0];
            const double xi_116 = omega_shear*(xi_0 + xi_114 + xi_115 + xi_16 + xi_77 - _data_pdfs_20_31_1m1[_stride_pdfs_0*ctr_0]);
            const double xi_117 = xi_116*0.125;
            const double xi_119 = omega_shear*(xi_115 + xi_68 + xi_71*2.0 + xi_75 - xi_76 + xi_79 + xi_9 - 2.0*_data_pdfs_20_33_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0] - 2.0*_data_pdfs_20_34_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0] + _data_pdfs_20_31_1m1[_stride_pdfs_0*ctr_0] + _data_pdfs_20_32_11[_stride_pdfs_0*ctr_0]);
            const double xi_121 = xi_119*-0.0416666666666667 + xi_120*-0.166666666666667;
            const double xi_122 = xi_121 + xi_61*-0.1 + xi_67*-0.05;
            const double xi_123 = xi_113 + xi_117 + xi_118 + xi_122 + xi_64*0.0285714285714286 + xi_70*0.0142857142857143;
            const double xi_138 = xi_118 + xi_119*0.0833333333333333 + xi_120*0.333333333333333 + xi_64*-0.0714285714285714 + xi_70*-0.0357142857142857;
            const double xi_143 = rho*u_2 - vel2Term + xi_140 + xi_6 + xi_73 + xi_78 + _data_pdfs_21_318_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            const double xi_144 = xi_143*xi_92;
            const double xi_152 = -xi_113 - xi_117 + xi_122 + xi_60*0.0952380952380952 + xi_64*-0.0428571428571429 + xi_70*-0.0214285714285714 + xi_84*0.0158730158730159;
            const double xi_155 = xi_116*0.0625;
            const double xi_160 = xi_63*0.0833333333333333 + xi_80*0.0416666666666667;
            const double xi_161 = xi_159 + xi_160;
            const double xi_162 = xi_124 + xi_154 + xi_155 + xi_156 + xi_157 + xi_161;
            const double xi_164 = xi_119*0.0208333333333333 + xi_120*0.0833333333333333;
            ...
            const double xi_175 = xi_109 + xi_154 + xi_155 + xi_156 + xi_157 + xi_174;
            const double xi_178 = xi_168*(u_2*xi_89 + xi_17 + xi_85 + _data_pdfs_21_315_1m1[_stride_pdfs_0*ctr_0]);
            const double xi_182 = xi_121 + xi_176 + xi_177 + xi_178 + xi_179 + xi_180 + xi_181;
            ...
            const double xi_201 = xi_121 - xi_176 + xi_177 - xi_178 + xi_179 + xi_180 + xi_181;
            const double xi_203 = -xi_155;
            const double xi_206 = xi_153 + xi_160 + xi_193 + xi_202 + xi_203 + xi_204 + xi_205;
            const double xi_208 = xi_168*(u_2*xi_125 + xi_10 + xi_128 + _data_pdfs_21_318_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0]);
            ...
            const double xi_219 = xi_151 + xi_160 + xi_202 + xi_203 + xi_204 + xi_205 + xi_217;
            ...
            _data_pdfs_tmp_20_30_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_0 + xi_60*0.142857142857143 + xi_61*0.2 - xi_63 + xi_64*0.0857142857142857 + xi_67*0.1 + xi_70*0.0428571428571429 + xi_80*-0.5 + xi_84*0.0238095238095238 + _data_pdfs_20_30_10[_stride_pdfs_0*ctr_0];
            _data_pdfs_tmp_20_31_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_1 + xi_109 + xi_123 - xi_88 + xi_93 - xi_98 + _data_pdfs_20_31_1m1[_stride_pdfs_0*ctr_0];
            _data_pdfs_tmp_20_32_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_2 + xi_123 + xi_124 + xi_88 - xi_93 + xi_98 + _data_pdfs_20_32_11[_stride_pdfs_0*ctr_0];
            _data_pdfs_tmp_20_33_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_3 - xi_127 + xi_130 + xi_132 + xi_137 + xi_138 + _data_pdfs_20_33_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            _data_pdfs_tmp_20_34_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_4 + xi_127 - xi_130 - xi_132 + xi_138 + xi_139 + _data_pdfs_20_34_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            _data_pdfs_tmp_20_35_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_5 - xi_142 + xi_144 - xi_146 + xi_151 + xi_152 + _data_pdfs_2m1_35_10[_stride_pdfs_0*ctr_0];
            _data_pdfs_tmp_20_36_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_6 + xi_142 - xi_144 + xi_146 + xi_152 + xi_153 + _data_pdfs_21_36_10[_stride_pdfs_0*ctr_0];
            _data_pdfs_tmp_20_37_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_7 + xi_162 + xi_166 + xi_170 + _data_pdfs_20_37_1m1[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            _data_pdfs_tmp_20_38_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_8 + xi_162 + xi_171 + xi_173 + _data_pdfs_20_38_1m1[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            _data_pdfs_tmp_20_39_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_9 + xi_166 + xi_171 + xi_175 + _data_pdfs_20_39_11[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            _data_pdfs_tmp_20_310_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_10 + xi_170 + xi_173 + xi_175 + _data_pdfs_20_310_11[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            _data_pdfs_tmp_20_311_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_11 + xi_182 + xi_194 + xi_199 + _data_pdfs_2m1_311_1m1[_stride_pdfs_0*ctr_0];
            _data_pdfs_tmp_20_312_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_12 + xi_194 + xi_200 + xi_201 + _data_pdfs_2m1_312_11[_stride_pdfs_0*ctr_0];
            _data_pdfs_tmp_20_313_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_13 + xi_206 + xi_209 + xi_214 + _data_pdfs_2m1_313_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            _data_pdfs_tmp_20_314_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_14 + xi_206 + xi_215 + xi_216 + _data_pdfs_2m1_314_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
            _data_pdfs_tmp_20_315_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_15 + xi_199 + xi_201 + xi_218 + _data_pdfs_21_315_1m1[_stride_pdfs_0*ctr_0];
            _data_pdfs_tmp_20_316_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_16 + xi_182 + xi_200 + xi_218 + _data_pdfs_21_316_11[_stride_pdfs_0*ctr_0];
            _data_pdfs_tmp_20_317_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_17 + xi_214 + xi_215 + xi_219 + _data_pdfs_21_317_10[_stride_pdfs_0*ctr_0 + _stride_pdfs_0];
            _data_pdfs_tmp_20_318_10[_stride_pdfs_tmp_0*ctr_0] = forceTerm_18 + xi_209 + xi_216 + xi_219 + _data_pdfs_21_318_10[_stride_pdfs_0*ctr_0 - _stride_pdfs_0];
         }
      }
   }
}
...
static FUNC_PREFIX void kernel_collide(double * RESTRICT const _data_force, double * RESTRICT _data_pdfs, int64_t const _size_force_0, int64_t const _size_force_1, int64_t const _size_force_2, int64_t const _stride_force_0, int64_t const _stride_force_1, int64_t const _stride_force_2, int64_t const _stride_force_3, int64_t const _stride_pdfs_0, int64_t const _stride_pdfs_1, int64_t const _stride_pdfs_2, int64_t const _stride_pdfs_3, uint32_t block_offset_0, uint32_t block_offset_1, uint32_t block_offset_2, double omega_bulk, double omega_even, double omega_odd, double omega_shear, uint32_t seed, double temperature, uint32_t time_step)
{
   ...
   for (int ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1)
   {
      ...
      for (int ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1)
      {
         ...
         {
            const double xi_220 = _data_pdfs_20_32_10[_stride_pdfs_0*ctr_0];
            const double xi_221 = _data_pdfs_20_311_10[_stride_pdfs_0*ctr_0];
            const double xi_222 = _data_pdfs_20_310_10[_stride_pdfs_0*ctr_0];
            const double xi_223 = _data_pdfs_20_36_10[_stride_pdfs_0*ctr_0];
            const double xi_224 = _data_pdfs_20_34_10[_stride_pdfs_0*ctr_0];
            const double xi_225 = _data_pdfs_20_37_10[_stride_pdfs_0*ctr_0];
            const double xi_226 = _data_pdfs_20_38_10[_stride_pdfs_0*ctr_0];
            const double xi_227 = _data_pdfs_20_318_10[_stride_pdfs_0*ctr_0];
            const double xi_228 = _data_force_20_31_10[_stride_force_0*ctr_0];
            const double xi_229 = _data_pdfs_20_30_10[_stride_pdfs_0*ctr_0];
            const double xi_230 = _data_pdfs_20_314_10[_stride_pdfs_0*ctr_0];
            ...
            const double xi_233 = _data_pdfs_20_312_10[_stride_pdfs_0*ctr_0];
            const double xi_234 = _data_pdfs_20_33_10[_stride_pdfs_0*ctr_0];
            ...
            const double xi_237 = _data_pdfs_20_315_10[_stride_pdfs_0*ctr_0];
            const double xi_238 = _data_pdfs_20_313_10[_stride_pdfs_0*ctr_0];
            const double xi_239 = _data_pdfs_20_317_10[_stride_pdfs_0*ctr_0];
            const double xi_240 = _data_pdfs_20_35_10[_stride_pdfs_0*ctr_0];
            const double xi_241 = _data_pdfs_20_39_10[_stride_pdfs_0*ctr_0];
            ...
            const double xi_0 = xi_227 + xi_230;
            const double xi_1 = xi_0 + xi_224;
            const double xi_2 = xi_221 + xi_231 + xi_237;
            const double xi_3 = xi_233 + xi_240;
            const double xi_4 = xi_234 + xi_241;
            const double xi_5 = xi_220 + xi_236;
            const double xi_6 = xi_223 + xi_239;
            const double xi_8 = -xi_241;
            const double xi_9 = -xi_225 + xi_8;
            const double xi_10 = -xi_239;
            const double xi_11 = -xi_238;
            const double xi_12 = -xi_234;
            const double xi_13 = xi_10 + xi_11 + xi_12;
            const double xi_14 = -xi_220;
            const double xi_15 = -xi_222;
            const double xi_16 = xi_14 + xi_15;
            const double xi_17 = -xi_236;
            const double xi_18 = -xi_233;
            const double xi_19 = xi_17 + xi_18;
            const double xi_20 = -xi_227;
            const double xi_21 = xi_10 + xi_20;
            const double xi_22 = -xi_237;
            const double xi_23 = -xi_223;
            const double xi_24 = xi_17 + xi_22 + xi_221 + xi_23;
            const double xi_30 = xi_228*0.166666666666667;
            const double xi_37 = xi_232*0.166666666666667;
            const double xi_43 = xi_235*0.166666666666667;
            const double xi_49 = xi_232*0.0833333333333333;
            const double xi_52 = xi_228*0.0833333333333333;
            const double xi_55 = xi_235*0.0833333333333333;
            const double xi_65 = -xi_229;
            const double xi_66 = xi_223*3.0 + xi_240*3.0 + xi_65;
            const double xi_67 = omega_even*(xi_220*3.0 + xi_221*-3.0 + xi_231*3.0 + xi_233*-3.0 + xi_236*-3.0 + xi_237*-3.0 + xi_66);
            const double xi_68 = xi_221*2.0 + xi_233*2.0 + xi_236*2.0 + xi_237*2.0;
            const double xi_69 = xi_224*5.0 + xi_234*5.0 + xi_68;
            const double xi_70 = omega_even*(xi_220*-2.0 + xi_227*-5.0 + xi_230*-5.0 + xi_231*-2.0 + xi_238*-5.0 + xi_239*-5.0 + xi_66 + xi_69);
            const double xi_73 = -xi_221;
            const double xi_74 = xi_18 + xi_73;
            const double xi_75 = -xi_226;
            const double xi_78 = -xi_230;
            const double xi_79 = xi_11 + xi_15 + xi_21 + xi_78;
            const double xi_81 = xi_238*2.0;
            const double xi_82 = xi_230*2.0;
            const double xi_83 = xi_227*2.0 + xi_239*2.0;
            const double xi_84 = omega_even*(xi_220*5.0 + xi_222*-7.0 + xi_223*-4.0 + xi_225*-7.0 + xi_226*-7.0 + xi_231*5.0 + xi_240*-4.0 + xi_241*-7.0 + xi_65 + xi_69 + xi_81 + xi_82 + xi_83);
            const double xi_85 = xi_233 + xi_73;
            const double xi_86 = xi_14 + xi_22 + xi_231 + xi_236 + xi_85;
            const double xi_88 = xi_86*xi_87;
            const double xi_90 = xi_222 + xi_75;
            const double xi_94 = Dummy_195 - 0.5;
            const double xi_99 = xi_225*2.0;
            const double xi_100 = xi_222*2.0;
            const double xi_101 = xi_226*-2.0 + xi_241*2.0;
            const double xi_102 = xi_100 + xi_101 + xi_14 + xi_19 + xi_2 - xi_99;
            const double xi_104 = xi_102*xi_103;
            const double xi_105 = Dummy_190 - 0.5;
            const double xi_110 = Dummy_185 - 0.5;
            const double xi_114 = xi_238 + xi_239;
            const double xi_128 = xi_238 + xi_78;
            const double xi_129 = xi_12 + xi_128 + xi_20 + xi_224 + xi_239;
            const double xi_130 = xi_129*xi_87;
            const double xi_131 = Dummy_193 - 0.5;
            const double xi_133 = xi_1 - xi_100 + xi_101 + xi_13 + xi_99;
            const double xi_134 = xi_103*xi_133;
            const double xi_135 = Dummy_192 - 0.5;
            const double xi_140 = xi_236 + xi_237;
            const double xi_141 = xi_140 + xi_23 + xi_240 + xi_74;
            const double xi_142 = xi_141*xi_87;
            const double xi_145 = Dummy_194 - 0.5;
            const double xi_147 = xi_24 + xi_3 - xi_81 - xi_82 + xi_83;
            const double xi_148 = xi_103*xi_147;
            ...
            const double xi_210 = xi_129*xi_185;
            const double xi_211 = xi_133*xi_183;
            const double vel0Term = xi_1 + xi_222 + xi_226;
            const double vel1Term = xi_2 + xi_225;
            const double vel2Term = xi_238 + xi_3;
            const double rho = vel0Term + vel1Term + vel2Term + xi_229 + xi_4 + xi_5 + xi_6;
            const double xi_7 = 1 / (rho);
            const double xi_58 = rho*temperature;
            const double xi_59 = sqrt(xi_58*(-((-omega_even + 1.0)*(-omega_even + 1.0)) + 1.0));
            const double xi_60 = xi_59*(Dummy_196 - 0.5)*3.7416573867739413;
            ...
            const double xi_71 = rho*(u_0*u_0);
            const double xi_125 = rho*u_0;
            const double xi_126 = -vel0Term + xi_114 + xi_125 + xi_225 + xi_4;
            const double xi_127 = xi_126*xi_92;
            const double xi_163 = xi_126*xi_158;
            const double u_1 = xi_7*(vel1Term + xi_16 + xi_19 + xi_226 + xi_8);
            const double xi_26 = u_1*xi_228;
            const double xi_28 = u_1*2.0;
            const double xi_29 = xi_28 + 1.0;
            const double xi_34 = xi_28 - 1.0;
            const double xi_38 = xi_26*-0.166666666666667;
            ...
            const double xi_77 = xi_75 + xi_76 + xi_9;
            const double xi_89 = rho*u_1;
            const double xi_91 = -vel1Term + xi_233 + xi_241 + xi_5 + xi_89 + xi_90;
            const double xi_93 = xi_91*xi_92;
            const double xi_159 = xi_158*xi_91;
            const double xi_169 = xi_168*(u_0*xi_89 + xi_225 + xi_8 + xi_90);
            const double xi_170 = -xi_167 - xi_169;
            const double xi_171 = xi_167 + xi_169;
            const double u_2 = xi_7*(vel2Term + xi_21 + xi_230 + xi_24);
            const double xi_27 = u_2*xi_235;
            const double xi_32 = xi_27*-0.166666666666667;
            const double xi_33 = xi_31 + xi_32;
            const double xi_39 = xi_32 + xi_38;
            const double xi_41 = u_2*2.0;
            ...
            const double xi_56 = -xi_54;
            const double xi_72 = rho*(u_2*u_2);
            const double xi_80 = omega_bulk*(xi_17 + xi_22 + xi_229 + xi_71 + xi_72 + xi_74 + xi_77 + xi_79);
            const double xi_115 = xi_223 + xi_240 - xi_72;
            const double xi_116 = omega_shear*(xi_0 + xi_114 + xi_115 + xi_16 - xi_231 + xi_77);
            const double xi_117 = xi_116*0.125;
            const double xi_119 = omega_shear*(xi_115 + xi_220 + xi_224*-2.0 + xi_231 + xi_234*-2.0 + xi_68 + xi_71*2.0 + xi_75 - xi_76 + xi_79 + xi_9);
            const double xi_121 = xi_119*-0.0416666666666667 + xi_120*-0.166666666666667;
            const double xi_122 = xi_121 + xi_61*-0.1 + xi_67*-0.05;
            const double xi_123 = xi_113 + xi_117 + xi_118 + xi_122 + xi_64*0.0285714285714286 + xi_70*0.0142857142857143;
            const double xi_138 = xi_118 + xi_119*0.0833333333333333 + xi_120*0.333333333333333 + xi_64*-0.0714285714285714 + xi_70*-0.0357142857142857;
            const double xi_143 = rho*u_2 - vel2Term + xi_140 + xi_227 + xi_6 + xi_73 + xi_78;
            const double xi_144 = xi_143*xi_92;
            const double xi_152 = -xi_113 - xi_117 + xi_122 + xi_60*0.0952380952380952 + xi_64*-0.0428571428571429 + xi_70*-0.0214285714285714 + xi_84*0.0158730158730159;
            const double xi_155 = xi_116*0.0625;
            const double xi_160 = xi_63*0.0833333333333333 + xi_80*0.0416666666666667;
            ...
            const double xi_174 = -xi_159 + xi_160;
            const double xi_175 = xi_109 + xi_154 + xi_155 + xi_156 + xi_157 + xi_174;
            const double xi_178 = xi_168*(u_2*xi_89 + xi_17 + xi_237 + xi_85);
            const double xi_182 = xi_121 + xi_176 + xi_177 + xi_178 + xi_179 + xi_180 + xi_181;
            const double xi_191 = xi_143*xi_158;
            const double xi_193 = xi_191 + xi_192;
            const double xi_194 = -xi_184 + xi_186 - xi_188 + xi_190 + xi_193;
            ...
            const double xi_203 = -xi_155;
            const double xi_206 = xi_153 + xi_160 + xi_193 + xi_202 + xi_203 + xi_204 + xi_205;
            const double xi_208 = xi_168*(u_2*xi_125 + xi_10 + xi_128 + xi_227);
            const double xi_209 = -xi_207 - xi_208;
            const double xi_214 = xi_165 - xi_210 + xi_211 - xi_212 + xi_213;
            const double xi_215 = xi_207 + xi_208;
            const double xi_216 = xi_172 + xi_210 - xi_211 + xi_212 - xi_213;
            ...
            const double forceTerm_17 = xi_49*(xi_36 + xi_54) + xi_55*(xi_45 + xi_50) + xi_57;
            const double forceTerm_18 = xi_49*(xi_40 + xi_56) + xi_55*(xi_45 + xi_51) + xi_57;
            _data_pdfs_20_30_10[_stride_pdfs_0*ctr_0] = forceTerm_0 + xi_229 + xi_60*0.142857142857143 + xi_61*0.2 - xi_63 + xi_64*0.0857142857142857 + xi_67*0.1 + xi_70*0.0428571428571429 + xi_80*-0.5 + xi_84*0.0238095238095238;
            _data_pdfs_20_31_10[_stride_pdfs_0*ctr_0] = forceTerm_1 + xi_109 + xi_123 + xi_231 - xi_88 + xi_93 - xi_98;
            _data_pdfs_20_32_10[_stride_pdfs_0*ctr_0] = forceTerm_2 + xi_123 + xi_124 + xi_220 + xi_88 - xi_93 + xi_98;
            _data_pdfs_20_33_10[_stride_pdfs_0*ctr_0] = forceTerm_3 - xi_127 + xi_130 + xi_132 + xi_137 + xi_138 + xi_234;
            _data_pdfs_20_34_10[_stride_pdfs_0*ctr_0] = forceTerm_4 + xi_127 - xi_130 - xi_132 + xi_138 + xi_139 + xi_224;
            _data_pdfs_20_35_10[_stride_pdfs_0*ctr_0] = forceTerm_5 - xi_142 + xi_144 - xi_146 + xi_151 + xi_152 + xi_240;
            _data_pdfs_20_36_10[_stride_pdfs_0*ctr_0] = forceTerm_6 + xi_142 - xi_144 + xi_146 + xi_152 + xi_153 + xi_223;
            _data_pdfs_20_37_10[_stride_pdfs_0*ctr_0] = forceTerm_7 + xi_162 + xi_166 + xi_170 + xi_225;
            _data_pdfs_20_38_10[_stride_pdfs_0*ctr_0] = forceTerm_8 + xi_162 + xi_171 + xi_173 + xi_226;
            _data_pdfs_20_39_10[_stride_pdfs_0*ctr_0] = forceTerm_9 + xi_166 + xi_171 + xi_175 + xi_241;
            _data_pdfs_20_310_10[_stride_pdfs_0*ctr_0] = forceTerm_10 + xi_170 + xi_173 + xi_175 + xi_222;
            _data_pdfs_20_311_10[_stride_pdfs_0*ctr_0] = forceTerm_11 + xi_182 + xi_194 + xi_199 + xi_221;
            _data_pdfs_20_312_10[_stride_pdfs_0*ctr_0] = forceTerm_12 + xi_194 + xi_200 + xi_201 + xi_233;
            _data_pdfs_20_313_10[_stride_pdfs_0*ctr_0] = forceTerm_13 + xi_206 + xi_209 + xi_214 + xi_238;
            _data_pdfs_20_314_10[_stride_pdfs_0*ctr_0] = forceTerm_14 + xi_206 + xi_215 + xi_216 + xi_230;
            _data_pdfs_20_315_10[_stride_pdfs_0*ctr_0] = forceTerm_15 + xi_199 + xi_201 + xi_218 + xi_237;
            _data_pdfs_20_316_10[_stride_pdfs_0*ctr_0] = forceTerm_16 + xi_182 + xi_200 + xi_218 + xi_236;
            _data_pdfs_20_317_10[_stride_pdfs_0*ctr_0] = forceTerm_17 + xi_214 + xi_215 + xi_219 + xi_239;
            _data_pdfs_20_318_10[_stride_pdfs_0*ctr_0] = forceTerm_18 + xi_209 + xi_216 + xi_219 + xi_227;
         }
      }
   }
}
