  ...
  for (int ctr_2 = 1; ctr_2 < _size_force_2 - 1; ctr_2 += 1) {
    ...
    for (int ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1) {
      ...
      for (int ctr_0 = 1; ctr_0 < _size_force_0 - 1; ctr_0 += 1) {
        ...
        const double xi_60 =
            omega_even *
            (xi_59 - 3.0 * _data_pdfs_21_315_1m1[_stride_pdfs_0 * ctr_0] -
        ...
        const double xi_78 =
            xi_66 + _data_pdfs_2m1_312_11[_stride_pdfs_0 * ctr_0];
        const double xi_79 = xi_14 + xi_22 + xi_78 +
        ...
        const double xi_113 = _data_pdfs_21_315_1m1[_stride_pdfs_0 * ctr_0] +
                              _data_pdfs_21_316_11[_stride_pdfs_0 * ctr_0];
        const double xi_114 = xi_113 + xi_23 + xi_67 +
                              _data_pdfs_2m1_35_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_73 =
            omega_bulk * (xi_17 + xi_22 + xi_64 + xi_65 + xi_67 + xi_70 +
                          xi_72 + _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0]);
        const double xi_96 = -xi_65 +
                             _data_pdfs_21_36_10[_stride_pdfs_0 * ctr_0] +
                             _data_pdfs_2m1_35_10[_stride_pdfs_0 * ctr_0];
        const double xi_97 =
            omega_shear * (xi_0 + xi_16 + xi_70 + xi_95 + xi_96 -
                           _data_pdfs_20_31_1m1[_stride_pdfs_0 * ctr_0]);
        const double xi_98 = xi_97 * 0.125;
        const double xi_99 =
            omega_shear *
            (xi_61 + xi_64 * 2.0 + xi_68 - xi_69 + xi_72 + xi_9 + xi_96 -
             2.0 *
                 _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] -
             2.0 *
                 _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] +
        ...
        const double xi_102 =
            xi_101 + xi_63 * 0.0142857142857143 + xi_94 + xi_98;
        const double xi_111 =
            xi_63 * -0.0357142857142857 + xi_94 + xi_99 * 0.0833333333333333;
        const double xi_119 =
            rho * u_2 - vel2Term + xi_113 + xi_6 + xi_66 + xi_71 +
            _data_pdfs_21_318_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const double xi_120 = xi_119 * xi_92;
        const double xi_121 = xi_101 + xi_63 * -0.0214285714285714 +
                              xi_77 * 0.0158730158730159 - xi_98;
  ...
  for (int ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        ...
        const double xi_60 =
            omega_even * (xi_172 * 3.0 + xi_175 * -3.0 + xi_185 * -3.0 +
                          xi_186 * -3.0 + xi_189 * 3.0 + xi_191 * -3.0 + xi_59);
        const double xi_61 =
            xi_175 * 2.0 + xi_185 * 2.0 + xi_186 * 2.0 + xi_191 * 2.0;
        const double xi_62 = xi_170 * 5.0 + xi_181 * 5.0 + xi_61;
        const double xi_63 =
            omega_even *
            (xi_171 * -5.0 + xi_172 * -2.0 + xi_176 * -5.0 + xi_182 * -5.0 +
             xi_188 * -5.0 + xi_189 * -2.0 + xi_59 + xi_62);
        ...
        const double xi_77 =
            omega_even *
            (xi_172 * 5.0 + xi_173 * -4.0 + xi_174 * -4.0 + xi_177 * -7.0 +
             xi_179 * -7.0 + xi_183 * -7.0 + xi_189 * 5.0 + xi_190 * -7.0 +
             xi_58 + xi_62 + xi_74 + xi_75 + xi_76);
        ...
        const double rho =
            vel0Term + vel1Term + vel2Term + xi_184 + xi_4 + xi_5 + xi_6;
        const double xi_7 = 1 / (rho);
        const double u_0 = xi_7 * (vel0Term + xi_13 + xi_9);
        ...
        const double xi_56 = -xi_54;
        const double xi_65 = rho * (u_2 * u_2);
        const double xi_73 = omega_bulk * (xi_17 + xi_184 + xi_22 + xi_64 +
                                           xi_65 + xi_67 + xi_70 + xi_72);
        const double xi_96 = xi_173 + xi_174 - xi_65;
        const double xi_97 =
            omega_shear * (xi_0 + xi_16 - xi_172 + xi_70 + xi_95 + xi_96);
        const double xi_98 = xi_97 * 0.125;
        const double xi_99 =
            omega_shear *
            (xi_170 * -2.0 + xi_172 + xi_181 * -2.0 + xi_189 + xi_61 +
             xi_64 * 2.0 + xi_68 - xi_69 + xi_72 + xi_9 + xi_96);
        const double xi_100 = xi_99 * -0.0416666666666667;
        const double xi_101 = xi_100 + xi_60 * -0.05;
        const double xi_102 =
            xi_101 + xi_63 * 0.0142857142857143 + xi_94 + xi_98;
        const double xi_111 =
            xi_63 * -0.0357142857142857 + xi_94 + xi_99 * 0.0833333333333333;
        const double xi_119 =
            rho * u_2 - vel2Term + xi_113 + xi_182 + xi_6 + xi_66 + xi_71;
        const double xi_120 = xi_119 * xi_92;
        const double xi_121 = xi_101 + xi_63 * -0.0214285714285714 +
                              xi_77 * 0.0158730158730159 - xi_98;
        const double xi_124 = xi_97 * 0.0625;
        ...
        const double forceTerm_18 =
            xi_49 * (xi_40 + xi_56) + xi_55 * (xi_45 + xi_51) + xi_57;
        _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_0 + xi_184 + xi_60 * 0.1 + xi_63 * 0.0428571428571429 +
            xi_73 * -0.5 + xi_77 * 0.0238095238095238;
        _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_1 + xi_102 + xi_172 - xi_81 + xi_88 + xi_93;
        _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_2 + xi_102 + xi_189 + xi_81 + xi_87 - xi_93;
        _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_3 - xi_105 + xi_108 + xi_110 + xi_111 + xi_170;
        _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_4 + xi_105 - xi_108 + xi_111 + xi_112 + xi_181;
        _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_5 - xi_115 + xi_118 + xi_120 + xi_121 + xi_174;
        _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_6 + xi_115 + xi_117 - xi_120 + xi_121 + xi_173;
        _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_7 + xi_126 + xi_129 + xi_134 + xi_177;
        _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_8 + xi_129 + xi_135 + xi_137 + xi_183;
        _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_9 + xi_134 + xi_135 + xi_139 + xi_179;
        _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_10 + xi_126 + xi_137 + xi_139 + xi_190;
        _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_11 + xi_143 + xi_151 + xi_154 + xi_191;
        _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_12 + xi_151 + xi_155 + xi_156 + xi_185;
        _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_13 + xi_160 + xi_161 + xi_164 + xi_171;
        _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_14 + xi_161 + xi_165 + xi_166 + xi_176;
        _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_15 + xi_154 + xi_156 + xi_168 + xi_175;
        _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_16 + xi_143 + xi_155 + xi_168 + xi_186;
        _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_17 + xi_164 + xi_165 + xi_169 + xi_188;
        _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_18 + xi_160 + xi_166 + xi_169 + xi_182;
      }
    }
  }
}
