...
public:
  ...
  virtual bool set_node_velocity(const Utils::Vector3i &node, const Utils::Vector3d v) = 0;
  virtual boost::optional<Utils::Vector3d>
  ...
  // Density
  virtual boost::optional<double> get_density_at_pos(const Utils::Vector3d &position) = 0;
  virtual bool set_node_density(const Utils::Vector3i node, const double density) = 0;
  virtual boost::optional<double> get_node_density(const Utils::Vector3i node) const = 0;
  ...
  virtual boost::optional<bool> get_node_is_boundary(const Utils::Vector3i &node) const = 0;
  ...
  virtual std::pair<Utils::Vector3d, Utils::Vector3d> get_local_domain() const = 0;
