...
// enum used in the lb_lbfluid_get_fluid_velocity_at_particle_positions function
enum class ParticleCoupling {
    twopoint,
    threepoint
};

std::vector<float> lb_lbfluid_get_fluid_velocity_at_particle_positions(ParticleCoupling coupling);
