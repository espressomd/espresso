...
/** \file lees_edwards_domain_decomposition.hpp
    Data and methods for Lees-Edwards periodic boundary conditions. Most of the
   domain decomposition is handled
 ...
 * GhostCommunicator and also \ref dd_prepare_comm) */
void le_dd_prepare_comm(le_dd_comms_manager *mgr, GhostCommunicator *comm,
                        int data_parts);

/** Update communicators based on a new LE offset. (see \ref GhostCommunicator
 * and also \ref le_dd_prepare_comm) */
