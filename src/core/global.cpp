...
const Datafield fields[] = {
  ...
  {&(langevin_gamma_rotation[0]),  TYPE_DOUBLE, 1, "gamma_rot",1 },    /* 61 from thermostat.cpp */
  {&(langevin_gamma_rotation[1]),  TYPE_DOUBLE, 1, "gamma_rot",1 },    /* 62 from thermostat.cpp */
  {&(langevin_gamma_rotation[2]),  TYPE_DOUBLE, 1, "gamma_rot",1 },    /* 63 from thermostat.cpp */
  { NULL, 0, 0, NULL, 0 }
};
