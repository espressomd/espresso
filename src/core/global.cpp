...
#endif
  {&vv_predcorr_langevin_pref1,     TYPE_DOUBLE, 1, "vv_predcorr_langevin_pref1", 13 }, /* 62 from thermostat.cpp */
#ifndef ROTATIONAL_INERTIA
  {&vv_predcorr_langevin_pref1_rot, TYPE_DOUBLE, 1, "vv_predcorr_langevin_pref1_rot",13 },    /* 63 from thermostat.cpp */
#else
  {vv_predcorr_langevin_pref1_rot,  TYPE_DOUBLE, 3, "vv_predcorr_langevin_pref1_rot",13 },    /* 63 from thermostat.cpp */
#endif
  { NULL, 0, 0, NULL, 0 }
};
