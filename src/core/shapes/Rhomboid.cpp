...
Parameters Rhomboid::all_parameters() const {
  ...
  p["corner"] = Parameter(Parameter::Type::DOUBLE_VECTOR, 3, true);
  p["a"] = Parameter(Parameter::Type::DOUBLE_VECTOR, 3, true);
  p["b"] = Parameter(Parameter::Type::DOUBLE_VECTOR, 3, true);
  p["c"] = Parameter(Parameter::Type::DOUBLE_VECTOR, 3, true);
  p["direction"] = Parameter(Parameter::Type::DOUBLE, true);

  return p;
}

std::map<std::string, Variant> Rhomboid::get_parameters() {
...
void Rhomboid::set_parameter(const std::string &name, const Variant &value) {
  SET_PARAMETER_HELPER("corner", pos);
  SET_PARAMETER_HELPER("a", a);
  SET_PARAMETER_HELPER("b", b);
  SET_PARAMETER_HELPER("c", c);
