...
namespace Bond {
  class IbmTriel : public ThreeParticleBond {
  public:
    ...
    IbmTriel(double a1_i, double a2_i, double b1_i, double b2_i, double l0_i, double lp0_i, 
	     ...
	     double elasticLaw_i, double k1_i, double k2_i) : m_a1{a1_i}, m_a2{a2_i}, m_b1{b1_i}, 
      m_b2{b2_i}, m_l0{l0_i}, m_lp0{lp0_i}, m_sinPhi0{sinPhi0_i}, m_cosPhi0{cosPhi0_i}, 
  ...
  private:
    ...
    // Internal function
    void RotateForces(const double f1_rot[2], const double f2_rot[2], double f1[3], double f2[3], double v12[3], double v13[3]) const;
