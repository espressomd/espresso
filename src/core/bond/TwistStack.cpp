...
int Bond::TwistStack::calc_bonded_eight_particle_force(Particle *si1, Particle *bi1, Particle *bi2, 
						      ...
						      double f_bi2[3], double f_si2[3], 
						      double f_sj1[3], double f_bj1[3], 
						      double f_bj2[3], double f_sj2[3]) const
{
  ...
  const double pot_twist_ref = m_ref_pot;
