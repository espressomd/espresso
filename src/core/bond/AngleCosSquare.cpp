...
/** Computes the three body angle interaction force and adds this
    ...
    @return 0
*/
int Bond::AngleCosSquare::calc_bonded_three_particle_force(Particle *p1, Particle *p2, Particle *p3, double force[3], double force2[3]) const {
...
/** Computes the three body angle interaction energy (see \ref tclcommand_inter, \ref tclcommand_analyze). 
    ...
    @return 0.
*/
int Bond::AngleCosSquare::calc_bonded_three_particle_energy(Particle *p1, Particle *p2, Particle *p3, 
