...
//---BONDED_COULOMB---
int Bond::BondedCoulomb::calc_bonded_pair_force(Particle *p1, Particle *p2, double dx[3], double force[3]) const {
...
int Bond::BondedCoulomb::calc_bonded_pair_energy(Particle *p1, Particle *p2, double dx[3], double *_energy) const {
#ifdef ELECTROSTATICS
