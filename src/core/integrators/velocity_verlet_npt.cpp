...
void velocity_verlet_npt_propagate_vel_final(const ParticleIterable &particles,
                                             double time_step) {
  nptiso.p_vel = {};
...
template <typename ParticleIterable>
void velocity_verlet_npt_propagate_pos(const ParticleIterable &particles,
                                       double time_step) {
  Utils::Vector3d scal{};
  double L_new = 0.0;
...
template <typename ParticleIterable>
void velocity_verlet_npt_propagate_vel(const ParticleIterable &particles,
                                       double time_step) {
  nptiso.p_vel = {};
...
template void velocity_verlet_npt_step_1(const ParticleRangeDefault &particles,
                                         double time_step);
template void velocity_verlet_npt_step_1(const ParticleRangeLangevin &particles,
                                         double time_step);
template void velocity_verlet_npt_step_2(const ParticleRange &particles,
                                         double time_step);
template void velocity_verlet_npt_step_2(const ParticleRangeDefault &particles,
                                         double time_step);
template void velocity_verlet_npt_step_2(const ParticleRangeLangevin &particles,
                                         double time_step);
#endif // NPT
