...
int IBM_Triel_SetParams(int bond_type, int ind1, int ind2,
                        int ind3, double maxDist,
                        tElasticLaw elasticLaw, double k1,
                        double k2);
...
int IBM_Triel_ResetParams(int bond_type, double k1,
                          double l0);
