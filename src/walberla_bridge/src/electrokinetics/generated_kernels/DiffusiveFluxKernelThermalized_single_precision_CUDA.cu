...
//
//! \\file DiffusiveFluxKernelThermalized_single_precision_CUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
namespace internal_diffusivefluxkernelthermalized_single_precision_cuda_diffusivefluxkernelthermalized_single_precision_cuda {
...
void DiffusiveFluxKernelThermalized_single_precision_CUDA::run(IBlock *block, gpuStream_t stream) {
  if (!this->configured_)
