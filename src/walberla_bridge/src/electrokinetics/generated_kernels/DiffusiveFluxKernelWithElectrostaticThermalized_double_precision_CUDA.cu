...
//
//! \\file DiffusiveFluxKernelWithElectrostaticThermalized_double_precision_CUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
namespace internal_diffusivefluxkernelwithelectrostaticthermalized_double_precision_cuda_diffusivefluxkernelwithelectrostaticthermalized_double_precision_cuda {
...
void DiffusiveFluxKernelWithElectrostaticThermalized_double_precision_CUDA::run(IBlock *block, gpuStream_t stream) {
  if (!this->configured_)
  ...
  auto phi = block->getData<gpu::GPUField<double>>(phiID);
