...
//
//! \\file DiffusiveFluxKernelThermalized_double_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class DiffusiveFluxKernelThermalized_double_precision_CUDA {
public:
  DiffusiveFluxKernelThermalized_double_precision_CUDA(
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<DiffusiveFluxKernelThermalized_double_precision_CUDA>
          &kernel) {
