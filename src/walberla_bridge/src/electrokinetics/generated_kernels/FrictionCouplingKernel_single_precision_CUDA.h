...
//
//! \\file FrictionCouplingKernel_single_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class FrictionCouplingKernel_single_precision_CUDA {
public:
  FrictionCouplingKernel_single_precision_CUDA(BlockDataID fID_,
                                               BlockDataID jID_, float D,
                                               float kT, float rho_lb)
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<FrictionCouplingKernel_single_precision_CUDA> &kernel) {
