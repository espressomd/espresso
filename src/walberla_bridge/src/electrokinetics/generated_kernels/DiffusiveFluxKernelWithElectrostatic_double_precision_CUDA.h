...
//
//! \\file DiffusiveFluxKernelWithElectrostatic_double_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class DiffusiveFluxKernelWithElectrostatic_double_precision_CUDA {
public:
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<
          DiffusiveFluxKernelWithElectrostatic_double_precision_CUDA> &kernel) {
