...
//
//! \\file DiffusiveFluxKernel_single_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class DiffusiveFluxKernel_single_precision_CUDA {
public:
  DiffusiveFluxKernel_single_precision_CUDA(BlockDataID jID_,
                                            BlockDataID rhoID_, float D)
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<DiffusiveFluxKernel_single_precision_CUDA> &kernel) {
