...
//
//! \\file ContinuityKernel_double_precision_CUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
#include "ContinuityKernel_double_precision_CUDA.h"
...
namespace internal_continuitykernel_double_precision_cuda_continuitykernel_double_precision_cuda {
...
void ContinuityKernel_double_precision_CUDA::run(IBlock *block, gpuStream_t stream) {
  ...
  internal_continuitykernel_double_precision_cuda_continuitykernel_double_precision_cuda::continuitykernel_double_precision_cuda_continuitykernel_double_precision_cuda<<<_grid, _block, 0, stream>>>(_data_j, _data_rho, _size_j_0, _size_j_1, _size_j_2, _stride_j_0, _stride_j_1, _stride_j_2, _stride_j_3, _stride_rho_0, _stride_rho_1, _stride_rho_2);
}

void ContinuityKernel_double_precision_CUDA::runOnCellInterval(const shared_ptr<StructuredBlockStorage> &blocks, const CellInterval &globalCellInterval, cell_idx_t ghostLayers, IBlock *block, gpuStream_t stream) {
