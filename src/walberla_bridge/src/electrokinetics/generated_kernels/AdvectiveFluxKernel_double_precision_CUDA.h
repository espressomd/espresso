...
//
//! \\file AdvectiveFluxKernel_double_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class AdvectiveFluxKernel_double_precision_CUDA {
public:
  AdvectiveFluxKernel_double_precision_CUDA(BlockDataID jID_,
                                            BlockDataID rhoID_,
                                            BlockDataID uID_)
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<AdvectiveFluxKernel_double_precision_CUDA> &kernel) {
