...
public:
  DiffusiveFluxKernelThermalized_double_precision(
      BlockDataID jID_, BlockDataID rhoID_, double D, uint32_t block_offset_0,
      uint32_t block_offset_1, uint32_t block_offset_2, uint32_t field_size_0,
      uint32_t field_size_1, uint32_t field_size_2, uint32_t seed,
      uint32_t time_step)
      : jID(jID_), rhoID(rhoID_), D_(D), block_offset_0_(block_offset_0),
        block_offset_1_(block_offset_1), block_offset_2_(block_offset_2),
        field_size_0_(field_size_0), field_size_1_(field_size_1),
        field_size_2_(field_size_2), seed_(seed), time_step_(time_step){};
