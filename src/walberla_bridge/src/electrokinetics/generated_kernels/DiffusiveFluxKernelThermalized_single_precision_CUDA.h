...
//
//! \\file DiffusiveFluxKernelThermalized_single_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class DiffusiveFluxKernelThermalized_single_precision_CUDA {
public:
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<DiffusiveFluxKernelThermalized_single_precision_CUDA>
          &kernel) {
