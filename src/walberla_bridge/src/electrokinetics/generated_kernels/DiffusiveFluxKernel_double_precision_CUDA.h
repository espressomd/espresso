...
//
//! \\file DiffusiveFluxKernel_double_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class DiffusiveFluxKernel_double_precision_CUDA {
public:
  DiffusiveFluxKernel_double_precision_CUDA(BlockDataID jID_,
                                            BlockDataID rhoID_, double D)
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<DiffusiveFluxKernel_double_precision_CUDA> &kernel) {
