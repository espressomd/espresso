...
//
//! \\file AdvectiveFluxKernel_single_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class AdvectiveFluxKernel_single_precision_CUDA {
public:
  AdvectiveFluxKernel_single_precision_CUDA(BlockDataID jID_,
                                            BlockDataID rhoID_,
                                            BlockDataID uID_)
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<AdvectiveFluxKernel_single_precision_CUDA> &kernel) {
