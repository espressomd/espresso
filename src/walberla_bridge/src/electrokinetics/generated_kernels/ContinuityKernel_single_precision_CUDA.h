...
//
//! \\file ContinuityKernel_single_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class ContinuityKernel_single_precision_CUDA {
public:
  ContinuityKernel_single_precision_CUDA(BlockDataID jID_, BlockDataID rhoID_)
  ...
  getSweep(const shared_ptr<ContinuityKernel_single_precision_CUDA> &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *, gpuStream_t)> getSweepOnCellInterval(
      const shared_ptr<ContinuityKernel_single_precision_CUDA> &kernel,
