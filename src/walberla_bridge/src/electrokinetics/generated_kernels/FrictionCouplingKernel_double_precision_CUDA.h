...
//
//! \\file FrictionCouplingKernel_double_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class FrictionCouplingKernel_double_precision_CUDA {
public:
  FrictionCouplingKernel_double_precision_CUDA(BlockDataID fID_,
                                               BlockDataID jID_, double D,
                                               double kT, double rho_lb)
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<FrictionCouplingKernel_double_precision_CUDA> &kernel) {
