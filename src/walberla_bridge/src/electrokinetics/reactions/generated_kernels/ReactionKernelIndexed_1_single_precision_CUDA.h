...
class ReactionKernelIndexed_1_single_precision_CUDA {
public:
  struct IndexInfo {
    int32_t x;
    int32_t y;
  ...
  ReactionKernelIndexed_1_single_precision_CUDA(
      const std::shared_ptr<StructuredBlockForest> &blocks,
      BlockDataID rho_0ID_, float order_0, float rate_coefficient,
      float stoech_0)
    ...
    indexVectorID = blocks->addStructuredBlockData<IndexVectors>(
        createIdxVector,
        "IndexField_ReactionKernelIndexed_1_single_precision_CUDA");
  }

  ReactionKernelIndexed_1_single_precision_CUDA(BlockDataID indexVectorID_,
