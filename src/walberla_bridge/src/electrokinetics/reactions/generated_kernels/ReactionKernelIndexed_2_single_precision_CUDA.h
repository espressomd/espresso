...
class ReactionKernelIndexed_2_single_precision_CUDA {
public:
  struct IndexInfo {
    int32_t x;
    int32_t y;
  ...
  ReactionKernelIndexed_2_single_precision_CUDA(
      ...
      BlockDataID rho_0ID_, BlockDataID rho_1ID_, float order_0, float order_1,
    ...
    indexVectorID = blocks->addStructuredBlockData<IndexVectors>(
        createIdxVector,
        "IndexField_ReactionKernelIndexed_2_single_precision_CUDA");
  };

  ReactionKernelIndexed_2_single_precision_CUDA(BlockDataID indexVectorID_,
