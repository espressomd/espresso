...
//
//! \\file ReactionKernelBulk_5_single_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class ReactionKernelBulk_5_single_precision_CUDA {
public:
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<ReactionKernelBulk_5_single_precision_CUDA> &kernel) {
