...
class ReactionKernelIndexed_2_double_precision_CUDA {
public:
  struct IndexInfo {
    int32_t x;
    int32_t y;
  ...
  ReactionKernelIndexed_2_double_precision_CUDA(
      ...
      BlockDataID rho_0ID_, BlockDataID rho_1ID_, double order_0,
    ...
    indexVectorID = blocks->addStructuredBlockData<IndexVectors>(
        createIdxVector,
        "IndexField_ReactionKernelIndexed_2_double_precision_CUDA");
  }

  ReactionKernelIndexed_2_double_precision_CUDA(
      BlockDataID indexVectorID_, BlockDataID rho_0ID_, BlockDataID rho_1ID_,
      double order_0, double order_1, double rate_coefficient, double stoech_0,
      double stoech_1)
