...
//
//! \\file ReactionKernelBulk_4_single_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class ReactionKernelBulk_4_single_precision_CUDA {
public:
  ReactionKernelBulk_4_single_precision_CUDA(
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<ReactionKernelBulk_4_single_precision_CUDA> &kernel) {
