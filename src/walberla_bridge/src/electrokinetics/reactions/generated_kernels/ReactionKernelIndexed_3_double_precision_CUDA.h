...
class ReactionKernelIndexed_3_double_precision_CUDA {
public:
  struct IndexInfo {
    int32_t x;
    int32_t y;
  ...
  ReactionKernelIndexed_3_double_precision_CUDA(
    ...
    indexVectorID = blocks->addStructuredBlockData<IndexVectors>(
        createIdxVector,
        "IndexField_ReactionKernelIndexed_3_double_precision_CUDA");
  }
