...
//
//! \\file ReactionKernelIndexed_3_double_precision_CUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
namespace internal_reactionkernelindexed_3_double_precision_cuda_boundary_ReactionKernelIndexed_3_double_precision_CUDA {
static FUNC_PREFIX __launch_bounds__(256) void reactionkernelindexed_3_double_precision_cuda_boundary_ReactionKernelIndexed_3_double_precision_CUDA(uint8_t *RESTRICT const _data_indexVector, double *RESTRICT _data_rho_0, double *RESTRICT _data_rho_1, double *RESTRICT _data_rho_2, int64_t const _stride_rho_0_0, int64_t const _stride_rho_0_1, int64_t const _stride_rho_0_2, int64_t const _stride_rho_1_0, int64_t const _stride_rho_1_1, int64_t const _stride_rho_1_2, int64_t const _stride_rho_2_0, int64_t const _stride_rho_2_1, int64_t const _stride_rho_2_2, int32_t indexVectorSize, double order_0, double order_1, double order_2, double rate_coefficient, double stoech_0, double stoech_1, double stoech_2) {
  if (blockDim.x * blockIdx.x + threadIdx.x < indexVectorSize) {
    ...
    double *RESTRICT _data_rho_0_10_20 = _data_rho_0 + _stride_rho_0_1 * y + _stride_rho_0_2 * z;
    const double local_rho_0 = _data_rho_0_10_20[_stride_rho_0_0 * x];
    double *RESTRICT _data_rho_1_10_20 = _data_rho_1 + _stride_rho_1_1 * y + _stride_rho_1_2 * z;
    const double local_rho_1 = _data_rho_1_10_20[_stride_rho_1_0 * x];
    double *RESTRICT _data_rho_2_10_20 = _data_rho_2 + _stride_rho_2_1 * y + _stride_rho_2_2 * z;
    const double local_rho_2 = _data_rho_2_10_20[_stride_rho_2_0 * x];
...
void ReactionKernelIndexed_3_double_precision_CUDA::run_impl(IBlock *block, IndexVectors::Type type, gpuStream_t stream) {
  ...
  internal_reactionkernelindexed_3_double_precision_cuda_boundary_ReactionKernelIndexed_3_double_precision_CUDA::reactionkernelindexed_3_double_precision_cuda_boundary_ReactionKernelIndexed_3_double_precision_CUDA<<<_grid, _block, 0, stream>>>(_data_indexVector, _data_rho_0, _data_rho_1, _data_rho_2, _stride_rho_0_0, _stride_rho_0_1, _stride_rho_0_2, _stride_rho_1_0, _stride_rho_1_1, _stride_rho_1_2, _stride_rho_2_0, _stride_rho_2_1, _stride_rho_2_2, indexVectorSize, order_0, order_1, order_2, rate_coefficient, stoech_0, stoech_1, stoech_2);
}

void ReactionKernelIndexed_3_double_precision_CUDA::run(IBlock *block, gpuStream_t stream) {
  run_impl(block, IndexVectors::ALL, stream);
}

void ReactionKernelIndexed_3_double_precision_CUDA::inner(IBlock *block, gpuStream_t stream) {
  run_impl(block, IndexVectors::INNER, stream);
}

void ReactionKernelIndexed_3_double_precision_CUDA::outer(IBlock *block, gpuStream_t stream) {
