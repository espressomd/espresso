...
class ReactionKernelIndexed_5_single_precision_CUDA {
public:
  struct IndexInfo {
    int32_t x;
    int32_t y;
  ...
  ReactionKernelIndexed_5_single_precision_CUDA(
    ...
    indexVectorID = blocks->addStructuredBlockData<IndexVectors>(
        createIdxVector,
        "IndexField_ReactionKernelIndexed_5_single_precision_CUDA");
  }
