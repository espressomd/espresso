...
//
//! \\file ReactionKernelBulk_3_double_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class ReactionKernelBulk_3_double_precision_CUDA {
public:
  ReactionKernelBulk_3_double_precision_CUDA(
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<ReactionKernelBulk_3_double_precision_CUDA> &kernel) {
