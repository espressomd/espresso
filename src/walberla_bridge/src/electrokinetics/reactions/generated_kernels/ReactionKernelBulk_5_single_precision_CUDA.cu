...
//
//! \\file ReactionKernelBulk_5_single_precision_CUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
void ReactionKernelBulk_5_single_precision_CUDA::run(IBlock *block, gpuStream_t stream) {
  ...
  internal_reactionkernelbulk_5_single_precision_cuda_reactionkernelbulk_5_single_precision_cuda::reactionkernelbulk_5_single_precision_cuda_reactionkernelbulk_5_single_precision_cuda<<<_grid, _block, 0, stream>>>(_data_rho_0, _data_rho_1, _data_rho_2, _data_rho_3, _data_rho_4, _size_rho_0_0, _size_rho_0_1, _size_rho_0_2, _stride_rho_0_0, _stride_rho_0_1, _stride_rho_0_2, _stride_rho_1_0, _stride_rho_1_1, _stride_rho_1_2, _stride_rho_2_0, _stride_rho_2_1, _stride_rho_2_2, _stride_rho_3_0, _stride_rho_3_1, _stride_rho_3_2, _stride_rho_4_0, _stride_rho_4_1, _stride_rho_4_2, order_0, order_1, order_2, order_3, order_4, rate_coefficient, stoech_0, stoech_1, stoech_2, stoech_3, stoech_4);
}

void ReactionKernelBulk_5_single_precision_CUDA::runOnCellInterval(const shared_ptr<StructuredBlockStorage> &blocks, const CellInterval &globalCellInterval, cell_idx_t ghostLayers, IBlock *block, gpuStream_t stream) {
