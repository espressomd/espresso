...
//
//! \\file ReactionKernelIndexed_1_double_precision_CUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
namespace internal_reactionkernelindexed_1_double_precision_cuda_boundary_ReactionKernelIndexed_1_double_precision_CUDA {
static FUNC_PREFIX __launch_bounds__(256) void reactionkernelindexed_1_double_precision_cuda_boundary_ReactionKernelIndexed_1_double_precision_CUDA(uint8_t *RESTRICT const _data_indexVector, double *RESTRICT _data_rho_0, int64_t const _stride_rho_0_0, int64_t const _stride_rho_0_1, int64_t const _stride_rho_0_2, int32_t indexVectorSize, double order_0, double rate_coefficient, double stoech_0) {
...
void ReactionKernelIndexed_1_double_precision_CUDA::run_impl(IBlock *block, IndexVectors::Type type, gpuStream_t stream) {
  ...
  internal_reactionkernelindexed_1_double_precision_cuda_boundary_ReactionKernelIndexed_1_double_precision_CUDA::reactionkernelindexed_1_double_precision_cuda_boundary_ReactionKernelIndexed_1_double_precision_CUDA<<<_grid, _block, 0, stream>>>(_data_indexVector, _data_rho_0, _stride_rho_0_0, _stride_rho_0_1, _stride_rho_0_2, indexVectorSize, order_0, rate_coefficient, stoech_0);
}

void ReactionKernelIndexed_1_double_precision_CUDA::run(IBlock *block, gpuStream_t stream) {
  run_impl(block, IndexVectors::ALL, stream);
}

void ReactionKernelIndexed_1_double_precision_CUDA::inner(IBlock *block, gpuStream_t stream) {
  run_impl(block, IndexVectors::INNER, stream);
}

void ReactionKernelIndexed_1_double_precision_CUDA::outer(IBlock *block, gpuStream_t stream) {
