...
//
//! \\file ReactionKernelIndexed_3_single_precision_CUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
void ReactionKernelIndexed_3_single_precision_CUDA::run_impl(IBlock *block, IndexVectors::Type type, gpuStream_t stream) {
  ...
  internal_reactionkernelindexed_3_single_precision_cuda_boundary_ReactionKernelIndexed_3_single_precision_CUDA::reactionkernelindexed_3_single_precision_cuda_boundary_ReactionKernelIndexed_3_single_precision_CUDA<<<_grid, _block, 0, stream>>>(_data_indexVector, _data_rho_0, _data_rho_1, _data_rho_2, _stride_rho_0_0, _stride_rho_0_1, _stride_rho_0_2, _stride_rho_1_0, _stride_rho_1_1, _stride_rho_1_2, _stride_rho_2_0, _stride_rho_2_1, _stride_rho_2_2, indexVectorSize, order_0, order_1, order_2, rate_coefficient, stoech_0, stoech_1, stoech_2);
}

void ReactionKernelIndexed_3_single_precision_CUDA::run(IBlock *block, gpuStream_t stream) {
  run_impl(block, IndexVectors::ALL, stream);
}

void ReactionKernelIndexed_3_single_precision_CUDA::inner(IBlock *block, gpuStream_t stream) {
  run_impl(block, IndexVectors::INNER, stream);
}

void ReactionKernelIndexed_3_single_precision_CUDA::outer(IBlock *block, gpuStream_t stream) {
