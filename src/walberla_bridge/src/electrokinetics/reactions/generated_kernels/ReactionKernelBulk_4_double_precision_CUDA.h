...
//
//! \\file ReactionKernelBulk_4_double_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class ReactionKernelBulk_4_double_precision_CUDA {
public:
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<ReactionKernelBulk_4_double_precision_CUDA> &kernel) {
