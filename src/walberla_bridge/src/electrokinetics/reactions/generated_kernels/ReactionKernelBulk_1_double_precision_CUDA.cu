...
//
//! \\file ReactionKernelBulk_1_double_precision_CUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
namespace internal_reactionkernelbulk_1_double_precision_cuda_reactionkernelbulk_1_double_precision_cuda {
static FUNC_PREFIX __launch_bounds__(256) void reactionkernelbulk_1_double_precision_cuda_reactionkernelbulk_1_double_precision_cuda(double *RESTRICT _data_rho_0, int64_t const _size_rho_0_0, int64_t const _size_rho_0_1, int64_t const _size_rho_0_2, int64_t const _stride_rho_0_0, int64_t const _stride_rho_0_1, int64_t const _stride_rho_0_2, double order_0, double rate_coefficient, double stoech_0) {
...
void ReactionKernelBulk_1_double_precision_CUDA::run(IBlock *block, gpuStream_t stream) {
  ...
  internal_reactionkernelbulk_1_double_precision_cuda_reactionkernelbulk_1_double_precision_cuda::reactionkernelbulk_1_double_precision_cuda_reactionkernelbulk_1_double_precision_cuda<<<_grid, _block, 0, stream>>>(_data_rho_0, _size_rho_0_0, _size_rho_0_1, _size_rho_0_2, _stride_rho_0_0, _stride_rho_0_1, _stride_rho_0_2, order_0, rate_coefficient, stoech_0);
}

void ReactionKernelBulk_1_double_precision_CUDA::runOnCellInterval(const shared_ptr<StructuredBlockStorage> &blocks, const CellInterval &globalCellInterval, cell_idx_t ghostLayers, IBlock *block, gpuStream_t stream) {
