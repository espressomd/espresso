...
//
//! \\file ReactionKernelBulk_2_double_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class ReactionKernelBulk_2_double_precision_CUDA {
public:
  ReactionKernelBulk_2_double_precision_CUDA(BlockDataID rho_0ID_,
                                             BlockDataID rho_1ID_,
                                             double order_0, double order_1,
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<ReactionKernelBulk_2_double_precision_CUDA> &kernel) {
