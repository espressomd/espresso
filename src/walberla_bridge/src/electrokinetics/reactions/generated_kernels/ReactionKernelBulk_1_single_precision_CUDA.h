...
//
//! \\file ReactionKernelBulk_1_single_precision_CUDA.h
//! \\author pystencils
//======================================================================================================================
...
class ReactionKernelBulk_1_single_precision_CUDA {
public:
  ReactionKernelBulk_1_single_precision_CUDA(BlockDataID rho_0ID_,
                                             float order_0,
  ...
  static std::function<void(IBlock *)> getSweep(
      const shared_ptr<ReactionKernelBulk_1_single_precision_CUDA> &kernel) {
