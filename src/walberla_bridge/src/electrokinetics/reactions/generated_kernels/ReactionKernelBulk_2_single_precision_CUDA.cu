...
//
//! \\file ReactionKernelBulk_2_single_precision_CUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
void ReactionKernelBulk_2_single_precision_CUDA::run(IBlock *block, gpuStream_t stream) {
  ...
  internal_reactionkernelbulk_2_single_precision_cuda_reactionkernelbulk_2_single_precision_cuda::reactionkernelbulk_2_single_precision_cuda_reactionkernelbulk_2_single_precision_cuda<<<_grid, _block, 0, stream>>>(_data_rho_0, _data_rho_1, _size_rho_0_0, _size_rho_0_1, _size_rho_0_2, _stride_rho_0_0, _stride_rho_0_1, _stride_rho_0_2, _stride_rho_1_0, _stride_rho_1_1, _stride_rho_1_2, order_0, order_1, rate_coefficient, stoech_0, stoech_1);
}

void ReactionKernelBulk_2_single_precision_CUDA::runOnCellInterval(const shared_ptr<StructuredBlockStorage> &blocks, const CellInterval &globalCellInterval, cell_idx_t ghostLayers, IBlock *block, gpuStream_t stream) {
