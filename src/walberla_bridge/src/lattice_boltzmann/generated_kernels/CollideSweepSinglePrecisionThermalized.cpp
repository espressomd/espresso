  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        ...
        const float xi_106 =
            powf(xi_105 * (1.0f - (-omega_even + 1.0f) * (-omega_even + 1.0f)),
                 0.5f);
        ...
        const float xi_110 =
            ...
            powf(xi_105 * (1.0f - (-omega_bulk + 1.0f) * (-omega_bulk + 1.0f)),
                 0.5f);
        const float xi_111 = xi_106 * (random_3_1 - 0.5f) * 8.3666002653407556f;
        const float xi_137 = powf(
            xi_105 * (1.0f - (-omega_odd + 1.0f) * (-omega_odd + 1.0f)), 0.5f);
        ...
        const float xi_199 = xi_198 * (u_0 * xi_197 + xi_120 + xi_249 + xi_260);
        ...
        const float xi_131 =
            ...
            (xi_114 + xi_115 * 3.0f + xi_126 + xi_128 + xi_129 + xi_130 +
             xi_247 * -4.0f + xi_249 * -7.0f + xi_251 * -4.0f + xi_252 * 5.0f +
             xi_253 * -7.0f + xi_256 * 5.0f + xi_258 * -7.0f + xi_260 * -7.0f);
        ...
        const float xi_160 =
            omega_shear *
            (-xi_112 + xi_113 * 2.0f + xi_120 + xi_123 + xi_125 + xi_156 +
             xi_251 + xi_252 + xi_256 + xi_261 * -2.0f + xi_262 * -2.0f + xi_9);
        const float xi_162 =
        ...
        const float xi_205 = xi_198 * (u_2 * xi_197 + xi_132 + xi_17 + xi_248);
