...
//
//! \\file StreamCollideSweepThermalizedSinglePrecisionCUDA.h
//! \\author pystencils
//======================================================================================================================
...
class StreamCollideSweepThermalizedSinglePrecisionCUDA {
public:
  ...
  getSweep(const shared_ptr<StreamCollideSweepThermalizedSinglePrecisionCUDA>
               &kernel) {
