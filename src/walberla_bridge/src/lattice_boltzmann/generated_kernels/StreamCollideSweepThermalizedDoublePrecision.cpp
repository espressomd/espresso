...
//
//! \\file StreamCollideSweepThermalizedDoublePrecision.cpp
//! \\author pystencils
//======================================================================================================================
...
namespace internal_fa53b6994358d65dbc792fd71884c2e7 {
...
void StreamCollideSweepThermalizedDoublePrecision::run(IBlock * block)
{
   if (!this->configured_)
