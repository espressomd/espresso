...
static FUNC_PREFIX __launch_bounds__(256) void collidesweepsingleprecisionthermalizedcuda_collidesweepsingleprecisionthermalizedcuda(float *RESTRICT const _data_force, float *RESTRICT _data_pdfs, int64_t const _size_force_0, int64_t const _size_force_1, int64_t const _size_force_2, int64_t const _stride_force_0, int64_t const _stride_force_1, int64_t const _stride_force_2, int64_t const _stride_force_3, int64_t const _stride_pdfs_0, int64_t const _stride_pdfs_1, int64_t const _stride_pdfs_2, int64_t const _stride_pdfs_3, uint32_t block_offset_0, uint32_t block_offset_1, uint32_t block_offset_2, float kT, float omega_bulk, float omega_even, float omega_odd, float omega_shear, uint32_t seed, uint32_t time_step) {
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 && blockDim.y * blockIdx.y + threadIdx.y < _size_force_1 && blockDim.z * blockIdx.z + threadIdx.z < _size_force_2) {
    ...
    const float xi_244 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 5 * _stride_pdfs_3];
    const float xi_245 = _data_force[_stride_force_0 * ctr_0 + _stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 + _stride_force_3];
    const float xi_246 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 14 * _stride_pdfs_3];
    const float xi_247 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 2 * _stride_pdfs_3];
    const float xi_248 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 16 * _stride_pdfs_3];
    const float xi_249 = _data_force[_stride_force_0 * ctr_0 + _stride_force_1 * ctr_1 + _stride_force_2 * ctr_2];
    const float xi_250 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 17 * _stride_pdfs_3];
    const float xi_251 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 9 * _stride_pdfs_3];
    const float xi_252 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 3 * _stride_pdfs_3];
    const float xi_253 = _data_force[_stride_force_0 * ctr_0 + _stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 + 2 * _stride_force_3];
    const float xi_254 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 10 * _stride_pdfs_3];
    const float xi_255 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 4 * _stride_pdfs_3];
    const float xi_256 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 13 * _stride_pdfs_3];
    const float xi_257 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + _stride_pdfs_3];
    const float xi_258 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 8 * _stride_pdfs_3];
    const float xi_259 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 15 * _stride_pdfs_3];
    const float xi_260 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 6 * _stride_pdfs_3];
    const float xi_261 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 11 * _stride_pdfs_3];
    const float xi_262 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 18 * _stride_pdfs_3];
    const float xi_263 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 7 * _stride_pdfs_3];
    const float xi_264 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2];
    const float xi_265 = _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 12 * _stride_pdfs_3];
    ...
    const float xi_2 = xi_246 + xi_262;
    const float xi_3 = xi_2 + xi_255;
    const float xi_4 = xi_257 + xi_259 + xi_261;
    const float xi_5 = xi_244 + xi_265;
    const float xi_6 = xi_250 + xi_260;
    const float xi_8 = -xi_251;
    const float xi_9 = -xi_263;
    const float xi_10 = -xi_250;
    const float xi_11 = -xi_256;
    const float xi_12 = -xi_252;
    const float xi_13 = xi_10 + xi_11 + xi_12;
    const float xi_14 = -xi_247;
    const float xi_15 = -xi_254;
    const float xi_16 = xi_14 + xi_15;
    const float xi_17 = -xi_248;
    const float xi_18 = -xi_265;
    const float xi_19 = xi_17 + xi_18;
    const float xi_20 = -xi_262;
    const float xi_21 = xi_10 + xi_20;
    const float xi_22 = -xi_259;
    const float xi_23 = -xi_260;
    const float xi_24 = xi_17 + xi_22 + xi_23 + xi_261;
    const float xi_28 = omega_bulk * 0.5f;
    const float xi_29 = xi_245 * 0.16666666666666666f;
    const float xi_30 = xi_245 * 0.083333333333333329f;
    const float xi_42 = xi_249 * 0.16666666666666666f;
    const float xi_43 = xi_249 * 0.083333333333333329f;
    const float xi_49 = xi_253 * 0.16666666666666666f;
    const float xi_50 = xi_253 * 0.083333333333333329f;
    const float xi_55 = omega_shear * 0.041666666666666664f;
    const float xi_60 = omega_bulk * 0.041666666666666664f;
    const float xi_67 = xi_245 * 0.25f;
    const float xi_71 = omega_shear * 0.125f;
    const float xi_72 = xi_245 * xi_71;
    const float xi_109 = 2.4494897427831779f;
    const float xi_114 = -xi_264;
    const float xi_118 = -xi_261;
    const float xi_119 = xi_118 + xi_18;
    const float xi_120 = -xi_258 + xi_8;
    const float xi_122 = -xi_246;
    const float xi_123 = xi_11 + xi_122 + xi_15 + xi_21;
    const float xi_125 = xi_248 * 2.0f + xi_259 * 2.0f + xi_261 * 2.0f + xi_265 * 2.0f;
    const float xi_126 = xi_125 + xi_252 * 5.0f + xi_255 * 5.0f;
    const float xi_128 = xi_256 * 2.0f;
    const float xi_129 = xi_246 * 2.0f;
    const float xi_130 = xi_250 * 2.0f + xi_262 * 2.0f;
    const float xi_132 = xi_118 + xi_265;
    const float xi_133 = xi_132 + xi_14 + xi_22 + xi_248 + xi_257;
    const float xi_134 = omega_odd * 0.25f;
    const float xi_135 = xi_133 * xi_134;
    const float xi_136 = random_2_3 - 0.5f;
    const float xi_141 = xi_263 * 2.0f;
    const float xi_142 = xi_254 * 2.0f;
    const float xi_143 = xi_251 * 2.0f + xi_258 * -2.0f;
    ...
    const float xi_167 = xi_12 + xi_166 + xi_20 + xi_250 + xi_255;
    ...
    const float xi_178 = xi_119 + xi_23 + xi_244 + xi_248 + xi_259;
    ...
    const float xi_54 = xi_249 * xi_53;
    const float xi_59 = xi_245 * xi_53;
    const float xi_81 = xi_253 * xi_53;
    const float vel0Term = xi_254 + xi_258 + xi_3;
    const float vel1Term = xi_263 + xi_4;
    const float vel2Term = xi_256 + xi_5;
    const float rho = vel0Term + vel1Term + vel2Term + xi_247 + xi_248 + xi_251 + xi_252 + xi_264 + xi_6;
    ...
    const float u_0 = xi_0 * (vel0Term + xi_13 + xi_8 + xi_9) + xi_249 * xi_7;
    const float xi_25 = u_0 * xi_249;
    ...
    const float xi_95 = u_0 * xi_253;
    const float xi_96 = xi_95 * 0.25f;
    const float xi_99 = xi_71 * xi_95;
    const float xi_113 = rho * (u_0 * u_0);
    const float u_1 = xi_0 * (vel1Term + xi_16 + xi_19 + xi_258 + xi_8) + xi_245 * xi_7;
    const float xi_26 = u_1 * xi_245;
    ...
    const float xi_116 = xi_114 + xi_115 * 0.66666666666666663f + xi_244 * 3.0f + xi_260 * 3.0f;
    const float xi_117 = omega_even * (xi_112 * 0.66666666666666663f + xi_113 * 1.6666666666666667f + xi_116 + xi_247 * 3.0f + xi_248 * -3.0f + xi_257 * 3.0f + xi_259 * -3.0f + xi_261 * -3.0f + xi_265 * -3.0f);
    const float xi_124 = omega_bulk * (xi_113 + xi_115 + xi_119 + xi_121 + xi_123 + xi_17 + xi_22 + xi_264);
    const float xi_127 = omega_even * (xi_112 * 2.3333333333333335f + xi_116 + xi_126 + xi_246 * -5.0f + xi_247 * -2.0f + xi_250 * -5.0f + xi_256 * -5.0f + xi_257 * -2.0f + xi_262 * -5.0f);
    const float xi_131 = omega_even * (xi_114 + xi_115 * 3.0f + xi_126 + xi_128 + xi_129 + xi_130 + xi_244 * -4.0f + xi_247 * 5.0f + xi_251 * -7.0f + xi_254 * -7.0f + xi_257 * 5.0f + xi_258 * -7.0f + xi_260 * -4.0f + xi_263 * -7.0f);
    const float xi_156 = -xi_115 + xi_244;
    const float xi_157 = omega_shear * (xi_121 + xi_156 + xi_16 + xi_2 + xi_256 - xi_257 + xi_6);
    const float xi_158 = xi_157 * 0.125f;
    const float xi_159 = xi_107 * -0.11904761904761904f + xi_131 * -0.01984126984126984f;
    const float xi_160 = omega_shear * (-xi_112 + xi_113 * 2.0f + xi_120 + xi_123 + xi_125 + xi_156 + xi_247 + xi_252 * -2.0f + xi_255 * -2.0f + xi_257 + xi_260 + xi_9);
    ...
    const float xi_205 = xi_198 * (u_2 * xi_197 + xi_132 + xi_17 + xi_259);
    ...
    const float xi_233 = xi_198 * (rho * u_0 * u_2 + xi_10 + xi_166 + xi_262);
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2] = forceTerm_0 + xi_107 * 0.14285714285714285f + xi_108 * 0.20000000000000001f - xi_110 + xi_111 * 0.085714285714285715f + xi_117 * 0.10000000000000001f + xi_124 * -0.5f + xi_127 * 0.042857142857142858f + xi_131 * 0.023809523809523808f + xi_264;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + _stride_pdfs_3] = forceTerm_1 - xi_135 - xi_140 + xi_151 + xi_164 + xi_257;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 2 * _stride_pdfs_3] = forceTerm_2 + xi_135 + xi_140 + xi_164 + xi_165 + xi_247;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 3 * _stride_pdfs_3] = forceTerm_3 + xi_168 + xi_170 + xi_175 + xi_176 + xi_252;
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 5 * _stride_pdfs_3] = forceTerm_5 - xi_179 - xi_181 + xi_186 + xi_187 + xi_244;
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 7 * _stride_pdfs_3] = forceTerm_7 + xi_177 + xi_195 + xi_200 + xi_263;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 8 * _stride_pdfs_3] = forceTerm_8 + xi_175 + xi_195 + xi_201 + xi_258;
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 10 * _stride_pdfs_3] = forceTerm_10 + xi_175 + xi_200 + xi_202 + xi_254;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 11 * _stride_pdfs_3] = forceTerm_11 + xi_210 + xi_219 + xi_224 + xi_261;
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 14 * _stride_pdfs_3] = forceTerm_14 + xi_231 + xi_240 + xi_241 + xi_246;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 15 * _stride_pdfs_3] = forceTerm_15 + xi_224 + xi_226 + xi_242 + xi_259;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 16 * _stride_pdfs_3] = forceTerm_16 + xi_210 + xi_225 + xi_242 + xi_248;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 17 * _stride_pdfs_3] = forceTerm_17 + xi_239 + xi_240 + xi_243 + xi_250;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 18 * _stride_pdfs_3] = forceTerm_18 + xi_234 + xi_241 + xi_243 + xi_262;
  }
}
} // namespace internal_collidesweepsingleprecisionthermalizedcuda_collidesweepsingleprecisionthermalizedcuda
