...
static FUNC_PREFIX __launch_bounds__(256) void collidesweepsingleprecisionthermalizedcuda_collidesweepsingleprecisionthermalizedcuda(float *RESTRICT const _data_force, float *RESTRICT _data_pdfs, int64_t const _size_force_0, int64_t const _size_force_1, int64_t const _size_force_2, int64_t const _stride_force_0, int64_t const _stride_force_1, int64_t const _stride_force_2, int64_t const _stride_force_3, int64_t const _stride_pdfs_0, int64_t const _stride_pdfs_1, int64_t const _stride_pdfs_2, int64_t const _stride_pdfs_3, uint32_t block_offset_0, uint32_t block_offset_1, uint32_t block_offset_2, float kT, float omega_bulk, float omega_even, float omega_odd, float omega_shear, uint32_t seed, uint32_t time_step) {
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 && blockDim.y * blockIdx.y + threadIdx.y < _size_force_1 && blockDim.z * blockIdx.z + threadIdx.z < _size_force_2) {
    ...
    const float xi_2 = xi_245 + xi_248;
    const float xi_3 = xi_2 + xi_259;
    const float xi_4 = xi_250 + xi_257 + xi_265;
    const float xi_5 = xi_256 + xi_262;
    const float xi_6 = xi_244 + xi_254;
    const float xi_8 = xi_246 * -1.0f;
    const float xi_9 = xi_255 * -1.0f;
    const float xi_10 = xi_254 * -1.0f;
    const float xi_11 = xi_253 * -1.0f;
    const float xi_12 = xi_251 * -1.0f;
    const float xi_13 = xi_10 + xi_11 + xi_12;
    const float xi_14 = xi_263 * -1.0f;
    const float xi_15 = xi_249 * -1.0f;
    const float xi_16 = xi_14 + xi_15;
    const float xi_17 = xi_264 * -1.0f;
    const float xi_18 = xi_256 * -1.0f;
    const float xi_19 = xi_17 + xi_18;
    const float xi_20 = xi_248 * -1.0f;
    const float xi_21 = xi_10 + xi_20;
    const float xi_22 = xi_250 * -1.0f;
    const float xi_23 = xi_244 * -1.0f;
    const float xi_24 = xi_17 + xi_22 + xi_23 + xi_257;
    const float xi_28 = omega_bulk * 0.5f;
    const float xi_29 = xi_252 * 0.16666666666666666f;
    const float xi_30 = xi_252 * 0.083333333333333329f;
    ...
    const float xi_67 = xi_252 * 0.25f;
    const float xi_71 = omega_shear * 0.125f;
    const float xi_72 = xi_252 * xi_71;
    const float xi_109 = 2.4494897427831779f;
    const float xi_114 = xi_258 * -1.0f;
    const float xi_118 = xi_257 * -1.0f;
    const float xi_119 = xi_118 + xi_18;
    const float xi_120 = xi_247 * -1.0f + xi_8;
    const float xi_122 = xi_245 * -1.0f;
    const float xi_123 = xi_11 + xi_122 + xi_15 + xi_21;
    const float xi_125 = xi_250 * 2.0f + xi_256 * 2.0f + xi_257 * 2.0f + xi_264 * 2.0f;
    const float xi_126 = xi_125 + xi_251 * 5.0f + xi_259 * 5.0f;
    const float xi_128 = xi_253 * 2.0f;
    const float xi_129 = xi_245 * 2.0f;
    const float xi_130 = xi_248 * 2.0f + xi_254 * 2.0f;
    const float xi_132 = xi_118 + xi_256;
    const float xi_133 = xi_132 + xi_14 + xi_22 + xi_264 + xi_265;
    ...
    const float xi_143 = xi_246 * 2.0f + xi_247 * -2.0f;
    ...
    const float xi_166 = xi_122 + xi_253;
    ...
    const float xi_178 = xi_119 + xi_23 + xi_250 + xi_262 + xi_264;
    ...
    const float xi_59 = xi_252 * xi_53;
    const float xi_81 = xi_260 * xi_53;
    const float vel0Term = xi_247 + xi_249 + xi_3;
    const float vel1Term = xi_255 + xi_4;
    const float vel2Term = xi_253 + xi_5;
    const float rho = vel0Term + vel1Term + vel2Term + xi_246 + xi_251 + xi_258 + xi_263 + xi_264 + xi_6;
    ...
    const float u_1 = xi_0 * (vel1Term + xi_16 + xi_19 + xi_247 + xi_8) + xi_252 * xi_7;
    const float xi_26 = u_1 * xi_252;
    ...
    const float xi_199 = xi_198 * (u_0 * xi_197 + xi_120 + xi_249 + xi_255);
    const float xi_200 = xi_196 * -1.0f + xi_199 * -1.0f;
    const float xi_201 = xi_196 + xi_199;
    const float u_2 = xi_0 * (vel2Term + xi_21 + xi_24 + xi_245) + xi_260 * xi_7;
    ...
    const float xi_116 = xi_114 + xi_115 * 0.66666666666666663f + xi_244 * 3.0f + xi_262 * 3.0f;
    const float xi_117 = omega_even * (xi_112 * 0.66666666666666663f + xi_113 * 1.6666666666666667f + xi_116 + xi_250 * -3.0f + xi_256 * -3.0f + xi_257 * -3.0f + xi_263 * 3.0f + xi_264 * -3.0f + xi_265 * 3.0f);
    const float xi_124 = omega_bulk * (xi_113 + xi_115 + xi_119 + xi_121 + xi_123 + xi_17 + xi_22 + xi_258);
    const float xi_127 = omega_even * (xi_112 * 2.3333333333333335f + xi_116 + xi_126 + xi_245 * -5.0f + xi_248 * -5.0f + xi_253 * -5.0f + xi_254 * -5.0f + xi_263 * -2.0f + xi_265 * -2.0f);
    const float xi_131 = omega_even * (xi_114 + xi_115 * 3.0f + xi_126 + xi_128 + xi_129 + xi_130 + xi_244 * -4.0f + xi_246 * -7.0f + xi_247 * -7.0f + xi_249 * -7.0f + xi_255 * -7.0f + xi_262 * -4.0f + xi_263 * 5.0f + xi_265 * 5.0f);
    const float xi_156 = xi_115 * -1.0f + xi_262;
    const float xi_157 = omega_shear * (xi_121 + xi_156 + xi_16 + xi_2 + xi_253 + xi_265 * -1.0f + xi_6);
    const float xi_158 = xi_157 * 0.125f;
    const float xi_159 = xi_107 * -0.11904761904761904f + xi_131 * -0.01984126984126984f;
    const float xi_160 = omega_shear * (xi_112 * -1.0f + xi_113 * 2.0f + xi_120 + xi_123 + xi_125 + xi_156 + xi_244 + xi_251 * -2.0f + xi_259 * -2.0f + xi_263 + xi_265 + xi_9);
    ...
    const float xi_205 = xi_198 * (u_2 * xi_197 + xi_132 + xi_17 + xi_250);
    ...
    const float xi_233 = xi_198 * (rho * u_0 * u_2 + xi_10 + xi_166 + xi_248);
    ...
    _data_pdfs_10_20_30[_stride_pdfs_0 * ctr_0] = forceTerm_0 + xi_107 * 0.14285714285714285f + xi_108 * 0.20000000000000001f + xi_110 * -1.0f + xi_111 * 0.085714285714285715f + xi_117 * 0.10000000000000001f + xi_124 * -0.5f + xi_127 * 0.042857142857142858f + xi_131 * 0.023809523809523808f + xi_258;
    _data_pdfs_10_20_31[_stride_pdfs_0 * ctr_0] = forceTerm_1 + xi_135 * -1.0f + xi_140 * -1.0f + xi_151 + xi_164 + xi_265;
    _data_pdfs_10_20_32[_stride_pdfs_0 * ctr_0] = forceTerm_2 + xi_135 + xi_140 + xi_164 + xi_165 + xi_263;
    _data_pdfs_10_20_33[_stride_pdfs_0 * ctr_0] = forceTerm_3 + xi_168 + xi_170 + xi_175 + xi_176 + xi_251;
    _data_pdfs_10_20_34[_stride_pdfs_0 * ctr_0] = forceTerm_4 + xi_168 * -1.0f + xi_170 * -1.0f + xi_176 + xi_177 + xi_259;
    _data_pdfs_10_20_35[_stride_pdfs_0 * ctr_0] = forceTerm_5 + xi_179 * -1.0f + xi_181 * -1.0f + xi_186 + xi_187 + xi_262;
    _data_pdfs_10_20_36[_stride_pdfs_0 * ctr_0] = forceTerm_6 + xi_179 + xi_181 + xi_187 + xi_188 + xi_244;
    _data_pdfs_10_20_37[_stride_pdfs_0 * ctr_0] = forceTerm_7 + xi_177 + xi_195 + xi_200 + xi_255;
    _data_pdfs_10_20_38[_stride_pdfs_0 * ctr_0] = forceTerm_8 + xi_175 + xi_195 + xi_201 + xi_247;
    _data_pdfs_10_20_39[_stride_pdfs_0 * ctr_0] = forceTerm_9 + xi_177 + xi_201 + xi_202 + xi_246;
    _data_pdfs_10_20_310[_stride_pdfs_0 * ctr_0] = forceTerm_10 + xi_175 + xi_200 + xi_202 + xi_249;
    _data_pdfs_10_20_311[_stride_pdfs_0 * ctr_0] = forceTerm_11 + xi_210 + xi_219 + xi_224 + xi_257;
    _data_pdfs_10_20_312[_stride_pdfs_0 * ctr_0] = forceTerm_12 + xi_219 + xi_225 + xi_226 + xi_256;
    _data_pdfs_10_20_313[_stride_pdfs_0 * ctr_0] = forceTerm_13 + xi_231 + xi_234 + xi_239 + xi_253;
    _data_pdfs_10_20_314[_stride_pdfs_0 * ctr_0] = forceTerm_14 + xi_231 + xi_240 + xi_241 + xi_245;
    _data_pdfs_10_20_315[_stride_pdfs_0 * ctr_0] = forceTerm_15 + xi_224 + xi_226 + xi_242 + xi_250;
    _data_pdfs_10_20_316[_stride_pdfs_0 * ctr_0] = forceTerm_16 + xi_210 + xi_225 + xi_242 + xi_264;
    _data_pdfs_10_20_317[_stride_pdfs_0 * ctr_0] = forceTerm_17 + xi_239 + xi_240 + xi_243 + xi_254;
    _data_pdfs_10_20_318[_stride_pdfs_0 * ctr_0] = forceTerm_18 + xi_234 + xi_241 + xi_243 + xi_248;
  }
}
} // namespace internal_collidesweepsingleprecisionthermalizedcuda_collidesweepsingleprecisionthermalizedcuda
