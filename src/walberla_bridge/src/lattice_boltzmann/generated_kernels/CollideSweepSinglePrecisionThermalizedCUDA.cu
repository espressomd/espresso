...
__launch_bounds__(256) void collidesweepsingleprecisionthermalizedcuda_collidesweepsingleprecisionthermalizedcuda(
  ...
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 &&
    ...
    const float xi_2 = xi_253 + xi_263;
    const float xi_3 = xi_2 + xi_257;
    const float xi_4 = xi_244 + xi_249 + xi_256;
    const float xi_5 = xi_259 + xi_265;
    const float xi_6 = xi_246 + xi_252;
    const float xi_8 = -xi_255;
    const float xi_9 = -xi_245;
    const float xi_10 = -xi_252;
    const float xi_11 = -xi_264;
    const float xi_12 = -xi_250;
    const float xi_13 = xi_10 + xi_11 + xi_12;
    const float xi_14 = -xi_247;
    const float xi_15 = -xi_254;
    const float xi_16 = xi_14 + xi_15;
    const float xi_17 = -xi_262;
    const float xi_18 = -xi_259;
    const float xi_19 = xi_17 + xi_18;
    const float xi_20 = -xi_263;
    const float xi_21 = xi_10 + xi_20;
    const float xi_22 = -xi_256;
    const float xi_23 = -xi_246;
    const float xi_24 = xi_17 + xi_22 + xi_23 + xi_244;
    ...
    const float xi_49 = xi_258 * 0.16666666666666666f;
    const float xi_50 = xi_258 * 0.083333333333333329f;
    ...
    const float xi_114 = -xi_251;
    const float xi_118 = -xi_244;
    const float xi_119 = xi_118 + xi_18;
    const float xi_120 = -xi_248 + xi_8;
    const float xi_122 = -xi_253;
    const float xi_123 = xi_11 + xi_122 + xi_15 + xi_21;
    const float xi_125 =
        xi_244 * 2.0f + xi_256 * 2.0f + xi_259 * 2.0f + xi_262 * 2.0f;
    const float xi_126 = xi_125 + xi_250 * 5.0f + xi_257 * 5.0f;
    const float xi_128 = xi_264 * 2.0f;
    const float xi_129 = xi_253 * 2.0f;
    const float xi_130 = xi_252 * 2.0f + xi_263 * 2.0f;
    const float xi_132 = xi_118 + xi_259;
    const float xi_133 = xi_132 + xi_14 + xi_22 + xi_249 + xi_262;
    const float xi_134 = omega_odd * 0.25f;
    const float xi_135 = xi_133 * xi_134;
    const float xi_136 = random_2_3 - 0.5f;
    const float xi_141 = xi_245 * 2.0f;
    const float xi_142 = xi_254 * 2.0f;
    const float xi_143 = xi_248 * -2.0f + xi_255 * 2.0f;
    ...
    const float xi_166 = xi_122 + xi_264;
    const float xi_167 = xi_12 + xi_166 + xi_20 + xi_252 + xi_257;
    ...
    const float xi_178 = xi_119 + xi_23 + xi_256 + xi_262 + xi_265;
    ...
    const float xi_81 = xi_258 * xi_53;
    const float vel0Term = xi_248 + xi_254 + xi_3;
    const float vel1Term = xi_245 + xi_4;
    const float vel2Term = xi_264 + xi_5;
    const float rho = vel0Term + vel1Term + vel2Term + xi_247 + xi_250 +
                      xi_251 + xi_255 + xi_262 + xi_6;
    const float xi_105 = kT * rho;
    const float xi_106 = powf(
        xi_105 * (1.0f - (-omega_even + 1.0f) * (-omega_even + 1.0f)), 0.5f);
    ...
    const float xi_137 =
        powf(xi_105 * (1.0f - (-omega_odd + 1.0f) * (-omega_odd + 1.0f)), 0.5f);
    ...
    const float xi_153 = powf(
        xi_105 * (1.0f - (-omega_shear + 1.0f) * (-omega_shear + 1.0f)), 0.5f);
    ...
    const float xi_86 = xi_258 * xi_69;
    const float xi_88 = xi_258 * xi_74;
    const float xi_93 = -xi_45;
    const float xi_112 = rho * (u_1 * u_1);
    const float xi_121 = xi_112 + xi_120 + xi_9;
    const float xi_197 = rho * u_1;
    const float xi_199 = xi_198 * (u_0 * xi_197 + xi_120 + xi_245 + xi_254);
    const float xi_200 = -xi_196 - xi_199;
    const float xi_201 = xi_196 + xi_199;
    const float u_2 =
        xi_0 * (vel2Term + xi_21 + xi_24 + xi_253) + xi_258 * xi_7;
    const float xi_27 = u_2 * xi_258;
    ...
    const float xi_116 =
        xi_114 + xi_115 * 0.66666666666666663f + xi_246 * 3.0f + xi_265 * 3.0f;
    const float xi_117 =
        omega_even *
        (xi_112 * 0.66666666666666663f + xi_113 * 1.6666666666666667f + xi_116 +
         xi_244 * -3.0f + xi_247 * 3.0f + xi_249 * 3.0f + xi_256 * -3.0f +
         xi_259 * -3.0f + xi_262 * -3.0f);
    ...
    const float xi_127 =
        omega_even * (xi_112 * 2.3333333333333335f + xi_116 + xi_126 +
                      xi_247 * -2.0f + xi_249 * -2.0f + xi_252 * -5.0f +
                      xi_253 * -5.0f + xi_263 * -5.0f + xi_264 * -5.0f);
    const float xi_131 =
        omega_even *
        (xi_114 + xi_115 * 3.0f + xi_126 + xi_128 + xi_129 + xi_130 +
         xi_245 * -7.0f + xi_246 * -4.0f + xi_247 * 5.0f + xi_248 * -7.0f +
         xi_249 * 5.0f + xi_254 * -7.0f + xi_255 * -7.0f + xi_265 * -4.0f);
    const float xi_156 = -xi_115 + xi_265;
    const float xi_157 =
        omega_shear * (xi_121 + xi_156 + xi_16 + xi_2 - xi_249 + xi_264 + xi_6);
    const float xi_158 = xi_157 * 0.125f;
    const float xi_159 =
        xi_107 * -0.11904761904761904f + xi_131 * -0.01984126984126984f;
    const float xi_160 =
        omega_shear *
        (-xi_112 + xi_113 * 2.0f + xi_120 + xi_123 + xi_125 + xi_156 + xi_246 +
         xi_247 + xi_249 + xi_250 * -2.0f + xi_257 * -2.0f + xi_9);
    const float xi_162 =
    ...
    const float xi_205 = xi_198 * (u_2 * xi_197 + xi_132 + xi_17 + xi_256);
    ...
    const float forceTerm_0 =
        xi_25 * xi_28 - xi_25 + xi_26 * xi_28 - xi_26 + xi_27 * xi_28 - xi_27;
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + _stride_pdfs_3] =
        forceTerm_1 - xi_135 - xi_140 + xi_151 + xi_164 + xi_249;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 2 * _stride_pdfs_3] =
        forceTerm_2 + xi_135 + xi_140 + xi_164 + xi_165 + xi_247;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 3 * _stride_pdfs_3] =
        forceTerm_3 + xi_168 + xi_170 + xi_175 + xi_176 + xi_250;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 4 * _stride_pdfs_3] =
        forceTerm_4 - xi_168 - xi_170 + xi_176 + xi_177 + xi_257;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 5 * _stride_pdfs_3] =
        forceTerm_5 - xi_179 - xi_181 + xi_186 + xi_187 + xi_265;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 6 * _stride_pdfs_3] =
        forceTerm_6 + xi_179 + xi_181 + xi_187 + xi_188 + xi_246;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 7 * _stride_pdfs_3] =
        forceTerm_7 + xi_177 + xi_195 + xi_200 + xi_245;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 8 * _stride_pdfs_3] =
        forceTerm_8 + xi_175 + xi_195 + xi_201 + xi_248;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 9 * _stride_pdfs_3] =
        forceTerm_9 + xi_177 + xi_201 + xi_202 + xi_255;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 10 * _stride_pdfs_3] =
        forceTerm_10 + xi_175 + xi_200 + xi_202 + xi_254;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 11 * _stride_pdfs_3] =
        forceTerm_11 + xi_210 + xi_219 + xi_224 + xi_244;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 12 * _stride_pdfs_3] =
        forceTerm_12 + xi_219 + xi_225 + xi_226 + xi_259;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 13 * _stride_pdfs_3] =
        forceTerm_13 + xi_231 + xi_234 + xi_239 + xi_264;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 14 * _stride_pdfs_3] =
        forceTerm_14 + xi_231 + xi_240 + xi_241 + xi_253;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 15 * _stride_pdfs_3] =
        forceTerm_15 + xi_224 + xi_226 + xi_242 + xi_256;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 16 * _stride_pdfs_3] =
        forceTerm_16 + xi_210 + xi_225 + xi_242 + xi_262;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 17 * _stride_pdfs_3] =
        forceTerm_17 + xi_239 + xi_240 + xi_243 + xi_252;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 18 * _stride_pdfs_3] =
