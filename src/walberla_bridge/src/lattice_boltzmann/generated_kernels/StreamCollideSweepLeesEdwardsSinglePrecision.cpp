...
//
//! \\file StreamCollideSweepLeesEdwardsSinglePrecision.cpp
//! \\author pystencils
//======================================================================================================================
...
#include "StreamCollideSweepLeesEdwardsSinglePrecision.h"
      ...
      for (int64_t ctr_2 = 1; ctr_2 < _size_force_2 - 1; ctr_2 += 1)
      {
         for (int64_t ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1)
         {
            for (int64_t ctr_0 = 1; ctr_0 < _size_force_0 - 1; ctr_0 += 1)
            {
               ...
               _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + _stride_pdfs_tmp_3] = forceTerm_1 + omega_even*xi_122*0.014285714285714285f + xi_107*xi_108*xi_96*0.028571428571428571f - xi_129 - xi_132 - xi_144 - xi_167 - xi_178 + ((grid_size <= ((float)(ctr_1))) ? (rho*v_s*(u_0*2.0f + v_s)*0.16666666666666666f): (0.0f));
               _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + 2*_stride_pdfs_tmp_3] = forceTerm_2 + xi_109*0.028571428571428571f + xi_123*0.014285714285714285f + xi_167 + xi_179 + xi_180 + xi_182 + ((1.0f >= ((float)(ctr_1))) ? (rho*v_s*(u_0*-2.0f + v_s)*0.16666666666666666f): (0.0f)) + _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_1 + _stride_pdfs_2*ctr_2 + 2*_stride_pdfs_3];
               ...
               _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + 7*_stride_pdfs_tmp_3] = forceTerm_7 + xi_213 + xi_214 + xi_219 + ((grid_size <= ((float)(ctr_1))) ? (rho*v_s*(u_0*-2.0f + u_1*3.0f - v_s + 1.0f)*0.083333333333333329f): (0.0f)) + _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_0 + _stride_pdfs_1*ctr_1 - _stride_pdfs_1 + _stride_pdfs_2*ctr_2 + 7*_stride_pdfs_3];
               _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + 8*_stride_pdfs_tmp_3] = forceTerm_8 + xi_194 + xi_213 + xi_220 + ((grid_size <= ((float)(ctr_1))) ? (rho*v_s*(u_0*-2.0f + u_1*-3.0f - v_s - 1.0f)*0.083333333333333329f): (0.0f)) + _data_pdfs[_stride_pdfs_0*ctr_0 - _stride_pdfs_0 + _stride_pdfs_1*ctr_1 - _stride_pdfs_1 + _stride_pdfs_2*ctr_2 + 8*_stride_pdfs_3];
               _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + 9*_stride_pdfs_tmp_3] = forceTerm_9 + xi_214 + xi_220 + xi_221 + ((1.0f >= ((float)(ctr_1))) ? (rho*v_s*(u_0*2.0f + u_1*3.0f - v_s - 1.0f)*0.083333333333333329f): (0.0f)) + _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_1 + _stride_pdfs_2*ctr_2 + 9*_stride_pdfs_3];
               _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + 10*_stride_pdfs_tmp_3] = forceTerm_10 + xi_194 + xi_219 + xi_221 + ((1.0f >= ((float)(ctr_1))) ? (rho*v_s*(u_0*2.0f + u_1*-3.0f - v_s + 1.0f)*0.083333333333333329f): (0.0f)) + _data_pdfs[_stride_pdfs_0*ctr_0 - _stride_pdfs_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_1 + _stride_pdfs_2*ctr_2 + 10*_stride_pdfs_3];
...
void StreamCollideSweepLeesEdwardsSinglePrecision::run(IBlock * block)
{
   if (!this->configured_)
