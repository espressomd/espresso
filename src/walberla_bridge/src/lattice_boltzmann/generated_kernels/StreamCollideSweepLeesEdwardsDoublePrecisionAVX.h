...
//
//! \\file StreamCollideSweepLeesEdwardsDoublePrecisionAVX.h
//! \\author pystencils
//======================================================================================================================
...
class StreamCollideSweepLeesEdwardsDoublePrecisionAVX {
public:
  StreamCollideSweepLeesEdwardsDoublePrecisionAVX(BlockDataID forceID_,
                                                  BlockDataID pdfsID_,
                                                  double grid_size,
                                                  double omega_shear,
                                                  double v_s)
  ...
  getSweep(const shared_ptr<StreamCollideSweepLeesEdwardsDoublePrecisionAVX>
               &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)> getSweepOnCellInterval(
      const shared_ptr<StreamCollideSweepLeesEdwardsDoublePrecisionAVX> &kernel,
