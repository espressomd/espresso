    ...
    for (int64_t ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1) {
      {
        for (int64_t ctr_0 = 1;
          ...
          const __m256d streamed_1 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 - _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 + _stride_pdfs_3 + ctr_0]);
          const __m256d streamed_2 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 + 2 * _stride_pdfs_3 + ctr_0]);
          const __m256d streamed_3 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
                          3 * _stride_pdfs_3 + ctr_0 + 1]);
          const __m256d streamed_4 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
                          4 * _stride_pdfs_3 + ctr_0 - 1]);
          const __m256d streamed_5 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 -
                          _stride_pdfs_2 + 5 * _stride_pdfs_3 + ctr_0]);
          const __m256d streamed_6 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
                          _stride_pdfs_2 + 6 * _stride_pdfs_3 + ctr_0]);
          const __m256d streamed_7 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 - _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 + 7 * _stride_pdfs_3 + ctr_0 +
                          1]);
          const __m256d streamed_8 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 - _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 + 8 * _stride_pdfs_3 + ctr_0 -
                          1]);
          const __m256d streamed_9 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 + 9 * _stride_pdfs_3 + ctr_0 +
                          1]);
          const __m256d streamed_10 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 + 10 * _stride_pdfs_3 + ctr_0 -
                          1]);
          const __m256d streamed_11 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 - _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 - _stride_pdfs_2 +
                          11 * _stride_pdfs_3 + ctr_0]);
          const __m256d streamed_12 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 - _stride_pdfs_2 +
                          12 * _stride_pdfs_3 + ctr_0]);
          const __m256d streamed_13 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 -
                          _stride_pdfs_2 + 13 * _stride_pdfs_3 + ctr_0 + 1]);
          const __m256d streamed_14 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 -
                          _stride_pdfs_2 + 14 * _stride_pdfs_3 + ctr_0 - 1]);
          const __m256d streamed_15 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 - _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 + _stride_pdfs_2 +
                          15 * _stride_pdfs_3 + ctr_0]);
          const __m256d streamed_16 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_1 +
                          _stride_pdfs_2 * ctr_2 + _stride_pdfs_2 +
                          16 * _stride_pdfs_3 + ctr_0]);
          const __m256d streamed_17 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
                          _stride_pdfs_2 + 17 * _stride_pdfs_3 + ctr_0 + 1]);
          const __m256d streamed_18 = _mm256_loadu_pd(
              &_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
                      ...
                      _mm256_add_pd(
                          _mm256_add_pd(
                              ...
                              _mm256_mul_pd(
                                  streamed_17,
                                  _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))),
                          _mm256_mul_pd(streamed_3,
                                        _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))),
                      _mm256_mul_pd(streamed_7,
                                    _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))),
          ...
          _mm256_storeu_pd(&_data_velocity[_stride_velocity_1 * ctr_1 +
                           ...
                           u_2);
          _mm256_store_pd(&_data_pdfs_tmp[_stride_pdfs_tmp_1 * ctr_1 +
                                          _stride_pdfs_tmp_2 * ctr_2 + ctr_0],
                          streamed_0);
          _mm256_storeu_pd(&_data_pdfs_tmp[_stride_pdfs_tmp_1 * ctr_1 +
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0 - 2) / (4)) * (4) + 1;
          ...
          const double streamed_0 = _data_pdfs[_stride_pdfs_1 * ctr_1 +
                                               _stride_pdfs_2 * ctr_2 + ctr_0];
          const double streamed_1 =
              _data_pdfs[_stride_pdfs_1 * ctr_1 - _stride_pdfs_1 +
                         _stride_pdfs_2 * ctr_2 + _stride_pdfs_3 + ctr_0];
          const double streamed_2 =
              _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_1 +
                         _stride_pdfs_2 * ctr_2 + 2 * _stride_pdfs_3 + ctr_0];
          ...
          const double streamed_4 =
              _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
                         4 * _stride_pdfs_3 + ctr_0 - 1];
          const double streamed_5 =
              _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 -
                         _stride_pdfs_2 + 5 * _stride_pdfs_3 + ctr_0];
          const double streamed_6 =
              _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
                         _stride_pdfs_2 + 6 * _stride_pdfs_3 + ctr_0];
          ...
          const double momdensity_0 = -streamed_13 - streamed_17 - streamed_3 -
                                      streamed_7 - streamed_9 + vel0Term;
          const double vel1Term =
              streamed_1 + streamed_11 + streamed_15 + streamed_7;
          const double momdensity_1 = -streamed_10 - streamed_12 - streamed_16 -
          ...
          const double momdensity_2 = streamed_11 + streamed_14 - streamed_15 -
