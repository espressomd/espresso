      ...
      for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
        {
          for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (4)) * (4); ctr_0 += 4) {
            const __m256d xi_263 = _mm256_load_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + ctr_0]);
            const __m256d xi_264 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 18 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_265 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 10 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_266 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 3 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_267 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 11 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_268 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 2 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_269 = _mm256_load_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 8 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_270 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 5 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_271 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 13 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_272 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 7 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_273 = _mm256_loadu_pd(&_data_force[_stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 + _stride_force_3 + ctr_0]);
            const __m256d xi_274 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 14 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_275 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 15 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_276 = _mm256_load_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 4 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_277 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + _stride_pdfs_3 + ctr_0]);
            const __m256d xi_278 = _mm256_load_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 12 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_279 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 6 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_280 = _mm256_loadu_pd(&_data_force[_stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 + 2 * _stride_force_3 + ctr_0]);
            const __m256d xi_281 = _mm256_load_pd(&_data_force[_stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 + ctr_0]);
            const __m256d xi_282 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 17 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_283 = _mm256_load_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 16 * _stride_pdfs_3 + ctr_0]);
            const __m256d xi_284 = _mm256_loadu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 9 * _stride_pdfs_3 + ctr_0]);
            ...
            const __m256d xi_2 = _mm256_add_pd(xi_265, xi_269);
            const __m256d xi_3 = _mm256_add_pd(_mm256_add_pd(xi_2, xi_264), xi_274);
            const __m256d xi_4 = _mm256_add_pd(xi_272, xi_277);
            const __m256d xi_5 = _mm256_add_pd(xi_267, xi_275);
            const __m256d xi_6 = _mm256_add_pd(xi_270, xi_278);
            const __m256d xi_7 = _mm256_add_pd(xi_266, xi_282);
            const __m256d xi_8 = _mm256_add_pd(xi_284, xi_7);
            const __m256d xi_9 = _mm256_add_pd(xi_268, xi_283);
            const __m256d xi_11 = _mm256_add_pd(xi_271, xi_272);
            const __m256d xi_12 = _mm256_add_pd(_mm256_mul_pd(xi_269, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), xi_265);
            const __m256d xi_13 = _mm256_add_pd(xi_278, xi_284);
            const __m256d xi_14 = _mm256_mul_pd(xi_267, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_15 = _mm256_mul_pd(xi_274, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_16 = _mm256_add_pd(xi_282, xi_283);
            const __m256d xi_21 = _mm256_mul_pd(xi_273, _mm256_set_pd(0.16666666666666666, 0.16666666666666666, 0.16666666666666666, 0.16666666666666666));
            const __m256d xi_22 = _mm256_mul_pd(xi_273, _mm256_set_pd(0.083333333333333329, 0.083333333333333329, 0.083333333333333329, 0.083333333333333329));
            const __m256d xi_33 = _mm256_mul_pd(xi_281, _mm256_set_pd(0.16666666666666666, 0.16666666666666666, 0.16666666666666666, 0.16666666666666666));
            const __m256d xi_34 = _mm256_mul_pd(xi_281, _mm256_set_pd(0.083333333333333329, 0.083333333333333329, 0.083333333333333329, 0.083333333333333329));
            const __m256d xi_39 = _mm256_mul_pd(xi_280, _mm256_set_pd(0.16666666666666666, 0.16666666666666666, 0.16666666666666666, 0.16666666666666666));
            const __m256d xi_40 = _mm256_mul_pd(xi_280, _mm256_set_pd(0.083333333333333329, 0.083333333333333329, 0.083333333333333329, 0.083333333333333329));
            const __m256d xi_58 = _mm256_mul_pd(xi_273, _mm256_set_pd(0.25, 0.25, 0.25, 0.25));
            const __m256d xi_63 = _mm256_mul_pd(xi_273, _mm256_set_pd(xi_62, xi_62, xi_62, xi_62));
            ...
            const __m256d xi_112 = _mm256_mul_pd(xi_263, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_118 = _mm256_add_pd(xi_11, xi_3);
            const __m256d xi_121 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_267, _mm256_set_pd(2.0, 2.0, 2.0, 2.0)), _mm256_mul_pd(xi_275, _mm256_set_pd(2.0, 2.0, 2.0, 2.0))), _mm256_mul_pd(xi_278, _mm256_set_pd(2.0, 2.0, 2.0, 2.0))), _mm256_mul_pd(xi_283, _mm256_set_pd(2.0, 2.0, 2.0, 2.0))), _mm256_mul_pd(xi_266, _mm256_set_pd(5.0, 5.0, 5.0, 5.0))), _mm256_mul_pd(xi_276, _mm256_set_pd(5.0, 5.0, 5.0, 5.0)));
            const __m256d xi_124 = _mm256_mul_pd(xi_271, _mm256_set_pd(2.0, 2.0, 2.0, 2.0));
            const __m256d xi_125 = _mm256_mul_pd(xi_274, _mm256_set_pd(2.0, 2.0, 2.0, 2.0));
            const __m256d xi_126 = _mm256_add_pd(_mm256_mul_pd(xi_264, _mm256_set_pd(2.0, 2.0, 2.0, 2.0)), _mm256_mul_pd(xi_282, _mm256_set_pd(2.0, 2.0, 2.0, 2.0)));
            const __m256d xi_129 = _mm256_mul_pd(xi_277, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_133 = _mm256_add_pd(_mm256_set_pd(-0.5, -0.5, -0.5, -0.5), random_0_1);
            const __m256d xi_137 = _mm256_mul_pd(xi_282, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_138 = _mm256_mul_pd(xi_264, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_139 = _mm256_mul_pd(xi_270, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_140 = _mm256_mul_pd(xi_279, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_145 = _mm256_mul_pd(xi_275, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_146 = _mm256_add_pd(xi_14, xi_278);
            const __m256d xi_147 = _mm256_mul_pd(xi_268, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_148 = _mm256_add_pd(xi_147, xi_277);
            const __m256d xi_149 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(xi_145, xi_146), xi_148), xi_283);
            const __m256d xi_151 = _mm256_add_pd(_mm256_set_pd(-0.5, -0.5, -0.5, -0.5), random_5_1);
            const __m256d xi_155 = _mm256_mul_pd(xi_283, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_156 = _mm256_mul_pd(xi_278, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_157 = _mm256_mul_pd(xi_269, _mm256_set_pd(2.0, 2.0, 2.0, 2.0));
            const __m256d xi_158 = _mm256_add_pd(_mm256_mul_pd(xi_265, _mm256_set_pd(2.0, 2.0, 2.0, 2.0)), _mm256_mul_pd(xi_272, _mm256_set_pd(-2.0, -2.0, -2.0, -2.0)));
            const __m256d xi_159 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_284, _mm256_set_pd(2.0, 2.0, 2.0, 2.0)), _mm256_mul_pd(xi_157, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), xi_148), xi_155), xi_156), xi_158), xi_5);
            ...
            const __m256d xi_185 = _mm256_add_pd(xi_15, xi_271);
            const __m256d xi_186 = _mm256_add_pd(xi_138, xi_185);
            const __m256d xi_187 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_266, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), xi_186), xi_276), xi_282);
            const __m256d xi_188 = _mm256_add_pd(_mm256_set_pd(-0.5, -0.5, -0.5, -0.5), random_4_1);
            const __m256d xi_189 = _mm256_mul_pd(xi_276, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            const __m256d xi_190 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_284, _mm256_set_pd(2.0, 2.0, 2.0, 2.0)), _mm256_mul_pd(xi_157, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), _mm256_mul_pd(xi_158, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), _mm256_mul_pd(xi_186, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), _mm256_mul_pd(xi_189, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), _mm256_mul_pd(xi_7, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)));
            ...
            const __m256d xi_198 = _mm256_add_pd(_mm256_add_pd(xi_145, xi_155), xi_267);
            const __m256d xi_199 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_139, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), _mm256_mul_pd(xi_198, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), _mm256_mul_pd(xi_278, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), _mm256_mul_pd(xi_279, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)));
            ...
            const __m256d xi_46 = _mm256_mul_pd(xi_281, _mm256_set_pd(xi_45, xi_45, xi_45, xi_45));
            const __m256d xi_50 = _mm256_mul_pd(xi_273, _mm256_set_pd(xi_45, xi_45, xi_45, xi_45));
            const __m256d xi_72 = _mm256_mul_pd(xi_280, _mm256_set_pd(xi_45, xi_45, xi_45, xi_45));
            const __m256d vel0Term = _mm256_add_pd(xi_276, xi_3);
            const __m256d vel1Term = _mm256_add_pd(xi_4, xi_5);
            const __m256d vel2Term = _mm256_add_pd(xi_271, xi_6);
            const __m256d rho = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(vel0Term, vel1Term), vel2Term), xi_263), xi_279), xi_8), xi_9);
            ...
            const __m256d u_0 = _mm256_add_pd(_mm256_mul_pd(xi_0, _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_11, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), _mm256_mul_pd(xi_8, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), vel0Term)), _mm256_mul_pd(xi_10, xi_281));
            const __m256d xi_17 = _mm256_mul_pd(u_0, xi_281);
            ...
            const __m256d xi_75 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(u_0, xi_281), _mm256_set_pd(-0.083333333333333329, -0.083333333333333329, -0.083333333333333329, -0.083333333333333329)), _mm256_set_pd(omega_shear, omega_shear, omega_shear, omega_shear));
            const __m256d xi_85 = _mm256_mul_pd(u_0, xi_280);
            ...
            const __m256d u_1 = _mm256_add_pd(_mm256_mul_pd(xi_0, _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_12, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), _mm256_mul_pd(xi_13, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), _mm256_mul_pd(xi_9, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), vel1Term)), _mm256_mul_pd(xi_10, xi_273));
            const __m256d xi_18 = _mm256_mul_pd(u_1, xi_273);
            ...
            const __m256d xi_36 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(u_1, xi_273), _mm256_set_pd(-0.083333333333333329, -0.083333333333333329, -0.083333333333333329, -0.083333333333333329)), _mm256_set_pd(omega_shear, omega_shear, omega_shear, omega_shear));
            ...
            const __m256d xi_61 = _mm256_mul_pd(xi_281, xi_60);
            const __m256d xi_65 = _mm256_mul_pd(u_1, _mm256_set_pd(xi_62, xi_62, xi_62, xi_62));
            const __m256d xi_66 = _mm256_mul_pd(xi_281, xi_65);
            ...
            const __m256d xi_77 = _mm256_mul_pd(xi_280, xi_60);
            const __m256d xi_79 = _mm256_mul_pd(xi_280, xi_65);
            ...
            const __m256d xi_218 = _mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_284, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), _mm256_mul_pd(u_0, xi_216)), xi_12), xi_272), _mm256_set_pd(xi_217, xi_217, xi_217, xi_217));
            ...
            const __m256d xi_37 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(u_2, xi_280), _mm256_set_pd(-0.083333333333333329, -0.083333333333333329, -0.083333333333333329, -0.083333333333333329)), _mm256_set_pd(omega_shear, omega_shear, omega_shear, omega_shear));
            const __m256d xi_38 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_28, _mm256_set_pd(omega_shear, omega_shear, omega_shear, omega_shear)), _mm256_mul_pd(_mm256_mul_pd(u_0, xi_281), _mm256_set_pd(-0.33333333333333331, -0.33333333333333331, -0.33333333333333331, -0.33333333333333331))), xi_24), xi_26), xi_36), xi_37);
            ...
            const __m256d xi_87 = _mm256_mul_pd(u_2, xi_281);
            ...
            const __m256d xi_114 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_270, _mm256_set_pd(3.0, 3.0, 3.0, 3.0)), _mm256_mul_pd(xi_279, _mm256_set_pd(3.0, 3.0, 3.0, 3.0))), _mm256_mul_pd(xi_113, _mm256_set_pd(0.66666666666666663, 0.66666666666666663, 0.66666666666666663, 0.66666666666666663))), xi_112);
            const __m256d xi_115 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_268, _mm256_set_pd(3.0, 3.0, 3.0, 3.0)), _mm256_mul_pd(xi_277, _mm256_set_pd(3.0, 3.0, 3.0, 3.0))), _mm256_mul_pd(xi_110, _mm256_set_pd(0.66666666666666663, 0.66666666666666663, 0.66666666666666663, 0.66666666666666663))), _mm256_mul_pd(xi_267, _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))), _mm256_mul_pd(xi_275, _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))), _mm256_mul_pd(xi_278, _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))), _mm256_mul_pd(xi_283, _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))), _mm256_mul_pd(_mm256_mul_pd(rho, xi_111), _mm256_set_pd(1.6666666666666667, 1.6666666666666667, 1.6666666666666667, 1.6666666666666667))), xi_114);
            ...
            const __m256d xi_225 = _mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(u_2, xi_216), xi_146), xi_155), xi_275), _mm256_set_pd(xi_217, xi_217, xi_217, xi_217));
            ...
            const __m256d xi_252 = _mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_mul_pd(rho, u_0), u_2), xi_137), xi_185), xi_264), _mm256_set_pd(xi_217, xi_217, xi_217, xi_217));
            ...
            _mm256_storeu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 6 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(xi_128, _mm256_set_pd(0.015873015873015872, 0.015873015873015872, 0.015873015873015872, 0.015873015873015872)), _mm256_mul_pd(xi_99, _mm256_set_pd(0.095238095238095233, 0.095238095238095233, 0.095238095238095233, 0.095238095238095233))), _mm256_mul_pd(xi_196, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), _mm256_mul_pd(xi_197, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0))), forceTerm_6), xi_144), xi_182), xi_206), xi_279));
            _mm256_storeu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 7 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_7, xi_213), xi_214), xi_219), xi_272));
            _mm256_store_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 8 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_8, xi_194), xi_213), xi_220), xi_269));
            _mm256_storeu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 9 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_9, xi_214), xi_220), xi_221), xi_284));
            _mm256_storeu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 10 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_10, xi_194), xi_219), xi_221), xi_265));
            _mm256_storeu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 11 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_11, xi_232), xi_237), xi_243), xi_267));
            ...
            _mm256_storeu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 13 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_13, xi_250), xi_253), xi_258), xi_271));
            _mm256_storeu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 14 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_14, xi_250), xi_259), xi_260), xi_274));
            ...
            _mm256_store_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 16 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_16, xi_243), xi_244), xi_261), xi_283));
            _mm256_storeu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 17 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_17, xi_258), xi_259), xi_262), xi_282));
            _mm256_storeu_pd(&_data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 18 * _stride_pdfs_3 + ctr_0], _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(forceTerm_18, xi_253), xi_260), xi_262), xi_264));
          }
          for (int64_t ctr_0 = (int64_t)((_size_force_0) / (4)) * (4); ctr_0 < _size_force_0; ctr_0 += 1) {
            const double xi_263 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + ctr_0];
            const double xi_264 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 18 * _stride_pdfs_3 + ctr_0];
            const double xi_265 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 10 * _stride_pdfs_3 + ctr_0];
            const double xi_266 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 3 * _stride_pdfs_3 + ctr_0];
            const double xi_267 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 11 * _stride_pdfs_3 + ctr_0];
            const double xi_268 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 2 * _stride_pdfs_3 + ctr_0];
            const double xi_269 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 8 * _stride_pdfs_3 + ctr_0];
            const double xi_270 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 5 * _stride_pdfs_3 + ctr_0];
            const double xi_271 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 13 * _stride_pdfs_3 + ctr_0];
            const double xi_272 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 7 * _stride_pdfs_3 + ctr_0];
            const double xi_273 = _data_force[_stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 + _stride_force_3 + ctr_0];
            const double xi_274 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 14 * _stride_pdfs_3 + ctr_0];
            const double xi_275 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 15 * _stride_pdfs_3 + ctr_0];
            const double xi_276 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 4 * _stride_pdfs_3 + ctr_0];
            const double xi_277 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + _stride_pdfs_3 + ctr_0];
            const double xi_278 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 12 * _stride_pdfs_3 + ctr_0];
            const double xi_279 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 6 * _stride_pdfs_3 + ctr_0];
            const double xi_280 = _data_force[_stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 + 2 * _stride_force_3 + ctr_0];
            const double xi_281 = _data_force[_stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 + ctr_0];
            const double xi_282 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 17 * _stride_pdfs_3 + ctr_0];
            const double xi_283 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 16 * _stride_pdfs_3 + ctr_0];
            const double xi_284 = _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 9 * _stride_pdfs_3 + ctr_0];
            ...
            const double xi_2 = xi_265 + xi_269;
            const double xi_3 = xi_2 + xi_264 + xi_274;
            const double xi_4 = xi_272 + xi_277;
            const double xi_5 = xi_267 + xi_275;
            const double xi_6 = xi_270 + xi_278;
            const double xi_7 = xi_266 + xi_282;
            const double xi_8 = xi_284 + xi_7;
            const double xi_9 = xi_268 + xi_283;
            const double xi_11 = xi_271 + xi_272;
            const double xi_12 = xi_265 - xi_269;
            const double xi_13 = xi_278 + xi_284;
            const double xi_14 = -xi_267;
            const double xi_15 = -xi_274;
            const double xi_16 = xi_282 + xi_283;
            const double xi_21 = xi_273 * 0.16666666666666666;
            const double xi_22 = xi_273 * 0.083333333333333329;
            const double xi_33 = xi_281 * 0.16666666666666666;
            const double xi_34 = xi_281 * 0.083333333333333329;
            const double xi_39 = xi_280 * 0.16666666666666666;
            const double xi_40 = xi_280 * 0.083333333333333329;
            const double xi_58 = xi_273 * 0.25;
            const double xi_63 = xi_273 * xi_62;
            ...
            const double xi_112 = -xi_263;
            const double xi_118 = xi_11 + xi_3;
            const double xi_121 = xi_266 * 5.0 + xi_267 * 2.0 + xi_275 * 2.0 + xi_276 * 5.0 + xi_278 * 2.0 + xi_283 * 2.0;
            const double xi_124 = xi_271 * 2.0;
            const double xi_125 = xi_274 * 2.0;
            const double xi_126 = xi_264 * 2.0 + xi_282 * 2.0;
            const double xi_129 = -xi_277;
            const double xi_133 = random_0_1 - 0.5;
            const double xi_137 = -xi_282;
            const double xi_138 = -xi_264;
            const double xi_139 = -xi_270;
            const double xi_140 = -xi_279;
            const double xi_145 = -xi_275;
            const double xi_146 = xi_14 + xi_278;
            const double xi_147 = -xi_268;
            const double xi_148 = xi_147 + xi_277;
            const double xi_149 = xi_145 + xi_146 + xi_148 + xi_283;
            const double xi_151 = random_5_1 - 0.5;
            const double xi_155 = -xi_283;
            const double xi_156 = -xi_278;
            const double xi_157 = xi_269 * 2.0;
            const double xi_158 = xi_265 * 2.0 + xi_272 * -2.0;
            const double xi_159 = xi_148 + xi_155 + xi_156 - xi_157 + xi_158 + xi_284 * 2.0 + xi_5;
            const double xi_161 = xi_159 * xi_160;
            const double xi_162 = random_3_0 - 0.5;
            const double xi_174 = random_0_0 - 0.5;
            const double xi_185 = xi_15 + xi_271;
            const double xi_186 = xi_138 + xi_185;
            const double xi_187 = xi_186 - xi_266 + xi_276 + xi_282;
            const double xi_188 = random_4_1 - 0.5;
            const double xi_189 = -xi_276;
            const double xi_190 = -xi_157 - xi_158 - xi_186 - xi_189 + xi_284 * 2.0 - xi_7;
            const double xi_191 = xi_160 * xi_190;
            const double xi_192 = random_4_0 - 0.5;
            const double xi_198 = xi_145 + xi_155 + xi_267;
            const double xi_199 = -xi_139 - xi_198 - xi_278 - xi_279;
            ...
            const double xi_46 = xi_281 * xi_45;
            const double xi_50 = xi_273 * xi_45;
            const double xi_72 = xi_280 * xi_45;
            const double vel0Term = xi_276 + xi_3;
            const double vel1Term = xi_4 + xi_5;
            const double vel2Term = xi_271 + xi_6;
            const double rho = vel0Term + vel1Term + vel2Term + xi_263 + xi_279 + xi_8 + xi_9;
            ...
            const double u_0 = xi_0 * (vel0Term - xi_11 - xi_8) + xi_10 * xi_281;
            const double xi_17 = u_0 * xi_281;
            ...
            const double xi_75 = omega_shear * u_0 * xi_281 * -0.083333333333333329;
            const double xi_85 = u_0 * xi_280;
            const double xi_86 = xi_85 * 0.25;
            const double xi_89 = xi_62 * xi_85;
            const double xi_111 = (u_0 * u_0);
            const double u_1 = xi_0 * (vel1Term - xi_12 - xi_13 - xi_9) + xi_10 * xi_273;
            const double xi_18 = u_1 * xi_273;
            const double xi_26 = xi_18 * 0.16666666666666666;
            const double xi_36 = omega_shear * u_1 * xi_273 * -0.083333333333333329;
            ...
            const double xi_61 = xi_281 * xi_60;
            const double xi_65 = u_1 * xi_62;
            const double xi_66 = xi_281 * xi_65;
            const double xi_67 = xi_59 + xi_61 - xi_64 - xi_66;
            const double xi_69 = -xi_59 - xi_61 + xi_64 + xi_66;
            const double xi_77 = xi_280 * xi_60;
            const double xi_79 = xi_280 * xi_65;
            const double xi_110 = rho * (u_1 * u_1);
            const double xi_117 = -xi_110;
            const double xi_216 = rho * u_1;
            const double xi_218 = xi_217 * (u_0 * xi_216 + xi_12 + xi_272 - xi_284);
            const double xi_219 = -xi_215 - xi_218;
            const double xi_220 = xi_215 + xi_218;
            const double u_2 = xi_0 * (vel2Term - xi_14 - xi_15 - xi_16 - xi_264 - xi_275 - xi_279) + xi_10 * xi_280;
            const double xi_19 = u_2 * xi_280;
            ...
            const double xi_37 = omega_shear * u_2 * xi_280 * -0.083333333333333329;
            const double xi_38 = omega_shear * xi_28 + u_0 * xi_281 * -0.33333333333333331 + xi_24 + xi_26 + xi_36 + xi_37;
            ...
            const double xi_114 = xi_112 + xi_113 * 0.66666666666666663 + xi_270 * 3.0 + xi_279 * 3.0;
            const double xi_115 = rho * xi_111 * 1.6666666666666667 + xi_110 * 0.66666666666666663 + xi_114 + xi_267 * -3.0 + xi_268 * 3.0 + xi_275 * -3.0 + xi_277 * 3.0 + xi_278 * -3.0 + xi_283 * -3.0;
            ...
            const double xi_122 = xi_110 * 2.3333333333333335 + xi_114 + xi_121 + xi_264 * -5.0 + xi_268 * -2.0 + xi_271 * -5.0 + xi_274 * -5.0 + xi_277 * -2.0 + xi_282 * -5.0;
            const double xi_123 = omega_even * xi_122;
            const double xi_127 = xi_112 + xi_113 * 3.0 + xi_121 + xi_124 + xi_125 + xi_126 + xi_265 * -7.0 + xi_268 * 5.0 + xi_269 * -7.0 + xi_270 * -4.0 + xi_272 * -7.0 + xi_277 * 5.0 + xi_279 * -4.0 + xi_284 * -7.0;
            const double xi_128 = omega_even * xi_127;
            const double xi_130 = xi_128 * 0.01984126984126984;
            const double xi_132 = xi_130 + xi_131;
            const double xi_141 = xi_113 + xi_139 + xi_140 + xi_284;
            const double xi_142 = omega_shear * (-xi_117 - xi_137 - xi_138 - xi_141 - xi_15 - xi_2 - xi_268 + xi_271 - xi_4);
            const double xi_143 = xi_142 * 0.125;
            const double xi_144 = -xi_136 - xi_143;
            const double xi_168 = xi_116 * 0.050000000000000003;
            const double xi_170 = rho * xi_111 * 2.0 - xi_110 - xi_118 - xi_129 - xi_141 - xi_147 + xi_266 * -2.0 + xi_267 * 2.0 + xi_275 * 2.0 + xi_276 * -2.0 + xi_278 * 2.0 - xi_282 + xi_283 * 2.0;
            ...
            const double xi_225 = xi_217 * (u_2 * xi_216 + xi_146 + xi_155 + xi_275);
            ...
            const double xi_252 = xi_217 * (rho * u_0 * u_2 + xi_137 + xi_185 + xi_264);
            ...
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + ctr_0] = forceTerm_0 + xi_102 * 0.20000000000000001 - xi_106 + xi_109 * 0.085714285714285715 + xi_116 * 0.10000000000000001 + xi_120 * -0.5 + xi_123 * 0.042857142857142858 + xi_128 * 0.023809523809523808 + xi_263 + xi_99 * 0.14285714285714285;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + _stride_pdfs_3 + ctr_0] = forceTerm_1 + omega_even * xi_122 * 0.014285714285714285 + xi_107 * xi_108 * xi_96 * 0.028571428571428571 - xi_129 - xi_132 - xi_144 - xi_167 - xi_178;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 2 * _stride_pdfs_3 + ctr_0] = forceTerm_2 + xi_109 * 0.028571428571428571 + xi_123 * 0.014285714285714285 + xi_167 + xi_179 + xi_180 + xi_182 + xi_268;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 3 * _stride_pdfs_3 + ctr_0] = forceTerm_3 + xi_171 * 0.083333333333333329 + xi_175 * 0.33333333333333331 + xi_179 - xi_183 - xi_184 + xi_195 + xi_266;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 4 * _stride_pdfs_3 + ctr_0] = forceTerm_4 + omega_shear * xi_170 * 0.083333333333333329 - xi_132 + xi_134 * xi_173 * xi_174 * 0.33333333333333331 - xi_183 - xi_184 - xi_189 - xi_195;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 5 * _stride_pdfs_3 + ctr_0] = forceTerm_5 + omega_even * xi_127 * 0.015873015873015872 - xi_139 - xi_178 - xi_180 - xi_196 - xi_197 - xi_206 + xi_96 * xi_97 * xi_98 * 0.095238095238095233;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 6 * _stride_pdfs_3 + ctr_0] = forceTerm_6 + xi_128 * 0.015873015873015872 + xi_144 + xi_182 - xi_196 - xi_197 + xi_206 + xi_279 + xi_99 * 0.095238095238095233;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 7 * _stride_pdfs_3 + ctr_0] = forceTerm_7 + xi_213 + xi_214 + xi_219 + xi_272;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 8 * _stride_pdfs_3 + ctr_0] = forceTerm_8 + xi_194 + xi_213 + xi_220 + xi_269;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 9 * _stride_pdfs_3 + ctr_0] = forceTerm_9 + xi_214 + xi_220 + xi_221 + xi_284;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 10 * _stride_pdfs_3 + ctr_0] = forceTerm_10 + xi_194 + xi_219 + xi_221 + xi_265;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 11 * _stride_pdfs_3 + ctr_0] = forceTerm_11 + xi_232 + xi_237 + xi_243 + xi_267;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 12 * _stride_pdfs_3 + ctr_0] = forceTerm_12 - xi_156 - xi_232 - xi_244 - xi_245;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 13 * _stride_pdfs_3 + ctr_0] = forceTerm_13 + xi_250 + xi_253 + xi_258 + xi_271;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 14 * _stride_pdfs_3 + ctr_0] = forceTerm_14 + xi_250 + xi_259 + xi_260 + xi_274;
            ...
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 17 * _stride_pdfs_3 + ctr_0] = forceTerm_17 + xi_258 + xi_259 + xi_262 + xi_282;
            _data_pdfs[_stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 + 18 * _stride_pdfs_3 + ctr_0] = forceTerm_18 + xi_253 + xi_260 + xi_262 + xi_264;
          }
        }
      }
    }
