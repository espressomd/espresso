  ...
  for (int64_t ctr_2 = 1; ctr_2 < _size_force_2 - 1; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 1; ctr_1 < _size_force_1 - 1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 1; ctr_0 < _size_force_0 - 1; ctr_0 += 1) {
        ...
        const float xi_2 = _data_pdfs_21_318_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] + _data_pdfs_2m1_314_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_3 = xi_2 + _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_4 = _data_pdfs_20_31_1m1[_stride_pdfs_0 * ctr_0] + _data_pdfs_21_315_1m1[_stride_pdfs_0 * ctr_0] + _data_pdfs_2m1_311_1m1[_stride_pdfs_0 * ctr_0];
        const float xi_5 = _data_pdfs_2m1_312_11[_stride_pdfs_0 * ctr_0] + _data_pdfs_2m1_35_10[_stride_pdfs_0 * ctr_0];
        const float xi_6 = _data_pdfs_21_317_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] + _data_pdfs_21_36_10[_stride_pdfs_0 * ctr_0];
        const float xi_8 = -1.0f * _data_pdfs_20_39_11[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float xi_9 = -1.0f * _data_pdfs_20_37_1m1[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float xi_10 = -1.0f * _data_pdfs_21_317_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float xi_11 = -1.0f * _data_pdfs_2m1_313_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float xi_12 = -1.0f * _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float xi_13 = xi_10 + xi_11 + xi_12;
        const float xi_14 = -1.0f * _data_pdfs_20_32_11[_stride_pdfs_0 * ctr_0];
        const float xi_15 = -1.0f * _data_pdfs_20_310_11[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_16 = xi_14 + xi_15;
        const float xi_17 = -1.0f * _data_pdfs_21_316_11[_stride_pdfs_0 * ctr_0];
        const float xi_18 = -1.0f * _data_pdfs_2m1_312_11[_stride_pdfs_0 * ctr_0];
        const float xi_19 = xi_17 + xi_18;
        const float xi_20 = -1.0f * _data_pdfs_21_318_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_21 = xi_10 + xi_20;
        const float xi_22 = -1.0f * _data_pdfs_21_315_1m1[_stride_pdfs_0 * ctr_0];
        const float xi_23 = -1.0f * _data_pdfs_21_36_10[_stride_pdfs_0 * ctr_0];
        const float xi_24 = xi_17 + xi_22 + xi_23 + _data_pdfs_2m1_311_1m1[_stride_pdfs_0 * ctr_0];
        const float xi_29 = 0.16666666666666666f * _data_force_20_31_10[_stride_force_0 * ctr_0];
        const float xi_30 = 0.083333333333333329f * _data_force_20_31_10[_stride_force_0 * ctr_0];
        const float xi_42 = 0.16666666666666666f * _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_43 = 0.083333333333333329f * _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_49 = 0.16666666666666666f * _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float xi_50 = 0.083333333333333329f * _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float xi_67 = 0.25f * _data_force_20_31_10[_stride_force_0 * ctr_0];
        const float xi_72 = xi_71 * _data_force_20_31_10[_stride_force_0 * ctr_0];
        const float xi_114 = -1.0f * _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0];
        const float xi_118 = -1.0f * _data_pdfs_2m1_311_1m1[_stride_pdfs_0 * ctr_0];
        const float xi_119 = xi_118 + xi_18;
        const float xi_120 = xi_8 - 1.0f * _data_pdfs_20_38_1m1[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_122 = -1.0f * _data_pdfs_2m1_314_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_123 = xi_11 + xi_122 + xi_15 + xi_21;
        const float xi_125 = 2.0f * _data_pdfs_21_315_1m1[_stride_pdfs_0 * ctr_0] + 2.0f * _data_pdfs_21_316_11[_stride_pdfs_0 * ctr_0] + 2.0f * _data_pdfs_2m1_311_1m1[_stride_pdfs_0 * ctr_0] + 2.0f * _data_pdfs_2m1_312_11[_stride_pdfs_0 * ctr_0];
        const float xi_126 = xi_125 + 5.0f * _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] + 5.0f * _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_128 = 2.0f * _data_pdfs_2m1_313_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float xi_129 = 2.0f * _data_pdfs_2m1_314_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_130 = 2.0f * _data_pdfs_21_317_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] + 2.0f * _data_pdfs_21_318_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_132 = xi_118 + _data_pdfs_2m1_312_11[_stride_pdfs_0 * ctr_0];
        const float xi_133 = xi_132 + xi_14 + xi_22 + _data_pdfs_20_31_1m1[_stride_pdfs_0 * ctr_0] + _data_pdfs_21_316_11[_stride_pdfs_0 * ctr_0];
        const float xi_135 = xi_133 * xi_134;
        const float xi_136 = random_2_3 - 0.5f;
        const float xi_141 = 2.0f * _data_pdfs_20_37_1m1[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float xi_142 = 2.0f * _data_pdfs_20_310_11[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float xi_143 = -2.0f * _data_pdfs_20_38_1m1[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] + 2.0f * _data_pdfs_20_39_11[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        ...
        const float xi_166 = xi_122 + _data_pdfs_2m1_313_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float xi_167 = xi_12 + xi_166 + xi_20 + _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] + _data_pdfs_21_317_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        ...
        const float xi_178 = xi_119 + xi_23 + _data_pdfs_21_315_1m1[_stride_pdfs_0 * ctr_0] + _data_pdfs_21_316_11[_stride_pdfs_0 * ctr_0] + _data_pdfs_2m1_35_10[_stride_pdfs_0 * ctr_0];
        ...
        const float xi_54 = xi_53 * _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_59 = xi_53 * _data_force_20_31_10[_stride_force_0 * ctr_0];
        const float xi_81 = xi_53 * _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float vel0Term = xi_3 + _data_pdfs_20_310_11[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] + _data_pdfs_20_38_1m1[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        const float vel1Term = xi_4 + _data_pdfs_20_37_1m1[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float vel2Term = xi_5 + _data_pdfs_2m1_313_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        const float rho = vel0Term + vel1Term + vel2Term + xi_6 + _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0] + _data_pdfs_20_32_11[_stride_pdfs_0 * ctr_0] + _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] + _data_pdfs_20_39_11[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] + _data_pdfs_21_316_11[_stride_pdfs_0 * ctr_0];
        ...
        const float u_0 = xi_0 * (vel0Term + xi_13 + xi_8 + xi_9) + xi_7 * _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_25 = u_0 * _data_force_20_30_10[_stride_force_0 * ctr_0];
        ...
        const float xi_95 = u_0 * _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float xi_96 = xi_95 * 0.25f;
        const float xi_99 = xi_71 * xi_95;
        const float xi_113 = rho * (u_0 * u_0);
        const float u_1 = xi_0 * (vel1Term + xi_16 + xi_19 + xi_8 + _data_pdfs_20_38_1m1[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0]) + xi_7 * _data_force_20_31_10[_stride_force_0 * ctr_0];
        const float xi_26 = u_1 * _data_force_20_31_10[_stride_force_0 * ctr_0];
        ...
        const float xi_70 = xi_69 * _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_74 = u_1 * xi_71;
        const float xi_75 = xi_74 * _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_76 = xi_68 * -1.0f + xi_70 * -1.0f + xi_73 + xi_75;
        const float xi_78 = xi_68 + xi_70 + xi_73 * -1.0f + xi_75 * -1.0f;
        const float xi_86 = xi_69 * _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float xi_88 = xi_74 * _data_force_20_32_10[_stride_force_0 * ctr_0];
        ...
        const float xi_199 = xi_198 * (u_0 * xi_197 + xi_120 + _data_pdfs_20_310_11[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] + _data_pdfs_20_37_1m1[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0]);
        const float xi_200 = xi_196 * -1.0f + xi_199 * -1.0f;
        const float xi_201 = xi_196 + xi_199;
        const float u_2 = xi_0 * (vel2Term + xi_21 + xi_24 + _data_pdfs_2m1_314_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0]) + xi_7 * _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float xi_27 = u_2 * _data_force_20_32_10[_stride_force_0 * ctr_0];
        ...
        const float xi_97 = u_2 * _data_force_20_30_10[_stride_force_0 * ctr_0];
        ...
        const float xi_116 = xi_114 + xi_115 * 0.66666666666666663f + 3.0f * _data_pdfs_21_36_10[_stride_pdfs_0 * ctr_0] + 3.0f * _data_pdfs_2m1_35_10[_stride_pdfs_0 * ctr_0];
        const float xi_117 = omega_even * (xi_112 * 0.66666666666666663f + xi_113 * 1.6666666666666667f + xi_116 - 3.0f * _data_pdfs_21_315_1m1[_stride_pdfs_0 * ctr_0] - 3.0f * _data_pdfs_21_316_11[_stride_pdfs_0 * ctr_0] - 3.0f * _data_pdfs_2m1_311_1m1[_stride_pdfs_0 * ctr_0] - 3.0f * _data_pdfs_2m1_312_11[_stride_pdfs_0 * ctr_0] + 3.0f * _data_pdfs_20_31_1m1[_stride_pdfs_0 * ctr_0] + 3.0f * _data_pdfs_20_32_11[_stride_pdfs_0 * ctr_0]);
        const float xi_124 = omega_bulk * (xi_113 + xi_115 + xi_119 + xi_121 + xi_123 + xi_17 + xi_22 + _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0]);
        const float xi_127 = omega_even * (xi_112 * 2.3333333333333335f + xi_116 + xi_126 - 2.0f * _data_pdfs_20_31_1m1[_stride_pdfs_0 * ctr_0] - 2.0f * _data_pdfs_20_32_11[_stride_pdfs_0 * ctr_0] - 5.0f * _data_pdfs_21_317_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] - 5.0f * _data_pdfs_21_318_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] - 5.0f * _data_pdfs_2m1_313_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] - 5.0f * _data_pdfs_2m1_314_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0]);
        const float xi_131 = omega_even * (xi_114 + xi_115 * 3.0f + xi_126 + xi_128 + xi_129 + xi_130 - 4.0f * _data_pdfs_21_36_10[_stride_pdfs_0 * ctr_0] - 4.0f * _data_pdfs_2m1_35_10[_stride_pdfs_0 * ctr_0] - 7.0f * _data_pdfs_20_310_11[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] - 7.0f * _data_pdfs_20_37_1m1[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] - 7.0f * _data_pdfs_20_38_1m1[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] - 7.0f * _data_pdfs_20_39_11[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] + 5.0f * _data_pdfs_20_31_1m1[_stride_pdfs_0 * ctr_0] + 5.0f * _data_pdfs_20_32_11[_stride_pdfs_0 * ctr_0]);
        const float xi_156 = xi_115 * -1.0f + _data_pdfs_2m1_35_10[_stride_pdfs_0 * ctr_0];
        const float xi_157 = omega_shear * (xi_121 + xi_156 + xi_16 + xi_2 + xi_6 - 1.0f * _data_pdfs_20_31_1m1[_stride_pdfs_0 * ctr_0] + _data_pdfs_2m1_313_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0]);
        const float xi_158 = xi_157 * 0.125f;
        const float xi_159 = xi_107 * -0.11904761904761904f + xi_131 * -0.01984126984126984f;
        const float xi_160 = omega_shear * (xi_112 * -1.0f + xi_113 * 2.0f + xi_120 + xi_123 + xi_125 + xi_156 + xi_9 - 2.0f * _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0] - 2.0f * _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0] + _data_pdfs_20_31_1m1[_stride_pdfs_0 * ctr_0] + _data_pdfs_20_32_11[_stride_pdfs_0 * ctr_0] + _data_pdfs_21_36_10[_stride_pdfs_0 * ctr_0]);
        ...
        const float xi_205 = xi_198 * (u_2 * xi_197 + xi_132 + xi_17 + _data_pdfs_21_315_1m1[_stride_pdfs_0 * ctr_0]);
        ...
        const float xi_233 = xi_198 * (rho * u_0 * u_2 + xi_10 + xi_166 + _data_pdfs_21_318_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0]);
        ...
        _data_pdfs_tmp_20_30_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_0 + xi_107 * 0.14285714285714285f + xi_108 * 0.20000000000000001f + xi_110 * -1.0f + xi_111 * 0.085714285714285715f + xi_117 * 0.10000000000000001f + xi_124 * -0.5f + xi_127 * 0.042857142857142858f + xi_131 * 0.023809523809523808f + _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0];
        _data_pdfs_tmp_20_31_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_1 + xi_135 * -1.0f + xi_140 * -1.0f + xi_151 + xi_164 + _data_pdfs_20_31_1m1[_stride_pdfs_0 * ctr_0];
        _data_pdfs_tmp_20_32_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_2 + xi_135 + xi_140 + xi_164 + xi_165 + _data_pdfs_20_32_11[_stride_pdfs_0 * ctr_0];
        _data_pdfs_tmp_20_33_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_3 + xi_168 + xi_170 + xi_175 + xi_176 + _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        _data_pdfs_tmp_20_34_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_4 + xi_168 * -1.0f + xi_170 * -1.0f + xi_176 + xi_177 + _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        _data_pdfs_tmp_20_35_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_5 + xi_179 * -1.0f + xi_181 * -1.0f + xi_186 + xi_187 + _data_pdfs_2m1_35_10[_stride_pdfs_0 * ctr_0];
        _data_pdfs_tmp_20_36_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_6 + xi_179 + xi_181 + xi_187 + xi_188 + _data_pdfs_21_36_10[_stride_pdfs_0 * ctr_0];
        _data_pdfs_tmp_20_37_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_7 + xi_177 + xi_195 + xi_200 + _data_pdfs_20_37_1m1[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        _data_pdfs_tmp_20_38_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_8 + xi_175 + xi_195 + xi_201 + _data_pdfs_20_38_1m1[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        _data_pdfs_tmp_20_39_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_9 + xi_177 + xi_201 + xi_202 + _data_pdfs_20_39_11[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        _data_pdfs_tmp_20_310_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_10 + xi_175 + xi_200 + xi_202 + _data_pdfs_20_310_11[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        _data_pdfs_tmp_20_311_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_11 + xi_210 + xi_219 + xi_224 + _data_pdfs_2m1_311_1m1[_stride_pdfs_0 * ctr_0];
        _data_pdfs_tmp_20_312_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_12 + xi_219 + xi_225 + xi_226 + _data_pdfs_2m1_312_11[_stride_pdfs_0 * ctr_0];
        _data_pdfs_tmp_20_313_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_13 + xi_231 + xi_234 + xi_239 + _data_pdfs_2m1_313_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        _data_pdfs_tmp_20_314_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_14 + xi_231 + xi_240 + xi_241 + _data_pdfs_2m1_314_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
        _data_pdfs_tmp_20_315_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_15 + xi_224 + xi_226 + xi_242 + _data_pdfs_21_315_1m1[_stride_pdfs_0 * ctr_0];
        _data_pdfs_tmp_20_316_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_16 + xi_210 + xi_225 + xi_242 + _data_pdfs_21_316_11[_stride_pdfs_0 * ctr_0];
        _data_pdfs_tmp_20_317_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_17 + xi_239 + xi_240 + xi_243 + _data_pdfs_21_317_10[_stride_pdfs_0 * ctr_0 + _stride_pdfs_0];
        _data_pdfs_tmp_20_318_10[_stride_pdfs_tmp_0 * ctr_0] = forceTerm_18 + xi_234 + xi_241 + xi_243 + _data_pdfs_21_318_10[_stride_pdfs_0 * ctr_0 - _stride_pdfs_0];
      }
    }
  }
}
