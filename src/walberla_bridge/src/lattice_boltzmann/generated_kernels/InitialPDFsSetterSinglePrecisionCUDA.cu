...
void InitialPDFsSetterSinglePrecisionCUDA::run(IBlock *block, cudaStream_t stream) {
...
void InitialPDFsSetterSinglePrecisionCUDA::runOnCellInterval(const shared_ptr<StructuredBlockStorage> &blocks, const CellInterval &globalCellInterval, cell_idx_t ghostLayers, IBlock *block, cudaStream_t stream) {
