...
__launch_bounds__(256) void collidesweepsingleprecisionleesedwardscuda_collidesweepsingleprecisionleesedwardscuda(
  ...
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 &&
    ...
    const float xi_3 = xi_29;
    const float xi_4 = xi_46;
    const float xi_5 = xi_30;
    const float xi_6 = xi_34;
    const float xi_7 = xi_41;
    const float xi_8 = xi_44;
    const float xi_9 = xi_33;
    const float xi_10 = xi_40;
    const float xi_11 = xi_36;
    const float xi_12 = xi_25;
    const float xi_13 = xi_31;
    const float xi_14 = xi_37;
    const float xi_15 = xi_32;
    const float xi_16 = xi_27;
    const float xi_17 = xi_43;
    const float xi_18 = xi_28;
    const float xi_19 = xi_45;
    const float xi_20 = xi_39;
    const float xi_21 = xi_26;
    const float xi_22 = xi_35;
    const float xi_23 = xi_42;
    const float xi_24 = xi_38;
    ...
    const float rho = vel0Term + vel1Term + vel2Term + xi_11 + xi_13 + xi_15 +
                      xi_16 + xi_17 + xi_18 + xi_5;
    const float xi_1 = ((1.0f) / (rho));
    const float u_0 = xi_1 * xi_23 * 0.5f +
                      xi_1 * (vel0Term - xi_11 - xi_15 - xi_19 - xi_21 - xi_5);
    const float u_1 = xi_1 * xi_7 * 0.5f + xi_1 * (vel1Term - xi_10 - xi_11 -
                                                   xi_17 - xi_18 + xi_4 - xi_6);
    const float u_2 =
        xi_1 * xi_20 * 0.5f +
        xi_1 * (vel2Term + xi_12 - xi_14 - xi_15 - xi_16 - xi_17 - xi_8 + xi_9);
    const float forceTerm_0 = omega_shear * u_0 * xi_23 * 0.5f +
                              omega_shear * u_1 * xi_7 * 0.5f +
                              omega_shear * u_2 * xi_20 * 0.5f - u_0 * xi_23 -
                              u_1 * xi_7 - u_2 * xi_20;
    ...
    const float forceTerm_3 =
        ...
        u_2 * xi_20 * -0.16666666666666666f + xi_23 * -0.16666666666666666f;
    ...
    const float forceTerm_7 =
        omega_shear * u_0 * xi_23 * -0.083333333333333329f +
        omega_shear * u_0 * xi_7 * 0.125f + omega_shear * u_1 * xi_23 * 0.125f +
        omega_shear * u_1 * xi_7 * -0.083333333333333329f +
        ...
        u_2 * xi_20 * -0.083333333333333329f + xi_23 * -0.083333333333333329f +
        xi_7 * 0.083333333333333329f;
    ...
    const float forceTerm_11 =
        ...
        u_1 * xi_7 * 0.16666666666666666f + u_2 * xi_20 * 0.16666666666666666f +
        u_2 * xi_7 * 0.25f + xi_20 * 0.083333333333333329f +
        xi_7 * 0.083333333333333329f;
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2] =
        forceTerm_0 +
        omega_shear * (f_eq_common * 0.33333333333333331f - xi_13) + xi_13;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + _stride_pdfs_3] =
        forceTerm_1 +
        omega_shear *
        ...
        rr_0 *
            (rho * u_1 * 0.16666666666666666f + xi_18 * 0.5f + xi_3 * -0.5f) +
        xi_3 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        rr_0 *
            (rho * u_0 * -0.16666666666666666f + xi_24 * 0.5f + xi_5 * -0.5f) +
        xi_5;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 4 * _stride_pdfs_3] =
        forceTerm_4 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        rr_0 *
            (rho * u_2 * 0.16666666666666666f + xi_16 * 0.5f + xi_22 * -0.5f) +
        xi_22;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 6 * _stride_pdfs_3] =
        forceTerm_6 +
