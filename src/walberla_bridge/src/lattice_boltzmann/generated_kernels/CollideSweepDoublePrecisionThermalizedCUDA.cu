...
__launch_bounds__(256) void collidesweepdoubleprecisionthermalizedcuda_collidesweepdoubleprecisionthermalizedcuda(
  ...
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 &&
    ...
    const double xi_2 = xi_257 + xi_262;
    const double xi_3 = xi_2 + xi_254;
    const double xi_4 = xi_247 + xi_258 + xi_265;
    const double xi_5 = xi_246 + xi_252;
    const double xi_6 = xi_255 + xi_260;
    const double xi_8 = -xi_253;
    const double xi_9 = -xi_249;
    ...
    const double xi_29 = xi_248 * 0.16666666666666666;
    const double xi_30 = xi_248 * 0.083333333333333329;
    const double xi_42 = xi_263 * 0.16666666666666666;
    const double xi_43 = xi_263 * 0.083333333333333329;
    ...
    const double xi_125 =
        xi_246 * 2.0 + xi_247 * 2.0 + xi_250 * 2.0 + xi_258 * 2.0;
    const double xi_126 = xi_125 + xi_254 * 5.0 + xi_256 * 5.0;
    const double xi_128 = xi_245 * 2.0;
    const double xi_129 = xi_262 * 2.0;
    const double xi_130 = xi_255 * 2.0 + xi_257 * 2.0;
    const double xi_132 = xi_118 + xi_246;
    const double xi_133 = xi_132 + xi_14 + xi_22 + xi_250 + xi_265;
    const double xi_134 = omega_odd * 0.25;
    const double xi_135 = xi_133 * xi_134;
    const double xi_136 = random_5_1 - 0.5;
    const double xi_141 = xi_249 * 2.0;
    const double xi_142 = xi_261 * 2.0;
    const double xi_143 = xi_251 * -2.0 + xi_253 * 2.0;
    ...
    const double xi_167 = xi_12 + xi_166 + xi_20 + xi_254 + xi_255;
    ...
    const double xi_178 = xi_119 + xi_23 + xi_250 + xi_252 + xi_258;
    ...
    const double xi_54 = xi_263 * xi_53;
    const double xi_59 = xi_248 * xi_53;
    const double xi_81 = xi_244 * xi_53;
    const double vel0Term = xi_251 + xi_261 + xi_3;
    const double vel1Term = xi_249 + xi_4;
    const double vel2Term = xi_245 + xi_5;
    const double rho = vel0Term + vel1Term + vel2Term + xi_250 + xi_253 +
                       xi_256 + xi_259 + xi_264 + xi_6;
    const double xi_105 = kT * rho;
    const double xi_106 =
        pow(xi_105 * (1.0 - (-omega_even + 1.0) * (-omega_even + 1.0)), 0.5);
    ...
    const double xi_110 =
        ...
        pow(xi_105 * (1.0 - (-omega_bulk + 1.0) * (-omega_bulk + 1.0)), 0.5);
    ...
    const double xi_153 =
        pow(xi_105 * (1.0 - (-omega_shear + 1.0) * (-omega_shear + 1.0)), 0.5);
    ...
    const double u_0 = xi_0 * (vel0Term + xi_13 + xi_8 + xi_9) + xi_263 * xi_7;
    const double xi_25 = u_0 * xi_263;
    ...
    const double u_1 =
        xi_0 * (vel1Term + xi_16 + xi_19 + xi_251 + xi_8) + xi_248 * xi_7;
    const double xi_26 = u_1 * xi_248;
    ...
    const double xi_70 = xi_263 * xi_69;
    const double xi_74 = u_1 * xi_71;
    const double xi_75 = xi_263 * xi_74;
    ...
    const double xi_199 = xi_198 * (u_0 * xi_197 + xi_120 + xi_249 + xi_261);
    const double xi_200 = -xi_196 - xi_199;
    const double xi_201 = xi_196 + xi_199;
    const double u_2 =
        xi_0 * (vel2Term + xi_21 + xi_24 + xi_262) + xi_244 * xi_7;
    ...
    const double xi_116 =
        xi_114 + xi_115 * 0.66666666666666663 + xi_252 * 3.0 + xi_260 * 3.0;
    const double xi_117 =
        omega_even *
        (xi_112 * 0.66666666666666663 + xi_113 * 1.6666666666666667 + xi_116 +
         xi_246 * -3.0 + xi_247 * -3.0 + xi_250 * -3.0 + xi_258 * -3.0 +
         xi_259 * 3.0 + xi_265 * 3.0);
    const double xi_124 = omega_bulk * (xi_113 + xi_115 + xi_119 + xi_121 +
                                        xi_123 + xi_17 + xi_22 + xi_264);
    const double xi_127 =
        omega_even * (xi_112 * 2.3333333333333335 + xi_116 + xi_126 +
                      xi_245 * -5.0 + xi_255 * -5.0 + xi_257 * -5.0 +
                      xi_259 * -2.0 + xi_262 * -5.0 + xi_265 * -2.0);
    const double xi_131 =
        omega_even *
        (xi_114 + xi_115 * 3.0 + xi_126 + xi_128 + xi_129 + xi_130 +
         xi_249 * -7.0 + xi_251 * -7.0 + xi_252 * -4.0 + xi_253 * -7.0 +
         xi_259 * 5.0 + xi_260 * -4.0 + xi_261 * -7.0 + xi_265 * 5.0);
    const double xi_156 = -xi_115 + xi_252;
    const double xi_157 =
        omega_shear * (xi_121 + xi_156 + xi_16 + xi_2 + xi_245 - xi_265 + xi_6);
    ...
    const double xi_160 =
        ...
        (-xi_112 + xi_113 * 2.0 + xi_120 + xi_123 + xi_125 + xi_156 +
         xi_254 * -2.0 + xi_256 * -2.0 + xi_259 + xi_260 + xi_265 + xi_9);
    const double xi_162 =
    ...
    const double xi_226 = xi_162 + xi_193 - xi_203 + xi_204 - xi_205 + xi_206 +
                          xi_207 + xi_208 + xi_209;
    ...
    const double xi_233 = xi_198 * (rho * u_0 * u_2 + xi_10 + xi_166 + xi_257);
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        xi_108 * 0.20000000000000001 - xi_110 + xi_111 * 0.085714285714285715 +
        xi_117 * 0.10000000000000001 + xi_124 * -0.5 +
        xi_127 * 0.042857142857142858 + xi_131 * 0.023809523809523808 + xi_264;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + _stride_pdfs_3] =
        forceTerm_1 - xi_135 - xi_140 + xi_151 + xi_164 + xi_265;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 2 * _stride_pdfs_3] =
        forceTerm_2 + xi_135 + xi_140 + xi_164 + xi_165 + xi_259;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 3 * _stride_pdfs_3] =
        forceTerm_3 + xi_168 + xi_170 + xi_175 + xi_176 + xi_256;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 4 * _stride_pdfs_3] =
        forceTerm_4 - xi_168 - xi_170 + xi_176 + xi_177 + xi_254;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 5 * _stride_pdfs_3] =
        forceTerm_5 - xi_179 - xi_181 + xi_186 + xi_187 + xi_252;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 6 * _stride_pdfs_3] =
        forceTerm_6 + xi_179 + xi_181 + xi_187 + xi_188 + xi_260;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 7 * _stride_pdfs_3] =
        forceTerm_7 + xi_177 + xi_195 + xi_200 + xi_249;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 8 * _stride_pdfs_3] =
        forceTerm_8 + xi_175 + xi_195 + xi_201 + xi_251;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 9 * _stride_pdfs_3] =
        forceTerm_9 + xi_177 + xi_201 + xi_202 + xi_253;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 10 * _stride_pdfs_3] =
        forceTerm_10 + xi_175 + xi_200 + xi_202 + xi_261;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 11 * _stride_pdfs_3] =
        forceTerm_11 + xi_210 + xi_219 + xi_224 + xi_247;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 12 * _stride_pdfs_3] =
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 14 * _stride_pdfs_3] =
        forceTerm_14 + xi_231 + xi_240 + xi_241 + xi_262;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 15 * _stride_pdfs_3] =
        forceTerm_15 + xi_224 + xi_226 + xi_242 + xi_258;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 16 * _stride_pdfs_3] =
        forceTerm_16 + xi_210 + xi_225 + xi_242 + xi_250;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 17 * _stride_pdfs_3] =
        forceTerm_17 + xi_239 + xi_240 + xi_243 + xi_255;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 18 * _stride_pdfs_3] =
        forceTerm_18 + xi_234 + xi_241 + xi_243 + xi_257;
  }
}
} // namespace
