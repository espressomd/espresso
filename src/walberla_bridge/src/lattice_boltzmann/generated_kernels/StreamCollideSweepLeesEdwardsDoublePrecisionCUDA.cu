...
//
//! \\file StreamCollideSweepLeesEdwardsDoublePrecisionCUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
namespace internal_streamcollidesweepleesedwardsdoubleprecisioncuda_streamcollidesweepleesedwardsdoubleprecisioncuda {
static FUNC_PREFIX __launch_bounds__(256) void streamcollidesweepleesedwardsdoubleprecisioncuda_streamcollidesweepleesedwardsdoubleprecisioncuda(double * RESTRICT const _data_force, double * RESTRICT const _data_pdfs, double * RESTRICT  _data_pdfs_tmp, int64_t const _size_force_0, int64_t const _size_force_1, int64_t const _size_force_2, int64_t const _stride_force_0, int64_t const _stride_force_1, int64_t const _stride_force_2, int64_t const _stride_force_3, int64_t const _stride_pdfs_0, int64_t const _stride_pdfs_1, int64_t const _stride_pdfs_2, int64_t const _stride_pdfs_3, int64_t const _stride_pdfs_tmp_0, int64_t const _stride_pdfs_tmp_1, int64_t const _stride_pdfs_tmp_2, int64_t const _stride_pdfs_tmp_3, uint32_t block_offset_0, uint32_t block_offset_1, uint32_t block_offset_2, double grid_size, double kT, double omega_bulk, double omega_even, double omega_odd, double omega_shear, uint32_t seed, uint32_t time_step, double v_s)
{
   if (blockDim.x*blockIdx.x + threadIdx.x + 1 < _size_force_0 - 1 && blockDim.y*blockIdx.y + threadIdx.y + 1 < _size_force_1 - 1 && blockDim.z*blockIdx.z + threadIdx.z + 1 < _size_force_2 - 1)
   {
      ...
      _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + _stride_pdfs_tmp_3] = forceTerm_1 + omega_even*xi_122*0.014285714285714285 + xi_107*xi_108*xi_96*0.028571428571428571 - xi_129 - xi_132 - xi_144 - xi_167 - xi_178 + ((grid_size <= ((double)(ctr_1))) ? (rho*v_s*(u_0*2.0 + v_s)*0.16666666666666666): (0.0));
      ...
      _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + 7*_stride_pdfs_tmp_3] = forceTerm_7 + xi_213 + xi_214 + xi_219 + ((grid_size <= ((double)(ctr_1))) ? (rho*v_s*(u_0*-2.0 + u_1*3.0 - v_s + 1.0)*0.083333333333333329): (0.0)) + _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_0 + _stride_pdfs_1*ctr_1 - _stride_pdfs_1 + _stride_pdfs_2*ctr_2 + 7*_stride_pdfs_3];
      _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + 8*_stride_pdfs_tmp_3] = forceTerm_8 + xi_194 + xi_213 + xi_220 + ((grid_size <= ((double)(ctr_1))) ? (rho*v_s*(u_0*-2.0 + u_1*-3.0 - v_s - 1.0)*0.083333333333333329): (0.0)) + _data_pdfs[_stride_pdfs_0*ctr_0 - _stride_pdfs_0 + _stride_pdfs_1*ctr_1 - _stride_pdfs_1 + _stride_pdfs_2*ctr_2 + 8*_stride_pdfs_3];
      _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + 9*_stride_pdfs_tmp_3] = forceTerm_9 + xi_214 + xi_220 + xi_221 + ((1.0 >= ((double)(ctr_1))) ? (rho*v_s*(u_0*2.0 + u_1*3.0 - v_s - 1.0)*0.083333333333333329): (0.0)) + _data_pdfs[_stride_pdfs_0*ctr_0 + _stride_pdfs_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_1 + _stride_pdfs_2*ctr_2 + 9*_stride_pdfs_3];
      _data_pdfs_tmp[_stride_pdfs_tmp_0*ctr_0 + _stride_pdfs_tmp_1*ctr_1 + _stride_pdfs_tmp_2*ctr_2 + 10*_stride_pdfs_tmp_3] = forceTerm_10 + xi_194 + xi_219 + xi_221 + ((1.0 >= ((double)(ctr_1))) ? (rho*v_s*(u_0*2.0 + u_1*-3.0 - v_s + 1.0)*0.083333333333333329): (0.0)) + _data_pdfs[_stride_pdfs_0*ctr_0 - _stride_pdfs_0 + _stride_pdfs_1*ctr_1 + _stride_pdfs_1 + _stride_pdfs_2*ctr_2 + 10*_stride_pdfs_3];
...
void StreamCollideSweepLeesEdwardsDoublePrecisionCUDA::run(IBlock * block, gpuStream_t stream)
{
   if (!this->configured_)
