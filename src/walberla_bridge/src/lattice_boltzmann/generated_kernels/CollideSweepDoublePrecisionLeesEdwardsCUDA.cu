...
__launch_bounds__(256) void collidesweepdoubleprecisionleesedwardscuda_collidesweepdoubleprecisionleesedwardscuda(
  ...
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 &&
    ...
    const double xi_7 = xi_36;
    const double xi_8 = xi_45;
    const double xi_9 = xi_29;
    const double xi_10 = xi_31;
    const double xi_11 = xi_26;
    const double xi_12 = xi_44;
    const double xi_13 = xi_37;
    const double xi_14 = xi_38;
    const double xi_15 = xi_28;
    const double xi_16 = xi_32;
    const double xi_17 = xi_42;
    const double xi_18 = xi_46;
    const double xi_19 = xi_25;
    const double xi_20 = xi_39;
    const double xi_21 = xi_27;
    const double xi_22 = xi_34;
    const double xi_23 = xi_33;
    const double xi_24 = xi_41;
    ...
    const double rho = vel0Term + vel1Term + vel2Term + xi_10 + xi_13 + xi_22 +
                       xi_24 + xi_4 + xi_7 + xi_8;
    const double xi_1 = ((1.0) / (rho));
    const double u_0 = xi_1 * xi_12 * 0.5 +
    ...
    const double u_2 =
        xi_1 * xi_19 * 0.5 +
        xi_1 * (vel2Term - xi_10 - xi_14 + xi_15 - xi_20 - xi_24 + xi_5 - xi_7);
    const double forceTerm_0 = omega_shear * u_0 * xi_12 * 0.5 +
                               omega_shear * u_1 * xi_16 * 0.5 +
                               omega_shear * u_2 * xi_19 * 0.5 - u_0 * xi_12 -
                               u_1 * xi_16 - u_2 * xi_19;
    const double forceTerm_1 =
        ...
        u_0 * xi_12 * -0.16666666666666666 + u_1 * xi_16 * 0.33333333333333331 +
    ...
    const double forceTerm_3 =
        ...
        u_0 * xi_12 * 0.33333333333333331 + u_1 * xi_16 * -0.16666666666666666 +
    ...
    const double forceTerm_5 =
        ...
        u_1 * xi_16 * -0.16666666666666666 + u_2 * xi_19 * 0.33333333333333331 +
    ...
    const double forceTerm_7 =
        omega_shear * u_0 * xi_12 * -0.083333333333333329 +
        omega_shear * u_0 * xi_16 * 0.125 + omega_shear * u_1 * xi_12 * 0.125 +
        omega_shear * u_1 * xi_16 * -0.083333333333333329 +
        ...
        u_2 * xi_19 * -0.083333333333333329 + xi_12 * -0.083333333333333329 +
        xi_16 * 0.083333333333333329;
    ...
    const double forceTerm_12 =
        omega_shear * u_0 * xi_12 * 0.041666666666666664 +
        omega_shear * u_1 * xi_16 * -0.083333333333333329 +
        omega_shear * u_1 * xi_19 * 0.125 + omega_shear * u_2 * xi_16 * 0.125 +
        omega_shear * u_2 * xi_19 * -0.083333333333333329 +
        rr_0 * xi_16 * 0.041666666666666664 +
        rr_0 * xi_19 * -0.041666666666666664 +
        u_0 * xi_12 * -0.083333333333333329 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2] =
        forceTerm_0 + omega_shear * (f_eq_common * 0.33333333333333331 - xi_8) +
        xi_8;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + _stride_pdfs_3] =
        forceTerm_1 +
        omega_shear *
            (f_eq_common * 0.16666666666666666 +
             ...
             xi_18 * -0.5 + xi_4 * -0.5) +
        rr_0 * (rho * u_1 * 0.16666666666666666 + xi_18 * -0.5 + xi_4 * 0.5) +
        xi_18 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        omega_shear *
            (f_eq_common * 0.16666666666666666 +
             ...
             xi_13 * -0.5 + xi_6 * -0.5) +
        rr_0 * (rho * u_0 * -0.16666666666666666 + xi_13 * -0.5 + xi_6 * 0.5) +
        xi_13;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 4 * _stride_pdfs_3] =
        forceTerm_4 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        omega_shear *
            (f_eq_common * 0.16666666666666666 +
             ...
             xi_23 * -0.5 + xi_24 * -0.5) +
        rr_0 * (rho * u_2 * 0.16666666666666666 + xi_23 * -0.5 + xi_24 * 0.5) +
        xi_23;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 6 * _stride_pdfs_3] =
        forceTerm_6 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        omega_shear *
            (f_eq_common * 0.041666666666666664 +
             ...
             xi_17 * -0.5 + xi_3 * -0.5) +
        rr_0 *
            (rho * u0Mu1 * -0.083333333333333329 + xi_17 * 0.5 + xi_3 * -0.5) +
        xi_3 +
        ((-1.0 <= -grid_size + ((double)(ctr_1)))
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        omega_shear *
            (f_eq_common * 0.041666666666666664 +
             ...
             xi_22 * -0.5 + xi_9 * -0.5) +
        rr_0 *
            (rho * u0Pu1 * 0.083333333333333329 + xi_22 * 0.5 + xi_9 * -0.5) +
        xi_9 +
        ((-1.0 <= -grid_size + ((double)(ctr_1)))
             ? (rho * v_s * (u_0 * 2.0 + u_1 * 3.0 + v_s + 1.0) *
                -0.083333333333333329)
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        omega_shear *
            (f_eq_common * 0.041666666666666664 +
             ...
             xi_10 * -0.5 + xi_15 * -0.5) +
        rr_0 *
            (rho * u1Pu2 * 0.083333333333333329 + xi_10 * 0.5 + xi_15 * -0.5) +
        xi_15;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 12 * _stride_pdfs_3] =
        forceTerm_12 +
        omega_shear *
            (f_eq_common * 0.041666666666666664 +
             ...
             xi_20 * -0.5 + xi_21 * -0.5) +
        rr_0 *
            (rho * u1Mu2 * -0.083333333333333329 + xi_20 * 0.5 + xi_21 * -0.5) +
        xi_21;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 13 * _stride_pdfs_3] =
        forceTerm_13 +
        omega_shear *
            (f_eq_common * 0.041666666666666664 +
             ...
             xi_11 * -0.5 + xi_14 * -0.5) +
        rr_0 *
            (rho * u0Mu2 * -0.083333333333333329 + xi_11 * -0.5 + xi_14 * 0.5) +
        xi_11;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 14 * _stride_pdfs_3] =
        forceTerm_14 +
        omega_shear *
            (f_eq_common * 0.041666666666666664 +
             rho * (-0.013888888888888888 + 0.041666666666666664 * (u_1 * u_1) +
                    0.125 * (u0Pu2 * u0Pu2)) +
             xi_5 * -0.5 + xi_7 * -0.5) +
        rr_0 * (rho * u0Pu2 * 0.083333333333333329 + xi_5 * -0.5 + xi_7 * 0.5) +
        xi_5;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 15 * _stride_pdfs_3] =
        forceTerm_15 +
    ...
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
        ...
        omega_shear *
            (f_eq_common * 0.041666666666666664 +
             ...
             xi_5 * -0.5 + xi_7 * -0.5) +
        rr_0 *
            (rho * u0Pu2 * -0.083333333333333329 + xi_5 * 0.5 + xi_7 * -0.5) +
        xi_7;
    _data_pdfs[_stride_pdfs_0 * ctr_0 + _stride_pdfs_1 * ctr_1 +
               _stride_pdfs_2 * ctr_2 + 18 * _stride_pdfs_3] =
        forceTerm_18 +
