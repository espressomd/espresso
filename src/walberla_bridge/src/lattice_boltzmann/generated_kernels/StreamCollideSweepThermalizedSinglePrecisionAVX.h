...
//
//! \\file StreamCollideSweepThermalizedSinglePrecisionAVX.h
//! \\author pystencils
//======================================================================================================================
...
class StreamCollideSweepThermalizedSinglePrecisionAVX {
public:
  ...
  getSweep(const shared_ptr<StreamCollideSweepThermalizedSinglePrecisionAVX>
               &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)> getSweepOnCellInterval(
      const shared_ptr<StreamCollideSweepThermalizedSinglePrecisionAVX> &kernel,
