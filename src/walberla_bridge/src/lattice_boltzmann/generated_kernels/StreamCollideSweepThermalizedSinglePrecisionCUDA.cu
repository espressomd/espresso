...
//
//! \\file StreamCollideSweepThermalizedSinglePrecisionCUDA.cpp
//! \\author pystencils
//======================================================================================================================
...
namespace internal_streamcollidesweepthermalizedsingleprecisioncuda_streamcollidesweepthermalizedsingleprecisioncuda {
...
void StreamCollideSweepThermalizedSinglePrecisionCUDA::run(IBlock * block, gpuStream_t stream)
{
   if (!this->configured_)
