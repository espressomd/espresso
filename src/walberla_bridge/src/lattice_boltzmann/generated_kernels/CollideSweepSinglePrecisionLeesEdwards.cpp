  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        const float xi_25 = _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0];
        const float xi_26 = _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0];
        const float xi_27 = _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0];
        const float xi_28 = _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0];
        const float xi_29 = _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0];
        const float xi_30 = _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0];
        const float xi_31 = _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0];
        const float xi_32 = _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0];
        const float xi_33 = _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0];
        const float xi_34 = _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float xi_35 = _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0];
        const float xi_36 = _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0];
        const float xi_37 = _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0];
        const float xi_38 = _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0];
        const float xi_39 = _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0];
        const float xi_40 = _data_force_20_31_10[_stride_force_0 * ctr_0];
        const float xi_41 = _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0];
        const float xi_42 = _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0];
        const float xi_43 = _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0];
        const float xi_44 = _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0];
        const float xi_45 = _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_46 = _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0];
        ...
        _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0] = forceTerm_0 + omega_shear * (f_eq_common * 0.33333333333333331f + xi_9 * -1.0f) + xi_9;
        _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0] = forceTerm_1 + omega_shear * (delta_rho * -0.1111111111111111f + f_eq_common * 0.16666666666666666f + rho * 0.33333333333333331f * (u_1 * u_1) + xi_18 * -0.5f + xi_20 * -0.5f) + rr_0 * (rho * u_1 * 0.16666666666666666f + xi_18 * 0.5f + xi_20 * -0.5f) + xi_20 + ((-1.0f <= grid_size * -1.0f + ((float)(ctr_1))) ? (rho * v_s * (u_0 * 2.0f + v_s) * 0.16666666666666666f) : (0.0f));
        _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0] = forceTerm_2 + omega_shear * (delta_rho * -0.1111111111111111f + f_eq_common * 0.16666666666666666f + rho * 0.33333333333333331f * (u_1 * u_1) + xi_18 * -0.5f + xi_20 * -0.5f) + rr_0 * (rho * u_1 * -0.16666666666666666f + xi_18 * -0.5f + xi_20 * 0.5f) + xi_18 + ((0.0f >= ((float)(ctr_1))) ? (rho * v_s * (u_0 * -2.0f + v_s) * 0.16666666666666666f) : (0.0f));
        _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0] = forceTerm_3 + omega_shear * (delta_rho * -0.1111111111111111f + f_eq_common * 0.16666666666666666f + rho * 0.33333333333333331f * (u_0 * u_0) + xi_15 * -0.5f + xi_5 * -0.5f) + rr_0 * (rho * u_0 * -0.16666666666666666f + xi_15 * 0.5f + xi_5 * -0.5f) + xi_5;
        _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0] = forceTerm_4 + omega_shear * (delta_rho * -0.1111111111111111f + f_eq_common * 0.16666666666666666f + rho * 0.33333333333333331f * (u_0 * u_0) + xi_15 * -0.5f + xi_5 * -0.5f) + rr_0 * (rho * u_0 * 0.16666666666666666f + xi_15 * -0.5f + xi_5 * 0.5f) + xi_15;
        _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0] = forceTerm_5 + omega_shear * (delta_rho * -0.1111111111111111f + f_eq_common * 0.16666666666666666f + rho * 0.33333333333333331f * (u_2 * u_2) + xi_17 * -0.5f + xi_8 * -0.5f) + rr_0 * (rho * u_2 * 0.16666666666666666f + xi_17 * 0.5f + xi_8 * -0.5f) + xi_8;
        _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0] = forceTerm_6 + omega_shear * (delta_rho * -0.1111111111111111f + f_eq_common * 0.16666666666666666f + rho * 0.33333333333333331f * (u_2 * u_2) + xi_17 * -0.5f + xi_8 * -0.5f) + rr_0 * (rho * u_2 * -0.16666666666666666f + xi_17 * -0.5f + xi_8 * 0.5f) + xi_17;
        _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0] = forceTerm_7 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_2 * u_2) + 0.125f * (u0Mu1 * u0Mu1)) + xi_10 * -0.5f + xi_7 * -0.5f) + rr_0 * (rho * u0Mu1 * -0.083333333333333329f + xi_10 * 0.5f + xi_7 * -0.5f) + xi_7 + ((-1.0f <= grid_size * -1.0f + ((float)(ctr_1))) ? (rho * v_s * (u_0 * -2.0f + u_1 * 3.0f + v_s * -1.0f + 1.0f) * 0.083333333333333329f) : (0.0f));
        _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0] = forceTerm_8 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_2 * u_2) + 0.125f * (u0Pu1 * u0Pu1)) + xi_14 * -0.5f + xi_24 * -0.5f) + rr_0 * (rho * u0Pu1 * 0.083333333333333329f + xi_14 * -0.5f + xi_24 * 0.5f) + xi_14 + ((-1.0f <= grid_size * -1.0f + ((float)(ctr_1))) ? (rho * v_s * (u_0 * -2.0f + u_1 * -3.0f + v_s * -1.0f - 1.0f) * 0.083333333333333329f) : (0.0f));
        _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0] = forceTerm_9 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_2 * u_2) + 0.125f * (u0Pu1 * u0Pu1)) + xi_14 * -0.5f + xi_24 * -0.5f) + rr_0 * (rho * u0Pu1 * -0.083333333333333329f + xi_14 * 0.5f + xi_24 * -0.5f) + xi_24 + ((0.0f >= ((float)(ctr_1))) ? (rho * v_s * (u_0 * 2.0f + u_1 * 3.0f + v_s * -1.0f - 1.0f) * 0.083333333333333329f) : (0.0f));
        _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0] = forceTerm_10 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_2 * u_2) + 0.125f * (u0Mu1 * u0Mu1)) + xi_10 * -0.5f + xi_7 * -0.5f) + rr_0 * (rho * u0Mu1 * 0.083333333333333329f + xi_10 * -0.5f + xi_7 * 0.5f) + xi_10 + ((0.0f >= ((float)(ctr_1))) ? (rho * v_s * (u_0 * 2.0f + u_1 * -3.0f + v_s * -1.0f + 1.0f) * 0.083333333333333329f) : (0.0f));
        _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0] = forceTerm_11 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_0 * u_0) + 0.125f * (u1Pu2 * u1Pu2)) + xi_12 * -0.5f + xi_23 * -0.5f) + rr_0 * (rho * u1Pu2 * 0.083333333333333329f + xi_12 * 0.5f + xi_23 * -0.5f) + xi_23;
        _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0] = forceTerm_12 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_0 * u_0) + 0.125f * (u1Mu2 * u1Mu2)) + xi_16 * -0.5f + xi_19 * -0.5f) + rr_0 * (rho * u1Mu2 * -0.083333333333333329f + xi_16 * -0.5f + xi_19 * 0.5f) + xi_16;
        _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0] = forceTerm_13 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_1 * u_1) + 0.125f * (u0Mu2 * u0Mu2)) + xi_21 * -0.5f + xi_6 * -0.5f) + rr_0 * (rho * u0Mu2 * -0.083333333333333329f + xi_21 * -0.5f + xi_6 * 0.5f) + xi_21;
        _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0] = forceTerm_14 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_1 * u_1) + 0.125f * (u0Pu2 * u0Pu2)) + xi_22 * -0.5f + xi_4 * -0.5f) + rr_0 * (rho * u0Pu2 * 0.083333333333333329f + xi_22 * 0.5f + xi_4 * -0.5f) + xi_4;
        _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0] = forceTerm_15 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_0 * u_0) + 0.125f * (u1Mu2 * u1Mu2)) + xi_16 * -0.5f + xi_19 * -0.5f) + rr_0 * (rho * u1Mu2 * 0.083333333333333329f + xi_16 * 0.5f + xi_19 * -0.5f) + xi_19;
        _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0] = forceTerm_16 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_0 * u_0) + 0.125f * (u1Pu2 * u1Pu2)) + xi_12 * -0.5f + xi_23 * -0.5f) + rr_0 * (rho * u1Pu2 * -0.083333333333333329f + xi_12 * -0.5f + xi_23 * 0.5f) + xi_12;
        _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0] = forceTerm_17 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_1 * u_1) + 0.125f * (u0Pu2 * u0Pu2)) + xi_22 * -0.5f + xi_4 * -0.5f) + rr_0 * (rho * u0Pu2 * -0.083333333333333329f + xi_22 * -0.5f + xi_4 * 0.5f) + xi_22;
        _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0] = forceTerm_18 + omega_shear * (delta_rho * -0.013888888888888888f + f_eq_common * 0.041666666666666664f + rho * (0.041666666666666664f * (u_1 * u_1) + 0.125f * (u0Mu2 * u0Mu2)) + xi_21 * -0.5f + xi_6 * -0.5f) + rr_0 * (rho * u0Mu2 * 0.083333333333333329f + xi_21 * 0.5f + xi_6 * -0.5f) + xi_6;
      }
    }
  }
}
