...
//
//! \\file StreamCollideSweepThermalizedSinglePrecision.cpp
//! \\author pystencils
//======================================================================================================================
...
#include "StreamCollideSweepThermalizedSinglePrecision.h"
...
void StreamCollideSweepThermalizedSinglePrecision::run(IBlock * block)
{
   if (!this->configured_)
