...
/**
MRTLatticeModelAvx was generated with lbmpy. Do not edit this file directly. Instead modify MRTLatticeModelAvx.py.
...
Usage:
    ...
    - The internal class MRTLatticeModelAvx::Sweep is a functor to execute one LB time step.
...
public:
    ...
    MRTLatticeModelAvx( BlockDataID forceID_, double omega_bulk, double omega_even, double omega_odd, double omega_shear )
...
private:
    ...
    friend mpi::SendBuffer & ::walberla::mpi::operator<< (mpi::SendBuffer & , const MRTLatticeModelAvx & );
    friend mpi::RecvBuffer & ::walberla::mpi::operator>> (mpi::RecvBuffer & ,       MRTLatticeModelAvx & );
...
template<>
class EquilibriumDistribution< MRTLatticeModelAvx, void>
{
public:
...
template<>
struct AdaptVelocityToForce<MRTLatticeModelAvx, void>
{
   template< typename FieldPtrOrIterator >
   static Vector3<real_t> get( FieldPtrOrIterator & it, const MRTLatticeModelAvx & lm,
   ...
   static Vector3<real_t> get( const cell_idx_t x, const cell_idx_t y, const cell_idx_t z, const MRTLatticeModelAvx & lm,
                               const Vector3< real_t > & velocity, const real_t rho )
   {
...
template<>
struct Equilibrium< MRTLatticeModelAvx, void >
{
...
template<>
struct Density<MRTLatticeModelAvx, void>
{
   template< typename FieldPtrOrIterator >
   static inline real_t get( const MRTLatticeModelAvx & , const FieldPtrOrIterator & it )
   {
...
template<>
struct DensityAndVelocity<MRTLatticeModelAvx>
{
    template< typename FieldPtrOrIterator >
                     ...
                     const Vector3< real_t > & u = Vector3< real_t >( real_t(0.0) ), const real_t rho_in = real_t(1.0) )
    {
        ...
        Equilibrium<MRTLatticeModelAvx>::set(it, Vector3<real_t>(u_0, u_1, u_2), rho);
    }

    template< typename PdfField_T >
    static void set( PdfField_T & pdf, const cell_idx_t x, const cell_idx_t y, const cell_idx_t z, const MRTLatticeModelAvx & lm,
                     const Vector3< real_t > & u = Vector3< real_t >( real_t(0.0) ), const real_t rho_in = real_t(1.0) )
    {
        const double rho = rho_in;
        const double u_0 = -0.5*lm.force_->get(x,y,z,0)/rho_in + u[0];
        ...
        Equilibrium<MRTLatticeModelAvx>::set(pdf, x, y, z, Vector3<real_t>(u_0, u_1, u_2), rho );
    }
};
...
struct DensityAndVelocityRange<MRTLatticeModelAvx, FieldIteratorXYZ>
{
   ...
   static void set( FieldIteratorXYZ & begin, const FieldIteratorXYZ & end, const MRTLatticeModelAvx & lm,
                    const Vector3< real_t > & u = Vector3< real_t >( real_t(0.0) ), const real_t rho_in = real_t(1.0) )
   {
        for( auto cellIt = begin; cellIt != end; ++cellIt )
        {
            ...
            Equilibrium<MRTLatticeModelAvx>::set(cellIt, Vector3<real_t>(u_0, u_1, u_2), rho);
        }
   }
};
...
template<>
struct DensityAndMomentumDensity<MRTLatticeModelAvx>
{
   template< typename FieldPtrOrIterator >
   static real_t get( Vector3< real_t > & momentumDensity, const MRTLatticeModelAvx & lm,
   ...
   template< typename PdfField_T >
   static real_t get( Vector3< real_t > & momentumDensity, const MRTLatticeModelAvx & lm, const PdfField_T & pdf,
...
template<>
struct MomentumDensity< MRTLatticeModelAvx>
{
   template< typename FieldPtrOrIterator >
   static void get( Vector3< real_t > & momentumDensity, const MRTLatticeModelAvx & lm, const FieldPtrOrIterator & it )
   {
        const auto x = it.x();
        const auto y = it.y();
        const auto z = it.z();
   ...
   template< typename PdfField_T >
   static void get( Vector3< real_t > & momentumDensity, const MRTLatticeModelAvx & lm, const PdfField_T & pdf,
                    const cell_idx_t x, const cell_idx_t y, const cell_idx_t z )
   {
        const real_t & xyz0 = pdf(x,y,z,0);
        const real_t f_0 = pdf.getF( &xyz0, 0);
...
template<>
struct PressureTensor<MRTLatticeModelAvx>
{
   template< typename FieldPtrOrIterator >
   static void get( Matrix3< real_t > & /* pressureTensor */, const MRTLatticeModelAvx & /* latticeModel */, const FieldPtrOrIterator & /* it */ )
   {
       WALBERLA_ABORT("Not implemented");
   }

   template< typename PdfField_T >
   static void get( Matrix3< real_t > & /* pressureTensor */, const MRTLatticeModelAvx & /* latticeModel */, const PdfField_T & /* pdf */,
                    const cell_idx_t /* x */, const cell_idx_t /* y */, const cell_idx_t /* z */ )
   {
       WALBERLA_ABORT("Not implemented");
   }
...
template<>
struct ShearRate<MRTLatticeModelAvx>
{
   template< typename FieldPtrOrIterator >
   static inline real_t get( const MRTLatticeModelAvx & /* latticeModel */, const FieldPtrOrIterator & /* it */,
                             const Vector3< real_t > & /* velocity */, const real_t /* rho */)
   {
       WALBERLA_ABORT("Not implemented");
       return real_t(0.0);
