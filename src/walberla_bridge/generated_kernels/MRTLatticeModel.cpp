  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0;
        ...
        const __m256d xi_197 = _mm256_load_pd(&_data_pdfs_20_33_10[ctr_0]);
        const __m256d xi_198 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
        ...
        const __m256d xi_202 = _mm256_load_pd(&_data_pdfs_20_38_10[ctr_0]);
        const __m256d xi_203 = _mm256_load_pd(&_data_pdfs_20_32_10[ctr_0]);
        const __m256d xi_204 = _mm256_load_pd(&_data_pdfs_20_39_10[ctr_0]);
        const __m256d xi_205 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
        const __m256d xi_206 = _mm256_load_pd(&_data_pdfs_20_318_10[ctr_0]);
        const __m256d xi_207 = _mm256_load_pd(&_data_pdfs_20_312_10[ctr_0]);
        const __m256d xi_208 = _mm256_load_pd(&_data_force_20_31_10[ctr_0]);
        const __m256d xi_209 = _mm256_load_pd(&_data_force_20_30_10[ctr_0]);
        ...
        const __m256d xi_212 = _mm256_load_pd(&_data_force_20_32_10[ctr_0]);
        const __m256d xi_213 = _mm256_load_pd(&_data_pdfs_20_315_10[ctr_0]);
        const __m256d xi_214 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
        const __m256d xi_215 = _mm256_load_pd(&_data_pdfs_20_30_10[ctr_0]);
        const __m256d xi_216 = _mm256_load_pd(&_data_pdfs_20_311_10[ctr_0]);
        const __m256d xi_217 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
        const __m256d xi_0 = _mm256_add_pd(xi_201, xi_206);
        const __m256d xi_1 = _mm256_add_pd(xi_0, xi_205);
        const __m256d xi_2 =
            _mm256_add_pd(_mm256_add_pd(xi_213, xi_214), xi_216);
        const __m256d xi_3 = _mm256_add_pd(xi_196, xi_207);
        const __m256d xi_4 = _mm256_add_pd(xi_197, xi_204);
        const __m256d xi_5 = _mm256_add_pd(xi_203, xi_217);
        const __m256d xi_6 = _mm256_add_pd(xi_199, xi_210);
        const __m256d xi_8 =
        ...
        const __m256d xi_24 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(xi_17, xi_216), xi_22), xi_23);
        ...
        const __m256d xi_48 = _mm256_mul_pd(
            xi_209, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                  0.166666666666667, 0.166666666666667));
        ...
        const __m256d xi_59 = _mm256_mul_pd(
            xi_209, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                  0.0833333333333333, 0.0833333333333333));
        ...
        const __m256d xi_88 = _mm256_add_pd(
            _mm256_add_pd(
                ...
                _mm256_mul_pd(xi_205, _mm256_set_pd(5.0, 5.0, 5.0, 5.0))),
            xi_87);
        const __m256d xi_89 = _mm256_mul_pd(
            _mm256_add_pd(
                _mm256_add_pd(
        ...
        const __m256d xi_103 = _mm256_mul_pd(
            _mm256_add_pd(
                ...
                xi_88),
            _mm256_set_pd(omega_even, omega_even, omega_even, omega_even));
        const __m256d xi_104 = _mm256_add_pd(xi_207, xi_92);
        const __m256d xi_105 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(xi_104, xi_14), xi_214),
                          xi_217),
            xi_22);
        const __m256d xi_107 = _mm256_mul_pd(
            xi_105, _mm256_set_pd(xi_106, xi_106, xi_106, xi_106));
        ...
        const __m256d xi_114 =
            _mm256_mul_pd(xi_113, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
        const __m256d xi_116 = _mm256_add_pd(xi_198, xi_94);
        const __m256d xi_120 = _mm256_mul_pd(
            xi_103, _mm256_set_pd(-0.0198412698412698, -0.0198412698412698,
                                  -0.0198412698412698, -0.0198412698412698));
        const __m256d xi_121 = _mm256_add_pd(xi_200, xi_210);
        ...
        const __m256d xi_138 =
            _mm256_mul_pd(xi_136, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
        const __m256d xi_139 = _mm256_add_pd(xi_213, xi_217);
        ...
        const __m256d vel0Term =
            _mm256_add_pd(_mm256_add_pd(xi_1, xi_198), xi_202);
        ...
        const __m256d u_0 = _mm256_mul_pd(
            xi_7, _mm256_add_pd(_mm256_add_pd(vel0Term, xi_13), xi_9));
        const __m256d xi_25 = _mm256_mul_pd(u_0, xi_209);
        const __m256d xi_26 = _mm256_mul_pd(
            xi_25, _mm256_set_pd(0.333333333333333, 0.333333333333333,
                                 0.333333333333333, 0.333333333333333));
        const __m256d xi_32 =
        ...
        const __m256d u_2 = _mm256_mul_pd(
            xi_7,
            _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(vel2Term, xi_201), xi_21),
                          xi_24));
        const __m256d xi_29 = _mm256_mul_pd(u_2, xi_212);
        const __m256d xi_30 = _mm256_mul_pd(
            xi_29, _mm256_set_pd(0.333333333333333, 0.333333333333333,
                                 0.333333333333333, 0.333333333333333));
        const __m256d xi_31 =
        ...
        const __m256d xi_76 =
            _mm256_mul_pd(xi_71, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
        const __m256d xi_77 = _mm256_mul_pd(
            _mm256_add_pd(_mm256_mul_pd(_mm256_mul_pd(u_0, xi_212),
                                        _mm256_set_pd(0.5, 0.5, 0.5, 0.5)),
                          _mm256_mul_pd(_mm256_mul_pd(u_2, xi_209),
                                        _mm256_set_pd(0.5, 0.5, 0.5, 0.5))),
            _mm256_set_pd(xi_56, xi_56, xi_56, xi_56));
        const __m256d xi_78 =
            _mm256_mul_pd(xi_77, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(
                        _mm256_add_pd(
                            _mm256_add_pd(
                                _mm256_add_pd(_mm256_add_pd(xi_17, xi_215),
                                              xi_22),
                                xi_90),
                            xi_91),
                        xi_93),
