...
namespace internal_collidesweepsingleprecision_collidesweepsingleprecision {
  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        const float xi_220 = _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0];
        const float xi_221 = _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float xi_222 = _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0];
        const float xi_223 = _data_force_20_31_10[_stride_force_0 * ctr_0];
        const float xi_224 = _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0];
        const float xi_225 = _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0];
        const float xi_226 = _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0];
        const float xi_227 = _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0];
        const float xi_228 = _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_229 = _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0];
        const float xi_230 = _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0];
        const float xi_231 = _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0];
        const float xi_232 = _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0];
        const float xi_233 = _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0];
        const float xi_234 = _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0];
        const float xi_235 = _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0];
        const float xi_236 = _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0];
        const float xi_237 = _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0];
        const float xi_238 = _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0];
        const float xi_239 = _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0];
        const float xi_240 = _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0];
        const float xi_241 = _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0];
        const float xi_0 = xi_233 + xi_235;
        const float xi_1 = xi_0 + xi_234;
        const float xi_2 = xi_220 + xi_232 + xi_240;
        const float xi_3 = xi_224 + xi_236;
        const float xi_4 = xi_225 + xi_231;
        const float xi_5 = xi_229 + xi_238;
        const float xi_6 = xi_222 + xi_239;
        const float xi_9 = -xi_231;
        const float xi_10 = -xi_230 + xi_9;
        const float xi_11 = -xi_239;
        const float xi_12 = -xi_241;
        const float xi_13 = -xi_225;
        const float xi_14 = xi_11 + xi_12 + xi_13;
        const float xi_15 = -xi_229;
        ...
        const float xi_23 = -xi_220;
        const float xi_24 = -xi_222;
        const float xi_25 = xi_18 + xi_23 + xi_232 + xi_24;
        const float xi_30 = xi_223 * 0.166666666666667f;
        const float xi_31 = xi_223 * 0.0833333333333333f;
        const float xi_43 = xi_228 * 0.166666666666667f;
        const float xi_44 = xi_228 * 0.0833333333333333f;
        const float xi_50 = xi_221 * 0.166666666666667f;
        const float xi_51 = xi_221 * 0.0833333333333333f;
        const float xi_68 = xi_223 * 0.25f;
        const float xi_73 = xi_223 * xi_72;
        const float xi_106 = -xi_226;
        const float xi_107 = xi_106 + xi_222 * 3.0f + xi_224 * 3.0f;
        const float xi_108 =
            omega_even *
            (xi_107 + xi_220 * -3.0f + xi_229 * 3.0f + xi_232 * -3.0f +
             xi_236 * -3.0f + xi_238 * -3.0f + xi_240 * 3.0f);
        const float xi_109 =
            xi_220 * 2.0f + xi_232 * 2.0f + xi_236 * 2.0f + xi_238 * 2.0f;
        const float xi_110 = xi_109 + xi_225 * 5.0f + xi_234 * 5.0f;
        const float xi_111 =
            omega_even *
            (xi_107 + xi_110 + xi_229 * -2.0f + xi_233 * -5.0f +
             xi_235 * -5.0f + xi_239 * -5.0f + xi_240 * -2.0f + xi_241 * -5.0f);
        const float xi_114 = -xi_232;
        const float xi_115 = xi_114 + xi_19;
        const float xi_116 = -xi_227;
        const float xi_119 = -xi_235;
        const float xi_120 = xi_119 + xi_12 + xi_16 + xi_22;
        const float xi_122 = xi_241 * 2.0f;
        const float xi_123 = xi_235 * 2.0f;
        const float xi_124 = xi_233 * 2.0f + xi_239 * 2.0f;
        const float xi_125 =
            omega_even *
            (xi_106 + xi_110 + xi_122 + xi_123 + xi_124 + xi_222 * -4.0f +
             xi_224 * -4.0f + xi_227 * -7.0f + xi_229 * 5.0f + xi_230 * -7.0f +
             xi_231 * -7.0f + xi_237 * -7.0f + xi_240 * 5.0f);
        const float xi_126 = xi_114 + xi_236;
        const float xi_127 = xi_126 + xi_15 + xi_23 + xi_238 + xi_240;
        const float xi_129 = xi_127 * xi_128;
        const float xi_130 = xi_230 * 2.0f;
        const float xi_131 = xi_237 * 2.0f;
        const float xi_132 = xi_227 * -2.0f + xi_231 * 2.0f;
        ...
        const float xi_142 = xi_239 + xi_241;
        const float xi_146 = xi_125 * -0.0198412698412698f;
        const float xi_154 = xi_119 + xi_241;
        const float xi_155 = xi_13 + xi_154 + xi_21 + xi_234 + xi_239;
        ...
        const float xi_161 = xi_220 + xi_238;
        const float xi_162 = xi_115 + xi_161 + xi_224 + xi_24;
        ...
        const float xi_82 = xi_221 * xi_54;
        const float vel0Term = xi_1 + xi_227 + xi_237;
        const float vel1Term = xi_2 + xi_230;
        const float vel2Term = xi_241 + xi_3;
        const float rho =
        ...
        const float u_1 =
            xi_223 * xi_8 + xi_7 * (vel1Term + xi_17 + xi_20 + xi_227 + xi_9);
        ...
        const float u_2 =
            xi_221 * xi_8 + xi_7 * (vel2Term + xi_22 + xi_235 + xi_25);
        const float xi_28 = u_2 * xi_221;
        ...
        const float xi_143 = -xi_113 + xi_222 + xi_224;
        const float xi_144 =
            omega_shear * (xi_0 + xi_118 + xi_142 + xi_143 + xi_17 - xi_240);
        const float xi_145 = xi_144 * 0.125f;
        const float xi_147 =
            omega_shear *
            (xi_10 + xi_109 + xi_112 * 2.0f + xi_116 - xi_117 + xi_120 +
             xi_143 + xi_225 * -2.0f + xi_229 + xi_234 * -2.0f + xi_240);
        ...
        const float xi_191 = xi_171 * (u_2 * xi_137 + xi_126 + xi_18 + xi_220);
        ...
        _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0] =
            ...
            xi_121 * -0.5f + xi_125 * 0.0238095238095238f + xi_226;
        _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_1 - xi_129 + xi_136 + xi_141 + xi_150 + xi_240;
        _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_2 + xi_129 + xi_135 - xi_141 + xi_150 + xi_229;
        ...
        _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_6 + xi_163 - xi_165 + xi_169 + xi_170 + xi_222;
        ...
        _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_9 + xi_184 + xi_185 + xi_189 + xi_231;
        ...
        _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_13 + xi_210 + xi_211 + xi_214 + xi_241;
        ...
        _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_15 + xi_204 + xi_206 + xi_218 + xi_220;
...
void CollideSweepSinglePrecision::run(IBlock *block) {
  ...
  internal_collidesweepsingleprecision_collidesweepsingleprecision::
