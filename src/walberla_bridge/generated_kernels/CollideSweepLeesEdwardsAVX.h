...
{
public:
    CollideSweepLeesEdwardsAVX( BlockDataID forceID_, BlockDataID pdfsID_, BlockDataID velocityID_, double omega_bulk, double omega_even, double omega_odd, double omega_shear, bool points_down, bool points_up )
    ...
    static std::function<void (IBlock*)> getSweep(const shared_ptr<CollideSweepLeesEdwardsAVX> & kernel) {
