...
/**
FluctuatingMRTLatticeModelAvx was generated with lbmpy. Do not edit this file
directly. Instead modify FluctuatingMRTLatticeModelAvx.py. For details see
...
values.
    - The internal class FluctuatingMRTLatticeModelAvx::Sweep is a functor to
...
public:
  ...
  FluctuatingMRTLatticeModelAvx(BlockDataID forceID_, double kT,
...
private:
  ...
  friend mpi::SendBuffer & ::walberla::mpi::operator<<(
      mpi::SendBuffer &, const FluctuatingMRTLatticeModelAvx &);
  friend mpi::RecvBuffer & ::walberla::mpi::operator>>(
      mpi::RecvBuffer &, FluctuatingMRTLatticeModelAvx &);
};
...
template <> class EquilibriumDistribution<FluctuatingMRTLatticeModelAvx, void> {
public:
...
template <> struct AdaptVelocityToForce<FluctuatingMRTLatticeModelAvx, void> {
  template <typename FieldPtrOrIterator>
  static Vector3<real_t>
  get(FieldPtrOrIterator &it, const FluctuatingMRTLatticeModelAvx &lm,
  ...
  static Vector3<real_t> get(const cell_idx_t x, const cell_idx_t y,
                             const cell_idx_t z,
                             const FluctuatingMRTLatticeModelAvx &lm,
...
template <> struct Equilibrium<FluctuatingMRTLatticeModelAvx, void> {
...
template <> struct Density<FluctuatingMRTLatticeModelAvx, void> {
  template <typename FieldPtrOrIterator>
...
template <> struct DensityAndVelocity<FluctuatingMRTLatticeModelAvx> {
  template <typename FieldPtrOrIterator>
  static void set(FieldPtrOrIterator &it,
                  const FluctuatingMRTLatticeModelAvx &lm,
                  const Vector3<real_t> &u = Vector3<real_t>(real_t(0.0)),
    ...
    Equilibrium<FluctuatingMRTLatticeModelAvx>::set(
        it, Vector3<real_t>(u_0, u_1, u_2), rho);
  }

  template <typename PdfField_T>
  static void set(PdfField_T &pdf, const cell_idx_t x, const cell_idx_t y,
                  const cell_idx_t z, const FluctuatingMRTLatticeModelAvx &lm,
                  const Vector3<real_t> &u = Vector3<real_t>(real_t(0.0)),
                  const real_t rho_in = real_t(1.0)) {
    const double rho = rho_in;
    const double u_0 = -0.5 * lm.force_->get(x, y, z, 0) / rho_in + u[0];
...
struct DensityAndVelocityRange<FluctuatingMRTLatticeModelAvx,
                               FieldIteratorXYZ> {
...
template <> struct DensityAndMomentumDensity<FluctuatingMRTLatticeModelAvx> {
  template <typename FieldPtrOrIterator>
...
template <> struct MomentumDensity<FluctuatingMRTLatticeModelAvx> {
  template <typename FieldPtrOrIterator>
...
template <> struct PressureTensor<FluctuatingMRTLatticeModelAvx> {
  template <typename FieldPtrOrIterator>
  static void get(Matrix3<real_t> & /* pressureTensor */,
                  const FluctuatingMRTLatticeModelAvx & /* latticeModel */,
                  const FieldPtrOrIterator & /* it */) {
...
template <> struct ShearRate<FluctuatingMRTLatticeModelAvx> {
  template <typename FieldPtrOrIterator>
  static inline real_t
  get(const FluctuatingMRTLatticeModelAvx & /* latticeModel */,
      const FieldPtrOrIterator & /* it */,
      const Vector3<real_t> & /* velocity */, const real_t /* rho */) {
    WALBERLA_ABORT("Not implemented");
    return real_t(0.0);
