...
namespace walberla{
namespace lbm {
   class FluctuatingMRTLatticeModelAvx;
}}
namespace walberla {
namespace mpi {
...
/**
FluctuatingMRTLatticeModelAvx was generated with lbmpy. Do not edit this file directly. Instead modify FluctuatingMRTLatticeModelAvx.py.
...
Usage:
    ...
    - The internal class FluctuatingMRTLatticeModelAvx::Sweep is a functor to execute one LB time step.
...
public:
    ...
    FluctuatingMRTLatticeModelAvx( BlockDataID forceID_, double kT, double omega_bulk, double omega_even, double omega_odd, double omega_shear, uint32_t seed, uint32_t time_step )
        : forceID(forceID_), kT_(kT), omega_bulk_(omega_bulk), omega_even_(omega_even), omega_odd_(omega_odd), omega_shear_(omega_shear), seed_(seed), time_step_(time_step), currentLevel(0)
    {};
...
private:
    ...
    friend class FluctuatingMRTLatticeModelAvx::Sweep;
    ...
    friend mpi::SendBuffer & ::walberla::mpi::operator<< (mpi::SendBuffer & , const FluctuatingMRTLatticeModelAvx & );
    friend mpi::RecvBuffer & ::walberla::mpi::operator>> (mpi::RecvBuffer & ,       FluctuatingMRTLatticeModelAvx & );
...
template<>
class EquilibriumDistribution< FluctuatingMRTLatticeModelAvx, void>
{
public:
   typedef typename FluctuatingMRTLatticeModelAvx::Stencil Stencil;
...
template<>
struct AdaptVelocityToForce<FluctuatingMRTLatticeModelAvx, void>
{
   template< typename FieldPtrOrIterator >
   static Vector3<real_t> get( FieldPtrOrIterator & it, const FluctuatingMRTLatticeModelAvx & lm,
   ...
   static Vector3<real_t> get( const cell_idx_t x, const cell_idx_t y, const cell_idx_t z, const FluctuatingMRTLatticeModelAvx & lm,
                               const Vector3< real_t > & velocity, const real_t rho )
   {
...
template<>
struct Equilibrium< FluctuatingMRTLatticeModelAvx, void >
{
...
template<>
struct Density<FluctuatingMRTLatticeModelAvx, void>
{
   template< typename FieldPtrOrIterator >
   static inline real_t get( const FluctuatingMRTLatticeModelAvx & , const FieldPtrOrIterator & it )
   {
   ...
   template< typename PdfField_T >
   static inline real_t get( const FluctuatingMRTLatticeModelAvx & ,
...
template<>
struct DensityAndVelocity<FluctuatingMRTLatticeModelAvx>
{
    template< typename FieldPtrOrIterator >
    static void set( FieldPtrOrIterator & it, const FluctuatingMRTLatticeModelAvx & lm,
                     const Vector3< real_t > & u = Vector3< real_t >( real_t(0.0) ), const real_t rho_in = real_t(1.0) )
    {
        ...
        Equilibrium<FluctuatingMRTLatticeModelAvx>::set(it, Vector3<real_t>(u_0, u_1, u_2), rho);
    }

    template< typename PdfField_T >
    static void set( PdfField_T & pdf, const cell_idx_t x, const cell_idx_t y, const cell_idx_t z, const FluctuatingMRTLatticeModelAvx & lm,
                     const Vector3< real_t > & u = Vector3< real_t >( real_t(0.0) ), const real_t rho_in = real_t(1.0) )
    {
        const double rho = rho_in;
        const double u_0 = -0.5*lm.force_->get(x,y,z,0)/rho_in + u[0];
        ...
        Equilibrium<FluctuatingMRTLatticeModelAvx>::set(pdf, x, y, z, Vector3<real_t>(u_0, u_1, u_2), rho );
    }
};


template<typename FieldIteratorXYZ >
struct DensityAndVelocityRange<FluctuatingMRTLatticeModelAvx, FieldIteratorXYZ>
{

   static void set( FieldIteratorXYZ & begin, const FieldIteratorXYZ & end, const FluctuatingMRTLatticeModelAvx & lm,
                    const Vector3< real_t > & u = Vector3< real_t >( real_t(0.0) ), const real_t rho_in = real_t(1.0) )
   {
        for( auto cellIt = begin; cellIt != end; ++cellIt )
        {
            ...
            Equilibrium<FluctuatingMRTLatticeModelAvx>::set(cellIt, Vector3<real_t>(u_0, u_1, u_2), rho);
        }
   }
};
...
template<>
struct DensityAndMomentumDensity<FluctuatingMRTLatticeModelAvx>
{
   template< typename FieldPtrOrIterator >
   static real_t get( Vector3< real_t > & momentumDensity, const FluctuatingMRTLatticeModelAvx & lm,
   ...
   template< typename PdfField_T >
   static real_t get( Vector3< real_t > & momentumDensity, const FluctuatingMRTLatticeModelAvx & lm, const PdfField_T & pdf,
...
template<>
struct MomentumDensity< FluctuatingMRTLatticeModelAvx>
{
   template< typename FieldPtrOrIterator >
   static void get( Vector3< real_t > & momentumDensity, const FluctuatingMRTLatticeModelAvx & lm, const FieldPtrOrIterator & it )
   {
        const auto x = it.x();
        const auto y = it.y();
        const auto z = it.z();
   ...
   template< typename PdfField_T >
   static void get( Vector3< real_t > & momentumDensity, const FluctuatingMRTLatticeModelAvx & lm, const PdfField_T & pdf,
                    const cell_idx_t x, const cell_idx_t y, const cell_idx_t z )
   {
        const real_t & xyz0 = pdf(x,y,z,0);
        const real_t f_0 = pdf.getF( &xyz0, 0);
...
template<>
struct PressureTensor<FluctuatingMRTLatticeModelAvx>
{
   template< typename FieldPtrOrIterator >
   static void get( Matrix3< real_t > & /* pressureTensor */, const FluctuatingMRTLatticeModelAvx & /* latticeModel */, const FieldPtrOrIterator & /* it */ )
   {
       WALBERLA_ABORT("Not implemented");
   }

   template< typename PdfField_T >
   static void get( Matrix3< real_t > & /* pressureTensor */, const FluctuatingMRTLatticeModelAvx & /* latticeModel */, const PdfField_T & /* pdf */,
                    const cell_idx_t /* x */, const cell_idx_t /* y */, const cell_idx_t /* z */ )
   {
       WALBERLA_ABORT("Not implemented");
   }
...
template<>
struct ShearRate<FluctuatingMRTLatticeModelAvx>
{
   template< typename FieldPtrOrIterator >
   static inline real_t get( const FluctuatingMRTLatticeModelAvx & /* latticeModel */, const FieldPtrOrIterator & /* it */,
                             const Vector3< real_t > & /* velocity */, const real_t /* rho */)
   {
       WALBERLA_ABORT("Not implemented");
       return real_t(0.0);
   ...
   template< typename PdfField_T >
   static inline real_t get( const FluctuatingMRTLatticeModelAvx & latticeModel,
                             const PdfField_T & /* pdf */, const cell_idx_t /* x */, const cell_idx_t /* y */, const cell_idx_t /* z */,
                             const Vector3< real_t > & /* velocity */, const real_t /* rho */ )
   {
       WALBERLA_ABORT("Not implemented");
