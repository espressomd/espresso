  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0;
           ...
           ctr_0 += 4) {
        const __m256d xi_198 = _mm256_load_pd(&_data_pdfs_20_314_10[ctr_0]);
        const __m256d xi_199 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
        ...
        const __m256d xi_206 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
        const __m256d xi_207 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
        const __m256d xi_208 = _mm256_load_pd(&_data_pdfs_20_37_10[ctr_0]);
        const __m256d xi_209 = _mm256_load_pd(&_data_pdfs_20_312_10[ctr_0]);
        ...
        const __m256d xi_218 = _mm256_load_pd(&_data_pdfs_20_313_10[ctr_0]);
        const __m256d xi_219 = _mm256_load_pd(&_data_pdfs_20_318_10[ctr_0]);
        const __m256d xi_0 = _mm256_add_pd(xi_198, xi_219);
        const __m256d xi_1 = _mm256_add_pd(xi_0, xi_199);
        const __m256d xi_2 =
            _mm256_add_pd(_mm256_add_pd(xi_204, xi_212), xi_216);
        const __m256d xi_3 = _mm256_add_pd(xi_209, xi_211);
        const __m256d xi_4 = _mm256_add_pd(xi_203, xi_210);
        const __m256d xi_5 = _mm256_add_pd(xi_205, xi_206);
        const __m256d xi_6 = _mm256_add_pd(xi_200, xi_217);
        const __m256d xi_8 =
            _mm256_mul_pd(xi_210, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
        const __m256d xi_9 = _mm256_add_pd(
            _mm256_mul_pd(xi_208, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), xi_8);
        const __m256d xi_10 =
        ...
        const __m256d xi_24 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(xi_17, xi_212), xi_22), xi_23);
        ...
        const __m256d xi_103 = _mm256_mul_pd(
            _mm256_add_pd(
                ...
                xi_88),
            _mm256_set_pd(omega_even, omega_even, omega_even, omega_even));
        const __m256d xi_104 = _mm256_add_pd(xi_209, xi_92);
        const __m256d xi_105 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(xi_104, xi_14), xi_206),
                          xi_216),
            xi_22);
        const __m256d xi_107 = _mm256_mul_pd(
            xi_105, _mm256_set_pd(xi_106, xi_106, xi_106, xi_106));
        ...
        const __m256d xi_120 = _mm256_add_pd(xi_217, xi_218);
        const __m256d xi_124 = _mm256_mul_pd(
            xi_103, _mm256_set_pd(-0.0198412698412698, -0.0198412698412698,
                                  -0.0198412698412698, -0.0198412698412698));
        const __m256d xi_132 = _mm256_add_pd(xi_218, xi_97);
        const __m256d xi_133 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(xi_12, xi_132), xi_199),
                          xi_20),
            xi_217);
        const __m256d xi_134 = _mm256_mul_pd(
            xi_133, _mm256_set_pd(xi_106, xi_106, xi_106, xi_106));
        ...
        const __m256d xi_138 =
            _mm256_mul_pd(xi_136, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
        const __m256d xi_139 = _mm256_add_pd(xi_204, xi_206);
        ...
        const __m256d vel1Term = _mm256_add_pd(xi_2, xi_208);
        const __m256d vel2Term = _mm256_add_pd(xi_218, xi_3);
        const __m256d rho = _mm256_add_pd(
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(
        ...
        const __m256d u_2 = _mm256_mul_pd(
            xi_7,
            _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(vel2Term, xi_198), xi_21),
                          xi_24));
