  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        const float xi_25 = _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0];
        const float xi_26 = _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0];
        const float xi_27 = _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0];
        const float xi_28 = _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0];
        const float xi_29 = _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0];
        const float xi_30 = _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0];
        const float xi_31 = _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0];
        const float xi_32 = _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0];
        const float xi_33 = _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0];
        const float xi_34 = _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0];
        const float xi_35 = _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0];
        const float xi_36 = _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0];
        const float xi_37 = _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_38 = _data_force_20_31_10[_stride_force_0 * ctr_0];
        ...
        const float xi_42 = _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0];
        const float xi_43 = _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0];
        const float xi_44 = _data_force_20_32_10[_stride_force_0 * ctr_0];
        const float xi_45 = _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0];
        const float xi_46 = _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0];
        ...
        const float forceTerm_1 =
            ...
            u_2 * xi_22 * -0.16666666666666667f + xi_16 * 0.16666666666666667f;
        ...
        const float forceTerm_3 =
            ...
            u_2 * xi_22 * -0.16666666666666667f + xi_15 * -0.16666666666666667f;
        ...
        const float forceTerm_11 =
            ...
            u_2 * xi_22 * 0.16666666666666667f + xi_16 * 0.083333333333333333f +
            xi_22 * 0.083333333333333333f;
        ...
        const float forceTerm_14 =
            ...
            u_1 * xi_16 * -0.083333333333333333f +
            u_2 * xi_15 * 0.25000000000000000f +
            u_2 * xi_22 * 0.16666666666666667f + xi_15 * 0.083333333333333333f +
            xi_22 * 0.083333333333333333f;
        ...
        _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_0 +
            omega_shear * (f_eq_common * 0.33333333333333333f - xi_13) + xi_13;
            ...
            omega_shear *
                (f_eq_common * 0.16666666666666667f +
                 rho * ((u_0 * u_0) * 0.33333333333333333f -
                        0.11111111111111111f) +
                 xi_14 * -0.50000000000000000f + xi_5 * -0.50000000000000000f) +
            rr_0 *
        ...
        _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0] =
            ...
            omega_shear *
                (f_eq_common * 0.041666666666666667f +
                 ...
                 xi_24 * -0.50000000000000000f + xi_4 * -0.50000000000000000f) +
            rr_0 *
        ...
        _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0] =
            ...
            rr_0 *
                (rho * u0Pu1 * 0.083333333333333333f +
                 xi_10 * -0.50000000000000000f + xi_19 * 0.50000000000000000f) +
            xi_10 +
            ((-1 <= ctr_1 - grid_size)
                 ? (rho * v_s * (u_0 * 2.0f + u_1 * 3.0f + v_s + 1.0f) *
                    -0.083333333333333333f)
        ...
        _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0] =
            ...
            rr_0 *
                (rho * u1Pu2 * 0.083333333333333333f +
                 xi_11 * -0.50000000000000000f + xi_18 * 0.50000000000000000f) +
            xi_11;
        _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0] =
            ...
            rr_0 *
                (rho * u1Mu2 * -0.083333333333333333f +
                 xi_21 * -0.50000000000000000f + xi_23 * 0.50000000000000000f) +
            xi_21;
            ...
            omega_shear *
                (f_eq_common * 0.041666666666666667f +
                 rho * ((u0Mu2 * u0Mu2) * 0.12500000000000000f +
                        ...
                        0.013888888888888889f) +
                 xi_12 * -0.50000000000000000f + xi_3 * -0.50000000000000000f) +
            rr_0 *
        ...
        _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0] =
            ...
            rr_0 *
                (rho * u0Pu2 * 0.083333333333333333f +
                 xi_17 * -0.50000000000000000f + xi_20 * 0.50000000000000000f) +
            xi_17;
