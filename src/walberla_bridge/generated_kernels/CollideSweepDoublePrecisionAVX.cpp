    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_35;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const __m256d xi_221 = _mm256_load_pd(&_data_pdfs_20_39_10[ctr_0]);
          const __m256d xi_222 = _mm256_load_pd(&_data_pdfs_20_311_10[ctr_0]);
          const __m256d xi_223 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
          const __m256d xi_224 = _mm256_load_pd(&_data_pdfs_20_38_10[ctr_0]);
          const __m256d xi_225 = _mm256_load_pd(&_data_pdfs_20_33_10[ctr_0]);
          ...
          const __m256d xi_228 = _mm256_load_pd(&_data_pdfs_20_312_10[ctr_0]);
          const __m256d xi_229 = _mm256_load_pd(&_data_pdfs_20_317_10[ctr_0]);
          const __m256d xi_230 = _mm256_load_pd(&_data_force_20_31_10[ctr_0]);
          const __m256d xi_231 = _mm256_load_pd(&_data_pdfs_20_30_10[ctr_0]);
          const __m256d xi_232 = _mm256_load_pd(&_data_pdfs_20_313_10[ctr_0]);
          ...
          const __m256d xi_237 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
          const __m256d xi_238 = _mm256_load_pd(&_data_force_20_32_10[ctr_0]);
          const __m256d xi_239 = _mm256_load_pd(&_data_pdfs_20_32_10[ctr_0]);
          const __m256d xi_240 = _mm256_load_pd(&_data_pdfs_20_37_10[ctr_0]);
          const __m256d xi_241 = _mm256_load_pd(&_data_pdfs_20_35_10[ctr_0]);
          const __m256d xi_0 = _mm256_add_pd(xi_220, xi_236);
          const __m256d xi_1 = _mm256_add_pd(xi_0, xi_235);
          const __m256d xi_2 =
              _mm256_add_pd(_mm256_add_pd(xi_222, xi_223), xi_233);
          const __m256d xi_3 = _mm256_add_pd(xi_228, xi_241);
          const __m256d xi_4 = _mm256_add_pd(xi_221, xi_225);
          const __m256d xi_5 = _mm256_add_pd(xi_237, xi_239);
          ...
          const __m256d xi_25 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(xi_18, xi_222), xi_23), xi_24);
          const __m256d xi_30 = _mm256_mul_pd(
              xi_230, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                    0.166666666666667, 0.166666666666667));
          const __m256d xi_31 = _mm256_mul_pd(
              xi_230, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
          ...
          const __m256d xi_51 = _mm256_mul_pd(
              xi_238, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                    0.0833333333333333, 0.0833333333333333));
          const __m256d xi_68 =
              _mm256_mul_pd(xi_230, _mm256_set_pd(0.25, 0.25, 0.25, 0.25));
          const __m256d xi_73 =
              _mm256_mul_pd(xi_230, _mm256_set_pd(xi_72, xi_72, xi_72, xi_72));
          ...
          const __m256d xi_110 = _mm256_add_pd(
              _mm256_add_pd(
                  _mm256_mul_pd(xi_225, _mm256_set_pd(5.0, 5.0, 5.0, 5.0)),
          ...
          const __m256d xi_125 = _mm256_mul_pd(
              _mm256_add_pd(
                  ...
                  xi_124),
              _mm256_set_pd(omega_even, omega_even, omega_even, omega_even));
          const __m256d xi_126 = _mm256_add_pd(xi_114, xi_228);
          const __m256d xi_127 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(xi_126, xi_15), xi_223),
                            xi_23),
              xi_237);
          ...
          const __m256d xi_142 = _mm256_add_pd(xi_229, xi_232);
          ...
          const __m256d xi_154 = _mm256_add_pd(xi_119, xi_232);
          ...
          const __m256d xi_161 = _mm256_add_pd(xi_233, xi_237);
          const __m256d xi_162 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(xi_115, xi_161), xi_24), xi_241);
          ...
          const __m256d xi_60 =
              _mm256_mul_pd(xi_230, _mm256_set_pd(xi_54, xi_54, xi_54, xi_54));
          const __m256d xi_82 =
              _mm256_mul_pd(xi_238, _mm256_set_pd(xi_54, xi_54, xi_54, xi_54));
          const __m256d vel0Term =
              _mm256_add_pd(_mm256_add_pd(xi_1, xi_224), xi_226);
          const __m256d vel1Term = _mm256_add_pd(xi_2, xi_240);
          const __m256d vel2Term = _mm256_add_pd(xi_232, xi_3);
          ...
          const __m256d xi_96 = _mm256_mul_pd(u_0, xi_238);
          const __m256d xi_97 =
              ...
              _mm256_mul_pd(
                  ...
                  _mm256_add_pd(
                      _mm256_add_pd(
                          ...
                          xi_224),
                      xi_9)),
              _mm256_mul_pd(xi_230, xi_8));
          const __m256d xi_27 = _mm256_mul_pd(u_1, xi_230);
          ...
          const __m256d xi_79 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  xi_69),
              xi_71);
          const __m256d xi_87 = _mm256_mul_pd(xi_238, xi_70);
          const __m256d xi_89 = _mm256_mul_pd(xi_238, xi_75);
          const __m256d xi_94 =
          ...
          const __m256d xi_28 = _mm256_mul_pd(u_2, xi_238);
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const double xi_221 = _data_pdfs_20_39_10[ctr_0];
          const double xi_222 = _data_pdfs_20_311_10[ctr_0];
          const double xi_223 = _data_pdfs_20_31_10[ctr_0];
          const double xi_224 = _data_pdfs_20_38_10[ctr_0];
          const double xi_225 = _data_pdfs_20_33_10[ctr_0];
          const double xi_226 = _data_pdfs_20_310_10[ctr_0];
          const double xi_227 = _data_force_20_30_10[ctr_0];
          const double xi_228 = _data_pdfs_20_312_10[ctr_0];
          const double xi_229 = _data_pdfs_20_317_10[ctr_0];
          const double xi_230 = _data_force_20_31_10[ctr_0];
          const double xi_231 = _data_pdfs_20_30_10[ctr_0];
          const double xi_232 = _data_pdfs_20_313_10[ctr_0];
          ...
          const double xi_237 = _data_pdfs_20_316_10[ctr_0];
          const double xi_238 = _data_force_20_32_10[ctr_0];
          const double xi_239 = _data_pdfs_20_32_10[ctr_0];
          const double xi_240 = _data_pdfs_20_37_10[ctr_0];
          const double xi_241 = _data_pdfs_20_35_10[ctr_0];
          ...
          const double xi_152 = -vel0Term + xi_142 + xi_151 + xi_240 + xi_4;
          ...
          const double xi_172 =
              xi_171 * (u_0 * xi_137 + xi_138 + xi_240 + xi_9);
          ...
          const double xi_147 =
              ...
              (xi_10 + xi_109 + xi_112 * 2.0 + xi_116 - xi_117 + xi_120 +
               xi_143 + xi_223 + xi_225 * -2.0 + xi_235 * -2.0 + xi_239);
