    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_37;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const __m256d xi_221 = _mm256_load_pd(&_data_pdfs_20_33_10[ctr_0]);
          ...
          const __m256d xi_224 = _mm256_load_pd(&_data_pdfs_20_38_10[ctr_0]);
          const __m256d xi_225 = _mm256_load_pd(&_data_pdfs_20_32_10[ctr_0]);
          const __m256d xi_226 = _mm256_load_pd(&_data_pdfs_20_311_10[ctr_0]);
          const __m256d xi_227 = _mm256_load_pd(&_data_force_20_30_10[ctr_0]);
          const __m256d xi_228 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
          const __m256d xi_229 = _mm256_load_pd(&_data_pdfs_20_317_10[ctr_0]);
          const __m256d xi_230 = _mm256_load_pd(&_data_pdfs_20_315_10[ctr_0]);
          const __m256d xi_231 = _mm256_load_pd(&_data_pdfs_20_30_10[ctr_0]);
          const __m256d xi_232 = _mm256_load_pd(&_data_pdfs_20_318_10[ctr_0]);
          const __m256d xi_233 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
          const __m256d xi_234 = _mm256_load_pd(&_data_pdfs_20_36_10[ctr_0]);
          const __m256d xi_235 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
          const __m256d xi_236 = _mm256_load_pd(&_data_pdfs_20_313_10[ctr_0]);
          const __m256d xi_237 = _mm256_load_pd(&_data_force_20_32_10[ctr_0]);
          const __m256d xi_238 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
          ...
          const __m256d xi_0 = _mm256_add_pd(xi_232, xi_239);
          const __m256d xi_1 = _mm256_add_pd(xi_0, xi_233);
          const __m256d xi_2 =
              _mm256_add_pd(_mm256_add_pd(xi_226, xi_230), xi_238);
          const __m256d xi_3 = _mm256_add_pd(xi_220, xi_223);
          const __m256d xi_4 = _mm256_add_pd(xi_221, xi_222);
          const __m256d xi_5 = _mm256_add_pd(xi_225, xi_235);
          const __m256d xi_6 = _mm256_add_pd(xi_229, xi_234);
          const __m256d xi_9 =
          ...
          const __m256d xi_43 = _mm256_mul_pd(
              xi_227, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                    0.166666666666667, 0.166666666666667));
          const __m256d xi_44 = _mm256_mul_pd(
              xi_227, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                    0.0833333333333333, 0.0833333333333333));
          const __m256d xi_50 = _mm256_mul_pd(
              xi_237, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                    0.166666666666667, 0.166666666666667));
          const __m256d xi_51 = _mm256_mul_pd(
              xi_237, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                    0.0833333333333333, 0.0833333333333333));
          const __m256d xi_68 =
          ...
          const __m256d xi_107 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  _mm256_mul_pd(xi_234, _mm256_set_pd(3.0, 3.0, 3.0, 3.0))),
              xi_106);
          ...
          const __m256d xi_110 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  _mm256_mul_pd(xi_233, _mm256_set_pd(5.0, 5.0, 5.0, 5.0))),
              xi_109);
                  ...
                  _mm256_add_pd(
                      _mm256_add_pd(
                          _mm256_add_pd(
                              ...
                              _mm256_mul_pd(xi_238, _mm256_set_pd(-2.0, -2.0,
                                                                  -2.0, -2.0))),
          ...
          const __m256d xi_138 = _mm256_add_pd(xi_116, xi_228);
          const __m256d xi_142 = _mm256_add_pd(xi_229, xi_236);
          ...
          const __m256d xi_154 = _mm256_add_pd(xi_119, xi_236);
          ...
          const __m256d xi_55 =
              _mm256_mul_pd(xi_227, _mm256_set_pd(xi_54, xi_54, xi_54, xi_54));
          const __m256d xi_60 =
          ...
          const __m256d vel0Term =
              _mm256_add_pd(_mm256_add_pd(xi_1, xi_224), xi_228);
          const __m256d vel1Term = _mm256_add_pd(xi_2, xi_241);
          const __m256d vel2Term = _mm256_add_pd(xi_236, xi_3);
          ...
          const __m256d u_0 = _mm256_add_pd(
              ...
              _mm256_mul_pd(xi_227, xi_8));
          const __m256d xi_26 = _mm256_mul_pd(u_0, xi_227);
          ...
          const __m256d xi_96 = _mm256_mul_pd(u_0, xi_237);
          const __m256d xi_97 =
          ...
          const __m256d xi_71 = _mm256_mul_pd(xi_227, xi_70);
          const __m256d xi_75 =
              _mm256_mul_pd(u_1, _mm256_set_pd(xi_72, xi_72, xi_72, xi_72));
          const __m256d xi_76 = _mm256_mul_pd(xi_227, xi_75);
          ...
          const __m256d xi_79 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  xi_69),
              xi_71);
          const __m256d xi_87 = _mm256_mul_pd(xi_237, xi_70);
          const __m256d xi_89 = _mm256_mul_pd(xi_237, xi_75);
          const __m256d xi_94 =
          ...
          const __m256d xi_28 = _mm256_mul_pd(u_2, xi_237);
          ...
          const __m256d xi_95 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  xi_84),
              xi_94);
          const __m256d xi_98 = _mm256_mul_pd(u_2, xi_227);
          const __m256d xi_99 =
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const double xi_221 = _data_pdfs_20_33_10[ctr_0];
          const double xi_222 = _data_pdfs_20_39_10[ctr_0];
          const double xi_223 = _data_pdfs_20_35_10[ctr_0];
          const double xi_224 = _data_pdfs_20_38_10[ctr_0];
          const double xi_225 = _data_pdfs_20_32_10[ctr_0];
          const double xi_226 = _data_pdfs_20_311_10[ctr_0];
          const double xi_227 = _data_force_20_30_10[ctr_0];
          const double xi_228 = _data_pdfs_20_310_10[ctr_0];
          const double xi_229 = _data_pdfs_20_317_10[ctr_0];
          const double xi_230 = _data_pdfs_20_315_10[ctr_0];
          const double xi_231 = _data_pdfs_20_30_10[ctr_0];
          const double xi_232 = _data_pdfs_20_318_10[ctr_0];
          const double xi_233 = _data_pdfs_20_34_10[ctr_0];
          const double xi_234 = _data_pdfs_20_36_10[ctr_0];
          const double xi_235 = _data_pdfs_20_316_10[ctr_0];
          const double xi_236 = _data_pdfs_20_313_10[ctr_0];
          const double xi_237 = _data_force_20_32_10[ctr_0];
          const double xi_238 = _data_pdfs_20_31_10[ctr_0];
          ...
          const double xi_0 = xi_232 + xi_239;
          const double xi_1 = xi_0 + xi_233;
          const double xi_2 = xi_226 + xi_230 + xi_238;
          const double xi_3 = xi_220 + xi_223;
          const double xi_4 = xi_221 + xi_222;
          const double xi_5 = xi_225 + xi_235;
          const double xi_6 = xi_229 + xi_234;
          const double xi_9 = -xi_222;
          const double xi_10 = -xi_241 + xi_9;
          const double xi_11 = -xi_229;
          const double xi_12 = -xi_236;
          const double xi_13 = -xi_221;
          const double xi_14 = xi_11 + xi_12 + xi_13;
          const double xi_15 = -xi_225;
          ...
          const double xi_50 = xi_237 * 0.166666666666667;
          const double xi_51 = xi_237 * 0.0833333333333333;
          const double xi_68 = xi_240 * 0.25;
          const double xi_73 = xi_240 * xi_72;
          const double xi_106 = -xi_231;
          const double xi_107 = xi_106 + xi_223 * 3.0 + xi_234 * 3.0;
          const double xi_108 =
              omega_even *
              (xi_107 + xi_220 * -3.0 + xi_225 * 3.0 + xi_226 * -3.0 +
               xi_230 * -3.0 + xi_235 * -3.0 + xi_238 * 3.0);
          const double xi_109 =
              xi_220 * 2.0 + xi_226 * 2.0 + xi_230 * 2.0 + xi_235 * 2.0;
          const double xi_110 = xi_109 + xi_221 * 5.0 + xi_233 * 5.0;
          const double xi_111 =
              omega_even *
              (xi_107 + xi_110 + xi_225 * -2.0 + xi_229 * -5.0 + xi_232 * -5.0 +
               xi_236 * -5.0 + xi_238 * -2.0 + xi_239 * -5.0);
          ...
          const double xi_122 = xi_236 * 2.0;
          const double xi_123 = xi_239 * 2.0;
          const double xi_124 = xi_229 * 2.0 + xi_232 * 2.0;
          const double xi_125 =
              omega_even *
              (xi_106 + xi_110 + xi_122 + xi_123 + xi_124 + xi_222 * -7.0 +
               xi_223 * -4.0 + xi_224 * -7.0 + xi_225 * 5.0 + xi_228 * -7.0 +
               xi_234 * -4.0 + xi_238 * 5.0 + xi_241 * -7.0);
          const double xi_126 = xi_114 + xi_220;
          const double xi_127 = xi_126 + xi_15 + xi_23 + xi_235 + xi_238;
          const double xi_129 = xi_127 * xi_128;
          const double xi_130 = xi_241 * 2.0;
          const double xi_131 = xi_228 * 2.0;
          const double xi_132 = xi_222 * 2.0 + xi_224 * -2.0;
          const double xi_133 =
              -xi_130 + xi_131 + xi_132 + xi_15 + xi_2 + xi_20;
          const double xi_135 = xi_133 * xi_134;
          const double xi_136 = -xi_135;
          const double xi_138 = xi_116 + xi_228;
          const double xi_142 = xi_229 + xi_236;
          const double xi_146 = xi_125 * -0.0198412698412698;
          const double xi_154 = xi_119 + xi_236;
          const double xi_155 = xi_13 + xi_154 + xi_21 + xi_229 + xi_233;
          ...
          const double xi_82 = xi_237 * xi_54;
          const double vel0Term = xi_1 + xi_224 + xi_228;
          const double vel1Term = xi_2 + xi_241;
          const double vel2Term = xi_236 + xi_3;
          const double rho =
          ...
          const double u_1 =
              xi_240 * xi_8 + xi_7 * (vel1Term + xi_17 + xi_20 + xi_224 + xi_9);
          ...
          const double xi_87 = xi_237 * xi_70;
          const double xi_89 = xi_237 * xi_75;
          ...
          const double xi_139 =
              -vel1Term + xi_137 + xi_138 + xi_220 + xi_222 + xi_5;
          ...
          const double u_2 =
              xi_237 * xi_8 + xi_7 * (vel2Term + xi_22 + xi_239 + xi_25);
          const double xi_28 = u_2 * xi_237;
          ...
          const double xi_121 =
              omega_bulk * (xi_112 + xi_113 + xi_115 + xi_118 + xi_120 + xi_18 +
                            xi_23 + xi_231);
          const double xi_143 = -xi_113 + xi_223 + xi_234;
          const double xi_144 =
              omega_shear * (xi_0 + xi_118 + xi_142 + xi_143 + xi_17 - xi_238);
          const double xi_145 = xi_144 * 0.125;
          const double xi_147 =
              omega_shear *
              (xi_10 + xi_109 + xi_112 * 2.0 + xi_116 - xi_117 + xi_120 +
               xi_143 + xi_221 * -2.0 + xi_225 + xi_233 * -2.0 + xi_238);
          ...
          _data_pdfs_20_31_10[ctr_0] =
              forceTerm_1 - xi_129 + xi_136 + xi_141 + xi_150 + xi_238;
          _data_pdfs_20_32_10[ctr_0] =
              forceTerm_2 + xi_129 + xi_135 - xi_141 + xi_150 + xi_225;
          _data_pdfs_20_33_10[ctr_0] =
              forceTerm_3 - xi_153 + xi_156 + xi_158 + xi_159 + xi_221;
          _data_pdfs_20_34_10[ctr_0] =
          ...
          _data_pdfs_20_39_10[ctr_0] =
              forceTerm_9 + xi_184 + xi_185 + xi_189 + xi_222;
          _data_pdfs_20_310_10[ctr_0] =
              forceTerm_10 + xi_175 + xi_187 + xi_189 + xi_228;
          _data_pdfs_20_311_10[ctr_0] =
