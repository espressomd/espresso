  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0;
        ...
        const __m256d xi_227 = _mm256_load_pd(&_data_pdfs_20_35_10[ctr_0]);
        ...
        const __m256d xi_231 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
        const __m256d xi_232 = _mm256_load_pd(&_data_pdfs_20_317_10[ctr_0]);
        const __m256d xi_233 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
        const __m256d xi_234 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
        const __m256d xi_235 = _mm256_load_pd(&_data_pdfs_20_313_10[ctr_0]);
        const __m256d xi_236 = _mm256_load_pd(&_data_force_20_32_10[ctr_0]);
        const __m256d xi_237 = _mm256_load_pd(&_data_pdfs_20_39_10[ctr_0]);
        const __m256d xi_238 = _mm256_load_pd(&_data_force_20_31_10[ctr_0]);
        const __m256d xi_239 = _mm256_load_pd(&_data_pdfs_20_37_10[ctr_0]);
        const __m256d xi_240 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
        const __m256d xi_241 = _mm256_load_pd(&_data_pdfs_20_311_10[ctr_0]);
        const __m256d xi_0 = _mm256_add_pd(xi_223, xi_226);
        const __m256d xi_1 = _mm256_add_pd(xi_0, xi_240);
        const __m256d xi_2 =
            _mm256_add_pd(_mm256_add_pd(xi_229, xi_234), xi_241);
        const __m256d xi_3 = _mm256_add_pd(xi_220, xi_227);
        const __m256d xi_4 = _mm256_add_pd(xi_221, xi_237);
        const __m256d xi_5 = _mm256_add_pd(xi_225, xi_231);
        const __m256d xi_6 = _mm256_add_pd(xi_224, xi_232);
        const __m256d xi_9 =
            _mm256_mul_pd(xi_237, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
        const __m256d xi_10 = _mm256_add_pd(
            _mm256_mul_pd(xi_239, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), xi_9);
        const __m256d xi_11 =
        ...
        const __m256d xi_25 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(xi_18, xi_23), xi_24), xi_241);
        ...
        const __m256d xi_107 = _mm256_add_pd(
            _mm256_add_pd(
                ...
                _mm256_mul_pd(xi_227, _mm256_set_pd(3.0, 3.0, 3.0, 3.0))),
            xi_106);
                        ...
                        _mm256_add_pd(
                            _mm256_add_pd(
                                ...
                                _mm256_mul_pd(
                                    ...
                                    _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))),
                            _mm256_mul_pd(
                                xi_231, _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))),
        ...
        const __m256d xi_110 = _mm256_add_pd(
            _mm256_add_pd(
                ...
                _mm256_mul_pd(xi_240, _mm256_set_pd(5.0, 5.0, 5.0, 5.0))),
            xi_109);
                        ...
                        _mm256_add_pd(
                            _mm256_add_pd(
                                _mm256_add_pd(
                                    _mm256_add_pd(
                                        _mm256_mul_pd(
                                            xi_223, _mm256_set_pd(-5.0, -5.0,
                                                                  -5.0, -5.0)),
                                        _mm256_mul_pd(
                                            xi_225, _mm256_set_pd(-2.0, -2.0,
                                                                  -2.0, -2.0))),
                                    _mm256_mul_pd(
                                        xi_226,
                                ...
                                _mm256_mul_pd(
                                    ...
                                    _mm256_set_pd(-5.0, -5.0, -5.0, -5.0))),
                            _mm256_mul_pd(
                                xi_234, _mm256_set_pd(-2.0, -2.0, -2.0, -2.0))),
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(
                        _mm256_add_pd(
                            _mm256_mul_pd(
                                xi_130, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)),
                            xi_131),
                        xi_132),
                    xi_15),
                xi_2),
        ...
        const __m256d xi_138 = _mm256_add_pd(xi_116, xi_233);
        const __m256d xi_142 = _mm256_add_pd(xi_232, xi_235);
        ...
        const __m256d xi_154 = _mm256_add_pd(xi_119, xi_235);
        ...
        const __m256d xi_161 = _mm256_add_pd(xi_229, xi_231);
        const __m256d xi_162 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(xi_115, xi_161), xi_227), xi_24);
        ...
        const __m256d xi_190 = _mm256_mul_pd(
            xi_111, _mm256_set_pd(-0.00714285714285714, -0.00714285714285714,
        ...
        const __m256d xi_198 = _mm256_mul_pd(
            xi_125, _mm256_set_pd(-0.00396825396825397, -0.00396825396825397,
        ...
        const __m256d vel0Term =
            _mm256_add_pd(_mm256_add_pd(xi_1, xi_228), xi_233);
        const __m256d vel1Term = _mm256_add_pd(xi_2, xi_239);
        const __m256d vel2Term = _mm256_add_pd(xi_235, xi_3);
        ...
        const __m256d xi_191 = _mm256_mul_pd(
            _mm256_add_pd(
                _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(u_2, xi_137), xi_126),
                              xi_18),
                xi_229),
            _mm256_set_pd(xi_171, xi_171, xi_171, xi_171));
        const __m256d xi_193 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(xi_148, xi_181), xi_190),
                          xi_191),
            xi_192);
        ...
        const __m256d xi_207 = _mm256_mul_pd(
            _mm256_add_pd(
                _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(u_2, xi_151), xi_11),
                              xi_154),
                xi_226),
            _mm256_set_pd(xi_171, xi_171, xi_171, xi_171));
                ...
                _mm256_add_pd(
                    _mm256_add_pd(
                        _mm256_add_pd(
                            _mm256_add_pd(
                                _mm256_mul_pd(
                                    xi_108, _mm256_set_pd(0.1, 0.1, 0.1, 0.1)),
                                _mm256_mul_pd(
                                    xi_111, _mm256_set_pd(0.0428571428571429,
                                                          0.0428571428571429,
                                                          0.0428571428571429,
                                                          0.0428571428571429))),
                            _mm256_mul_pd(
                                xi_121, _mm256_set_pd(-0.5, -0.5, -0.5, -0.5))),
        ...
        _mm256_store_pd(
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(_mm256_add_pd(forceTerm_10, xi_175), xi_187),
                    xi_189),
                xi_233));
        _mm256_store_pd(
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(_mm256_add_pd(forceTerm_11, xi_193), xi_201),
                    xi_204),
                xi_241));
        _mm256_store_pd(
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(_mm256_add_pd(forceTerm_12, xi_201), xi_205),
                    xi_206),
                xi_220));
        _mm256_store_pd(
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(_mm256_add_pd(forceTerm_13, xi_210), xi_211),
                    xi_214),
                xi_235));
        _mm256_store_pd(
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(_mm256_add_pd(forceTerm_14, xi_211), xi_215),
                    xi_216),
                xi_223));
        _mm256_store_pd(
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(_mm256_add_pd(forceTerm_15, xi_204), xi_206),
                    xi_218),
                xi_229));
        _mm256_store_pd(
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(_mm256_add_pd(forceTerm_16, xi_193), xi_205),
                    xi_218),
                xi_231));
        _mm256_store_pd(
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(_mm256_add_pd(forceTerm_17, xi_214), xi_215),
                    xi_219),
                xi_232));
        _mm256_store_pd(
            ...
            _mm256_add_pd(
                _mm256_add_pd(
                    _mm256_add_pd(_mm256_add_pd(forceTerm_18, xi_210), xi_216),
                    xi_219),
                xi_226));
      }
    }
