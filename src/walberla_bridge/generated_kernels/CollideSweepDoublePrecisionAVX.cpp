    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_316;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (4)) * (4);
             ctr_0 += 4) {
          const __m256d xi_220 = _mm256_load_pd(&_data_force_20_32_10[ctr_0]);
          ...
          const __m256d xi_223 = _mm256_load_pd(&_data_pdfs_20_33_10[ctr_0]);
          ...
          const __m256d xi_227 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
          const __m256d xi_228 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
          const __m256d xi_229 = _mm256_load_pd(&_data_pdfs_20_39_10[ctr_0]);
          ...
          const __m256d xi_232 = _mm256_load_pd(&_data_pdfs_20_318_10[ctr_0]);
          const __m256d xi_233 = _mm256_load_pd(&_data_pdfs_20_315_10[ctr_0]);
          const __m256d xi_234 = _mm256_load_pd(&_data_pdfs_20_37_10[ctr_0]);
          const __m256d xi_235 = _mm256_load_pd(&_data_pdfs_20_30_10[ctr_0]);
          const __m256d xi_236 = _mm256_load_pd(&_data_pdfs_20_314_10[ctr_0]);
          ...
          const __m256d xi_239 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
          const __m256d xi_240 = _mm256_load_pd(&_data_pdfs_20_38_10[ctr_0]);
          const __m256d xi_241 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
          const __m256d xi_0 = _mm256_add_pd(xi_232, xi_236);
          const __m256d xi_1 = _mm256_add_pd(xi_0, xi_227);
          const __m256d xi_2 =
              _mm256_add_pd(_mm256_add_pd(xi_226, xi_228), xi_233);
          const __m256d xi_3 = _mm256_add_pd(xi_224, xi_231);
          const __m256d xi_4 = _mm256_add_pd(xi_223, xi_229);
          const __m256d xi_5 = _mm256_add_pd(xi_237, xi_241);
          const __m256d xi_6 = _mm256_add_pd(xi_230, xi_238);
          const __m256d xi_9 =
          ...
          const __m256d xi_43 = _mm256_mul_pd(
              xi_225, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                    0.166666666666667, 0.166666666666667));
          const __m256d xi_44 = _mm256_mul_pd(
              xi_225, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                    0.0833333333333333, 0.0833333333333333));
          const __m256d xi_50 = _mm256_mul_pd(
              xi_220, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                    0.166666666666667, 0.166666666666667));
          const __m256d xi_51 = _mm256_mul_pd(
              xi_220, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                    0.0833333333333333, 0.0833333333333333));
          const __m256d xi_68 =
                          ...
                          _mm256_add_pd(
                              _mm256_add_pd(
                                  ...
                                  _mm256_mul_pd(
                                      xi_231,
                                      _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))),
                              _mm256_mul_pd(xi_233, _mm256_set_pd(-3.0, -3.0,
                                                                  -3.0, -3.0))),
          ...
          const __m256d xi_127 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(xi_126, xi_15), xi_228),
                            xi_23),
              xi_241);
          ...
          const __m256d xi_138 = _mm256_add_pd(xi_116, xi_239);
          const __m256d xi_142 = _mm256_add_pd(xi_222, xi_230);
          ...
          const __m256d xi_161 = _mm256_add_pd(xi_233, xi_241);
          ...
          const __m256d xi_55 =
              _mm256_mul_pd(xi_225, _mm256_set_pd(xi_54, xi_54, xi_54, xi_54));
          const __m256d xi_60 =
          ...
          const __m256d vel0Term =
              _mm256_add_pd(_mm256_add_pd(xi_1, xi_239), xi_240);
          ...
          const __m256d u_0 = _mm256_add_pd(
              ...
              _mm256_mul_pd(xi_225, xi_8));
          const __m256d xi_26 = _mm256_mul_pd(u_0, xi_225);
          ...
          const __m256d xi_96 = _mm256_mul_pd(u_0, xi_220);
          const __m256d xi_97 =
          ...
          const __m256d xi_71 = _mm256_mul_pd(xi_225, xi_70);
          const __m256d xi_75 =
              _mm256_mul_pd(u_1, _mm256_set_pd(xi_72, xi_72, xi_72, xi_72));
          const __m256d xi_76 = _mm256_mul_pd(xi_225, xi_75);
          ...
          const __m256d xi_79 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  xi_69),
              xi_71);
          const __m256d xi_87 = _mm256_mul_pd(xi_220, xi_70);
          const __m256d xi_89 = _mm256_mul_pd(xi_220, xi_75);
          const __m256d xi_94 =
          ...
          const __m256d u_2 = _mm256_add_pd(
              _mm256_mul_pd(
                  xi_7,
                  _mm256_add_pd(
                      _mm256_add_pd(_mm256_add_pd(vel2Term, xi_22), xi_236),
                      xi_25)),
              _mm256_mul_pd(xi_220, xi_8));
          const __m256d xi_28 = _mm256_mul_pd(u_2, xi_220);
          ...
          const __m256d xi_95 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  xi_84),
              xi_94);
          const __m256d xi_98 = _mm256_mul_pd(u_2, xi_225);
          const __m256d xi_99 =
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const double xi_220 = _data_force_20_32_10[ctr_0];
          const double xi_221 = _data_force_20_31_10[ctr_0];
          const double xi_222 = _data_pdfs_20_313_10[ctr_0];
          const double xi_223 = _data_pdfs_20_33_10[ctr_0];
          const double xi_224 = _data_pdfs_20_35_10[ctr_0];
          const double xi_225 = _data_force_20_30_10[ctr_0];
          const double xi_226 = _data_pdfs_20_311_10[ctr_0];
          const double xi_227 = _data_pdfs_20_34_10[ctr_0];
          const double xi_228 = _data_pdfs_20_31_10[ctr_0];
          const double xi_229 = _data_pdfs_20_39_10[ctr_0];
          const double xi_230 = _data_pdfs_20_317_10[ctr_0];
          const double xi_231 = _data_pdfs_20_312_10[ctr_0];
          const double xi_232 = _data_pdfs_20_318_10[ctr_0];
          const double xi_233 = _data_pdfs_20_315_10[ctr_0];
          const double xi_234 = _data_pdfs_20_37_10[ctr_0];
          const double xi_235 = _data_pdfs_20_30_10[ctr_0];
          const double xi_236 = _data_pdfs_20_314_10[ctr_0];
          const double xi_237 = _data_pdfs_20_32_10[ctr_0];
          const double xi_238 = _data_pdfs_20_36_10[ctr_0];
          const double xi_239 = _data_pdfs_20_310_10[ctr_0];
          const double xi_240 = _data_pdfs_20_38_10[ctr_0];
          const double xi_241 = _data_pdfs_20_316_10[ctr_0];
          const double xi_0 = xi_232 + xi_236;
          const double xi_1 = xi_0 + xi_227;
          const double xi_2 = xi_226 + xi_228 + xi_233;
          const double xi_3 = xi_224 + xi_231;
          const double xi_4 = xi_223 + xi_229;
          const double xi_5 = xi_237 + xi_241;
          const double xi_6 = xi_230 + xi_238;
          const double xi_9 = -xi_229;
          const double xi_10 = -xi_234 + xi_9;
          const double xi_11 = -xi_230;
          const double xi_12 = -xi_222;
          const double xi_13 = -xi_223;
          const double xi_14 = xi_11 + xi_12 + xi_13;
          const double xi_15 = -xi_237;
          const double xi_16 = -xi_239;
          const double xi_17 = xi_15 + xi_16;
          const double xi_18 = -xi_241;
          const double xi_19 = -xi_231;
          const double xi_20 = xi_18 + xi_19;
          const double xi_21 = -xi_232;
          ...
          const double xi_43 = xi_225 * 0.166666666666667;
          const double xi_44 = xi_225 * 0.0833333333333333;
          const double xi_50 = xi_220 * 0.166666666666667;
          const double xi_51 = xi_220 * 0.0833333333333333;
          const double xi_68 = xi_221 * 0.25;
          const double xi_73 = xi_221 * xi_72;
          const double xi_106 = -xi_235;
          const double xi_107 = xi_106 + xi_224 * 3.0 + xi_238 * 3.0;
          const double xi_108 =
              omega_even *
              (xi_107 + xi_226 * -3.0 + xi_228 * 3.0 + xi_231 * -3.0 +
               xi_233 * -3.0 + xi_237 * 3.0 + xi_241 * -3.0);
          const double xi_109 =
              xi_226 * 2.0 + xi_231 * 2.0 + xi_233 * 2.0 + xi_241 * 2.0;
          const double xi_110 = xi_109 + xi_223 * 5.0 + xi_227 * 5.0;
          const double xi_111 =
              omega_even *
              (xi_107 + xi_110 + xi_222 * -5.0 + xi_228 * -2.0 + xi_230 * -5.0 +
               xi_232 * -5.0 + xi_236 * -5.0 + xi_237 * -2.0);
          ...
          const double xi_124 = xi_230 * 2.0 + xi_232 * 2.0;
          const double xi_125 =
              omega_even *
              (xi_106 + xi_110 + xi_122 + xi_123 + xi_124 + xi_224 * -4.0 +
               xi_228 * 5.0 + xi_229 * -7.0 + xi_234 * -7.0 + xi_237 * 5.0 +
               xi_238 * -4.0 + xi_239 * -7.0 + xi_240 * -7.0);
          const double xi_126 = xi_114 + xi_231;
          const double xi_127 = xi_126 + xi_15 + xi_228 + xi_23 + xi_241;
          const double xi_129 = xi_127 * xi_128;
          const double xi_130 = xi_234 * 2.0;
          const double xi_131 = xi_239 * 2.0;
          const double xi_132 = xi_229 * 2.0 + xi_240 * -2.0;
          const double xi_133 =
              -xi_130 + xi_131 + xi_132 + xi_15 + xi_2 + xi_20;
          const double xi_135 = xi_133 * xi_134;
          const double xi_136 = -xi_135;
          const double xi_138 = xi_116 + xi_239;
          const double xi_142 = xi_222 + xi_230;
          const double xi_146 = xi_125 * -0.0198412698412698;
          const double xi_154 = xi_119 + xi_222;
          const double xi_155 = xi_13 + xi_154 + xi_21 + xi_227 + xi_230;
          ...
          const double xi_161 = xi_233 + xi_241;
          ...
          const double xi_55 = xi_225 * xi_54;
          const double xi_60 = xi_221 * xi_54;
          const double xi_82 = xi_220 * xi_54;
          const double vel0Term = xi_1 + xi_239 + xi_240;
          ...
          const double u_0 = xi_225 * xi_8 + xi_7 * (vel0Term + xi_10 + xi_14);
          const double xi_26 = u_0 * xi_225;
          ...
          const double u_1 =
              xi_221 * xi_8 + xi_7 * (vel1Term + xi_17 + xi_20 + xi_240 + xi_9);
          ...
          const double xi_71 = xi_225 * xi_70;
          const double xi_75 = u_1 * xi_72;
          const double xi_76 = xi_225 * xi_75;
          const double xi_77 = -xi_69 - xi_71 + xi_74 + xi_76;
          const double xi_79 = xi_69 + xi_71 - xi_74 - xi_76;
          const double xi_87 = xi_220 * xi_70;
          const double xi_89 = xi_220 * xi_75;
          ...
          const double xi_139 =
              -vel1Term + xi_137 + xi_138 + xi_229 + xi_231 + xi_5;
          ...
          const double u_2 =
              xi_220 * xi_8 + xi_7 * (vel2Term + xi_22 + xi_236 + xi_25);
          const double xi_28 = u_2 * xi_220;
          ...
          const double xi_144 =
              omega_shear * (xi_0 + xi_118 + xi_142 + xi_143 + xi_17 - xi_228);
          const double xi_145 = xi_144 * 0.125;
          const double xi_147 =
              omega_shear *
              (xi_10 + xi_109 + xi_112 * 2.0 + xi_116 - xi_117 + xi_120 +
               xi_143 + xi_223 * -2.0 + xi_227 * -2.0 + xi_228 + xi_237);
          ...
          const double xi_164 =
              rho * u_2 - vel2Term + xi_114 + xi_119 + xi_161 + xi_232 + xi_6;
          ...
          const double xi_207 =
              xi_171 * (u_2 * xi_151 + xi_11 + xi_154 + xi_232);
          ...
          _data_pdfs_20_30_10[ctr_0] =
              ...
              xi_121 * -0.5 + xi_125 * 0.0238095238095238 + xi_235;
          _data_pdfs_20_31_10[ctr_0] =
              forceTerm_1 - xi_129 + xi_136 + xi_141 + xi_150 + xi_228;
          _data_pdfs_20_32_10[ctr_0] =
              forceTerm_2 + xi_129 + xi_135 - xi_141 + xi_150 + xi_237;
          _data_pdfs_20_33_10[ctr_0] =
              forceTerm_3 - xi_153 + xi_156 + xi_158 + xi_159 + xi_223;
          _data_pdfs_20_34_10[ctr_0] =
              forceTerm_4 + xi_153 - xi_156 + xi_159 + xi_160 + xi_227;
          _data_pdfs_20_35_10[ctr_0] =
          ...
          _data_pdfs_20_39_10[ctr_0] =
              forceTerm_9 + xi_184 + xi_185 + xi_189 + xi_229;
          _data_pdfs_20_310_10[ctr_0] =
          ...
          _data_pdfs_20_316_10[ctr_0] =
              forceTerm_16 + xi_193 + xi_205 + xi_218 + xi_241;
          _data_pdfs_20_317_10[ctr_0] =
              forceTerm_17 + xi_214 + xi_215 + xi_219 + xi_230;
          _data_pdfs_20_318_10[ctr_0] =
              forceTerm_18 + xi_210 + xi_216 + xi_219 + xi_232;
        }
      }
    }
  }
