...
public:
  LeesEdwards_Collision(BlockDataID forceID_, BlockDataID pdfsID_,
                        BlockDataID velocityID_, double omega)
  ...
  getSweep(const shared_ptr<LeesEdwards_Collision> &kernel) {
    return [kernel](IBlock *b) { kernel->run(b); };
  }

  static std::function<void(IBlock *)>
  getSweepOnCellInterval(const shared_ptr<LeesEdwards_Collision> &kernel,
