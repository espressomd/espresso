...
//
//! \\file UpdateVelocityFromPDFSweepSinglePrecision.cpp
//! \\ingroup lbm
//! \\author lbmpy
//======================================================================================================================
...
#include "UpdateVelocityFromPDFSweepSinglePrecision.h"
...
updatevelocityfrompdfsweepsingleprecision_updatevelocityfrompdfsweepsingleprecision(
  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        const float vel0Term = _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0] +
        ...
        const float vel1Term = _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0] +
        ...
        const float vel2Term = _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0] +
                               _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0] +
                               _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0];
        const float rho = vel0Term + vel1Term + vel2Term +
...
void UpdateVelocityFromPDFSweepSinglePrecision::run(IBlock *block) {
  ...
  internal_5bc8ae7b61d5e7dd0cac9df61b0fb69a::
      updatevelocityfrompdfsweepsingleprecision_updatevelocityfrompdfsweepsingleprecision(
...
void UpdateVelocityFromPDFSweepSinglePrecision::runOnCellInterval(
