...
namespace internal_collidesweepdoubleprecisionthermalized {
static FUNC_PREFIX void collidesweepdoubleprecisionthermalized(
  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        ...
        const double xi_250 = _data_force_20_31_10[_stride_force_0 * ctr_0];
        ...
        const double xi_254 = _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0];
        const double xi_255 = _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0];
        const double xi_256 = _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_262 = _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_266 = _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0];
        const double xi_267 = _data_force_20_30_10[_stride_force_0 * ctr_0];
        ...
        const double xi_0 = xi_252 + xi_260;
        const double xi_1 = xi_0 + xi_253;
        const double xi_2 = xi_249 + xi_251 + xi_264;
        const double xi_3 = xi_259 + xi_266;
        const double xi_4 = xi_261 + xi_269;
        const double xi_5 = xi_254 + xi_268;
        const double xi_6 = xi_255 + xi_262;
        const double xi_8 = -xi_269;
        const double xi_9 = -xi_256 + xi_8;
        const double xi_10 = -xi_255;
        const double xi_11 = -xi_263;
        const double xi_12 = -xi_261;
        const double xi_13 = xi_10 + xi_11 + xi_12;
        const double xi_14 = -xi_254;
        const double xi_15 = -xi_257;
        const double xi_16 = xi_14 + xi_15;
        const double xi_17 = -xi_268;
        const double xi_18 = -xi_266;
        ...
        const double xi_42 = xi_250 * 0.166666666666667;
        const double xi_50 = xi_267 * 0.166666666666667;
        const double xi_54 = xi_248 * 0.166666666666667;
        const double xi_57 = xi_250 * 0.5;
        const double xi_61 = xi_267 * 0.0833333333333333;
        const double xi_65 = xi_250 * 0.0833333333333333;
        const double xi_75 = xi_248 * 0.0833333333333333;
        const double xi_93 = -xi_258;
        const double xi_94 = xi_259 * 3.0 + xi_262 * 3.0 + xi_93;
        const double xi_95 =
            omega_even *
            (xi_249 * 3.0 + xi_251 * -3.0 + xi_254 * 3.0 + xi_264 * -3.0 +
             xi_266 * -3.0 + xi_268 * -3.0 + xi_94);
        const double xi_96 =
            xi_251 * 2.0 + xi_264 * 2.0 + xi_266 * 2.0 + xi_268 * 2.0;
        const double xi_97 = xi_253 * 5.0 + xi_261 * 5.0 + xi_96;
        const double xi_98 =
            omega_even *
            (xi_249 * -2.0 + xi_252 * -5.0 + xi_254 * -2.0 + xi_255 * -5.0 +
             xi_260 * -5.0 + xi_263 * -5.0 + xi_94 + xi_97);
        const double xi_101 = -xi_264;
        const double xi_102 = xi_101 + xi_18;
        const double xi_103 = -xi_265;
        const double xi_106 = -xi_260;
        const double xi_107 = xi_106 + xi_11 + xi_15 + xi_21;
        const double xi_109 = xi_263 * 2.0;
        const double xi_110 = xi_260 * 2.0;
        const double xi_111 = xi_252 * 2.0 + xi_255 * 2.0;
        const double xi_112 =
            omega_even *
            (xi_109 + xi_110 + xi_111 + xi_249 * 5.0 + xi_254 * 5.0 +
             xi_256 * -7.0 + xi_257 * -7.0 + xi_259 * -4.0 + xi_262 * -4.0 +
             xi_265 * -7.0 + xi_269 * -7.0 + xi_93 + xi_97);
        const double xi_113 = xi_101 + xi_266;
        const double xi_114 = xi_113 + xi_14 + xi_22 + xi_249 + xi_268;
        const double xi_116 = xi_114 * xi_115;
        const double xi_118 = xi_103 + xi_257;
        const double xi_122 = random_5_1 - 0.5;
        const double xi_127 = xi_256 * 2.0;
        const double xi_128 = xi_257 * 2.0;
        const double xi_129 = xi_265 * -2.0 + xi_269 * 2.0;
        ...
        const double xi_142 = xi_255 + xi_263;
        const double xi_156 = xi_106 + xi_263;
        const double xi_157 = xi_12 + xi_156 + xi_20 + xi_253 + xi_255;
        ...
        const double xi_168 = xi_251 + xi_268;
        ...
        const double vel1Term = xi_2 + xi_256;
        ...
        const double xi_79 = xi_58 * (u_0 * xi_248 * 0.5 + u_2 * xi_267 * 0.5);
        ...
        const double xi_143 = -xi_100 + xi_259 + xi_262;
        const double xi_144 =
            omega_shear * (xi_0 + xi_105 + xi_142 + xi_143 + xi_16 - xi_249);
        const double xi_145 = xi_144 * 0.125;
        const double xi_147 =
            omega_shear *
            (xi_103 - xi_104 + xi_107 + xi_143 + xi_249 + xi_253 * -2.0 +
             xi_254 + xi_261 * -2.0 + xi_9 + xi_96 + xi_99 * 2.0);
        const double xi_149 =
        ...
        _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_6 + xi_170 - xi_172 + xi_174 + xi_180 + xi_181 + xi_262;
        _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_7 + xi_190 + xi_194 + xi_198 + xi_256;
        ...
        _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_12 + xi_222 + xi_228 + xi_229 + xi_266;
        _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_13 + xi_234 + xi_237 + xi_242 + xi_263;
        _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_14 + xi_234 + xi_243 + xi_244 + xi_260;
        ...
        _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_16 + xi_210 + xi_228 + xi_246 + xi_268;
...
void CollideSweepDoublePrecisionThermalized::operator()(IBlock *block) {
  ...
  internal_collidesweepdoubleprecisionthermalized::
