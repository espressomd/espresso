...
namespace internal_collidesweepdoubleprecisionthermalizedavx {
static FUNC_PREFIX void collidesweepdoubleprecisionthermalizedavx(
  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0;
        ...
        const __m256d xi_249 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
        const __m256d xi_250 = _mm256_load_pd(&_data_force_20_31_10[ctr_0]);
        const __m256d xi_251 = _mm256_load_pd(&_data_pdfs_20_315_10[ctr_0]);
        const __m256d xi_252 = _mm256_load_pd(&_data_pdfs_20_318_10[ctr_0]);
        const __m256d xi_253 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
        const __m256d xi_254 = _mm256_load_pd(&_data_pdfs_20_32_10[ctr_0]);
        const __m256d xi_255 = _mm256_load_pd(&_data_pdfs_20_317_10[ctr_0]);
        const __m256d xi_256 = _mm256_load_pd(&_data_pdfs_20_37_10[ctr_0]);
        const __m256d xi_257 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
        const __m256d xi_258 = _mm256_load_pd(&_data_pdfs_20_30_10[ctr_0]);
        const __m256d xi_259 = _mm256_load_pd(&_data_pdfs_20_35_10[ctr_0]);
        ...
        const __m256d xi_262 = _mm256_load_pd(&_data_pdfs_20_36_10[ctr_0]);
        const __m256d xi_263 = _mm256_load_pd(&_data_pdfs_20_313_10[ctr_0]);
        const __m256d xi_264 = _mm256_load_pd(&_data_pdfs_20_311_10[ctr_0]);
        const __m256d xi_265 = _mm256_load_pd(&_data_pdfs_20_38_10[ctr_0]);
        const __m256d xi_266 = _mm256_load_pd(&_data_pdfs_20_312_10[ctr_0]);
        const __m256d xi_267 = _mm256_load_pd(&_data_force_20_30_10[ctr_0]);
        ...
        const __m256d xi_0 = _mm256_add_pd(xi_252, xi_260);
        const __m256d xi_1 = _mm256_add_pd(xi_0, xi_253);
        const __m256d xi_2 =
            _mm256_add_pd(_mm256_add_pd(xi_249, xi_251), xi_264);
        const __m256d xi_3 = _mm256_add_pd(xi_259, xi_266);
        const __m256d xi_4 = _mm256_add_pd(xi_261, xi_269);
        const __m256d xi_5 = _mm256_add_pd(xi_254, xi_268);
        const __m256d xi_6 = _mm256_add_pd(xi_255, xi_262);
        const __m256d xi_8 =
            _mm256_mul_pd(xi_269, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0));
        const __m256d xi_9 = _mm256_add_pd(
            _mm256_mul_pd(xi_256, _mm256_set_pd(-1.0, -1.0, -1.0, -1.0)), xi_8);
        const __m256d xi_10 =
        ...
        const __m256d xi_24 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(xi_17, xi_22), xi_23), xi_264);
        ...
        const __m256d xi_50 = _mm256_mul_pd(
            xi_267, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                  0.166666666666667, 0.166666666666667));
        const __m256d xi_54 = _mm256_mul_pd(
            xi_248, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                  0.166666666666667, 0.166666666666667));
        const __m256d xi_57 =
            _mm256_mul_pd(xi_250, _mm256_set_pd(0.5, 0.5, 0.5, 0.5));
        const __m256d xi_61 = _mm256_mul_pd(
            xi_267, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
        ...
        const __m256d xi_94 = _mm256_add_pd(
            _mm256_add_pd(
                _mm256_mul_pd(xi_259, _mm256_set_pd(3.0, 3.0, 3.0, 3.0)),
                            ...
                            _mm256_add_pd(
                                _mm256_add_pd(
                                    ...
                                    _mm256_mul_pd(
                                        ...
                                        _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))),
                                _mm256_mul_pd(
                                    xi_254, _mm256_set_pd(3.0, 3.0, 3.0, 3.0))),
                            _mm256_mul_pd(
                                xi_264, _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))),
                        _mm256_mul_pd(xi_266,
                                      _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))),
                ...
                _mm256_add_pd(
                    _mm256_add_pd(
                        _mm256_add_pd(
                            ...
                            _mm256_mul_pd(
                                xi_260, _mm256_set_pd(-5.0, -5.0, -5.0, -5.0))),
        ...
        const __m256d xi_112 = _mm256_mul_pd(
            _mm256_add_pd(
                ...
                xi_97),
            _mm256_set_pd(omega_even, omega_even, omega_even, omega_even));
        const __m256d xi_113 = _mm256_add_pd(xi_101, xi_266);
        ...
        const __m256d xi_118 = _mm256_add_pd(xi_103, xi_257);
        ...
        const __m256d xi_142 = _mm256_add_pd(xi_255, xi_263);
        const __m256d xi_156 = _mm256_add_pd(xi_106, xi_263);
        ...
        const __m256d xi_168 = _mm256_add_pd(xi_251, xi_268);
        const __m256d xi_169 = _mm256_add_pd(
            _mm256_add_pd(_mm256_add_pd(xi_102, xi_168), xi_23), xi_259);
        ...
        const __m256d vel0Term =
            _mm256_add_pd(_mm256_add_pd(xi_1, xi_257), xi_265);
        const __m256d vel1Term = _mm256_add_pd(xi_2, xi_256);
        const __m256d vel2Term = _mm256_add_pd(xi_263, xi_3);
        ...
        const __m256d xi_26 = _mm256_mul_pd(u_0, xi_267);
        ...
        const __m256d u_1 = _mm256_mul_pd(
            xi_7, _mm256_add_pd(
                      _mm256_add_pd(
                          ...
                          xi_265),
                      xi_8));
        const __m256d xi_28 = _mm256_mul_pd(u_1, xi_250);
        ...
        const __m256d xi_79 = _mm256_mul_pd(
            _mm256_add_pd(_mm256_mul_pd(_mm256_mul_pd(u_0, xi_248),
                                        _mm256_set_pd(0.5, 0.5, 0.5, 0.5)),
                          _mm256_mul_pd(_mm256_mul_pd(u_2, xi_267),
                                        _mm256_set_pd(0.5, 0.5, 0.5, 0.5))),
            _mm256_set_pd(xi_58, xi_58, xi_58, xi_58));
        const __m256d xi_80 =
...
void CollideSweepDoublePrecisionThermalizedAVX::operator()(IBlock *block) {
  ...
  internal_collidesweepdoubleprecisionthermalizedavx::
