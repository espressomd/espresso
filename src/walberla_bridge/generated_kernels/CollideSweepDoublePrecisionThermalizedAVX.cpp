    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_30;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const __m256d xi_270 = _mm256_load_pd(&_data_pdfs_20_33_10[ctr_0]);
          ...
          const __m256d xi_273 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
          ...
          const __m256d xi_278 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
          const __m256d xi_279 = _mm256_load_pd(&_data_force_20_32_10[ctr_0]);
          const __m256d xi_280 = _mm256_load_pd(&_data_force_20_30_10[ctr_0]);
          ...
          const __m256d xi_283 = _mm256_load_pd(&_data_pdfs_20_315_10[ctr_0]);
          const __m256d xi_284 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
          ...
          const __m256d xi_0 = _mm256_add_pd(xi_274, xi_277);
          const __m256d xi_1 = _mm256_add_pd(xi_0, xi_273);
          const __m256d xi_2 =
              _mm256_add_pd(_mm256_add_pd(xi_269, xi_278), xi_283);
          const __m256d xi_3 = _mm256_add_pd(xi_271, xi_281);
          const __m256d xi_4 = _mm256_add_pd(xi_268, xi_270);
          const __m256d xi_5 = _mm256_add_pd(xi_284, xi_285);
          const __m256d xi_6 = _mm256_add_pd(xi_272, xi_282);
          const __m256d xi_9 =
          ...
          const __m256d xi_50 = _mm256_mul_pd(
              xi_279, _mm256_set_pd(0.166666666666667, 0.166666666666667,
                                    0.166666666666667, 0.166666666666667));
          const __m256d xi_51 = _mm256_mul_pd(
              xi_279, _mm256_set_pd(0.0833333333333333, 0.0833333333333333,
                                    0.0833333333333333, 0.0833333333333333));
          const __m256d xi_68 =
              _mm256_mul_pd(xi_276, _mm256_set_pd(0.25, 0.25, 0.25, 0.25));
          const __m256d xi_73 =
                  ...
                  _mm256_add_pd(
                      _mm256_add_pd(
                          _mm256_add_pd(
                              ...
                              _mm256_mul_pd(xi_283, _mm256_set_pd(-3.0, -3.0,
                                                                  -3.0, -3.0))),
          ...
          const __m256d xi_117 = _mm256_add_pd(
              _mm256_add_pd(
                  _mm256_mul_pd(xi_270, _mm256_set_pd(5.0, 5.0, 5.0, 5.0)),
          ...
          const __m256d xi_162 = _mm256_add_pd(xi_272, xi_287);
          ...
          const __m256d xi_188 = _mm256_add_pd(xi_283, xi_284);
          ...
          const __m256d vel0Term =
              _mm256_add_pd(_mm256_add_pd(xi_1, xi_275), xi_286);
          ...
          const __m256d xi_26 = _mm256_mul_pd(u_0, xi_280);
          ...
          const __m256d xi_96 = _mm256_mul_pd(u_0, xi_279);
          const __m256d xi_97 =
          ...
          const __m256d xi_71 = _mm256_mul_pd(xi_280, xi_70);
          const __m256d xi_75 =
              _mm256_mul_pd(u_1, _mm256_set_pd(xi_72, xi_72, xi_72, xi_72));
          const __m256d xi_76 = _mm256_mul_pd(xi_280, xi_75);
          ...
          const __m256d xi_79 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  xi_69),
              xi_71);
          const __m256d xi_87 = _mm256_mul_pd(xi_279, xi_70);
          const __m256d xi_89 = _mm256_mul_pd(xi_279, xi_75);
          const __m256d xi_94 =
          ...
          const __m256d xi_28 = _mm256_mul_pd(u_2, xi_279);
          ...
          const __m256d xi_95 = _mm256_add_pd(
              _mm256_add_pd(
                  ...
                  xi_84),
              xi_94);
          const __m256d xi_98 = _mm256_mul_pd(u_2, xi_280);
          const __m256d xi_99 =
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const double xi_278 = _data_pdfs_20_31_10[ctr_0];
          const double xi_279 = _data_force_20_32_10[ctr_0];
          const double xi_280 = _data_force_20_30_10[ctr_0];
          const double xi_281 = _data_pdfs_20_35_10[ctr_0];
          const double xi_282 = _data_pdfs_20_36_10[ctr_0];
          const double xi_283 = _data_pdfs_20_315_10[ctr_0];
          const double xi_284 = _data_pdfs_20_316_10[ctr_0];
          ...
          const double xi_0 = xi_274 + xi_277;
          const double xi_1 = xi_0 + xi_273;
          const double xi_2 = xi_269 + xi_278 + xi_283;
          const double xi_3 = xi_271 + xi_281;
          const double xi_4 = xi_268 + xi_270;
          const double xi_5 = xi_284 + xi_285;
          const double xi_6 = xi_272 + xi_282;
          const double xi_9 = -xi_268;
          const double xi_10 = -xi_288 + xi_9;
          const double xi_11 = -xi_272;
          const double xi_12 = -xi_287;
          const double xi_13 = -xi_270;
          const double xi_14 = xi_11 + xi_12 + xi_13;
          const double xi_15 = -xi_285;
          const double xi_16 = -xi_286;
          const double xi_17 = xi_15 + xi_16;
          const double xi_18 = -xi_284;
          const double xi_19 = -xi_271;
          const double xi_20 = xi_18 + xi_19;
          const double xi_21 = -xi_277;
          const double xi_22 = xi_11 + xi_21;
          const double xi_23 = -xi_283;
          const double xi_24 = -xi_282;
          const double xi_25 = xi_18 + xi_23 + xi_24 + xi_269;
          const double xi_30 = xi_276 * 0.166666666666667;
          const double xi_31 = xi_276 * 0.0833333333333333;
          const double xi_43 = xi_280 * 0.166666666666667;
          const double xi_44 = xi_280 * 0.0833333333333333;
          const double xi_50 = xi_279 * 0.166666666666667;
          const double xi_51 = xi_279 * 0.0833333333333333;
          const double xi_68 = xi_276 * 0.25;
          const double xi_73 = xi_276 * xi_72;
          const double xi_113 = -xi_289;
          const double xi_114 = xi_113 + xi_281 * 3.0 + xi_282 * 3.0;
          const double xi_115 =
              omega_even *
              (xi_114 + xi_269 * -3.0 + xi_271 * -3.0 + xi_278 * 3.0 +
               xi_283 * -3.0 + xi_284 * -3.0 + xi_285 * 3.0);
          const double xi_116 =
              xi_269 * 2.0 + xi_271 * 2.0 + xi_283 * 2.0 + xi_284 * 2.0;
          const double xi_117 = xi_116 + xi_270 * 5.0 + xi_273 * 5.0;
          const double xi_118 =
              omega_even *
              (xi_114 + xi_117 + xi_272 * -5.0 + xi_274 * -5.0 + xi_277 * -5.0 +
               xi_278 * -2.0 + xi_285 * -2.0 + xi_287 * -5.0);
          ...
          const double xi_131 = xi_272 * 2.0 + xi_277 * 2.0;
          const double xi_132 =
              omega_even *
              (xi_113 + xi_117 + xi_129 + xi_130 + xi_131 + xi_268 * -7.0 +
               xi_275 * -7.0 + xi_278 * 5.0 + xi_281 * -4.0 + xi_282 * -4.0 +
               xi_285 * 5.0 + xi_286 * -7.0 + xi_288 * -7.0);
          const double xi_133 = xi_121 + xi_271;
          const double xi_134 = xi_133 + xi_15 + xi_23 + xi_278 + xi_284;
          ...
          const double xi_149 = xi_268 * 2.0 + xi_275 * -2.0;
          const double xi_150 =
          ...
          const double xi_162 = xi_272 + xi_287;
          const double xi_176 = xi_126 + xi_287;
          const double xi_177 = xi_13 + xi_176 + xi_21 + xi_272 + xi_273;
          ...
          const double xi_188 = xi_283 + xi_284;
          ...
          const double xi_55 = xi_280 * xi_54;
          const double xi_60 = xi_276 * xi_54;
          const double xi_82 = xi_279 * xi_54;
          const double vel0Term = xi_1 + xi_275 + xi_286;
          ...
          const double u_0 = xi_280 * xi_8 + xi_7 * (vel0Term + xi_10 + xi_14);
          const double xi_26 = u_0 * xi_280;
          ...
          const double u_1 =
              xi_276 * xi_8 + xi_7 * (vel1Term + xi_17 + xi_20 + xi_275 + xi_9);
          ...
          const double xi_71 = xi_280 * xi_70;
          const double xi_75 = u_1 * xi_72;
          const double xi_76 = xi_280 * xi_75;
          const double xi_77 = -xi_69 - xi_71 + xi_74 + xi_76;
          const double xi_79 = xi_69 + xi_71 - xi_74 - xi_76;
          const double xi_87 = xi_279 * xi_70;
          const double xi_89 = xi_279 * xi_75;
          ...
          const double xi_139 =
              -vel1Term + xi_137 + xi_138 + xi_268 + xi_271 + xi_5;
          ...
          const double u_2 =
              xi_279 * xi_8 + xi_7 * (vel2Term + xi_22 + xi_25 + xi_274);
          const double xi_28 = u_2 * xi_279;
          ...
          const double xi_128 =
              omega_bulk * (xi_119 + xi_120 + xi_122 + xi_125 + xi_127 + xi_18 +
                            xi_23 + xi_289);
          const double xi_163 = -xi_120 + xi_281 + xi_282;
          const double xi_164 =
          ...
          const double xi_167 =
              ...
              (xi_10 + xi_116 + xi_119 * 2.0 + xi_123 - xi_124 + xi_127 +
               xi_163 + xi_270 * -2.0 + xi_273 * -2.0 + xi_278 + xi_285);
          const double xi_169 =
          ...
          _data_pdfs_20_33_10[ctr_0] =
              forceTerm_3 - xi_175 + xi_178 + xi_180 + xi_185 + xi_186 + xi_270;
          _data_pdfs_20_34_10[ctr_0] =
              forceTerm_4 + xi_175 - xi_178 - xi_180 + xi_186 + xi_187 + xi_273;
          _data_pdfs_20_35_10[ctr_0] =
