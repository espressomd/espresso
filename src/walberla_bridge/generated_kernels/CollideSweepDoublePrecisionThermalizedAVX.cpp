    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_38;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const __m256d xi_271 = _mm256_load_pd(&_data_pdfs_20_35_10[ctr_0]);
          const __m256d xi_272 = _mm256_load_pd(&_data_pdfs_20_314_10[ctr_0]);
          const __m256d xi_273 = _mm256_load_pd(&_data_pdfs_20_318_10[ctr_0]);
          const __m256d xi_274 = _mm256_load_pd(&_data_pdfs_20_31_10[ctr_0]);
          const __m256d xi_275 = _mm256_load_pd(&_data_pdfs_20_313_10[ctr_0]);
          const __m256d xi_276 = _mm256_load_pd(&_data_pdfs_20_316_10[ctr_0]);
          const __m256d xi_277 = _mm256_load_pd(&_data_pdfs_20_315_10[ctr_0]);
          const __m256d xi_278 = _mm256_load_pd(&_data_pdfs_20_312_10[ctr_0]);
          const __m256d xi_279 = _mm256_load_pd(&_data_pdfs_20_32_10[ctr_0]);
          const __m256d xi_280 = _mm256_load_pd(&_data_pdfs_20_36_10[ctr_0]);
          const __m256d xi_281 = _mm256_load_pd(&_data_pdfs_20_39_10[ctr_0]);
          const __m256d xi_282 = _mm256_load_pd(&_data_pdfs_20_37_10[ctr_0]);
          const __m256d xi_283 = _mm256_load_pd(&_data_pdfs_20_311_10[ctr_0]);
          const __m256d xi_284 = _mm256_load_pd(&_data_pdfs_20_34_10[ctr_0]);
          const __m256d xi_285 = _mm256_load_pd(&_data_pdfs_20_30_10[ctr_0]);
          const __m256d xi_286 = _mm256_load_pd(&_data_pdfs_20_310_10[ctr_0]);
          const __m256d xi_287 = _mm256_load_pd(&_data_pdfs_20_317_10[ctr_0]);
          const __m256d xi_288 = _mm256_load_pd(&_data_force_20_32_10[ctr_0]);
          const __m256d xi_289 = _mm256_load_pd(&_data_pdfs_20_38_10[ctr_0]);
          ...
          const __m256d xi_0 = _mm256_add_pd(xi_272, xi_273);
          const __m256d xi_1 = _mm256_add_pd(xi_0, xi_284);
          const __m256d xi_2 =
              _mm256_add_pd(_mm256_add_pd(xi_274, xi_277), xi_283);
          const __m256d xi_3 = _mm256_add_pd(xi_271, xi_278);
          const __m256d xi_4 = _mm256_add_pd(xi_268, xi_281);
          const __m256d xi_5 = _mm256_add_pd(xi_276, xi_279);
          const __m256d xi_6 = _mm256_add_pd(xi_280, xi_287);
          const __m256d xi_9 =
          ...
          const __m256d xi_25 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(xi_18, xi_23), xi_24), xi_283);
          ...
          const __m256d xi_114 = _mm256_add_pd(
              _mm256_add_pd(
                  _mm256_mul_pd(xi_271, _mm256_set_pd(3.0, 3.0, 3.0, 3.0)),
                          ...
                          _mm256_add_pd(
                              _mm256_add_pd(
                                  _mm256_add_pd(
                                      ...
                                      _mm256_mul_pd(xi_276,
                                                    _mm256_set_pd(-3.0, -3.0,
                                                                  -3.0, -3.0))),
                                  _mm256_mul_pd(
                                      xi_277,
                                      _mm256_set_pd(-3.0, -3.0, -3.0, -3.0))),
                              _mm256_mul_pd(xi_278, _mm256_set_pd(-3.0, -3.0,
                                                                  -3.0, -3.0))),
          ...
          const __m256d xi_117 = _mm256_add_pd(
              _mm256_add_pd(
                  _mm256_mul_pd(xi_268, _mm256_set_pd(5.0, 5.0, 5.0, 5.0)),
                  _mm256_mul_pd(xi_284, _mm256_set_pd(5.0, 5.0, 5.0, 5.0))),
              xi_116);
          ...
          const __m256d xi_132 = _mm256_mul_pd(
              _mm256_add_pd(
                  ...
                  xi_131),
              _mm256_set_pd(omega_even, omega_even, omega_even, omega_even));
          const __m256d xi_133 = _mm256_add_pd(xi_121, xi_278);
          ...
          const __m256d xi_162 = _mm256_add_pd(xi_275, xi_287);
          ...
          const __m256d xi_188 = _mm256_add_pd(xi_276, xi_277);
          const __m256d xi_189 = _mm256_add_pd(
              _mm256_add_pd(_mm256_add_pd(xi_122, xi_188), xi_24), xi_271);
          ...
          const __m256d vel0Term =
              _mm256_add_pd(_mm256_add_pd(xi_1, xi_286), xi_289);
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (4)) * (4);
          ...
          const double xi_268 = _data_pdfs_20_33_10[ctr_0];
          const double xi_269 = _data_force_20_31_10[ctr_0];
          const double xi_270 = _data_force_20_30_10[ctr_0];
          const double xi_271 = _data_pdfs_20_35_10[ctr_0];
          const double xi_272 = _data_pdfs_20_314_10[ctr_0];
          const double xi_273 = _data_pdfs_20_318_10[ctr_0];
          const double xi_274 = _data_pdfs_20_31_10[ctr_0];
          const double xi_275 = _data_pdfs_20_313_10[ctr_0];
          const double xi_276 = _data_pdfs_20_316_10[ctr_0];
          const double xi_277 = _data_pdfs_20_315_10[ctr_0];
          const double xi_278 = _data_pdfs_20_312_10[ctr_0];
          const double xi_279 = _data_pdfs_20_32_10[ctr_0];
          const double xi_280 = _data_pdfs_20_36_10[ctr_0];
          const double xi_281 = _data_pdfs_20_39_10[ctr_0];
          const double xi_282 = _data_pdfs_20_37_10[ctr_0];
          const double xi_283 = _data_pdfs_20_311_10[ctr_0];
          const double xi_284 = _data_pdfs_20_34_10[ctr_0];
          const double xi_285 = _data_pdfs_20_30_10[ctr_0];
          const double xi_286 = _data_pdfs_20_310_10[ctr_0];
          const double xi_287 = _data_pdfs_20_317_10[ctr_0];
          const double xi_288 = _data_force_20_32_10[ctr_0];
          const double xi_289 = _data_pdfs_20_38_10[ctr_0];
          ...
          const double xi_0 = xi_272 + xi_273;
          const double xi_1 = xi_0 + xi_284;
          const double xi_2 = xi_274 + xi_277 + xi_283;
          const double xi_3 = xi_271 + xi_278;
          const double xi_4 = xi_268 + xi_281;
          const double xi_5 = xi_276 + xi_279;
          const double xi_6 = xi_280 + xi_287;
          const double xi_9 = -xi_281;
          const double xi_10 = -xi_282 + xi_9;
          const double xi_11 = -xi_287;
          const double xi_12 = -xi_275;
          const double xi_13 = -xi_268;
          const double xi_14 = xi_11 + xi_12 + xi_13;
          const double xi_15 = -xi_279;
          const double xi_16 = -xi_286;
          const double xi_17 = xi_15 + xi_16;
          const double xi_18 = -xi_276;
          const double xi_19 = -xi_278;
          const double xi_20 = xi_18 + xi_19;
          const double xi_21 = -xi_273;
          const double xi_22 = xi_11 + xi_21;
          const double xi_23 = -xi_277;
          const double xi_24 = -xi_280;
          const double xi_25 = xi_18 + xi_23 + xi_24 + xi_283;
          ...
          const double xi_113 = -xi_285;
          const double xi_114 = xi_113 + xi_271 * 3.0 + xi_280 * 3.0;
          const double xi_115 =
              omega_even *
              (xi_114 + xi_274 * 3.0 + xi_276 * -3.0 + xi_277 * -3.0 +
               xi_278 * -3.0 + xi_279 * 3.0 + xi_283 * -3.0);
          const double xi_116 =
              xi_276 * 2.0 + xi_277 * 2.0 + xi_278 * 2.0 + xi_283 * 2.0;
          const double xi_117 = xi_116 + xi_268 * 5.0 + xi_284 * 5.0;
          const double xi_118 =
              omega_even *
              (xi_114 + xi_117 + xi_272 * -5.0 + xi_273 * -5.0 + xi_274 * -2.0 +
               xi_275 * -5.0 + xi_279 * -2.0 + xi_287 * -5.0);
          const double xi_121 = -xi_283;
          const double xi_122 = xi_121 + xi_19;
          const double xi_123 = -xi_289;
          const double xi_126 = -xi_272;
          const double xi_127 = xi_12 + xi_126 + xi_16 + xi_22;
          const double xi_129 = xi_275 * 2.0;
          const double xi_130 = xi_272 * 2.0;
          const double xi_131 = xi_273 * 2.0 + xi_287 * 2.0;
          const double xi_132 =
              omega_even *
              (xi_113 + xi_117 + xi_129 + xi_130 + xi_131 + xi_271 * -4.0 +
               xi_274 * 5.0 + xi_279 * 5.0 + xi_280 * -4.0 + xi_281 * -7.0 +
               xi_282 * -7.0 + xi_286 * -7.0 + xi_289 * -7.0);
          const double xi_133 = xi_121 + xi_278;
          const double xi_134 = xi_133 + xi_15 + xi_23 + xi_274 + xi_276;
          ...
          const double xi_149 = xi_281 * 2.0 + xi_289 * -2.0;
          const double xi_150 =
          ...
          const double xi_162 = xi_275 + xi_287;
          const double xi_176 = xi_126 + xi_275;
          const double xi_177 = xi_13 + xi_176 + xi_21 + xi_284 + xi_287;
          ...
          const double xi_188 = xi_276 + xi_277;
          const double xi_189 = xi_122 + xi_188 + xi_24 + xi_271;
          ...
          const double vel0Term = xi_1 + xi_286 + xi_289;
          const double vel1Term = xi_2 + xi_282;
          const double vel2Term = xi_275 + xi_3;
          const double rho =
              vel0Term + vel1Term + vel2Term + xi_285 + xi_4 + xi_5 + xi_6;
          ...
          const double u_1 =
              xi_269 * xi_8 + xi_7 * (vel1Term + xi_17 + xi_20 + xi_289 + xi_9);
          ...
          const double xi_139 =
              -vel1Term + xi_137 + xi_138 + xi_278 + xi_281 + xi_5;
          ...
          const double u_2 =
              xi_288 * xi_8 + xi_7 * (vel2Term + xi_22 + xi_25 + xi_272);
          ...
          const double xi_128 =
              omega_bulk * (xi_119 + xi_120 + xi_122 + xi_125 + xi_127 + xi_18 +
                            xi_23 + xi_285);
          const double xi_163 = -xi_120 + xi_271 + xi_280;
          const double xi_164 =
              omega_shear * (xi_0 + xi_125 + xi_162 + xi_163 + xi_17 - xi_274);
          const double xi_165 = xi_164 * 0.125;
          const double xi_167 =
              omega_shear *
              (xi_10 + xi_116 + xi_119 * 2.0 + xi_123 - xi_124 + xi_127 +
               xi_163 + xi_268 * -2.0 + xi_274 + xi_279 + xi_284 * -2.0);
          const double xi_169 =
          ...
          const double xi_191 =
              rho * u_2 - vel2Term + xi_121 + xi_126 + xi_188 + xi_273 + xi_6;
          ...
          const double xi_226 =
              xi_216 * (u_2 * xi_137 + xi_133 + xi_18 + xi_277);
          const double xi_230 =
          ...
          const double xi_256 =
              xi_216 * (u_2 * xi_173 + xi_11 + xi_176 + xi_273);
          ...
          _data_pdfs_20_30_10[ctr_0] =
              ...
              xi_132 * 0.0238095238095238 + xi_285;
          _data_pdfs_20_31_10[ctr_0] =
              forceTerm_1 - xi_136 + xi_141 - xi_146 + xi_157 + xi_171 + xi_274;
          _data_pdfs_20_32_10[ctr_0] =
              forceTerm_2 + xi_136 - xi_141 + xi_146 + xi_171 + xi_172 + xi_279;
          _data_pdfs_20_33_10[ctr_0] =
              forceTerm_3 - xi_175 + xi_178 + xi_180 + xi_185 + xi_186 + xi_268;
          _data_pdfs_20_34_10[ctr_0] =
              forceTerm_4 + xi_175 - xi_178 - xi_180 + xi_186 + xi_187 + xi_284;
          _data_pdfs_20_35_10[ctr_0] =
              forceTerm_5 - xi_190 + xi_192 - xi_194 + xi_199 + xi_200 + xi_271;
          _data_pdfs_20_36_10[ctr_0] =
          ...
          _data_pdfs_20_311_10[ctr_0] =
              forceTerm_11 + xi_230 + xi_242 + xi_247 + xi_283;
          _data_pdfs_20_312_10[ctr_0] =
              forceTerm_12 + xi_242 + xi_248 + xi_249 + xi_278;
          _data_pdfs_20_313_10[ctr_0] =
              forceTerm_13 + xi_254 + xi_257 + xi_262 + xi_275;
          _data_pdfs_20_314_10[ctr_0] =
              forceTerm_14 + xi_254 + xi_263 + xi_264 + xi_272;
          _data_pdfs_20_315_10[ctr_0] =
              forceTerm_15 + xi_247 + xi_249 + xi_266 + xi_277;
          _data_pdfs_20_316_10[ctr_0] =
              forceTerm_16 + xi_230 + xi_248 + xi_266 + xi_276;
          _data_pdfs_20_317_10[ctr_0] =
              forceTerm_17 + xi_262 + xi_263 + xi_267 + xi_287;
          _data_pdfs_20_318_10[ctr_0] =
              forceTerm_18 + xi_257 + xi_264 + xi_267 + xi_273;
        }
      }
    }
  }
