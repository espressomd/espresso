...
#include "ReactionKernelBulk_2.h"
...
namespace internal_reactionkernelbulk_2_reactionkernelbulk_2 {
static FUNC_PREFIX void reactionkernelbulk_2_reactionkernelbulk_2(
...
void ReactionKernelBulk_2::run(IBlock *block) {
  ...
  internal_reactionkernelbulk_2_reactionkernelbulk_2::
      reactionkernelbulk_2_reactionkernelbulk_2(
...
void ReactionKernelBulk_2::runOnCellInterval(
