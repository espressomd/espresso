  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        const float xi_268 = _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0];
        const float xi_269 = _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0];
        const float xi_270 = _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0];
        const float xi_271 = _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0];
        const float xi_272 = _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0];
        const float xi_273 = _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0];
        const float xi_274 = _data_force_20_30_10[_stride_force_0 * ctr_0];
        const float xi_275 = _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0];
        const float xi_276 = _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0];
        const float xi_277 = _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0];
        const float xi_278 = _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0];
        const float xi_279 = _data_force_20_31_10[_stride_force_0 * ctr_0];
        const float xi_280 = _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0];
        const float xi_281 = _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0];
        const float xi_282 = _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0];
        const float xi_283 = _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0];
        const float xi_284 = _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0];
        const float xi_285 = _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0];
        const float xi_286 = _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0];
        const float xi_287 = _data_force_20_32_10[_stride_force_0 * ctr_0];
        ...
        const float xi_118 =
            omega_even *
            (xi_114 + xi_117 + xi_270 * -5.0f + xi_278 * -5.0f +
             xi_280 * -5.0f + xi_284 * -5.0f + xi_288 * -2.0f + xi_289 * -2.0f);
        ...
        const float xi_132 =
            ...
            (xi_113 + xi_117 + xi_129 + xi_130 + xi_131 + xi_269 * -7.0f +
             xi_272 * -7.0f + xi_273 * -7.0f + xi_277 * -4.0f + xi_281 * -4.0f +
             xi_282 * -7.0f + xi_288 * 5.0f + xi_289 * 5.0f);
        ...
        const float xi_256 = xi_216 * (u_2 * xi_173 + xi_11 + xi_176 + xi_278);
