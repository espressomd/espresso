...
namespace internal_collidesweepthermalized {
static FUNC_PREFIX void collidesweepthermalized(
  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        const double xi_248 = _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0];
        const double xi_249 = _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0];
        const double xi_250 = _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_253 = _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0];
        const double xi_254 = _data_force_20_31_10[_stride_force_0 * ctr_0];
        const double xi_255 = _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0];
        const double xi_256 = _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0];
        const double xi_257 = _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0];
        const double xi_258 = _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0];
        const double xi_259 = _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0];
        const double xi_260 = _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0];
        const double xi_261 = _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0];
        const double xi_262 = _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0];
        const double xi_263 = _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0];
        const double xi_264 = _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0];
        const double xi_265 = _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0];
        const double xi_266 = _data_force_20_30_10[_stride_force_0 * ctr_0];
        const double xi_267 = _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0];
        const double xi_268 = _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_0 = xi_255 + xi_258;
        const double xi_1 = xi_0 + xi_260;
        const double xi_2 = xi_253 + xi_264 + xi_267;
        const double xi_3 = xi_257 + xi_263;
        const double xi_4 = xi_261 + xi_262;
        const double xi_5 = xi_259 + xi_268;
        const double xi_6 = xi_252 + xi_256;
        const double xi_8 = -xi_261;
        const double xi_9 = -xi_248 + xi_8;
        const double xi_10 = -xi_256;
        const double xi_11 = -xi_265;
        const double xi_12 = -xi_262;
        const double xi_13 = xi_10 + xi_11 + xi_12;
        const double xi_14 = -xi_268;
        const double xi_15 = -xi_269;
        const double xi_16 = xi_14 + xi_15;
        const double xi_17 = -xi_259;
        const double xi_18 = -xi_257;
        const double xi_19 = xi_17 + xi_18;
        const double xi_20 = -xi_255;
        const double xi_21 = xi_10 + xi_20;
        const double xi_22 = -xi_267;
        const double xi_23 = -xi_252;
        const double xi_24 = xi_17 + xi_22 + xi_23 + xi_253;
        const double xi_42 = xi_254 * 0.166666666666667;
        const double xi_50 = xi_266 * 0.166666666666667;
        const double xi_54 = xi_251 * 0.166666666666667;
        const double xi_57 = xi_254 * 0.5;
        const double xi_61 = xi_266 * 0.0833333333333333;
        const double xi_65 = xi_254 * 0.0833333333333333;
        const double xi_75 = xi_251 * 0.0833333333333333;
        const double xi_93 = -xi_250;
        const double xi_94 = xi_252 * 3.0 + xi_263 * 3.0 + xi_93;
        const double xi_95 =
            omega_even * (xi_253 * -3.0 + xi_257 * -3.0 + xi_259 * -3.0 +
                          xi_264 * 3.0 + xi_267 * -3.0 + xi_268 * 3.0 + xi_94);
        const double xi_96 =
            xi_253 * 2.0 + xi_257 * 2.0 + xi_259 * 2.0 + xi_267 * 2.0;
        const double xi_97 = xi_260 * 5.0 + xi_262 * 5.0 + xi_96;
        const double xi_98 =
            omega_even *
            (xi_255 * -5.0 + xi_256 * -5.0 + xi_258 * -5.0 + xi_264 * -2.0 +
             xi_265 * -5.0 + xi_268 * -2.0 + xi_94 + xi_97);
        const double xi_101 = -xi_253;
        const double xi_102 = xi_101 + xi_18;
        const double xi_103 = -xi_249;
        const double xi_106 = -xi_258;
        const double xi_107 = xi_106 + xi_11 + xi_15 + xi_21;
        const double xi_109 = xi_265 * 2.0;
        const double xi_110 = xi_258 * 2.0;
        const double xi_111 = xi_255 * 2.0 + xi_256 * 2.0;
        const double xi_112 =
            omega_even *
            (xi_109 + xi_110 + xi_111 + xi_248 * -7.0 + xi_249 * -7.0 +
             xi_252 * -4.0 + xi_261 * -7.0 + xi_263 * -4.0 + xi_264 * 5.0 +
             xi_268 * 5.0 + xi_269 * -7.0 + xi_93 + xi_97);
        const double xi_113 = xi_101 + xi_257;
        const double xi_114 = xi_113 + xi_14 + xi_22 + xi_259 + xi_264;
        const double xi_116 = xi_114 * xi_115;
        const double xi_118 = xi_103 + xi_269;
        const double xi_122 = random_5_1 - 0.5;
        const double xi_127 = xi_248 * 2.0;
        const double xi_128 = xi_269 * 2.0;
        const double xi_129 = xi_249 * -2.0 + xi_261 * 2.0;
        ...
        const double xi_142 = xi_256 + xi_265;
        const double xi_156 = xi_106 + xi_265;
        const double xi_157 = xi_12 + xi_156 + xi_20 + xi_256 + xi_260;
        ...
        const double xi_168 = xi_259 + xi_267;
        const double xi_169 = xi_102 + xi_168 + xi_23 + xi_263;
        ...
        const double vel0Term = xi_1 + xi_249 + xi_269;
        const double vel1Term = xi_2 + xi_248;
        const double vel2Term = xi_265 + xi_3;
        const double rho =
            vel0Term + vel1Term + vel2Term + xi_250 + xi_4 + xi_5 + xi_6;
        ...
        const double xi_154 = -vel0Term + xi_142 + xi_153 + xi_248 + xi_4;
        const double xi_155 = xi_120 * xi_154;
        const double xi_191 = xi_154 * xi_186;
        const double u_1 = xi_7 * (vel1Term + xi_16 + xi_19 + xi_249 + xi_8);
        ...
        const double xi_108 = omega_bulk * (xi_100 + xi_102 + xi_105 + xi_107 +
                                            xi_17 + xi_22 + xi_250 + xi_99);
        const double xi_143 = -xi_100 + xi_252 + xi_263;
        const double xi_144 =
            omega_shear * (xi_0 + xi_105 + xi_142 + xi_143 + xi_16 - xi_264);
        const double xi_145 = xi_144 * 0.125;
        const double xi_147 =
            omega_shear *
            (xi_103 - xi_104 + xi_107 + xi_143 + xi_260 * -2.0 + xi_262 * -2.0 +
             xi_264 + xi_268 + xi_9 + xi_96 + xi_99 * 2.0);
        const double xi_149 =
        ...
        const double xi_171 =
            rho * u_2 - vel2Term + xi_101 + xi_106 + xi_168 + xi_255 + xi_6;
        ...
        const double xi_206 = xi_196 * (u_2 * xi_117 + xi_113 + xi_17 + xi_267);
        const double xi_210 =
        ...
        const double xi_236 = xi_196 * (u_2 * xi_153 + xi_10 + xi_156 + xi_255);
        ...
        _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_0 + xi_108 * -0.5 + xi_112 * 0.0238095238095238 + xi_250 +
        ...
        _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_1 - xi_116 + xi_121 - xi_126 + xi_137 + xi_151 + xi_264;
        _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_2 + xi_116 - xi_121 + xi_126 + xi_151 + xi_152 + xi_268;
        _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_3 - xi_155 + xi_158 + xi_160 + xi_165 + xi_166 + xi_262;
        ...
        _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_5 - xi_170 + xi_172 - xi_174 + xi_179 + xi_180 + xi_263;
        ...
        _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_7 + xi_190 + xi_194 + xi_198 + xi_248;
        _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_8 + xi_190 + xi_199 + xi_201 + xi_249;
        _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_9 + xi_194 + xi_199 + xi_203 + xi_261;
        _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_10 + xi_198 + xi_201 + xi_203 + xi_269;
        _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_11 + xi_210 + xi_222 + xi_227 + xi_253;
        _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_12 + xi_222 + xi_228 + xi_229 + xi_257;
        _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_13 + xi_234 + xi_237 + xi_242 + xi_265;
        _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_14 + xi_234 + xi_243 + xi_244 + xi_258;
        _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_15 + xi_227 + xi_229 + xi_246 + xi_267;
        _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_16 + xi_210 + xi_228 + xi_246 + xi_259;
        _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_17 + xi_242 + xi_243 + xi_247 + xi_256;
        _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_18 + xi_237 + xi_244 + xi_247 + xi_255;
      }
    }
  }
}
...
void CollideSweepThermalized::operator()(IBlock *block) {
  ...
  internal_collidesweepthermalized::collidesweepthermalized(
