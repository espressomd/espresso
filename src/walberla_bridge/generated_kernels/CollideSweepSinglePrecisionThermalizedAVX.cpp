    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_34;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (8)) * (8);
             ctr_0 += 8) {
          const __m256 xi_268 = _mm256_load_ps(&_data_pdfs_20_38_10[ctr_0]);
          const __m256 xi_269 = _mm256_load_ps(&_data_pdfs_20_316_10[ctr_0]);
          const __m256 xi_270 = _mm256_load_ps(&_data_pdfs_20_315_10[ctr_0]);
          const __m256 xi_271 = _mm256_load_ps(&_data_pdfs_20_35_10[ctr_0]);
          const __m256 xi_272 = _mm256_load_ps(&_data_pdfs_20_31_10[ctr_0]);
          const __m256 xi_273 = _mm256_load_ps(&_data_pdfs_20_39_10[ctr_0]);
          const __m256 xi_274 = _mm256_load_ps(&_data_pdfs_20_317_10[ctr_0]);
          const __m256 xi_275 = _mm256_load_ps(&_data_pdfs_20_36_10[ctr_0]);
          ...
          const __m256 xi_278 = _mm256_load_ps(&_data_pdfs_20_32_10[ctr_0]);
          ...
          const __m256 xi_281 = _mm256_load_ps(&_data_pdfs_20_314_10[ctr_0]);
          const __m256 xi_282 = _mm256_load_ps(&_data_pdfs_20_311_10[ctr_0]);
          ...
          const __m256 xi_286 = _mm256_load_ps(&_data_pdfs_20_30_10[ctr_0]);
          const __m256 xi_287 = _mm256_load_ps(&_data_pdfs_20_310_10[ctr_0]);
          const __m256 xi_288 = _mm256_load_ps(&_data_pdfs_20_37_10[ctr_0]);
          const __m256 xi_289 = _mm256_load_ps(&_data_pdfs_20_34_10[ctr_0]);
          ...
          const __m256 xi_0 = _mm256_add_ps(xi_279, xi_281);
          const __m256 xi_1 = _mm256_add_ps(xi_0, xi_289);
          const __m256 xi_2 =
              _mm256_add_ps(_mm256_add_ps(xi_270, xi_272), xi_282);
          const __m256 xi_3 = _mm256_add_ps(xi_271, xi_285);
          const __m256 xi_4 = _mm256_add_ps(xi_273, xi_280);
          const __m256 xi_5 = _mm256_add_ps(xi_269, xi_278);
          const __m256 xi_6 = _mm256_add_ps(xi_274, xi_275);
          const __m256 xi_9 =
          ...
          const __m256 xi_25 = _mm256_add_ps(
              _mm256_add_ps(_mm256_add_ps(xi_18, xi_23), xi_24), xi_282);
          ...
          const __m256 xi_114 = _mm256_add_ps(
              _mm256_add_ps(
                  _mm256_mul_ps(xi_271, _mm256_set_ps(3.0f, 3.0f, 3.0f, 3.0f,
                                                      3.0f, 3.0f, 3.0f, 3.0f)),
                  _mm256_mul_ps(xi_275, _mm256_set_ps(3.0f, 3.0f, 3.0f, 3.0f,
                                                      3.0f, 3.0f, 3.0f, 3.0f))),
              xi_113);
                                  ...
                                  _mm256_add_ps(
                                      ...
                                      _mm256_mul_ps(
                                          ...
                                          _mm256_set_ps(-5.0f, -5.0f, -5.0f,
                                                        ...
                                                        -5.0f, -5.0f))),
                                  _mm256_mul_ps(
                                      xi_278, _mm256_set_ps(-2.0f, -2.0f, -2.0f,
                                                            -2.0f, -2.0f, -2.0f,
                                                            -2.0f, -2.0f))),
                              _mm256_mul_ps(xi_279,
                                            _mm256_set_ps(-5.0f, -5.0f, -5.0f,
                                                          -5.0f, -5.0f, -5.0f,
                                                          -5.0f, -5.0f))),
          ...
          const __m256 xi_149 = _mm256_add_ps(
              _mm256_mul_ps(xi_268, _mm256_set_ps(-2.0f, -2.0f, -2.0f, -2.0f,
                                                  -2.0f, -2.0f, -2.0f, -2.0f)),
          ...
          const __m256 xi_158 = _mm256_add_ps(
              random_0_1, _mm256_set_ps(-0.5f, -0.5f, -0.5f, -0.5f, -0.5f,
                                        -0.5f, -0.5f, -0.5f));
          const __m256 xi_162 = _mm256_add_ps(xi_274, xi_276);
          ...
          const __m256 xi_183 = _mm256_add_ps(
              random_2_0, _mm256_set_ps(-0.5f, -0.5f, -0.5f, -0.5f, -0.5f,
                                        -0.5f, -0.5f, -0.5f));
          const __m256 xi_188 = _mm256_add_ps(xi_269, xi_270);
          const __m256 xi_189 = _mm256_add_ps(
              _mm256_add_ps(_mm256_add_ps(xi_122, xi_188), xi_24), xi_271);
          ...
          const __m256 vel0Term =
              _mm256_add_ps(_mm256_add_ps(xi_1, xi_268), xi_287);
          const __m256 vel1Term = _mm256_add_ps(xi_2, xi_288);
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (8)) * (8);
          ...
          const float xi_268 = _data_pdfs_20_38_10[ctr_0];
          const float xi_269 = _data_pdfs_20_316_10[ctr_0];
          const float xi_270 = _data_pdfs_20_315_10[ctr_0];
          const float xi_271 = _data_pdfs_20_35_10[ctr_0];
          const float xi_272 = _data_pdfs_20_31_10[ctr_0];
          const float xi_273 = _data_pdfs_20_39_10[ctr_0];
          const float xi_274 = _data_pdfs_20_317_10[ctr_0];
          const float xi_275 = _data_pdfs_20_36_10[ctr_0];
          const float xi_276 = _data_pdfs_20_313_10[ctr_0];
          const float xi_277 = _data_force_20_30_10[ctr_0];
          const float xi_278 = _data_pdfs_20_32_10[ctr_0];
          const float xi_279 = _data_pdfs_20_318_10[ctr_0];
          const float xi_280 = _data_pdfs_20_33_10[ctr_0];
          const float xi_281 = _data_pdfs_20_314_10[ctr_0];
          const float xi_282 = _data_pdfs_20_311_10[ctr_0];
          ...
          const float xi_286 = _data_pdfs_20_30_10[ctr_0];
          const float xi_287 = _data_pdfs_20_310_10[ctr_0];
          const float xi_288 = _data_pdfs_20_37_10[ctr_0];
          const float xi_289 = _data_pdfs_20_34_10[ctr_0];
          ...
          const float xi_0 = xi_279 + xi_281;
          const float xi_1 = xi_0 + xi_289;
          const float xi_2 = xi_270 + xi_272 + xi_282;
          const float xi_3 = xi_271 + xi_285;
          const float xi_4 = xi_273 + xi_280;
          const float xi_5 = xi_269 + xi_278;
          const float xi_6 = xi_274 + xi_275;
          const float xi_9 = -xi_273;
          const float xi_10 = -xi_288 + xi_9;
          const float xi_11 = -xi_274;
          ...
          const float xi_23 = -xi_270;
          const float xi_24 = -xi_275;
          const float xi_25 = xi_18 + xi_23 + xi_24 + xi_282;
          ...
          const float xi_113 = -xi_286;
          const float xi_114 = xi_113 + xi_271 * 3.0f + xi_275 * 3.0f;
          const float xi_115 =
              omega_even *
              (xi_114 + xi_269 * -3.0f + xi_270 * -3.0f + xi_272 * 3.0f +
               xi_278 * 3.0f + xi_282 * -3.0f + xi_285 * -3.0f);
          const float xi_116 =
              xi_269 * 2.0f + xi_270 * 2.0f + xi_282 * 2.0f + xi_285 * 2.0f;
          const float xi_117 = xi_116 + xi_280 * 5.0f + xi_289 * 5.0f;
          const float xi_118 =
              omega_even * (xi_114 + xi_117 + xi_272 * -2.0f + xi_274 * -5.0f +
                            xi_276 * -5.0f + xi_278 * -2.0f + xi_279 * -5.0f +
                            xi_281 * -5.0f);
          const float xi_121 = -xi_282;
          const float xi_122 = xi_121 + xi_19;
          const float xi_123 = -xi_268;
          const float xi_126 = -xi_281;
          const float xi_127 = xi_12 + xi_126 + xi_16 + xi_22;
          const float xi_129 = xi_276 * 2.0f;
          const float xi_130 = xi_281 * 2.0f;
          const float xi_131 = xi_274 * 2.0f + xi_279 * 2.0f;
          const float xi_132 =
              omega_even * (xi_113 + xi_117 + xi_129 + xi_130 + xi_131 +
                            xi_268 * -7.0f + xi_271 * -4.0f + xi_272 * 5.0f +
                            xi_273 * -7.0f + xi_275 * -4.0f + xi_278 * 5.0f +
                            xi_287 * -7.0f + xi_288 * -7.0f);
          const float xi_133 = xi_121 + xi_285;
          const float xi_134 = xi_133 + xi_15 + xi_23 + xi_269 + xi_272;
          const float xi_136 = xi_134 * xi_135;
          const float xi_138 = xi_123 + xi_287;
          const float xi_142 = random_2_3 - 0.5f;
          const float xi_147 = xi_288 * 2.0f;
          const float xi_148 = xi_287 * 2.0f;
          const float xi_149 = xi_268 * -2.0f + xi_273 * 2.0f;
          ...
          const float xi_162 = xi_274 + xi_276;
          const float xi_176 = xi_126 + xi_276;
          const float xi_177 = xi_13 + xi_176 + xi_21 + xi_274 + xi_289;
          ...
          const float xi_188 = xi_269 + xi_270;
          const float xi_189 = xi_122 + xi_188 + xi_24 + xi_271;
          ...
          const float vel0Term = xi_1 + xi_268 + xi_287;
          const float vel1Term = xi_2 + xi_288;
          const float vel2Term = xi_276 + xi_3;
          const float rho =
              vel0Term + vel1Term + vel2Term + xi_286 + xi_4 + xi_5 + xi_6;
          ...
          const float xi_174 = -vel0Term + xi_162 + xi_173 + xi_288 + xi_4;
          const float xi_175 = xi_140 * xi_174;
          const float xi_211 = xi_174 * xi_206;
          const float u_1 =
              xi_283 * xi_8 + xi_7 * (vel1Term + xi_17 + xi_20 + xi_268 + xi_9);
          ...
          const float xi_139 =
              -vel1Term + xi_137 + xi_138 + xi_273 + xi_285 + xi_5;
          const float xi_141 = xi_139 * xi_140;
          const float xi_207 = xi_139 * xi_206;
          const float xi_217 = xi_216 * (u_0 * xi_137 + xi_138 + xi_288 + xi_9);
          const float xi_218 = -xi_215 - xi_217;
          const float xi_219 = xi_215 + xi_217;
          const float u_2 =
              xi_284 * xi_8 + xi_7 * (vel2Term + xi_22 + xi_25 + xi_281);
          ...
          const float xi_128 = omega_bulk * (xi_119 + xi_120 + xi_122 + xi_125 +
                                             xi_127 + xi_18 + xi_23 + xi_286);
          const float xi_163 = -xi_120 + xi_271 + xi_275;
          const float xi_164 =
          ...
          const float xi_167 =
              ...
              (xi_10 + xi_116 + xi_119 * 2.0f + xi_123 - xi_124 + xi_127 +
               xi_163 + xi_272 + xi_278 + xi_280 * -2.0f + xi_289 * -2.0f);
          const float xi_169 =
          ...
          _data_pdfs_20_30_10[ctr_0] =
              ...
              xi_132 * 0.0238095238095238f + xi_286;
          _data_pdfs_20_31_10[ctr_0] =
          ...
          _data_pdfs_20_36_10[ctr_0] =
              forceTerm_6 + xi_190 - xi_192 + xi_194 + xi_200 + xi_201 + xi_275;
          _data_pdfs_20_37_10[ctr_0] =
              forceTerm_7 + xi_210 + xi_214 + xi_218 + xi_288;
          _data_pdfs_20_38_10[ctr_0] =
              forceTerm_8 + xi_210 + xi_219 + xi_221 + xi_268;
          _data_pdfs_20_39_10[ctr_0] =
              forceTerm_9 + xi_214 + xi_219 + xi_223 + xi_273;
          _data_pdfs_20_310_10[ctr_0] =
              forceTerm_10 + xi_218 + xi_221 + xi_223 + xi_287;
          _data_pdfs_20_311_10[ctr_0] =
              forceTerm_11 + xi_230 + xi_242 + xi_247 + xi_282;
          _data_pdfs_20_312_10[ctr_0] =
          ...
          _data_pdfs_20_317_10[ctr_0] =
              forceTerm_17 + xi_262 + xi_263 + xi_267 + xi_274;
          _data_pdfs_20_318_10[ctr_0] =
