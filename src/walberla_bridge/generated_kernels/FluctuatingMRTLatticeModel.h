...
namespace walberla{
namespace lbm {
   class FluctuatingMRTLatticeModel;
}}
namespace walberla {
namespace mpi {
...
/**
FluctuatingMRTLatticeModel was generated with lbmpy. Do not edit this file directly. Instead modify FluctuatingMRTLatticeModel.py.
...
Usage:
    ...
    - The internal class FluctuatingMRTLatticeModel::Sweep is a functor to execute one LB time step.
...
public:
    ...
    FluctuatingMRTLatticeModel( BlockDataID forceID_, double kT, double omega_bulk, double omega_even, double omega_odd, double omega_shear, uint32_t seed, uint32_t time_step )
...
private:
    ...
    friend class FluctuatingMRTLatticeModel::Sweep;
    ...
    friend mpi::SendBuffer & ::walberla::mpi::operator<< (mpi::SendBuffer & , const FluctuatingMRTLatticeModel & );
    friend mpi::RecvBuffer & ::walberla::mpi::operator>> (mpi::RecvBuffer & ,       FluctuatingMRTLatticeModel & );
...
template<>
class EquilibriumDistribution< FluctuatingMRTLatticeModel, void>
{
public:
   typedef typename FluctuatingMRTLatticeModel::Stencil Stencil;
...
template<>
struct AdaptVelocityToForce<FluctuatingMRTLatticeModel, void>
{
   template< typename FieldPtrOrIterator >
   static Vector3<real_t> get( FieldPtrOrIterator & it, const FluctuatingMRTLatticeModel & lm,
   ...
   static Vector3<real_t> get( const cell_idx_t x, const cell_idx_t y, const cell_idx_t z, const FluctuatingMRTLatticeModel & lm,
                               const Vector3< real_t > & velocity, const real_t rho )
   {
...
template<>
struct Equilibrium< FluctuatingMRTLatticeModel, void >
{
...
template<>
struct Density<FluctuatingMRTLatticeModel, void>
{
   template< typename FieldPtrOrIterator >
   static inline real_t get( const FluctuatingMRTLatticeModel & , const FieldPtrOrIterator & it )
   {
   ...
   template< typename PdfField_T >
   static inline real_t get( const FluctuatingMRTLatticeModel & ,
...
template<>
struct DensityAndVelocity<FluctuatingMRTLatticeModel>
{
    template< typename FieldPtrOrIterator >
    static void set( FieldPtrOrIterator & it, const FluctuatingMRTLatticeModel & lm,
                     const Vector3< real_t > & u = Vector3< real_t >( real_t(0.0) ), const real_t rho_in = real_t(1.0) )
    {
        ...
        Equilibrium<FluctuatingMRTLatticeModel>::set(it, Vector3<real_t>(u_0, u_1, u_2), rho);
    }

    template< typename PdfField_T >
    static void set( PdfField_T & pdf, const cell_idx_t x, const cell_idx_t y, const cell_idx_t z, const FluctuatingMRTLatticeModel & lm,
                     const Vector3< real_t > & u = Vector3< real_t >( real_t(0.0) ), const real_t rho_in = real_t(1.0) )
    {
        const double rho = rho_in;
        const double u_0 = -0.5*lm.force_->get(x,y,z,0)/rho_in + u[0];
        ...
        Equilibrium<FluctuatingMRTLatticeModel>::set(pdf, x, y, z, Vector3<real_t>(u_0, u_1, u_2), rho );
    }
};


template<typename FieldIteratorXYZ >
struct DensityAndVelocityRange<FluctuatingMRTLatticeModel, FieldIteratorXYZ>
{

   static void set( FieldIteratorXYZ & begin, const FieldIteratorXYZ & end, const FluctuatingMRTLatticeModel & lm,
                    const Vector3< real_t > & u = Vector3< real_t >( real_t(0.0) ), const real_t rho_in = real_t(1.0) )
   {
        for( auto cellIt = begin; cellIt != end; ++cellIt )
        {
            ...
            Equilibrium<FluctuatingMRTLatticeModel>::set(cellIt, Vector3<real_t>(u_0, u_1, u_2), rho);
        }
   }
};
...
template<>
struct DensityAndMomentumDensity<FluctuatingMRTLatticeModel>
{
   template< typename FieldPtrOrIterator >
   static real_t get( Vector3< real_t > & momentumDensity, const FluctuatingMRTLatticeModel & lm,
   ...
   template< typename PdfField_T >
   static real_t get( Vector3< real_t > & momentumDensity, const FluctuatingMRTLatticeModel & lm, const PdfField_T & pdf,
...
template<>
struct MomentumDensity< FluctuatingMRTLatticeModel>
{
   template< typename FieldPtrOrIterator >
   static void get( Vector3< real_t > & momentumDensity, const FluctuatingMRTLatticeModel & lm, const FieldPtrOrIterator & it )
   {
        const auto x = it.x();
        const auto y = it.y();
        const auto z = it.z();
   ...
   template< typename PdfField_T >
   static void get( Vector3< real_t > & momentumDensity, const FluctuatingMRTLatticeModel & lm, const PdfField_T & pdf,
                    const cell_idx_t x, const cell_idx_t y, const cell_idx_t z )
   {
        const real_t & xyz0 = pdf(x,y,z,0);
        const real_t f_0 = pdf.getF( &xyz0, 0);
...
template<>
struct PressureTensor<FluctuatingMRTLatticeModel>
{
   template< typename FieldPtrOrIterator >
   static void get( Matrix3< real_t > & /* pressureTensor */, const FluctuatingMRTLatticeModel & /* latticeModel */, const FieldPtrOrIterator & /* it */ )
   {
       WALBERLA_ABORT("Not implemented");
   }

   template< typename PdfField_T >
   static void get( Matrix3< real_t > & /* pressureTensor */, const FluctuatingMRTLatticeModel & /* latticeModel */, const PdfField_T & /* pdf */,
                    const cell_idx_t /* x */, const cell_idx_t /* y */, const cell_idx_t /* z */ )
   {
       WALBERLA_ABORT("Not implemented");
   }
...
template<>
struct ShearRate<FluctuatingMRTLatticeModel>
{
   template< typename FieldPtrOrIterator >
   static inline real_t get( const FluctuatingMRTLatticeModel & /* latticeModel */, const FieldPtrOrIterator & /* it */,
                             const Vector3< real_t > & /* velocity */, const real_t /* rho */)
   {
       WALBERLA_ABORT("Not implemented");
       return real_t(0.0);
   ...
   template< typename PdfField_T >
   static inline real_t get( const FluctuatingMRTLatticeModel & latticeModel,
                             const PdfField_T & /* pdf */, const cell_idx_t /* x */, const cell_idx_t /* y */, const cell_idx_t /* z */,
                             const Vector3< real_t > & /* velocity */, const real_t /* rho */ )
   {
       WALBERLA_ABORT("Not implemented");
