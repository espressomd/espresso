...
/**
FluctuatingMRTLatticeModel was generated with lbmpy. Do not edit this file
directly. Instead modify FluctuatingMRTLatticeModel.py. For details see
documentation of lbmpy.
...
values.
    - The internal class FluctuatingMRTLatticeModel::Sweep is a functor to
execute one LB time step. Stream, collide steps can be executed separately, or
together in an optimized stream-pull-collide scheme
...
public:
  ...
  FluctuatingMRTLatticeModel(BlockDataID forceID_, double kT, double omega_bulk,
                             double omega_even, double omega_odd,
                             double omega_shear, uint32_t seed,
                             uint32_t time_step)
      : forceID(forceID_), kT_(kT), omega_bulk_(omega_bulk),
...
private:
  ...
  friend mpi::SendBuffer & ::walberla::mpi::operator<<(
      mpi::SendBuffer &, const FluctuatingMRTLatticeModel &);
  friend mpi::RecvBuffer & ::walberla::mpi::operator>>(
      mpi::RecvBuffer &, FluctuatingMRTLatticeModel &);
};
...
template <> class EquilibriumDistribution<FluctuatingMRTLatticeModel, void> {
public:
...
template <> struct AdaptVelocityToForce<FluctuatingMRTLatticeModel, void> {
  template <typename FieldPtrOrIterator>
  static Vector3<real_t>
  get(FieldPtrOrIterator &it, const FluctuatingMRTLatticeModel &lm,
  ...
  static Vector3<real_t> get(const cell_idx_t x, const cell_idx_t y,
                             const cell_idx_t z,
                             const FluctuatingMRTLatticeModel &lm,
...
template <> struct Equilibrium<FluctuatingMRTLatticeModel, void> {
...
template <> struct Density<FluctuatingMRTLatticeModel, void> {
  template <typename FieldPtrOrIterator>
...
template <> struct DensityAndVelocity<FluctuatingMRTLatticeModel> {
  template <typename FieldPtrOrIterator>
  static void set(FieldPtrOrIterator &it, const FluctuatingMRTLatticeModel &lm,
    ...
    Equilibrium<FluctuatingMRTLatticeModel>::set(
        it, Vector3<real_t>(u_0, u_1, u_2), rho);
  }

  template <typename PdfField_T>
  static void set(PdfField_T &pdf, const cell_idx_t x, const cell_idx_t y,
                  const cell_idx_t z, const FluctuatingMRTLatticeModel &lm,
                  const Vector3<real_t> &u = Vector3<real_t>(real_t(0.0)),
                  const real_t rho_in = real_t(1.0)) {
    const double rho = rho_in;
    const double u_0 = -0.5 * lm.force_->get(x, y, z, 0) / rho_in + u[0];
...
template <> struct DensityAndMomentumDensity<FluctuatingMRTLatticeModel> {
  template <typename FieldPtrOrIterator>
  ...
  template <typename PdfField_T>
  static real_t get(Vector3<real_t> &momentumDensity,
                    const FluctuatingMRTLatticeModel &lm, const PdfField_T &pdf,
...
template <> struct MomentumDensity<FluctuatingMRTLatticeModel> {
  template <typename FieldPtrOrIterator>
...
template <> struct PressureTensor<FluctuatingMRTLatticeModel> {
  template <typename FieldPtrOrIterator>
  static void get(Matrix3<real_t> & /* pressureTensor */,
                  const FluctuatingMRTLatticeModel & /* latticeModel */,
                  const FieldPtrOrIterator & /* it */) {
...
template <> struct ShearRate<FluctuatingMRTLatticeModel> {
  template <typename FieldPtrOrIterator>
  static inline real_t
  get(const FluctuatingMRTLatticeModel & /* latticeModel */,
      const FieldPtrOrIterator & /* it */,
      const Vector3<real_t> & /* velocity */, const real_t /* rho */) {
    WALBERLA_ABORT("Not implemented");
    return real_t(0.0);
