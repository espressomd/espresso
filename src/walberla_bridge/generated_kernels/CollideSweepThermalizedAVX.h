...
public:
  CollideSweepThermalizedAVX(BlockDataID forceID_, BlockDataID pdfsID_,
                             uint32_t block_offset_0, uint32_t block_offset_1,
                             uint32_t block_offset_2, double kT,
  ...
  getSweep(const shared_ptr<CollideSweepThermalizedAVX> &kernel) {
