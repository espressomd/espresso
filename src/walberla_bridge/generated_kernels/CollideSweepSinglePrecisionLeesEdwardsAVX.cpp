    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
          ...
          _stride_pdfs_1 * ctr_1 + _data_pdfs_20_312;
      {
        for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((_size_force_0) / (8)) * (8);
             ctr_0 += 8) {
          const __m256 xi_25 = _mm256_load_ps(&_data_pdfs_20_38_10[ctr_0]);
          const __m256 xi_26 = _mm256_load_ps(&_data_pdfs_20_318_10[ctr_0]);
          const __m256 xi_27 = _mm256_load_ps(&_data_pdfs_20_36_10[ctr_0]);
          const __m256 xi_28 = _mm256_load_ps(&_data_force_20_32_10[ctr_0]);
          const __m256 xi_29 = _mm256_load_ps(&_data_pdfs_20_31_10[ctr_0]);
          const __m256 xi_30 = _mm256_load_ps(&_data_pdfs_20_313_10[ctr_0]);
          ...
          const __m256 xi_35 = _mm256_load_ps(&_data_pdfs_20_311_10[ctr_0]);
          const __m256 xi_36 = _mm256_load_ps(&_data_pdfs_20_33_10[ctr_0]);
          const __m256 xi_37 = _mm256_load_ps(&_data_pdfs_20_317_10[ctr_0]);
          const __m256 xi_38 = _mm256_load_ps(&_data_pdfs_20_315_10[ctr_0]);
          const __m256 xi_39 = _mm256_load_ps(&_data_force_20_30_10[ctr_0]);
          const __m256 xi_40 = _mm256_load_ps(&_data_pdfs_20_39_10[ctr_0]);
          const __m256 xi_41 = _mm256_load_ps(&_data_pdfs_20_37_10[ctr_0]);
          const __m256 xi_42 = _mm256_load_ps(&_data_pdfs_20_316_10[ctr_0]);
          const __m256 xi_43 = _mm256_load_ps(&_data_pdfs_20_35_10[ctr_0]);
          const __m256 xi_44 = _mm256_load_ps(&_data_pdfs_20_30_10[ctr_0]);
          const __m256 xi_45 = _mm256_load_ps(&_data_force_20_31_10[ctr_0]);
          const __m256 xi_46 = _mm256_load_ps(&_data_pdfs_20_312_10[ctr_0]);
          ...
          const __m256 vel0Term = _mm256_add_ps(
              _mm256_add_ps(_mm256_add_ps(_mm256_add_ps(xi_10, xi_12), xi_3),
                            xi_4),
              xi_9);
          const __m256 vel1Term = _mm256_add_ps(
              _mm256_add_ps(_mm256_add_ps(xi_13, xi_16), xi_19), xi_7);
          const __m256 vel2Term =
              _mm256_add_ps(_mm256_add_ps(xi_21, xi_24), xi_8);
                  ...
                  _mm256_add_ps(
                      _mm256_add_ps(
                          ...
                          _mm256_mul_ps(xi_8, _mm256_set_ps(-1.0f, -1.0f, -1.0f,
                                                            ...
                                                            -1.0f, -1.0f))),
                      vel0Term)),
              _mm256_mul_ps(_mm256_mul_ps(xi_1, xi_17),
                                  ...
                                  _mm256_add_ps(
                                      ...
                                      _mm256_mul_ps(
                                          ...
                                          _mm256_set_ps(-1.0f, -1.0f, -1.0f,
                                                        ...
                                                        -1.0f, -1.0f))),
                                  _mm256_mul_ps(
                                      xi_5, _mm256_set_ps(-1.0f, -1.0f, -1.0f,
                                                          -1.0f, -1.0f, -1.0f,
                                                          -1.0f, -1.0f))),
                              vel2Term),
                          xi_12),
          ...
          const __m256 forceTerm_0 = _mm256_add_ps(
              _mm256_add_ps(
                  _mm256_add_ps(
                      _mm256_add_ps(
                          _mm256_add_ps(
                              _mm256_mul_ps(_mm256_mul_ps(u_0, xi_17),
                                            _mm256_set_ps(-1.0f, -1.0f, -1.0f,
                                                          -1.0f, -1.0f, -1.0f,
                                                          -1.0f, -1.0f)),
                          ...
                          _mm256_add_ps(
                              ...
                              _mm256_mul_ps(
                                  ...
                                  _mm256_set_ps(omega_shear, omega_shear,
                                                ...
                                                omega_shear, omega_shear))),
                          _mm256_mul_ps(
                              _mm256_mul_ps(_mm256_mul_ps(u_1, xi_17),
                                            _mm256_set_ps(0.125f, 0.125f,
                                                          0.125f, 0.125f,
                                                          0.125f, 0.125f,
                                                          0.125f, 0.125f)),
                          ...
                          _mm256_add_ps(
                              ...
                              _mm256_mul_ps(
                                  ...
                                  _mm256_set_ps(omega_shear, omega_shear,
                                                ...
                                                omega_shear, omega_shear))),
                          _mm256_mul_ps(
                              _mm256_mul_ps(_mm256_mul_ps(u_2, xi_17),
                                            _mm256_set_ps(0.125f, 0.125f,
                                                          0.125f, 0.125f,
                                                          0.125f, 0.125f,
                                                          0.125f, 0.125f)),
        ...
        for (int64_t ctr_0 = (int64_t)((_size_force_0) / (8)) * (8);
          ...
          const float xi_25 = _data_pdfs_20_38_10[ctr_0];
          const float xi_26 = _data_pdfs_20_318_10[ctr_0];
          const float xi_27 = _data_pdfs_20_36_10[ctr_0];
          const float xi_28 = _data_force_20_32_10[ctr_0];
          const float xi_29 = _data_pdfs_20_31_10[ctr_0];
          const float xi_30 = _data_pdfs_20_313_10[ctr_0];
          ...
          const float xi_35 = _data_pdfs_20_311_10[ctr_0];
          const float xi_36 = _data_pdfs_20_33_10[ctr_0];
          const float xi_37 = _data_pdfs_20_317_10[ctr_0];
          const float xi_38 = _data_pdfs_20_315_10[ctr_0];
          const float xi_39 = _data_force_20_30_10[ctr_0];
          const float xi_40 = _data_pdfs_20_39_10[ctr_0];
          const float xi_41 = _data_pdfs_20_37_10[ctr_0];
          const float xi_42 = _data_pdfs_20_316_10[ctr_0];
          const float xi_43 = _data_pdfs_20_35_10[ctr_0];
          const float xi_44 = _data_pdfs_20_30_10[ctr_0];
          const float xi_45 = _data_force_20_31_10[ctr_0];
          const float xi_46 = _data_pdfs_20_312_10[ctr_0];
          ...
          const float u_0 =
              xi_1 * xi_17 * 0.5f +
              xi_1 * (vel0Term + xi_14 * -1.0f + xi_15 * -1.0f + xi_18 * -1.0f +
                      xi_19 * -1.0f + xi_8 * -1.0f);
          const float u_1 =
              xi_1 * xi_23 * 0.5f +
          ...
          const float forceTerm_0 = omega_shear * u_0 * xi_17 * 0.5f +
                                    omega_shear * u_1 * xi_23 * 0.5f +
                                    omega_shear * u_2 * xi_6 * 0.5f +
                                    u_0 * xi_17 * -1.0f + u_1 * xi_23 * -1.0f +
                                    u_2 * xi_6 * -1.0f;
          ...
          const float forceTerm_13 =
              ...
              u_2 * xi_6 * 0.16666666666666666f +
              xi_17 * -0.083333333333333329f + xi_6 * 0.083333333333333329f;
