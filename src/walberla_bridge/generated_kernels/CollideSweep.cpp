...
namespace internal_collidesweep_collidesweep {
static FUNC_PREFIX void collidesweep_collidesweep(
  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        ...
        const double xi_200 = _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0];
        const double xi_201 = _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0];
        const double xi_202 = _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0];
        const double xi_203 = _data_force_20_32_10[_stride_force_0 * ctr_0];
        const double xi_204 = _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0];
        const double xi_205 = _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_208 = _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_212 = _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0];
        const double xi_213 = _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0];
        const double xi_214 = _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0];
        const double xi_215 = _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0];
        const double xi_216 = _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0];
        const double xi_217 = _data_pdfs_20_30_10[_stride_pdfs_0 * ctr_0];
        const double xi_218 = _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0];
        const double xi_219 = _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0];
        const double xi_0 = xi_199 + xi_219;
        const double xi_1 = xi_0 + xi_201;
        const double xi_2 = xi_198 + xi_212 + xi_216;
        const double xi_3 = xi_204 + xi_206;
        const double xi_4 = xi_209 + xi_213;
        const double xi_5 = xi_200 + xi_205;
        const double xi_6 = xi_214 + xi_215;
        const double xi_8 = -xi_209;
        const double xi_9 = -xi_202 + xi_8;
        const double xi_10 = -xi_215;
        const double xi_11 = -xi_208;
        const double xi_12 = -xi_213;
        const double xi_13 = xi_10 + xi_11 + xi_12;
        const double xi_14 = -xi_205;
        const double xi_15 = -xi_218;
        const double xi_16 = xi_14 + xi_15;
        const double xi_17 = -xi_200;
        const double xi_18 = -xi_206;
        const double xi_19 = xi_17 + xi_18;
        const double xi_20 = -xi_219;
        const double xi_21 = xi_10 + xi_20;
        const double xi_22 = -xi_212;
        const double xi_23 = -xi_214;
        const double xi_24 = xi_17 + xi_198 + xi_22 + xi_23;
        const double xi_40 = xi_207 * 0.166666666666667;
        const double xi_48 = xi_210 * 0.166666666666667;
        const double xi_52 = xi_203 * 0.166666666666667;
        const double xi_55 = xi_207 * 0.5;
        const double xi_59 = xi_210 * 0.0833333333333333;
        const double xi_63 = xi_207 * 0.0833333333333333;
        const double xi_73 = xi_203 * 0.0833333333333333;
        const double xi_84 = -xi_217;
        const double xi_85 = xi_204 * 3.0 + xi_214 * 3.0 + xi_84;
        const double xi_86 =
            omega_even * (xi_198 * -3.0 + xi_200 * -3.0 + xi_205 * 3.0 +
                          xi_206 * -3.0 + xi_212 * -3.0 + xi_216 * 3.0 + xi_85);
        const double xi_87 =
            xi_198 * 2.0 + xi_200 * 2.0 + xi_206 * 2.0 + xi_212 * 2.0;
        const double xi_88 = xi_201 * 5.0 + xi_213 * 5.0 + xi_87;
        const double xi_89 =
            omega_even *
            (xi_199 * -5.0 + xi_205 * -2.0 + xi_208 * -5.0 + xi_215 * -5.0 +
             xi_216 * -2.0 + xi_219 * -5.0 + xi_85 + xi_88);
        ...
        const double xi_100 = xi_208 * 2.0;
        const double xi_101 = xi_199 * 2.0;
        const double xi_102 = xi_215 * 2.0 + xi_219 * 2.0;
        const double xi_103 =
            omega_even *
            (xi_100 + xi_101 + xi_102 + xi_202 * -7.0 + xi_204 * -4.0 +
             xi_205 * 5.0 + xi_209 * -7.0 + xi_211 * -7.0 + xi_214 * -4.0 +
             xi_216 * 5.0 + xi_218 * -7.0 + xi_84 + xi_88);
        const double xi_104 = xi_206 + xi_92;
        const double xi_105 = xi_104 + xi_14 + xi_200 + xi_216 + xi_22;
        const double xi_107 = xi_105 * xi_106;
        const double xi_108 = xi_202 * 2.0;
        const double xi_109 = xi_218 * 2.0;
        const double xi_110 = xi_209 * 2.0 + xi_211 * -2.0;
        const double xi_111 = -xi_108 + xi_109 + xi_110 + xi_14 + xi_19 + xi_2;
        const double xi_113 = xi_111 * xi_112;
        const double xi_114 = -xi_113;
        const double xi_116 = xi_218 + xi_94;
        const double xi_120 = xi_208 + xi_215;
        const double xi_124 = xi_103 * -0.0198412698412698;
        const double xi_132 = xi_208 + xi_97;
        const double xi_133 = xi_12 + xi_132 + xi_20 + xi_201 + xi_215;
        ...
        const double xi_139 = xi_200 + xi_212;
        const double xi_140 = xi_139 + xi_204 + xi_23 + xi_93;
        ...
        const double vel0Term = xi_1 + xi_211 + xi_218;
        const double vel1Term = xi_2 + xi_202;
        const double vel2Term = xi_208 + xi_3;
        const double rho =
            vel0Term + vel1Term + vel2Term + xi_217 + xi_4 + xi_5 + xi_6;
        const double xi_7 = 1 / (rho);
        const double u_0 = xi_7 * (vel0Term + xi_13 + xi_9);
        const double xi_25 = u_0 * xi_210;
        ...
        const double xi_130 = -vel0Term + xi_120 + xi_129 + xi_202 + xi_4;
        ...
        const double xi_77 = xi_56 * (u_0 * xi_203 * 0.5 + u_2 * xi_210 * 0.5);
        ...
        const double xi_121 = xi_204 + xi_214 - xi_91;
        const double xi_122 =
            omega_shear * (xi_0 + xi_120 + xi_121 + xi_16 - xi_216 + xi_96);
        const double xi_123 = xi_122 * 0.125;
        const double xi_125 =
            omega_shear *
            (xi_121 + xi_201 * -2.0 + xi_205 + xi_213 * -2.0 + xi_216 + xi_87 +
        ...
        const double xi_169 = xi_149 * (u_2 * xi_115 + xi_104 + xi_17 + xi_212);
        ...
        _data_pdfs_20_32_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_2 + xi_107 + xi_113 - xi_119 + xi_128 + xi_205;
        ...
        _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_5 - xi_141 + xi_143 + xi_146 + xi_147 + xi_204;
        ...
        _data_pdfs_20_313_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_13 + xi_188 + xi_189 + xi_192 + xi_208;
        _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_14 + xi_189 + xi_193 + xi_194 + xi_199;
        _data_pdfs_20_315_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_15 + xi_182 + xi_184 + xi_196 + xi_212;
        ...
        _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_17 + xi_192 + xi_193 + xi_197 + xi_215;
...
void CollideSweep::run(IBlock *block) {
  ...
  internal_collidesweep_collidesweep::collidesweep_collidesweep(
