  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_force_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_force_1; ctr_1 += 1) {
      ...
      for (int64_t ctr_0 = 0; ctr_0 < _size_force_0; ctr_0 += 1) {
        const double xi_196 = _data_force_20_30_10[_stride_force_0 * ctr_0];
        const double xi_197 = _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_203 = _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0];
        const double xi_204 = _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0];
        const double xi_205 = _data_pdfs_20_31_10[_stride_pdfs_0 * ctr_0];
        const double xi_206 = _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0];
        const double xi_207 = _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0];
        ...
        const double xi_217 = _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0];
        const double xi_0 = xi_197 + xi_201;
        const double xi_1 = xi_0 + xi_200;
        const double xi_2 = xi_205 + xi_211 + xi_217;
        const double xi_3 = xi_209 + xi_216;
        const double xi_4 = xi_204 + xi_210;
        const double xi_5 = xi_202 + xi_213;
        const double xi_6 = xi_203 + xi_207;
        const double xi_8 = -xi_210;
        const double xi_9 = -xi_198 + xi_8;
        const double xi_10 = -xi_203;
        const double xi_11 = -xi_214;
        const double xi_12 = -xi_204;
        const double xi_13 = xi_10 + xi_11 + xi_12;
        const double xi_14 = -xi_213;
        const double xi_15 = -xi_208;
        const double xi_16 = xi_14 + xi_15;
        const double xi_17 = -xi_202;
        const double xi_18 = -xi_216;
        const double xi_19 = xi_17 + xi_18;
        const double xi_20 = -xi_197;
        const double xi_21 = xi_10 + xi_20;
        const double xi_22 = -xi_211;
        const double xi_23 = -xi_207;
        const double xi_24 = xi_17 + xi_217 + xi_22 + xi_23;
        const double xi_40 = xi_215 * 0.166666666666667;
        const double xi_48 = xi_196 * 0.166666666666667;
        const double xi_52 = xi_199 * 0.166666666666667;
        const double xi_55 = xi_215 * 0.5;
        const double xi_59 = xi_196 * 0.0833333333333333;
        const double xi_63 = xi_215 * 0.0833333333333333;
        const double xi_73 = xi_199 * 0.0833333333333333;
        const double xi_84 = -xi_212;
        const double xi_85 = xi_207 * 3.0 + xi_209 * 3.0 + xi_84;
        const double xi_86 =
            omega_even * (xi_202 * -3.0 + xi_205 * 3.0 + xi_211 * -3.0 +
                          xi_213 * 3.0 + xi_216 * -3.0 + xi_217 * -3.0 + xi_85);
        const double xi_87 =
            xi_202 * 2.0 + xi_211 * 2.0 + xi_216 * 2.0 + xi_217 * 2.0;
        const double xi_88 = xi_200 * 5.0 + xi_204 * 5.0 + xi_87;
        const double xi_89 =
            omega_even *
            (xi_197 * -5.0 + xi_201 * -5.0 + xi_203 * -5.0 + xi_205 * -2.0 +
             xi_213 * -2.0 + xi_214 * -5.0 + xi_85 + xi_88);
        const double xi_92 = -xi_217;
        const double xi_93 = xi_18 + xi_92;
        const double xi_94 = -xi_206;
        const double xi_97 = -xi_201;
        const double xi_98 = xi_11 + xi_15 + xi_21 + xi_97;
        const double xi_100 = xi_214 * 2.0;
        const double xi_101 = xi_201 * 2.0;
        const double xi_102 = xi_197 * 2.0 + xi_203 * 2.0;
        const double xi_103 =
            omega_even *
            (xi_100 + xi_101 + xi_102 + xi_198 * -7.0 + xi_205 * 5.0 +
             xi_206 * -7.0 + xi_207 * -4.0 + xi_208 * -7.0 + xi_209 * -4.0 +
             xi_210 * -7.0 + xi_213 * 5.0 + xi_84 + xi_88);
        const double xi_104 = xi_216 + xi_92;
        const double xi_105 = xi_104 + xi_14 + xi_202 + xi_205 + xi_22;
        const double xi_107 = xi_105 * xi_106;
        const double xi_108 = xi_198 * 2.0;
        const double xi_109 = xi_208 * 2.0;
        const double xi_110 = xi_206 * -2.0 + xi_210 * 2.0;
        const double xi_111 = -xi_108 + xi_109 + xi_110 + xi_14 + xi_19 + xi_2;
        const double xi_113 = xi_111 * xi_112;
        const double xi_114 = -xi_113;
        const double xi_116 = xi_208 + xi_94;
        const double xi_120 = xi_103 * -0.0198412698412698;
        const double xi_121 = xi_203 + xi_214;
        ...
        const double xi_139 = xi_202 + xi_211;
        ...
        const double vel0Term = xi_1 + xi_206 + xi_208;
        ...
        const double u_2 = xi_7 * (vel2Term + xi_201 + xi_21 + xi_24);
        ...
        const double xi_77 = xi_56 * (u_0 * xi_199 * 0.5 + u_2 * xi_196 * 0.5);
        ...
        const double xi_122 = xi_207 + xi_209 - xi_91;
        const double xi_123 =
            omega_shear * (xi_0 + xi_121 + xi_122 + xi_16 - xi_205 + xi_96);
        const double xi_124 = xi_123 * 0.125;
        const double xi_125 =
            omega_shear *
            (xi_122 + xi_200 * -2.0 + xi_204 * -2.0 + xi_205 + xi_213 + xi_87 +
        ...
        const double xi_145 =
            rho * u_2 - vel2Term + xi_139 + xi_197 + xi_6 + xi_92 + xi_97;
        ...
        const double xi_183 = xi_148 * (u_2 * xi_129 + xi_10 + xi_132 + xi_197);
        ...
        _data_pdfs_20_33_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_3 - xi_131 + xi_134 + xi_136 + xi_137 + xi_204;
        _data_pdfs_20_34_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_4 + xi_131 - xi_134 + xi_137 + xi_138 + xi_200;
        _data_pdfs_20_35_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_5 - xi_141 + xi_144 + xi_146 + xi_147 + xi_209;
        _data_pdfs_20_36_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_6 + xi_141 + xi_143 - xi_146 + xi_147 + xi_207;
        _data_pdfs_20_37_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_7 + xi_152 + xi_155 + xi_160 + xi_198;
        _data_pdfs_20_38_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_8 + xi_155 + xi_161 + xi_163 + xi_206;
        _data_pdfs_20_39_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_9 + xi_160 + xi_161 + xi_165 + xi_210;
        _data_pdfs_20_310_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_10 + xi_152 + xi_163 + xi_165 + xi_208;
        _data_pdfs_20_311_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_11 + xi_169 + xi_177 + xi_180 + xi_217;
        _data_pdfs_20_312_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_12 + xi_177 + xi_181 + xi_182 + xi_216;
        ...
        _data_pdfs_20_314_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_14 + xi_187 + xi_191 + xi_192 + xi_201;
        ...
        _data_pdfs_20_316_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_16 + xi_169 + xi_181 + xi_194 + xi_202;
        _data_pdfs_20_317_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_17 + xi_190 + xi_191 + xi_195 + xi_203;
        _data_pdfs_20_318_10[_stride_pdfs_0 * ctr_0] =
            forceTerm_18 + xi_186 + xi_192 + xi_195 + xi_197;
      }
    }
  }
}
