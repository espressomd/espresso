...
public:
  ...
  /** @brief Get interpolated velocities at several positions. */
  virtual std::vector<Utils::Vector3d> get_velocities_at_pos(
      std::vector<Utils::Vector3d> const &positions) const = 0;
