...
public:
    ...
    Dirichlet_double_precision(BlockDataID fieldID_, BlockDataID indexVectorID_, std::function<double(const Cell &, const shared_ptr<StructuredBlockForest>&, IBlock&)>& dirichletCallback )
