...
frictioncouplingkernel_single_precision_frictioncouplingkernel_single_precision(
    float D, float *RESTRICT _data_f, float *RESTRICT const _data_j,
  ...
  for (int64_t ctr_2 = 1; ctr_2 < _size_f_2 - 1; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 1; ctr_1 < _size_f_1 - 1; ctr_1 += 1) {
      ...
      float *RESTRICT _data_j_2m1_310_11 =
          _stride_j_1 * ctr_1 + _stride_j_1 + _data_j_2m1_310;
      float *RESTRICT _data_j_2m1_312_1m1 =
      ...
      float *RESTRICT _data_j_20_31_11 =
          _stride_j_1 * ctr_1 + _stride_j_1 + _data_j_20_31;
      float *RESTRICT _data_j_21_37_11 =
...
void FrictionCouplingKernel_single_precision::run(IBlock *block) {
  ...
  internal_910e9429dc8b77dbed969a16d3f227fb::
      frictioncouplingkernel_single_precision_frictioncouplingkernel_single_precision(
...
void FrictionCouplingKernel_single_precision::runOnCellInterval(
