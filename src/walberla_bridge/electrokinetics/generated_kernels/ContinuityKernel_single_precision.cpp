...
continuitykernel_single_precision_continuitykernel_single_precision(
    float *RESTRICT const _data_j, float *RESTRICT _data_rho,
...
void ContinuityKernel_single_precision::run(IBlock *block) {
  ...
  internal_990034b4e4dd57d2802b4bcb5f716e46::
      continuitykernel_single_precision_continuitykernel_single_precision(
...
void ContinuityKernel_single_precision::runOnCellInterval(
