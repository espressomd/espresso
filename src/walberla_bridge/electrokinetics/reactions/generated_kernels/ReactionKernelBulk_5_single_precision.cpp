...
reactionkernelbulk_5_single_precision_reactionkernelbulk_5_single_precision(
    ...
    float *RESTRICT _data_rho_4, int64_t const _size_rho_0_0,
    ...
    int64_t const _stride_rho_4_2, float order_0, float order_1, float order_2,
  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_rho_0_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_rho_0_1; ctr_1 += 1) {
      ...
      float *RESTRICT _data_rho_4_20_10 =
...
void ReactionKernelBulk_5_single_precision::runOnCellInterval(
