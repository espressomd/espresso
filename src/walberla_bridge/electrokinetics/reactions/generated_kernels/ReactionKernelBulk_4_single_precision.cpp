...
namespace internal_reactionkernelbulk_4_single_precision_reactionkernelbulk_4_single_precision {
static FUNC_PREFIX void
reactionkernelbulk_4_single_precision_reactionkernelbulk_4_single_precision(
    float *RESTRICT _data_rho_0, float *RESTRICT _data_rho_1,
    float *RESTRICT _data_rho_2, float *RESTRICT _data_rho_3,
    ...
    int64_t const _stride_rho_3_2, float order_0, float order_1, float order_2,
  ...
  for (int64_t ctr_2 = 0; ctr_2 < _size_rho_0_2; ctr_2 += 1) {
    ...
    for (int64_t ctr_1 = 0; ctr_1 < _size_rho_0_1; ctr_1 += 1) {
      ...
      float *RESTRICT _data_rho_3_20_10 =
  ...
  // internal_reactionkernelbulk_4_single_precision_reactionkernelbulk_4_single_precision
...
void ReactionKernelBulk_4_single_precision::runOnCellInterval(
