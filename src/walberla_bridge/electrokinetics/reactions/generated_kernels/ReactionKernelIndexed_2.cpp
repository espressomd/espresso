...
//
//! \\file ReactionKernelIndexed_2.cpp
//! \\author pystencils
//======================================================================================================================

#include <cmath>

#include "ReactionKernelIndexed_2.h"
...
namespace internal_reactionkernelindexed_2_boundary_ReactionKernelIndexed_2 {
static FUNC_PREFIX void
reactionkernelindexed_2_boundary_ReactionKernelIndexed_2(
...
void ReactionKernelIndexed_2::run_impl(IBlock *block, IndexVectors::Type type) {
  ...
  internal_reactionkernelindexed_2_boundary_ReactionKernelIndexed_2::
      reactionkernelindexed_2_boundary_ReactionKernelIndexed_2(
...
void ReactionKernelIndexed_2::run(IBlock *block) {
  run_impl(block, IndexVectors::ALL);
}

void ReactionKernelIndexed_2::inner(IBlock *block) {
  run_impl(block, IndexVectors::INNER);
}

void ReactionKernelIndexed_2::outer(IBlock *block) {
