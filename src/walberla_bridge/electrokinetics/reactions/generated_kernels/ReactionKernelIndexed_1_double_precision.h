...
//
//! \\file ReactionKernelIndexed_1_double_precision.h
//! \\author pystencils
//======================================================================================================================
...
public:
    ...
    ReactionKernelIndexed_1_double_precision( const shared_ptr<StructuredBlockForest> & blocks,
        ...
        : rho_0ID(rho_0ID_), order_0_(order_0), rate_coefficient_(rate_coefficient), stoech_0_(stoech_0)
    {
        ...
        indexVectorID = blocks->addStructuredBlockData< IndexVectors >( createIdxVector, "IndexField_ReactionKernelIndexed_1_double_precision");
    };
