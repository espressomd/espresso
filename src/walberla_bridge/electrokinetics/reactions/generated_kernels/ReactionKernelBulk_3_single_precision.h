...
{
public:
    ReactionKernelBulk_3_single_precision( BlockDataID rho_0ID_, BlockDataID rho_1ID_, BlockDataID rho_2ID_, float order_0, float order_1, float order_2, float rate_coefficient, float stoech_0, float stoech_1, float stoech_2 )
    ...
    static std::function<void (IBlock *)> getSweep(const shared_ptr<ReactionKernelBulk_3_single_precision> & kernel)
    {
        return [kernel] 
               (IBlock * b) 
               { kernel->run(b); };
    ...
    static std::function<void (IBlock*)> getSweepOnCellInterval(const shared_ptr<ReactionKernelBulk_3_single_precision> & kernel, const shared_ptr<StructuredBlockStorage> & blocks, const CellInterval & globalCellInterval, cell_idx_t ghostLayers=1)
    {
