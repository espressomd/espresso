...
MACRO(TEST_C99 OUTPUT_VARIABLE)
  IF(NOT ${OUTPUT_VARIABLE})
    ...
    FOREACH(TEST_C99_FLAG '' -std=gnu99 -std=c99 -c99 -AC99 -xc99=all -qlanglvl=extc99)
      ...
      IF(FOUND_C99_FLAG)
        SET(${OUTPUT_VARIABLE} ${TEST_C99_FLAG} CACHE INTERNAL "Result of TestC99" FORCE)
	MESSAGE(STATUS "Compiler option for C99: ${${OUTPUT_VARIABLE}}")
        BREAK()
      ENDIF(FOUND_C99_FLAG)
    ENDFOREACH(TEST_C99_FLAG)
    IF(NOT FOUND_C99_FLAG)
      SET(${OUTPUT_VARIABLE} C99-NOTFOUND CACHE INTERNAL "Result of TestC99" FORCE)
    ENDIF(NOT FOUND_C99_FLAG)
  ENDIF(NOT ${OUTPUT_VARIABLE})
ENDMACRO(TEST_C99)
