...
par(mfrow=c(2,2))
plot(data.frame(particle0[13], particle0[1]), xlim=c(ct-zoomX, ct), ylim=c(c0posx-zoomX, c0posx))
points(data.frame(particle1[13], particle1[1]), col=2)
points(data.frame(particle2[13], particle2[1]), col=3)
#points(data.frame(particle2[13], interpolatedp2x), col=4)
legend("topleft",c("p0","p1","p2"), col=c(1,2,3), pch=c(1,1,1))


plot(data.frame(particle0[13], particle0[4]), xlim=c(ct-zoomX, ct), ylim=c(c0vx-zoomX, c0vx))
...
## plot(particle0[[13]], l0, ylim=c(0,5))
## points(particle0[[13]], lp0, col=2)
## #points(particle0[[13]], (0.5 * l0 * interpolatedlp0), col=3)
