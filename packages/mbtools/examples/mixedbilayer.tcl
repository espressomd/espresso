...
#
#
# To run this file use $ESPRESSO_SOURCE/$PLATFORM/Espresso ./scripts/main.tcl mixedbilayer.tcl
#
...
# type 2.  Note that the bonding interactions are also different.  In
# both cases consecutive atoms are bonded by FENE (type 0 ) but the
# bending interactions are different (type 1 and 2 respectively).  See
# the specification of bonded interactions later in this file.
