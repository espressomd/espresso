...
\url{http://espressomd.org/html/doc/visualization.html#opengl-visualizer}.
Specific visualization examples for \es can be found in the \path{samples}
folder. You may need to recompile \es with the required features used in the
examples.
