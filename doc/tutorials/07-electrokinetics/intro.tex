...
This tutorial is divided into three sections. The first section \todo{ref} introduces the electrokinetic equations and the analytical solution for the slit pore system, the second \todo{ref} discusses the structure of the EK algorithm imlemented in \ES{}, and the third section \todo{ref} deals exclusively with the simulation, its setup, and the results.
