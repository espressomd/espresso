...
# physical constants
amu=const.physical_constants['atomic mass constant'][0]; # kg atomic mass unit
...
class si_units():
    def __init__(self, **kwargs):
        ...
        self.conc_N_sigma_to_mol_L=1.0e-3/(N_Av*(self.params['sigma_in_nm']*1e-9)**3);
        pass;
    ...
    def convert(self,from_value,from_unit,to_unit,exponent=1.0):
        ...
        if (to_unit=="mol/L" and from_unit=="N/sigma^3"):
                return from_value/self.conc_N_sigma_to_mol_L;
        raise ValueError("conversion from {} to {} is not implemented\n".format(from_unit,to_unit))
