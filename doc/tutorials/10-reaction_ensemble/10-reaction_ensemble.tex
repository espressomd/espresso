...
When a dissociation move is attempted, the titratable molecule HA is charged and a counterion \ce{H+} is randomly placed into the simulation box, while when an association move is attempted, a \ce{A-} is neutralized and a random counterion \ce{A+} is removed from the cell.
