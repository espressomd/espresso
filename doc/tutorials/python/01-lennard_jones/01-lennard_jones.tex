...
\newpage
\section{Exercise 1: Binary Lennard-Jones Liquid}
...
If you need a hint, look at the \texttt{two-component.py} script in the \texttt{scripts} directory. Run \texttt{two-component-visualization.py} to see a visualization.
\end{task}


\section{Exercise 2: Measuring the particles' mean square displacement}
...
If you need a hint, look at \texttt{msd.py} in the \texttt{scripts} directory.
\end{task}
