...
the type of correlation, in this case \codees{"scalar_product"},
which gives the MSD. The time step \codees{dt}
...
(e.g., \codees{vel=5.0}). You can plot these using \codees{matplotlib.pyplot}, 
for instance.
