...
On the other hand, flexibility of \es stems from the employment of Tcl at
...
\todo{Maybe available simulation methods would be a better name?}
...
The Tcl interpreter contains several special commands as an
