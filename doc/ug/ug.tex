...
\usepackage[hidelinks,backref]{hyperref}  % automatically creates links when
...
\usepackage{chemfig} %chemical reactions
...
%Python
\newsavebox{\thepyessyntaxbox}
\newlength{\pyessyntaxboxheight}
\newlength{\pyessyntaxboxdepth}
\newenvironment{pyessyntaxbox}{%
  \par\noindent%
 \begin{lrbox}{\thepyessyntaxbox}%
   \begin{minipage}{\linewidth-5em}%
     \ttfamily%
     \hyphenpenalty=10000% prevent hyphenation
     \setlength{\parindent}{-3em}%
   ...
   \end{minipage}%
 \end{lrbox}%
 \settoheight{\pyessyntaxboxheight}{\usebox{\thepyessyntaxbox}}%
 \settodepth{\pyessyntaxboxdepth}{\usebox{\thepyessyntaxbox}}%
 \hspace{1.5em}%
 \rule[-\pyessyntaxboxdepth]{1pt}{\pyessyntaxboxheight+\pyessyntaxboxdepth}%
 \hspace{3.5em}%
 \usebox{\thepyessyntaxbox}%
}
...
%Python
\newcounter{pyessyntaxcounter}
\setcounter{pyessyntaxcounter}{0}
\newenvironment{pyessyntax}{%
  \stepcounter{pyessyntaxcounter}%
  \label{pyessyntax:\arabic{pyessyntaxcounter}}%
  % Create headings
...
% Declarations for the Python Syntax
\input{pypresso.tex}

% Alternative python code environment with pypresso syntax highlighting
\input{misc/common}
