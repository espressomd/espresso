...
% requiresfeature
\gdef\requiresfeaturesave{}
\newlength{\requiresfeaturewidth}
\newcounter{requiresfeaturecounter}
\newcommand{\requiresfeature}[2]{%
  \mbox{%
    \begingroup%
    \setlength{\fboxsep}{2pt}%
    \fbox{#1}\,%
    \endgroup%
    \raisebox{0.5ex}{\footnotesize%
      \arabic{requiresfeaturecounter}%
    }%
  }%
  % append the feature 
  \xdef\requiresfeaturesave{%
    \requiresfeaturesave\noexpand\newline%
    \noexpand\raisebox{0.5ex}{\noexpand\footnotesize%
      \arabic{requiresfeaturecounter}%
    }\,%
    #2%
  }%
...
\newenvironment{essyntax}[1][NONE]{%
  \ifthenelse{\equal{#1}{NONE}}{}{%
    \gdef\requiresfeaturesave{#1}%
  }%
  \setcounter{requiresfeaturecounter}{1}%
  % Create headings
  \minisec{Syntax}\nopagebreak%
  ...
  \end{essyntaxbox}%
%  \ifthenelse{\equal{\requiresfeaturesave}{}}{}{
    \minisec{Required features}\nopagebreak%
    \nopagebreak%
    \ttfamily\requiresfeaturesave%
    \gdef\requiresfeaturesave{}%
%  }
  \minisec{Description}%
}
