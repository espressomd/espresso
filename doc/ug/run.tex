...
\begin{essyntax}
  ...
  \variant{10} reaction\_ensemble wang\_landau initialize
  \variant{11} reaction\_ensemble wang\_landau final\_wang\_landau\_parameter \var{final\_wang\_landau\_parameter}
  \variant{12} reaction\_ensemble wang\_landau full\_path\_to\_output\_filename \var{full\_path\_to\_output\_filename}
  \variant{13} reaction\_ensemble do_not_sample_reaction_partition_function
  \variant{14} reaction\_ensemble wang\_landau update\_maximum\_and\_minimum\_energies\_at\_current\_state
  \variant{15} reaction\_ensemble wang\_landau write\_out\_preliminary\_energy\_run\_results \var{energy\_boundary\_filename}
  \variant{16} reaction_ensemble wang_landau \var{wang\_landau\_relaxation\_setps} 
