...
\begin{essyntax}
  ...
  \variant{7} reaction\_ensemble water\_type \var{type}
  ...
  \variant{12} reaction\_ensemble wang\_landau final\_wang\_landau\_parameter \var{final\_wang\_landau\_parameter}
  \variant{13} reaction\_ensemble wang\_landau full\_path\_to\_output\_filename \var{full\_path\_to\_output\_filename}
  \variant{14} reaction\_ensemble wang\_landau do\_not\_sample\_reaction\_partition\_function
  \variant{15} reaction\_ensemble wang\_landau update\_maximum\_and\_minimum\_energies\_at\_current\_state
  \variant{16} reaction\_ensemble wang\_landau write\_out\_preliminary\_energy\_run\_results \var{energy\_boundary\_filename}
  \variant{17} reaction_ensemble wang_landau \var{wang\_landau\_setps}
    \variant{18} reaction\_ensemble wang\_landau use\_hybrid\_monte\_carlo (Requires feature CONSTRAINTS)
  \variant{19} reaction\_ensemble [wang\_landau] do
  \variant{20} reaction\_ensemble wang\_landau write\_wang\_landau\_checkpoint \var{unique identifier}
  \variant{21} reaction\_ensemble wang\_landau load\_wang\_landau\_checkpoint \var{unique identifier}
  \variant{22} reaction\_ensemble monte\_carlo\_move\_for\_type \var{type}
  \variant{23} reaction\_ensemble cylindrical\_constraint\_in\_z\_direction center \var{cyl_x} \var{cyl_y} radius \var{radius}
  \variant{24} reaction\_ensemble volume \var{volume}
