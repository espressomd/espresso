...
\begin{pysyntax}
	...
	}{ f\textunderscore max = \arg{double},
	   gamma			    = \arg{double}, 
	   max\textunderscore steps = \arg{double},
	   max\textunderscore displacement = \arg{double} 
   }\\
   \object{espressomd.minimize_energy}{minimize}{}\\
   \object{System.minimize_energy}{init
	}{ f\textunderscore max = \arg{double},
	   gamma			    = \arg{double}, 
	   max\textunderscore steps = \arg{double},
	   max\textunderscore displacement = \arg{double} 
   }\\
   \object{System.minimize_energy}{minimize}{}
\end{pysyntax}
