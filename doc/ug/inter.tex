...
\begin{pysyntax}
	...
	\object{
		...
		mesh=[\arg{int}, \arg{int}, \arg{int}],
		cao=\arg{int},
		alpha=\arg{double},
		alpha=\arg{double},
		epsilon=metallic | \arg{double},
		inter=\arg{int},
		[mesh\textunderscore off=[\arg{double}, \arg{double}, \arg{double}]],
	}
	\begin{features}
...
\begin{pysyntax}
	\object{
		...
		bjerrum\textunderscore length=\arg{double},
		accuracy=\arg{double},
		precision=\arg{double},
		K\textunderscore max=\arg{int} | [\arg{int}, \arg{int}, \arg{int}],
		[alpha=\arg{double}],
	}
	\begin{features}
		\required{ELECTROSTATICS}
...
\begin{pysyntax}
	\object{
		...
		bjerrum\textunderscore length=\arg{double},
		maxPWerror=\arg{double}, 
		[far\textunderscore cut=\arg{double}],
		dielectric=1,
		top=\arg{double},
		mid=\arg{double},
		bot=\arg{double}
	...
	\object{ 
		...
		[far\textunderscore cut=\arg{double}],
		capacitor=1,
		pot\textunderscore diff=\arg{double}
	}[
	]
	\leavevmode\\
	\object{ 
		...
		maxPWerror=\arg{double}, 
		[far\textunderscore cut=\arg{double}],
		dielectric\textunderscore contrast\textunderscore on=1,
		delta\textunderscore mid\textunderscore top=\arg{double},
		delta\textunderscore mid\textunderscore bot=\arg{double}
	}[
	]
\end{pysyntax}
...
\begin{pysyntax}
	...
	bjerrum\textunderscore length=\arg{double},
	[far\textunderscore switch\textunderscore radius=\arg{double},]
	maxPWerror=\arg{double}
	}	
	\begin{features}
...
\begin{pysyntax}
	\object{
		...
		MMM1D\textunderscore GPU
	}{
		bjerrum\textunderscore length=\arg{double},
		[far\textunderscore switch\textunderscore radius=\arg{double}],
		[bessel\textunderscore cutoff=\arg{int}],
		maxPWerror=\arg{double}
	}
	\begin{features}
