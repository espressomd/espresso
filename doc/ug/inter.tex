...
This command activates the P3M method to handle the electrostatic
interactions between charged particles. The interaction type is:
\begin{equation}
...
This command activates the P3M method to handle the magnetostatic
interactions (magnetic dipole-dipole) (so-called dipolar P3M). The
interaction type is
\begin{equation}
...
This method should only be used if it is not possible to P3M or DLC
and has a low accuracy.
