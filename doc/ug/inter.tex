...
might not achieve the requested precision for highly symmetric
systems. Because of the nature of the P3M algorithm, systems are
problematic where most charges are placed in one plane, or on a grid.

The function employs the analytical expression of the error estimate
for the P3M method \cite[8.23]{hockney88} and its real space error
