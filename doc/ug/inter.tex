...
Without any arguments, {\tt inter} returns a list of all defined interactions as a
Tcl-list. The format of each entry corresponds to the syntax described below,
\eg
\begin{tclcode}
...
particles. Many of the following potentials are therefore singular at zero
distance. This is not a problem during the simulation, as particles will simply not
overlap, but my cause a problem during the equilibration of the system.

lj_forcecap: LJ, LJ generic and ljcos2
