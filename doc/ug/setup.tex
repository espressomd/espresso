...
\subsubsection{Transverse DPD thermostat}\label{sec:transDPD}
This is an extension of the above thermostat\cite{junghans2008}, which dampes the degrees of freedom
perpendicular on the axis between two particles. To switch it on, the feature TRANS_DPD is required.
...
\subsubsection{Interaction DPD thermostat}\label{sec:interDPD}
