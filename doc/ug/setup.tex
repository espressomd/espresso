...
\begin{essyntax}
  thermostat langevin \var{temperature} \var{gamma\_trans} \opt{\alt{\var{gamma\_rotate} \asep \var{gamma\_rotate\_x} \var{gamma\_rotate\_y} \var{gamma\_rotate\_z}}} \opt{on/off} \opt{on/off}
\end{essyntax}
...
refer to \cite{grest86a}. Feature \feature{ROTATIONAL_INERTIA} enables an anisotropic diffusion coefficient tensor through corresponding friction coefficients \var{gamma\_rotate\_x} \var{gamma\_rotate\_y} \var{gamma\_rotate\_z}.
It helpts to simulate anisotropic colloids (rods, etc.) properly.
