...
\item[periodicity] (bool[3]) Specifies periodicity for the three
  ...
  readonly and gives the default setting (1,1,1). Caveat: Be aware of the fact that setting a dimension to be not periodic does not hinder particles from leaving the box in this direction. In this case for keeping particles in the simulation box a constraint has to be set.
