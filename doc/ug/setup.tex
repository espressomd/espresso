...
\variant{5} on\_collision \opt{exception} glue_to_surface \var{d} \var{bond1} \var{bond2} \var{type} \var{type2} \var{type3} \var{d2}
\end{essyntax}
...
After the collision, the particle of type \var{type3} is changed to type 0.
\end{itemize}
