...
\begin{essyntax}
  kill_particle_forces \require{1}{\opt{torque}}
  \begin{features}
    \required[1]{ROTATION}
  \end{features}
\end{essyntax}
This command sets all forces on the particles to zero, as well as all torques if the option \texttt{torque} is specified and  the feature ROTATION has been compiled in.
