...
\item The particle type of the virtual sites created in ``bind at point of collision`` approach is always 1.
...
\variant{3} collision\_detection bind\_at\_point\_of\_collision} \var{d} \var{bodd1} \var{bodd2}
\end{essyntax}

Here, \var{d} is the distance at which the bond is created, \var{bond1} denotes the type of the bodd created between the collideng partecles, and \var{bond2} determines the type of the bond created between the virtual sites (if applicable).
