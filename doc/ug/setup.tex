...
\begin{essyntax}
  thermostat dpd \var{temperature} \var{gamma} \var{r\_cut} \opt{ WF \var{wf} }
\end{essyntax}
...
The constants $\sigma $ and $\zeta $ are calculated in the following way:

$$ \zeta = \frac{\var{gamma}}{\var{time\_step}} \; \; \; , \; \; \; \; \; \; \sigma = \sqrt{\var{temperature} \; \zeta} $$
