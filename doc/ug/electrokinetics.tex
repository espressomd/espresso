...
\begin{essyntax}
  ...
  \opt{reactant_resrv_density \var{reactant\_resrv_density}}
  \opt{product0_resrv_density \var{product0\_resrv_density}}
  \opt{product1_resrv_density \var{product1\_resrv_density}}
...
\var{reactant\_resrv_density}, \var{product0\_resrv_density}, and
\var{product1\_resrv_density}, respectively. These reservoir densities, in tandem
