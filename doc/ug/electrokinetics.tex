...
\textbf{TODO: complete in broad strokes the applicability of the model + difference in temperatures between EK and LB species.}
...
Eqs.~\eqref{eq:ek-reaction-continuity}-\eqref{eq:ek-reaction-continuity-fl}, in our 
