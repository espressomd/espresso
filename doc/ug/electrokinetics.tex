...
\begin{align}
  \frac{\partial \rho_k}{\partial t} &= -\,\nabla\cdot\vec j_k \; , \vphantom{\left(\frac{\partial \vec v}{\partial t} \right)} \label{eq:ek_model_continuity}\\
  \vec j_{k} &= -D_k \nabla \rho_k - \nu_k \, q_k \rho_k\, \nabla \Phi + \rho_\mathrm{k} \vec v \; , \vphantom{\left(\frac{\partial \vec v}{\partial t} \right) \sum_k} \label{eq:ek_model_fluxes}\\
  \Delta \Phi &= -4 \pi \, \lb \, \kT \sum_k q_k \rho_k \; , \vphantom{\left(\frac{\partial \vec v}{\partial t} \right)} \label{eq:ek_model_poisson}\\
  ...
  \frac{\partial \rho_\text{fl}}{\partial t} &= -\,\nabla\cdot\left( \rho_\text{fl} \vec v \right) \vphantom{\left(\frac{\partial \vec v}{\partial t} \right)} \label{eq:ek_model_continuity_fl}
\end{align}
...
TODO broad borders on the applicability of the model.
\begin{itemize}
