...
If you are interested in using the electrokinetic implementation in \es{} for scientific purposes, please contact G.~Rempfer before you start your project.
...
(local) catalytic reaction which converts one species into another.\\

If you are interested in using this implementation in \es{} for scientific purposes, please contact J.~de~Graaf before you start your project.\\
