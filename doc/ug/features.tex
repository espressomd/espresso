...
\todo{This list is not complete! To get a full list of available
  features, look into \texttt{myconfig-sample.h}.}
...
\item \newfeature{ROTATION} Switch on rotational degrees of freedom
  ...
  large.  \todo{Docs for rotation missing}
...
\item \newfeature{VIRTUAL\_SITES} Virtual sites are particles, the position and velocity of which is not obtained by integrating equations of motion. Rather, they are placed using the position (and orientation) of other particles. This allows for rigid arrangements of particles and for placing a particle in the center of mass of a set of other particles. See section \ref{sec:virtual}.
\item \newfeature{OLD_RW_VERSION} This switches back to the old,
