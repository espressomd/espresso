...
observables. Different observables may require different further parameters.
\begin{essyntax}
  \variant{2} correlation \var{id} autoupdate start
  \variant{3} correlation \var{id} finalize
  \variant{4} correlation \var{id} print \opt{formatted}
...
\variant{2} 
Starts automatically updating the correlation estimates as often as 
required by the specified \var{dt}.
