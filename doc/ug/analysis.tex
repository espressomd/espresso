...
This command returns the temperature of the lattice-Boltzmann (LB) fluid, see Chapter~\ref{sec:lb},
by averaging over the fluid nodes. In case \lit{LB\_BOUNDARIES} or \lit{LB\_BOUNDARIES\_GPU}
