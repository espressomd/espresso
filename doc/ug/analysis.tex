...
\begin{pysyntax}
  \object{
    ...
    r_max = \arg{float},
    r_bins = \arg{int (100)},
    log_flag = \arg{int 0/1},
    int_flag = \arg{int (0)/1}
  }
\end{pysyntax}
...
\begin{pysyntax}
  \object{
    espressomd.System.analsysis
  }{
    cylindrical_average
  }{
    center = \arg{array of 3 floats},
    direction = \arg{array of 3 floats},
    length = \arg{float},
    radius = \arg{float},
    bins_axial = \arg{int},
    bins_radial = \arg{int},
...
\begin{pysyntax}
  \object{
    ...
    etype = \arg{string 'all'/'bonded'/'non_bonded'},
  }
\end{pysyntax}
...
\begin{pysyntax}
  \object{
    ...
    periodicity = \arg{array of three ints},
    range_start = \arg{array of three floats},
    stress_range = \arg{array of three floats},
    bins = \arg{array of ints}
  }
\end{pysyntax}
