...
The generic arguments to any observable for which they make sense are
  \begin{itemize}
    ...
    \todo{the following two do not really work yet}
...
\variant{2} 
With \lit{autoupdate \{start | stop\}} it starts or stops automatically updating t
he correlation estimates. The update frewuency is automatically adjusted based 
the value of \var{dt} provided when defining the correlation.
...
\begin{figure}[ht]
\includegraphics[width=7cm]{figures/data_set_N}
