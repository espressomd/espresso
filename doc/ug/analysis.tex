...
index_radial index_axial pos_radial pos_radial binvolume density v_radial v_axial density v_radial v_axial
0            0           0.05       -0.25      0.0314159 0       0        0       0       0        0
0            1           0.05       0.25       0.0314159 31.831  1.41421  1       0       0        0
\end{SaveVerbatim}
\bigbreak\noindent%
...
\end{pysyntax}
\begin{essyntax}
  analyze momentum \opt{particles}
\end{essyntax}
This command returns the total linear momentum of the particles and the lattice-Boltzmann (LB) fluid, if one exists. Giving the optional parameter particles
causes the command to ignore the contribution of LB. In the Python interface both particles and fluid can be toggled on and off using the include_particles and
include_lbfluid flags respectively.
