...
in P3M. For electrostatic interactions, the $k$-space contribution is not well tested, 
so use with caution!
...
Only two-body bonded interactions (FENE, Harmonic) are included 
(angular and dihedral are not).
In case of rotation, virial contribution from torques is not included.
