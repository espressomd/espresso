...
\begin{essyntax}
  ...
  \begin{features}
    ...
    \required[2]{ROTATION}
    \required[3]{DIPOLES}
    \required[4]{Essential for TUNABLE_SLIP boundary interactions} 
  \end{features}
\end{essyntax}
...
have to be negative. For the tunable-slip boundary
interactions you have to set {\bf two} constraints.\\
{\em Example:} 
\var{x}=-10.0,
\var{y}=-10.0,
\var{z}=20.0
creates an infinite plane in $z$-direction at $z=20.0$.
