...
\item[\opt{bond \var{type_bond}}] Sets the type number of the bonded
  interaction to be set between the monomers. This defaults to 0. \todo{Link to
  bonded interactions}
...
\var{a}. \todo{A picture would be helpful.}
