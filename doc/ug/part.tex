...
a (\var{a_x} \var{a_y} \var{a_z}), b (\var{b_x} \var{b_y} \var{b_z}) and 
c (\var{c_x} \var{c_y} \var{c_z}).
...
\item In a simulation on more than one cpu, the effective cell size
  ...
  distance. Espresso issues a warning when creating a virtual site with vs\_auto\_relate\_to and the cutoff is insufficient.
