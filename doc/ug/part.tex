...
\begin{essyntax}
  ...
  \require{12}{\opt{swimming \alt{\alt{v_swim \var{v\_swim} \asep f_swim \var{f\_swim}} \alt{pusher \asep puller} dipole_length \var{dipole\_length}} \asep off}}
  \begin{features}
...
\item[\opt{swimming \alt{\alt{v_swim \var{v\_swim} \asep f_swim \var{f\_swim}} \alt{pusher \asep puller} dipole_length \var{dipole\_length} \asep off}}]
