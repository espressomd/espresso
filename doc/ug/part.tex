...
\begin{essyntax}
  ...
  dist \var{d} type \var{id} penetrable \var{flag}
  
  \variant{2}
  constraint sphere center \var{c_x} \var{c_y} \var{c_z} 
  radius \var{rad} direction \var{direction} type \var{id} \opt{penetrable \var{flag}} 
...
the \codebox{inter} command. In vatiants \variant{1} to \variant{4}, constraints
