...
\item[\opt{solvation \var{solv1A} \var{solv2A} \var{solv1B} \var{solv2B}}] Sets the four solvation coupling constant for the two components of a Shan-Chen fluid, as documented in Section \ref{sec:scmd-coupling}.
\end{arguments}
