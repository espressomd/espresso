...
\begin{pysyntax}
	\object{espressomd}{polymer}{
		N\textunderscore P = \arg{int},
		MPC = \arg{int},
		bond\textunderscore length = \arg{double},
		start\textunderscore id = \arg{int},
		start\textunderscore pos = \arg{ndarray},
		mode = 0 or 1 or 2,
		shield = \arg{double},
		max\textunderscore tries = \arg{int},
		val\textunderscore poly = \arg{double},
		charge\textunderscore distance = \arg{int},
		type\textunderscore poly\textunderscore neutral = \arg{int}, 
		type\textunderscore poly\textunderscore charged = \arg{int},
		bond\textunderscore id = \arg{int}, 
		angle = \arg{double} , 
		angle2 = \arg{double}, 
		pos2 = \arg{ndarray}, 
		constraint = 0 or 1
