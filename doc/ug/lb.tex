...
A complete description of the copuling scheme can be found in \cite{sega13c}.

\section{SC component-dependent interactions between particles\label{sec:scmd-affinity}}
