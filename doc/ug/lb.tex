...
specified with the option \lit{mobility}. Additional details are
...
modified with the \lit{lbdnode} command.


\section{Coupling particles to the Shan-Chen fluid\label{sec:scmd-coupling}}
The coupling of particles to the Shan-Chen fluid has been conceived as an extension
...
The particle property \lit{solvation} sets the coupling constants
...
\begin{tabular}{p{0.2\columnwidth}p{0.5\columnwidth}}
  \lit{rho}\ & the density (one scalar$^1$ or two scalars$^2$). \\
