...
In the GPU implementation the force can be interpolated using a three point scheme which couples the particles to the nearest 27 LB nodes.
This can be called using ``lbfluid \lit{couple} 3pt'' and is described in D\"{u}nweg and Ladd in equation 301\cite{duenweg08a}.
