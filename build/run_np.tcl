...
set distVtk  [expr $numSteps / ($numSteps / 10000)]
set distCellSeq [expr $numSteps / ($numSteps / 1000)]
set distDone 1000
...
puts "Volumetric Flow Rate = $QP"
puts "Pressure Gradient = $PP"
puts "External Force with G: $G = $FP"
...
puts $simInfo "cappilary number G = $G"
puts $simInfo "shear rate = $shear_rate"
puts $simInfo "fluid velocity for shear flow = $u"
puts $simInfo "external force for poiseuille flow = $FP"
...
#set type of flow 0-Shear flow with +-$u at walls and ext_force 0, 1-Hagen–Poiseuille flow with ext_force $FP and 0 at walls
set flow 0 
